<?php	
	...
	//имя базы данной
	define('DB_NAME', 'imon');
	//define('DB_NAME', 'imon_samara1');
	//define('DB_NAME', 'imon_omsk');
	...
	define('MOBILE_GUEST_GROUP_ID', '-2');
	define('MOBILE_VIP_GROUP_ID', '-2');
	define('MOBILE_GUEST_GROUP_NAME', 'MobileGuest');
	define('MOBILE_VIP_GROUP_NAME', 'MobileVIP');
	...
	class OperationState
	{
		...
		const EXECUTING = 2;
		//успешно завершена
		const SUCCESS_ENDED = 3;
		//завершена с ошибкой
		const FAILED_ENDED = 4;
	}
?>