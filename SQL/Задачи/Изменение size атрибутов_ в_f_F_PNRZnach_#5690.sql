/* Start - #5690 - Изменение size атрибутов в f_F_PNRZnach - shelpanov - 10.06.2013 */
...
UPDATE [DV].MetaObjects SET Configuration = '<?xml version="1.0" encoding="windows-1251"?>
		...
		<Attributes>
			...
			<Attribute objectKey="a598371d-5e4d-4b2e-bcde-d65741722b38" name="Info" caption="Дополнительная информация" type="ftString" size="200" nullable="true" lookupType="1" position="13" />
			<Attribute objectKey="987ce7ce-427a-4362-a785-49cd1d6813fe" name="Source" caption="Источник информации" type="ftString" size="4000" nullable="true" lookupType="1" position="14" />
		</Attributes>
		</DataTable>
		</DatabaseConfiguration>'
...
/* End - #5690 - Изменение size атрибутов в f_F_PNRZnach - shelpanov - 10.06.2013 */
