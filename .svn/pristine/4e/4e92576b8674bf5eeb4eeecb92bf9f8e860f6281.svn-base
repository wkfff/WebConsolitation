...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
    public partial class FO_0035_0018 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            dt = GetDataSource("FO_0035_0018_chart_incomes");
        ...
        private DataTable GetDataSource(string queryName)
        {
            ...
            for (int i = 0; i < dtSource.Rows.Count; i++)
            {
                ...
                if (dtSource.Rows[i][4] != DBNull.Value &&
                    dtSource.Rows[i][5] != DBNull.Value)
                {
                    dtSource.Rows[i][4] = Convert.ToDouble(dtSource.Rows[i][4].ToString()) + Convert.ToDouble(dtSource.Rows[i][5].ToString());
                }
            }
