    ...
    <div>
        ...
        <table style="width: 100%; border-collapse: collapse">
            ...
            <tr>
                ...
                <asp:Label ID="Texto" runat="server" Text="Текст отчёта" Font-Names="Arial" Font-Size="12pt"></asp:Label></td>
                <td class="right">
                </td>
            </tr>
            <tr>
                    ...
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel3" runat="server"
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                            ...
                            <tr>
                                ...
                                <td class="headerReport" style="width: 439px">
                                    <asp:Label ID="Label10" runat="server" CssClass="ElementTitle" Text="Структура показателя"></asp:Label></td>
                                <td class="headerright">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="background-color: white">
                                    ...
                                    <igchart:UltraChart id="UltraChart3" runat="server" Version="9.1"   BackgroundImageFileName EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="UltraChart3_DataBinding" ChartType="AreaChart" OnFillSceneGraph="FillSceneGraph" OnInvalidDataReceived="UltraChart3_InvalidDataReceived" Width="1143px">
