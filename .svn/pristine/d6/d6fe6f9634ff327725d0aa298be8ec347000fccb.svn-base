<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0035_0025.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0025" %>
...
<body link="White" vlink="White" style="background-color: black;">
    ...
    <div style="position: absolute; width: 768px; height: 950px; top: 0px; left: 0px;
        ...
        <table style="width: 765; height: 950; border-collapse: collapse; background-color: Black;
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="lbDescriptionKosgu" runat="server" SkinID="InformationText" Text=""></asp:Label>
                    <igtbl:UltraWebGrid ID="UltraWebGridKosgu" runat="server" Height="200px" Width="509px"
