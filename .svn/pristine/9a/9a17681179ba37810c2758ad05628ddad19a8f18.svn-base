<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FK_0001_0002_wm2_h.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FK_0001_0002_wm2_h" %>
...
<body bgcolor="black">
    <table style="width:100%; border-collapse: collapse;">
        <tr>
            <td align="left" valign="bottom" style="width:100%; border-collapse: collapse; background-color: black;">
                <asp:Label ID="LabelPageTitle" runat="server" Text="Label" SkinID="InformationText"></asp:Label> <br />
                <asp:Label ID="LabelComments1" runat="server" Text="Label" SkinID="InformationText"></asp:Label>                          
            </td>
        </tr>
        <tr>
        ...
        <tr>            
            <td>
                <asp:Label ID="LabelComments2" runat="server" Text="Label" SkinID="InformationText"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width:100%; border-right: 0px solid; border-top: 0px solid; background-image: url(../../../images/servePane.gif);
                ...
                border-collapse: collapse;" align="left" valign="top" colspan="" rowspan="">
