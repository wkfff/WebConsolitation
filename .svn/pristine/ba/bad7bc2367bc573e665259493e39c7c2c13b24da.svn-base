<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0032_0001_H.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0032_0001_H" %>
...
<body>
    ...
    <div>
            <table style="left: 0px; position: absolute; top: 0px; border-collapse: collapse; border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px;">
                     
        <tr><td style="background-color: black; border-right: 0px solid; border-top: 0px solid; border-left: 0px solid; border-bottom: 0px solid; position: static; border-collapse: collapse; width: 480px;" valign="top">
...
<Layout Behavior="Auto"></Layout>
                ...
                <DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_fo32_01_#SEQNUM(100).png" />
                    ...
                    <tr>
                     <td style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; background-color: black; background-image: url(../../../images/servePane.gif); position: static;" align="left" valign="top" colspan="" rowspan="">
