<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0033_0001_H.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0033_0001_H" %>
...
<body>
    ...
    <div>
    <table style="left: 320px; width: 160px; position: absolute; top: 0px; height: 365px; background-color: black">
    <tr><td></td></tr></table>
...
<igGaugeProp:SolidFillBrushElement Color="Silver"></igGaugeProp:SolidFillBrushElement>
                ...
                <DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Gaude_Fo_33_01_h_#SEQNUM(100).png" />
            </igGauge:UltraGauge>
            <gauges>
</gauges>
            ...
            <td style="font-weight: normal; font-size: 14px; color: #d1d1d1; font-family: arial; border-right: 0px solid; border-top: 0px solid; left: 150px; border-left: 0px solid; width: 168px; border-bottom: 0px solid; position: static; top: 45px; border-collapse: collapse; height: 150px; background-color: black;" valign="top" align="right">
                <table style="border-collapse: collapse;"><tr><td style="padding-right: 10px; padding-top: 10px; border-collapse: collapse; width: 86px; border-right: 0px solid; border-top: 0px solid; font-size: 16px; border-left: 0px solid; border-bottom: 0px solid; background-color: black; text-align: right; padding-left: 70px;" align="right">Исполнено</td></tr><tr><td style="padding-right: 5px; padding-top: 5px; font-weight: bold; font-size: 36px; color: #ffd400; font-family: arial; border-collapse: separate; height: 35px; width: 160px; background-color: black;" align="right"><asp:Label ID="lbExecuted" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="36px"
                ForeColor="#FFD400" Text="38.91"></asp:Label>%</td></tr>
                </table>
                <br />
                <br />
                <br />
     ...
     <!--       <tr>
            <td style="width: 320px; border-right: 0px solid; border-top: 0px solid; left: 0px; background-image: url(../../images/iSlice.gif); border-left: 0px solid; border-bottom: 0px solid; background-repeat: repeat-y; position: static; top: 406px; height: 2px; border-collapse: collapse;" align="left" valign="top" colspan="2"></td>
            </tr>
            <tr><td style="width: 315px; border-right: 0px solid; border-top: 0px solid; padding-left: 5px; background-image: url(../../images/iFooter.GIF); border-left: 0px solid; border-bottom: 0px solid; background-repeat: repeat-y; border-collapse: collapse; height: 25px; left: 0px; position: static; top: 408px;" align="left" valign="top" colspan="2">
