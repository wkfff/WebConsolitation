...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        &nbsp;<asp:Label ID="Label10" runat="server" Text="Label" CssClass="PageTitle"></asp:Label><br />
        <table style="width: 100%">
            <tr>
                <td style="text-align: left">
                    <asp:Label ID="Label15" runat="server" CssClass="PageSubTitle" Text="Анализ динамики и структуры основных показателей, характеризующих содержание и использование жилищного фонда в муниципальном образовании"></asp:Label></td>
        ...
        <br />
                    ...
                    <igtbl:UltraWebGrid ID="GT" runat="server" EnableAppStyling="True" OnActiveCellChange="GT_ActiveCellChange"
                        OnClick="web_grid_Click" OnDataBinding="GT_DataBinding" StyleSetName="Office2007Blue" OnInitializeLayout="GT_InitializeLayout">
                        <Bands>
                            <igtbl:UltraGridBand>
            ...
            <tr>
                <td style="vertical-align: top">
                    ...
                    <asp:Label id="Label2" runat="server" Text="Label" CssClass="ElementTitle"></asp:Label><br />
                        <igchart:UltraChart id="C1" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C1_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Height="334px" OnChartDrawItem="C1_ChartDrawItem">
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    ...
                    <asp:Label id="Label3" runat="server" Text="Label" CssClass="ElementTitle"></asp:Label><br />
                                    <igchart:UltraChart id="C2" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C2_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" OnChartDrawItem="C2_ChartDrawItem" Height="334px">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel3" runat="server"
                        ...
                        <igchart:UltraChart id="C3" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C3_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" Height="334px" OnChartDrawItem="C3_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel6" runat="server"
                        ...
                        <igchart:UltraChart id="C4" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C4_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C4_ChartDrawItem" Height="334px">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
            ...
            <tr>
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel4" runat="server"
                        ...
                        <igchart:UltraChart id="C21" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C21_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" ChartType="DoughnutChart" Height="334px" Width="410px" OnChartDrawItem="C21_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel5" runat="server"
                        ...
                        <igchart:UltraChart id="C22" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C22_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C22_ChartDrawItem" Height="334px">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    ...
                    <igchart:ultrachart id="C23" runat="server" backgroundimagefilename=""  
                        ...
                        version="9.1" OnDataBinding="C23_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C23_ChartDrawItem" Height="334px">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    ...
                    <igchart:ultrachart id="C24" runat="server" backgroundimagefilename=""  
                         emptycharttext="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                        version="9.1" OnDataBinding="C24_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C24_ChartDrawItem" Height="334px">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
