<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0036.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" SkinID="UltraWebGrid"
                                ...
                                OnInitializeRow="UltraWebGrid_InitializeRow" OnActiveRowChange="UltraWebGrid_ActiveRowChange">
                                <Bands>
                                    <igtbl:UltraGridBand>
    ...
    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server">
        <table style="border-collapse: collapse; background-color: White; width: 67%; margin-top: 5px;">
            <tr>
                <td class="topleft">
                </td>
                <td class="top">
            ...
            <tr>
                ...
                <asp:Label ID="chart1Caption" runat="server" CssClass="ElementTitle"></asp:Label>
                </td>
