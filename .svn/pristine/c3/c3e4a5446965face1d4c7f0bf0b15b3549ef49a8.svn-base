...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0014_Yamal
{
...
//            }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0002_0014_Yamal_date");
        ...
        private void SetQueryParams(string indicatorName)
        {
            ...
            switch (indicatorName)
            {
                case "Доходы бюджета ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_incomes";
                        shareMeasure.Value = "";
                ...
                case "В том числе по КОСГУ ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = "";
                        filterIndicator.Value = String.Format("{0}, [КОСГУ].[Сопоставимый].[KOSGUSlicer]", RegionSettingsHelper.Instance.OutcomeFKRTotal);
                ...
                case "Заработная плата и начисления на выплаты по оплате труда ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Оплата труда и начисления на оплату труда], {0}.[FKRSlicer]",
                ...
                case "Заработная плата ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Оплата труда и начисления на оплату труда].[Заработная плата], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Прочие выплаты ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Оплата труда и начисления на оплату труда].[Прочие выплаты], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Начисления на выплаты по оплате труда ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Оплата труда и начисления на оплату труда].[Начисления на оплату труда], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Оплата работ, услуг ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Приобретение услуг], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Услуги связи ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Приобретение услуг].[Услуги связи], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Транспортные услуги ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Приобретение услуг].[Транспортные услуги], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Коммунальные услуги ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Приобретение услуг].[Коммунальные услуги], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Арендная плата за пользование имуществом ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Приобретение услуг].[Арендная плата за пользование имуществом], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Работы, услуги по содержанию имущества ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Приобретение услуг].[Услуги по содержанию имущества], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Прочие работы, услуги ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Приобретение услуг].[Прочие услуги], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Обслуживание государственного (муниципального) долга ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Обслуживание долговых обязательств], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Обслуживание внутреннего долга ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Обслуживание долговых обязательств].[Обслуживание внутренних долговых обязательств], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Безвозмездные перечисления организациям ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Безвозмездные и безвозвратные перечисления организациям], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Безвозм. перечисления гос. и мун. организациям ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Безвозмездные и безвозвратные перечисления организациям].[Безвозмездные и безвозвратные перечисления государственным и муниципальным организациям], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Безвозм. перечисления организациям, за исключением гос. и мун. организаций ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Безвозмездные и безвозвратные перечисления организациям].[Безвозмездные и безвозвратные перечисления организациям, за исключением государственных и муниципальных организаций], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Безвозмездные перечисления бюджетам ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{1}.[Все коды ЭКР].[Расходы].[Безвозмездные и безвозвратные перечисления бюджетам], {0}.[FKRSlicer]",
                            UserParams.FKRDimension.Value, UserParams.EKRDimension.Value);
                ...
                case "Результат исполнения бюджета (дефицит/профицит) ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_deficit";
                        shareMeasure.Value = "";
                ...
                case "Кредиты кредитных организаций ":
                    {
                        ...
                        gridQueryName = "FO_0002_0014_Yamal_grid_credit";
                        shareMeasure.Value = "";
...
[КИФ].[Сопоставимый].[Все источники финансирования].[ИСТОЧНИКИ ВНУТРЕННЕГО ФИНАНСИРОВАНИЯ ДЕФИЦИТОВ БЮДЖЕТОВ].[Бюджетные кредиты от других бюджетов бюджетной системы Российской Федерации].[Погашение бюджетных кредитов, полученных от других бюджетов бюджетной системы Российской Федерации в валюте Российской Федерации]";
                ...
                case "Муниципальный долг ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_innerDebtsMO";
                        shareMeasure.Value = "";
                ...
                case "Остатки бюджетных средств ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_budgetarySurpluses";
                        shareMeasure.Value = "";
                ...
                case "Просроченная кредиторская задолженность ":
                    {
                        gridQueryName = "FO_0002_0014_Yamal_grid_creditDebts";
                        shareMeasure.Value = "";
