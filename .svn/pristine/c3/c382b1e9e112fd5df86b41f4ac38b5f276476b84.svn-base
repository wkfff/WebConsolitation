...
namespace Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessEducation_YANAO
{
    public partial class _default : CustomReportPage
    {
        ...
        string[] columnFormul2 = {
            "О1= О11 + О12", 
            "О11= (Учф - Чу/Уц х Кс) х (ЗПу х (1+СВ) х 12 мес.)/1000", 
            "Учф", 
            "Чу", 
            "Уц", 
            "Кс",   
            "ЗПу", 
            "О12 = (Чп - 0,53 х Чу /Уц х Кс) х (ЗПи х (1+СВ) х 12 мес.)/1000",
            "Чп",
            "Чу",
            "Уц",
            "Кс",
        ...
        void ColumnFormula()
        {
            ...
            G.Rows[2 * 3].Cells[lastColumn].RowSpan = 2;
...
");
            G.Rows[3 * 3].Cells[lastColumn].RowSpan = 2;
