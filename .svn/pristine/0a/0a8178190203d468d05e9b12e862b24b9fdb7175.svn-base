<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_002_HMAO._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" 
                    NavigateUrl="~/reports/SEP_001_HMAO/default.aspx" SkinID="HyperLink">Ежегодный мониторинг социально-<br>экономического развития (в разрезе субъектов РФ)</asp:HyperLink></div>
                                ...
                                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; height: 360px;"><igmisc:WebAsyncRefreshPanel id = "PanelChart" runat="server" TriggerControlIDs="Grid">
                                            <asp:Label ID="HeaderChart" runat="server" CssClass="ElementTitle"></asp:Label><igchart:UltraChart ID="Chart" runat="server" BackgroundImageFileName="" 
                                                ...
                                                <Axis>
                                                    ...
                                                    <Y Extent="10" TickmarkInterval="40" TickmarkStyle="Smart" Visible="True" 
                                                        LineThickness="1">
                                                        <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                                            Visible="True" />
                                                    ...
                                                    <Y2 Extent="0" LineThickness="1" TickmarkInterval="40" TickmarkStyle="Smart" 
                                                        Visible="False">
                                                        <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                                            Visible="True" />
                                                        <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                            ...
                                            <asp:Label ID="TestChartPoint" runat=server></asp:Label>
