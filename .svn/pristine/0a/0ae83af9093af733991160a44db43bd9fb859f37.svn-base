<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.OMCY_0003.REGION_01_YANAO._default" %>
        ...
        <table style="vertical-align: top">
            <tr>
                ...
                <td align="right" style="width: 100%" valign="top">
                    ...
                    NavigateUrl="~/reports/OMCY_0003/REGION_YANAO/default.aspx">Оценка эффективности деятельности ОМСУ по субъекту РФ</asp:HyperLink>
                    </td>
            </tr>
        </table>
        <table>
