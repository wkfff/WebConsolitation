<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.SEP_0001_0001.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            ...
            <td align="right" rowspan="1" style="width: 100%;">
                <uc4:ReportExcelExporter ID="ReportExcelExporter" runat="server" />
                <uc5:ReportPDFExporter ID="ReportPDFExporter" runat="server" />
            </td>
        </tr>
    </table>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <igmisc:WebAsyncRefreshPanel ID="PanelChart" runat="server">
                    <asp:Label ID="LabelChart" runat="server" BorderStyle="None" CssClass="ElementTitle"
