<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0010.Default" Title="Индикаторы БК и КУ " %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top">
                ...
                <td valign="top">
                <uc3:CustomMultiCombo ID="ComboIncomes1" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboIncomes2" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboOutcomes1" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboOutcomes2" runat="server"></uc3:CustomMultiCombo>
            </td>
            ...
            <table style="vertical-align: top;"><tr><td align="right" width="100%">
              <asp:RadioButtonList ID="RList" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                    Width="600px" style="font-family:Verdana;font-size:12px;">
                    <asp:ListItem Selected="True">фактические данные</asp:ListItem>
                    <asp:ListItem>плановые данные</asp:ListItem>
                    <asp:ListItem>проект бюджета</asp:ListItem>
    ...
    <asp:RadioButtonList ID="RadioList" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                    Width="200px" style="font-family:Verdana;font-size:12px;">
        ...
        <tr>
            <td valign="top" align="left" style="font-family:Verdana; font-size:12px;" colspan="5">
                <asp:RadioButtonList ID="MeasureButtonList" runat="server" AutoPostBack="True" RepeatDirection="horizontal"
                    Width="600px">
                    <asp:ListItem Selected="True">Консолидированный&nbsp;бюджет&nbsp;МР</asp:ListItem>
                    <asp:ListItem>Бюджет&nbsp;МР</asp:ListItem>
                    <asp:ListItem>Свод&nbsp;бюджетов&nbsp;поселений</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
    </table>
    ...
    <table>
        <tr>
                ...
                <table runat="server" id="ChartTable1" style="border-collapse: collapse; background-color: white;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text="Динамика доходов бюджетов"></asp:Label>
                        </td>
            ...
            <td>
                <table runat="server" id="Table1" style="border-collapse: collapse; background-color: white;
                    width: 100%; margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption2" runat="server" CssClass="ElementTitle" Text="Динамика расходов бюджетов"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
