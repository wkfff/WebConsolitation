<%@ Page Language="C#" AutoEventWireup="true" Codebehind="STAT_0001_0005_v.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.STAT_0001_0005_v" %>
    ...
    <form id="form1" runat="server">
        <div style="position: absolute; width: 768px; background-color: black; top: 0px;
            ...
            <table style="width: 768; height: 900; border-collapse: collapse; background-color: Black;
                ...
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="Map1Caption" runat="server" Text="Уровень безработицы по муниципальным образованиям"
                            Width="100%" />
                ...
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="Map2Caption" runat="server" Text="Численность безработных на 1 вакансию"
                            Width="100%" />
                        <div style="margin-left: -45px">
                            <DMWC:MapControl ID="MapControl2" runat="server" BackColor="White" ResourceKey="#MapControlResKey#DundasMap1#"
                                ImageUrl="../../../TemporaryImages/map_stat_01_02_01#SEQ(300,3)" RenderingImageUrl="../../../TemporaryImages/"
                                RenderType="ImageTag">
                            </DMWC:MapControl>
                        </div>
                ...
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="Map3Caption" runat="server" Text="Суммарный объем просроченной задолженности по выплате заработной платы"
                            Width="100%" />
                        <div style="margin-left: -45px">
                            <DMWC:MapControl ID="MapControl3" runat="server" BackColor="White" ResourceKey="#MapControlResKey#DundasMap1#"
                                ImageUrl="../../../TemporaryImages/map_stat_01_02_01#SEQ(300,3)" RenderingImageUrl="../../../TemporaryImages/"
                                RenderType="ImageTag">
                            </DMWC:MapControl>
                        </div>
