<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs" 
         Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0018.Default"
         Title="Источники финансирования дефицита бюджета субъекта РФ" %>
   ...
   <asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder1" runat = "server">
     <Table>
      <tr>
        <td style ="width:100%">
         ...
         <uc7:PopupInformer ID="PopupInformer1" HelpPageURL = "Default.html" runat="server"> </uc7:PopupInformer>
         &nbsp;&nbsp; 
        ...
        <td valign = "top">
         <uc6:UltraGridExporter ID= "UltraGridExporter1" runat="server"></uc6:UltraGridExporter>
        </td>
     ...
     <Table>
      <tr>
       ...
       <td valign="top">  
         <uc3:CustomMultiCombo ID="ComboSubject" runat="server"> </uc3:CustomMultiCombo>  
       </td>
       <td valign="top">  
     ...
     <Table>
      <tr>
        <td valign = "top" align  = "left" style ="padding-right: 6px; padding-right: 3px">
         <table style =" border-collapse: collapse; background-color: White; margin-top: 5px;">
           <tr>
             <td class="topleft">
             </td>
             <td class="top">
           ...
           <tr>
            ...
            <td class="overflow: visible;">
             <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="200px"
                                 ...
                                 Width="400px" EnableAppStyling ="True"
               ...
               <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault = "OnServer"
                              ...
                              Name="UltraWbGrid" RowHeightDefault="20px" SelectTypeRowDefault="Extended"
                              StationaryMargins="Header" StationaryMarginsOutlookGroupBy ="true"
                              TableLayout="Fixed" Version="4.0" NoDataMessage = "Нет данных для отображения" 
