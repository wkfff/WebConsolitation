<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MFRF_0001_0005_H.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.MFRF_0001_0005_H" %>
...
<body>
    ...
    <div>
            <table style="background-color: black; left: 0px; position: absolute; top: 0px; border-collapse: collapse;">      
            <tr>
                <td>                    
                    ...
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="InformationText" ReadOnly="True"
                        SkinID="TextBoxInformationText" Width="470px"></asp:TextBox></td>
            </tr>
            <tr><td style="width: 480px; height: 360px; border-right: lime 0px solid; border-top: lime 0px solid; border-left: lime 0px solid; border-bottom: lime 0px solid; position: relative; left: 0px; top: 0px; padding-left: 3px; border-collapse: collapse;" align="left" valign="top" colspan="" rowspan="">
                <igtbl:ultrawebgrid id="UltraWebGrid" runat="server" height="257px" ondatabinding="UltraWebGrid_DataBinding"
                    skinid="UltraWebGrid" width="476px" OnInitializeLayout="UltraWebGrid_InitializeLayout" OnInitializeRow="UltraWebGrid_InitializeRow"><Bands>
<igtbl:UltraGridBand>
...
<FrameStyle BorderWidth="1px" BorderColor="InactiveCaption" BorderStyle="Solid" Font-Size="8.25pt" Font-Names="Microsoft Sans Serif" BackColor="Window" Width="476px" Height="257px"></FrameStyle>
                 ...
                 <tr><td style="width: 297px; border-right: 0px solid; border-top: 0px solid; background-image: url(../../../images/servePane.gif); border-left: 0px solid; border-bottom: 0px solid; background-repeat: repeat-x; border-collapse: collapse; height: 25px; padding-left: 5px; left: 0px; margin-left: 0px; position: static; top: 408px;" align="left" valign="top" colspan="" rowspan="">
                     <asp:Table
                         ...
                         <asp:TableRow runat="server">
                             <asp:TableCell runat="server"><asp:Label ID="Label4" runat="server" SkinID="ServeText" Text="Label"></asp:Label><br />
                     <asp:Label ID="Label5" runat="server" SkinID="ServeText" Text="Label"></asp:Label></asp:TableCell>
                         </asp:TableRow>
                     </asp:Table>
                 </td></tr> 
