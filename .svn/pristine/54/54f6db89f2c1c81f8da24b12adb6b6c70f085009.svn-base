...
namespace Krista.FM.RIA.Extensions.Consolidation.Forms.Org3PricesAndTariffs.Gasoline
{
    ...
    {
        public const string FormClassName = "PricesAndTariffsGasoline";
        ...
        public static void Initialize(IUnityContainer container)
        {
            ...
            container.RegisterType<IExportService, ExportService>("{0}ExportService".FormatWith(GoodType.Gasoline));
        }
