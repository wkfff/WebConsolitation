<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Oil_0009_0001_Text.ascx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.Oil_0009_0001_Text" %>
...
<%@ Register Src="~/Components/ChartBricks/BarChartBrick.ascx" TagName="BarChartBrick"
    ...
    <uc1:iPadElementHeader ID="IncomesHeader" runat="server" Text="Розничные цены на нефтепродукты" Width="100%" />
