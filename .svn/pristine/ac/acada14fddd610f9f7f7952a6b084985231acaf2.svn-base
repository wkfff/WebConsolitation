<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0009.Default" Title="Сравнение темпа роста доходов по субъектам РФ" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="comboOKVED" runat="server">
                </uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboBudgetLevel" runat="server">
                </uc3:CustomMultiCombo>
            </td>
            <td valign="top">
        ...
        <tr> 
            <td style="width: 100%" colspan="7">
                <table>
                    <tr>
                        <td valign="top">
                            <asp:RadioButtonList ID="IncomesList" runat="server" AutoPostBack="True" RepeatDirection="horizontal"
                                Width="180px" Style="font-family: Verdana; font-size: 12px;">
                                <asp:ListItem Selected="True">ОКВЭД</asp:ListItem>
                                <asp:ListItem>КД</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
