...
{
    public partial class FK_0001_0002_wm2_v : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label3.Text = string.Format("Процент исполнения плана по доходам и среднедушевые доходы (тыс.руб./чел.) за {0}&nbsp;{1}&nbsp;{2}&nbsp;года по субъектам {3}. Ранг субъекта в {3}.",
                                        monthNum,
                                        monthStr,
                                        yearNum,
