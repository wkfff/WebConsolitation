<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0003_0018_Novosib.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id = "tabletext" runat=server style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        <tr>
            <td class="topleft">
            </td>
            <td class="top">
                ...
                <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ...
                        <Skin ApplyRowWise="False">
                            <PEs>
                                <igchartprop:PaintElement ElementType="Hatch" Fill="White" FillStopColor="Gray" 
                                    Hatch="ForwardDiagonal" Texture="Horizontal" />
                                <igchartprop:PaintElement Fill="Teal" 
                                    FillStopColor="Green" Hatch="ForwardDiagonal" />
                            </PEs>
                        </Skin>
                    </ColorModel>
