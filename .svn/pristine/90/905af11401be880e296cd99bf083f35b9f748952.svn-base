...
namespace Krista.FM.Server.Dashboards.reports.FNS_0004_0006
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            UltraChart2.Legend.SpanPercentage = 31;
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string queryName = "FNS_0004_0006_date";
            ...
            Page.Title = "Анализ выпадающих доходов по налогам по Ханты-Мансийскому автономному округу – Югре";
            ...
            UltraChart2.Tooltips.FormatString = String.Format("<ITEM_LABEL>\n Предоставлено льгот за {0} год <DATA_VALUE:N1> {1}\n", ComboYear.SelectedValue, units, KDKind.Value);
        }
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FNS_0004_0006_compare_Grid");
            dtGrid = new DataTable();
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Вид налога", dtGrid);

            if (dtGrid.Rows.Count > 0)
            {
                if (Convert.ToInt32(ComboYear.SelectedValue) < 2010)
                {
        ...
        {
            string query = DataProvider.GetQueryText("FNS_0004_0006_compare_Chart1_1");
        ...
        {
            string query = DataProvider.GetQueryText("FNS_0004_0006_compare_Chart1_2");
            DataTable dtChart1 = new DataTable();
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Dummy", dtChart1);
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            {
                e.Layout.Bands[0].Columns[4].Header.Title = "Рост или снижение выпадающих доходов по налогу по отношению к предыдущему отчетному периоду";
        ...
        protected void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
            if (e.Row.Cells.Count > 4)
            {
                ...
                if (e.Row.Cells[colNum].Value != null && e.Row.Cells[colNum].Value.ToString() != string.Empty)
                {
                    double currentValue = Convert.ToDouble(e.Row.Cells[colNum].Value);

                    if (currentValue > 0)
                    {
                        e.Row.Cells[colNum].Style.BackgroundImage = "~/images/arrowGreenUpBB.png";
                        e.Row.Cells[colNum].Title = "";
                    }
                    else if (currentValue < 0)
                    {
                        e.Row.Cells[colNum].Style.BackgroundImage = "~/images/arrowRedDownBB.png";
                        e.Row.Cells[colNum].Title = "";
                    }
                }
                e.Row.Cells[colNum].Style.CustomRules = "background-repeat: no-repeat; background-position: left center; margin: 2px";
            }   
        }
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            Worksheet sheet2 = workbook.Worksheets.Add("Стр. диагр. 1");
            Worksheet sheet3 = workbook.Worksheets.Add("Стр. диагр. 2");
            sheet2.Rows[0].Cells[0].Value = String.Format("{0} {1}", ChartCaption1.Text, Label2.Text);
            UltraGridExporter.ChartExcelExport(sheet2.Rows[1].Cells[0], UltraChart1);
            sheet3.Rows[0].Cells[0].Value = String.Format("{0} {1}", ChartCaption1.Text, Label2.Text);
