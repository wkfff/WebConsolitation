...
namespace Krista.FM.RIA.Extensions.Consolidation.Forms.Org3PricesAndTariffs.Food
{
    public class ExportService : IExportService
    {
        ...
        {
            Stream template = new MemoryStream(Resource.TemplateFood);
            ...
            // Рисуем шапку
            // Столбцы по количеству организаций
            ...
            {
                NPOIHelper.SetCellValue(sheet, 2, currentColumnIndex, org.NameOrg);
                currentColumnIndex++;
            }
            ...
            foreach (D_Org_Good good in goods)
            {
                ...
                NPOIHelper.SetCellValue(sheet, currentRowIndex, currentColumnIndex, good.Name);
                currentColumnIndex++;
                foreach (D_Org_RegistrOrg org in orgs)
                {
