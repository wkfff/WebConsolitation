...
{
    public partial class FO_0735_0008 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            // мера Остаток на конец
            //CustomParams.MakeGrbsParams("38", "id");
            ...
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "name", dtData);
            ...
            Image1.ImageUrl = String.Format("../../../images/YamalPhotos/{0}.jpg", HttpContext.Current.Session["CurrentGrbsID"]);
        ...
        {
            detailTable.CssClass = "HtmlTableCompactPopup";
            ...
            for (int i = 0; i < dtData.Rows.Count; i++)
            {
                ...
                double ethalon = Convert.ToDouble(dtData.Rows[i][4]);                
        ...
        private TableCell GetValueCell(string value)
        {
            ...
            Label lb;
            cell = new TableCell();
            cell.CssClass = "HtmlTableCompactPopup";
            lb = new Label();
            lb.Text = value;
            lb.CssClass = "TableFontPopup";
        ...
        private TableCell GetPercentCell(object value, double ethalon)
        {
            ...
            if (ethalon != 0 && Double.TryParse(value.ToString(), out convertedValue))
            {
                ...
                hintRowText = convertedValue >= ethalon
                                  ? String.Format("Выше среднего % исполнения по ГРБС ({0:P2})&nbsp;", ethalon)
                                  : String.Format("Ниже среднего % исполнения по ГРБС ({0:P2})&nbsp;", ethalon);
                lb = new Label();
                lb.Text = hintRowText;
                lb.CssClass = "ServeTextPopup";
        ...
        private TableCell GetNameCell(string name, bool child)
        {
            ...
            if (child)
            {
                lb.CssClass = "TableFontGreyPopup";
        ...
        private void AddHeaderRow(Table table)
        {
            ...
            cell = new TableCell();
            cell.Width = 215;
            cell.CssClass = "HtmlTableHeaderPopup";
