<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0016_03.Default" Title="Untitled Page" %>
                    ...
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport" style="overflow: visible;">
                                 <asp:Label ID="KdGridCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;">
                                    <uc5:UltraGridBrick ID="KdGridBrick" runat="server">
                                    </uc5:UltraGridBrick>
                            </td>
                            <td class="right">
                            </td>
