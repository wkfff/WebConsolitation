<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
	Inherits="Krista.FM.Server.Dashboards.reports.SKK.SKK_007.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="SpaceWrapper">
		...
		<div class="SpaceHeader"><div><div>
			<asp:Label ID="LabelChartSubjects" runat="server" CssClass="ElementTitle" />
		</div></div></div>
		<div class="RoundedCenter"><div><div>
			<igchart:UltraChart ID="ChartSubjects" runat="server" >
				<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk071#SEQNUM(100).png" />
			</igchart:UltraChart>
		</div></div></div>
		...
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartGroupsCount" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk072#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>
		</div>
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartGroupsVolume" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk073#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>
		</div>
		...
		<div class="RoundedCenter"><div><div>			
			...
			<div class="SpaceFloat2Items">
				<igchart:UltraChart ID="ChartTransport" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk074#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div>
			<div class="clear"></div>						
		</div></div></div>
