<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0017.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <igmisc:WebAsyncRefreshPanel ID="commentTextWebAsyncPanel" runat="server">
        <table style="vertical-align: top;">
            <tr>
                <table runat="server" id="commentTextTable" style="border-collapse: collapse; background-color: White;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="commentTextCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <asp:Label ID="PeriodLabel" runat="server" CssClass="PageSubTitle" Visible="false"></asp:Label>
                            <asp:Label ID="DeficitLimitText" runat="server" CssClass="PageSubTitle"></asp:Label><br />
                            <asp:Label ID="DebtOutcomesLimitText" runat="server" CssClass="PageSubTitle"></asp:Label><br />
                            <asp:Label ID="DebtLimitText" runat="server" CssClass="PageSubTitle"></asp:Label>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FO0207__1#SEQNUM(100).png" />
                            </igchart:UltraChart>
                            <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName=""
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FO0207_2_#SEQNUM(100).png" />
                            </igchart:UltraChart>
                            <igchart:UltraChart ID="UltraChart3" runat="server" BackgroundImageFileName=""
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FO0207_3_#SEQNUM(100).png" />
                            </igchart:UltraChart>
                            <igchart:UltraChart ID="UltraChart4" runat="server" BackgroundImageFileName=""
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FO0207_4_#SEQNUM(100).png" />
                            </igchart:UltraChart>                            
                        </td>
                        <td class="right">
                        </td>
