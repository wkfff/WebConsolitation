<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sgm_0017.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SGM.SGM_0017.sgm_0017"  Title="Данные о прививках" MasterPageFile="~/Reports.Master" %>
        ...
        <table style="width: 300px">
            <tr>
                <td align="left" valign="top">
                    <uc1:CustomMultiCombo ID="ComboYear" runat="server" Title="Год" Width="107" />
                </td>
                <td align="left" valign="top">
                    <uc1:CustomMultiCombo ID="ComboDesease" runat="server" Title="Заболевание" Width="300" />
                </td>
                <td align="left" valign="top">
