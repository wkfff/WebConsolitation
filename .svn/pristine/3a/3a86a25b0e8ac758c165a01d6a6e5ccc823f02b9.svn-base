...
namespace Krista.FM.Server.Dashboards.reports.FO_0045_0002_Sakhalin
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink2.NavigateUrl = "~/reports/FO_0045_0003_Sakhalin/Default.aspx";
        }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                DateTime lastDate = CubeInfo.GetLastDate(DataProvidersFactory.PrimaryMASDataProvider, "FO_0045_0002_Sakhalin_date");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0045_0002_Sakhalin_grid");
            ...
            {
                query = DataProvider.GetQueryText("FO_0045_0002_Sakhalin_population");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0045_0002_Sakhalin_chart");
        ...
        public void SetMapSettings()
        {
            ...
            legend.Visible = true;
            legend.Dock = PanelDockStyle.Bottom;
