<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FK_0001_0004_Gadget.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.FK_0001_0004_Gadget" %>
...
<igtbl:ultrawebgrid id="UltraWebGrid" runat="server" height="200px" width="325px" EnableAppStyling="True" StyleSetName="Office2007Blue" OnDataBinding="UltraWebGrid_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout" OnInitializeRow="UltraWebGrid_InitializeRow" SkinID="GadgetGrid"><Bands>
<igtbl:UltraGridBand>
<AddNewRow View="NotSet" Visible="NotSet"></AddNewRow>
</igtbl:UltraGridBand>
</Bands>

<DisplayLayout ViewType="OutlookGroupBy" Version="4.00" AllowSortingDefault="OnClient" StationaryMargins="Header" AllowColSizingDefault="Free" AllowUpdateDefault="Yes" StationaryMarginsOutlookGroupBy="True" HeaderClickActionDefault="SortMulti" Name="ctl00xUltraWebGrid" BorderCollapseDefault="Separate" AllowDeleteDefault="Yes" RowSelectorsDefault="No" TableLayout="Fixed" RowHeightDefault="20px" AllowColumnMovingDefault="OnServer" SelectTypeRowDefault="Extended">
<GroupByBox>
...
<FrameStyle BorderWidth="1px" BorderColor="InactiveCaption" BorderStyle="Double" Font-Size="8.25pt" Font-Names="Microsoft Sans Serif" BackColor="Window" Width="325px" Height="200px">
