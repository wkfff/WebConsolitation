<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0003_0006_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0003_0006_Horizontal" %>
...
<body style="background-color: black;">
    ...
    <div style="position: absolute; width: 767px; height: 950px; top: 0px; left: 0px;
        ...
        <table style="border-collapse: collapse">
            ...
            <tr>
                <td>
                 <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Справочно: кредиторская задолженность, тыс.руб."
                                        Width="100%" />
             ...
             <tr>
                <td>
                <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Иные показатели"
                                        Width="100%" />
