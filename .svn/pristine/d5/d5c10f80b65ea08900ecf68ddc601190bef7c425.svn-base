<%@ Control Language="C#" AutoEventWireup="true" Codebehind="IT_0002_0001_BanksChart.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.IT_0002_0001_BanksChart" %>
...
<table style="border-collapse: collapse">    
    <tr>
        <td>
            <igchart:UltraChart ID="UltraChart3" runat="server" BackgroundImageFileName="" BorderColor="Black" BorderWidth="1px"
