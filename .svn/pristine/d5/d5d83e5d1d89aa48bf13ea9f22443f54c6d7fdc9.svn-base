<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FST_0001_0032.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FST_0001_0032" %>
...
<body style="background-color: Black">
    ...
    <div style="position: absolute; width: 768px; height: 950px; top: 0px; left: 0px;
        ...
        <table style="background-color: Black; top: 0px; left: 0px; overflow: hidden">
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Водоснабжение (среднеотпускной тариф)"
                        Width="100%" />
                    <uc1:FST_0001_0001_Chart ID="UltraChartFST_0001_0001_Chart1" runat="server" />
                </td>
            </tr>
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader3" runat="server" Text="Водоснабжение (тариф для населения)"
                        Width="100%" />
                    <uc1:FST_0001_0001_Chart ID="UltraChartFST_0001_0001_Chart2" runat="server" />
                </td>
            </tr>
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader4" runat="server" Text="Водоснабжение (тариф для бюджетных потребителей)"
                        Width="100%" />
                    <uc1:FST_0001_0001_Chart ID="UltraChartFST_0001_0001_Chart3" runat="server" />
                </td>
            </tr>
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader5" runat="server" Text="Водоснабжение (тариф для прочих потребителей)"
                        Width="100%" />
                    <uc1:FST_0001_0001_Chart ID="UltraChartFST_0001_0001_Chart4" runat="server" />
                </td>
            </tr>
        </table>
        <table style="background-color: Black; top: 0px; left: 0px; overflow: hidden">
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Водоснабжение"
                        Width="100%" />
    ...
    <div style="padding-top: 10px; padding-left: 30px"><asp:Label ID="Label3" runat="server" SkinID="ServeText" Visible="false" Text="* Возможно уточнение тарифа"></asp:Label></div>
    </form>
</body>
</html>
