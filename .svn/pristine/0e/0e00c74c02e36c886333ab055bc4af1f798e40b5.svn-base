...
namespace Krista.FM.Server.Dashboards.reports.FO_0045_0003
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink2.NavigateUrl = "~/reports/FO_0045_0002/Default.aspx";
        }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0045_0003_date");
            ...
            CommentTitle.Text = "Показатель «Уровень долговой нагрузки» рассчитывается в соответствии с Приказом Минфина РФ от 3 декабря 2010 г. №552 «О порядке проведения оценки качества организации и осуществления бюджетного процесса в субъектах РФ» рассчитывается как отношение объема государственного (муниципального) долга к доходам бюджета субъекта (муниципального образования) за исключением субвенций.";
        ...
        {
            string query = DataProvider.GetQueryText("FO_0045_0003_grid");
        ...
        protected void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            int worseRankColumnIndex = e.Row.Cells.Count - 1;
