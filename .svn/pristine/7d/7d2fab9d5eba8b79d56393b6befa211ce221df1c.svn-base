<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.ORG_0001_0008._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        ...
        <table style="vertical-align: top">
            <tr>
                ...
                <td colspan="1" valign="top">
                    <uc2:CustomMultiCombo ID="TypeField" runat="server" Title="Товар" 
        ...
        <igchart:UltraChart ID="ChartLine" runat="server" ChartType="LineChart" 
            ...
            <ColorModel AlphaLevel="61" ColorBegin="OrangeRed" ColorEnd="BlueViolet" 
                ModelStyle="LinearRange">
        ...
        <igchart:UltraChart ID="ChartColumn" runat="server" ChartType="LineChart" 
                        BackgroundImageFileName="" 
                        EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" 
                        Version="9.1" Height="400px" BackColor="">
