<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0004_0002.Default" Title="Расходы бюджета по отраслям социальной сферы" %>
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                       ...
                       <td valign="top">
                             <asp:RadioButtonList ID="DebtKindButtonList1" runat="server" AutoPostBack="True"
                                 RepeatDirection="Horizontal" Width="260px" style="font-family:Verdana; font-size:12px;">
        ...
        <tr>
            <td valign="top">
                             <asp:RadioButtonList ID="DebtKindButtonList2" runat="server" AutoPostBack="True"
                                 RepeatDirection="Horizontal" Width="150px" style="font-family:Verdana; font-size:12px;">
                                <asp:ListItem Selected="True">тыс.руб.</asp:ListItem> 
                                <asp:ListItem>млн.руб.</asp:ListItem>
                             </asp:RadioButtonList>
           </td>
          <td valign="top" align ="right">
                       <uc3:CustomMultiCombo ID="ComboVariantYear" runat="server"></uc3:CustomMultiCombo>
                    </td>                     
          <td valign="top" align="right">
                      <uc3:CustomMultiCombo ID="ComboVariantLastYear" runat="server"></uc3:CustomMultiCombo>
          </td>
    ...
    <table>
        ...
        <tr>   
           <td valign="top" align="left">
               <igmisc:WebAsyncRefreshPanel ID="UltraChart1WebAsyncRefreshPanel" runat="server"  Style="width: 100%">
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        <tr>
                            <td class="topleft">
                            </td>
