<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.MO.MO_0002._003._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
                    ...
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="L1" runat="server" CssClass="ElementTitle"></asp:Label></td>
        ...
        </div><table style="width: 100%; border-collapse: collapse; height: 10%">
            <tr>
                <td colspan="2" style="vertical-align: top; height: 100%;">
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="L2" runat="server" CssClass="ElementTitle"></asp:Label></td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 100%; height: 100%">
                                <igtbl:UltraWebGrid
                                    ID="G2" runat="server" OnDataBinding="G2_DataBinding"
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue" OnInitializeLayout="G_InitializeLayout" OnInitializeRow="G_InitializeRow" OnActiveRowChange="G2_ActiveRowChange">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                            <AddNewRow View="NotSet" Visible="NotSet">
                                            </AddNewRow>
                    ...
                    <table style="vertical-align: top; width: 100%; border-collapse: collapse; height: 10%;
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="Label4" runat="server" BorderStyle="None" CssClass="ElementTitle"
                                    Text="Динамика показателя"></asp:Label></td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: top; height: 100%; width: 100%;">
                                <igmisc:WebAsyncRefreshPanel ID="pa2" runat="server" Width="100%">
                                    <asp:Label ID="Label5" runat="server" BorderStyle="None" CssClass="ElementTitle"
                                        Height="30px" Text="заголовок"></asp:Label><igchart:UltraChart ID="C2" runat="server"
                                            BackgroundImageFileName="" BorderColor="InactiveCaption" BorderWidth="0px" EmptyChartText="в настоящий момент данные отсутствуют"
                                            OnDataBinding="C2_DataBinding" SplineAreaChart-LineDrawStyle="Solid" Transform3D-Scale="90"
                                            Transform3D-XRotation="120" Transform3D-YRotation="5" Version="8.2" Width="100%" OnInvalidDataReceived="C_InvalidDataReceived">
                                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                Font-Underline="False" FormatString="&lt;DATA_VALUE:0.##&gt; , &lt;b&gt;&lt;ITEM_LABEL&gt;&lt;/b&gt;" />
                                            <TitleBottom Extent="33" Flip="True" Location="Bottom" Orientation="VerticalLeftFacing">
        ...
        </table><table style="width: 100%; border-collapse: collapse; height: 10%">
            <tr>
                <td colspan="2" style="vertical-align: top; height: 100%;">
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="L3" runat="server" CssClass="ElementTitle"></asp:Label></td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 100%; height: 100%">
                                <igtbl:UltraWebGrid
                                    ID="G3" runat="server" OnDataBinding="G3_DataBinding"
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue" OnInitializeLayout="G_InitializeLayout" OnInitializeRow="G_InitializeRow" OnActiveRowChange="G3_ActiveRowChange">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                            <AddNewRow View="NotSet" Visible="NotSet">
                                            </AddNewRow>
                    ...
                    <table style="vertical-align: top; width: 100%; border-collapse: collapse; height: 10%;
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="Label7" runat="server" BorderStyle="None" CssClass="ElementTitle"
                                    Text="Динамика показателя"></asp:Label></td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: top; height: 100%; width: 100%;">
                                <igmisc:WebAsyncRefreshPanel ID="pa3" runat="server" Width="100%">
                                    <asp:Label ID="Label8" runat="server" BorderStyle="None" CssClass="ElementTitle"
                                        Height="30px" Text="заголовок"></asp:Label><igchart:UltraChart ID="C3" runat="server"
                                            BackgroundImageFileName="" BorderColor="InactiveCaption" BorderWidth="0px" EmptyChartText="в настоящий момент данные отсутствуют"
                                            OnDataBinding="C3_DataBinding" SplineAreaChart-LineDrawStyle="Solid" Transform3D-Scale="90"
                                            Transform3D-XRotation="120" Transform3D-YRotation="5" Version="8.2" Width="100%" OnInvalidDataReceived="C_InvalidDataReceived">
                                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                Font-Underline="False" FormatString="&lt;DATA_VALUE:0.##&gt; , &lt;b&gt;&lt;ITEM_LABEL&gt;&lt;/b&gt;" />
                                            <TitleBottom Extent="33" Flip="True" Location="Bottom" Orientation="VerticalLeftFacing">
                ...
                <td colspan="2" style="vertical-align: top; height: 100%;">
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="L4" runat="server" CssClass="ElementTitle"></asp:Label></td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 100%; height: 100%">
                                <igtbl:UltraWebGrid
                                    ID="G4" runat="server" OnDataBinding="G4_DataBinding"
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue" OnInitializeLayout="G_InitializeLayout" OnInitializeRow="G_InitializeRow" OnActiveRowChange="G4_ActiveRowChange">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                            <AddNewRow View="NotSet" Visible="NotSet">
                                            </AddNewRow>
                    ...
                    <table style="vertical-align: top; width: 100%; border-collapse: collapse; height: 10%;
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="Label10" runat="server" BorderStyle="None" CssClass="ElementTitle"
                                    Text="Динамика показателя"></asp:Label></td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="vertical-align: top; height: 100%; width: 100%;">
                                <igmisc:WebAsyncRefreshPanel ID="pa4" runat="server" Width="100%">
                                    <asp:Label ID="Label11" runat="server" BorderStyle="None" CssClass="ElementTitle"
                                        Height="30px" Text="заголовок"></asp:Label><igchart:UltraChart ID="C4" runat="server"
                                            BackgroundImageFileName="" BorderColor="InactiveCaption" BorderWidth="0px" EmptyChartText="в настоящий момент данные отсутствуют"
                                            OnDataBinding="C4_DataBinding" SplineAreaChart-LineDrawStyle="Solid" Transform3D-Scale="90"
                                            Transform3D-XRotation="120" Transform3D-YRotation="5" Version="8.2" Width="100%" OnInvalidDataReceived="C_InvalidDataReceived">
                                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                Font-Underline="False" FormatString="&lt;DATA_VALUE:0.##&gt; , &lt;b&gt;&lt;ITEM_LABEL&gt;&lt;/b&gt;" />
                                            <TitleBottom Extent="33" Flip="True" Location="Bottom" Orientation="VerticalLeftFacing">
