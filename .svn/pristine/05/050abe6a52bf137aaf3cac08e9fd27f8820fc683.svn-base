...
{
    public partial class FST_0001_0021 : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText("FST_0001_0021_Grid");
            ...
            CRHelper.SaveToErrorLog(foGrownAvgRF.ToString());
            CRHelper.SaveToErrorLog(notZeroGrownCountRF.ToString());
