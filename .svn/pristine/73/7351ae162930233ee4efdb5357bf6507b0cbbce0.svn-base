<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Title="Помесячная динамика поступления доходов"
    Codebehind="DefaultDetail.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0007_NAO.DefaultDetail" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboSKIF" runat="server"></uc3:CustomMultiCombo>
            </td> 
            <td valign="top">
    ...
    <table style="vertical-align: top;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                                ...
                                Version="9.1" OnDataBinding="UltraChart_DataBinding"  SkinID="UltraWebChart">
        ...
        <tr>
            <td valign="top" align="left" style="padding-right: 3px;">
                <table style="border-collapse: collapse; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        <td class="left" style="height: 211px">
                        </td>
                        <td style="overflow: visible; height: 211px;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px"
                                OnDataBinding="UltraWebGrid_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout" SkinID="UltraWebGrid" Width="325px"
                        ...
                        <td class="right" style="height: 211px">
                        </td>
                    </tr>
                    <tr>
                        <td class="bottomleft">
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="GrowRateHintLabel" runat="server" CssClass="PageSubTitle"></asp:Label>
                </td>
            </tr>
        </table>
        </div>
