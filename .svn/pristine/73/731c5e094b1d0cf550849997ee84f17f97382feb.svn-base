...
namespace bus.gov.ru.fk.Item1
{
        ...
        public partial class bodyLocalType : global::bus.gov.ru.types.Item1.packetResultType, IXMetaData {
         ...
         public static explicit operator bodyLocalType(XElement xe) { return XTypedServices.ToXTypedElement<bodyLocalType>(xe,LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
            ...
            public string refType {
                ...
                set {
                    this.SetElementWithValidation(XName.Get("refType", "http://bus.gov.ru/fk/1"), value, "refType", refTypeLocalType.TypeDefinition);
                }
            }
            ...
            private class refTypeLocalType {
                ...
                public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(16)), new object[] {
                                ...
                                "CRC",
                                "CRS",
                                "REG"}, 0, 0, null, null, 0, null, null, 0, null, 0, XmlSchemaWhiteSpace.Preserve));
                
                private refTypeLocalType() {
                }
            }
        }
    }
    ...
    public partial class regPublishedInfo : XTypedElement, IXMetaData {
        ...
        /// <summary>
        /// <para>
        /// Regular expression: (position+, loadNum?)
        /// </para>
        /// </summary>
        public partial class bodyLocalType : XTypedElement, IXMetaData {
         ...
         public static explicit operator bodyLocalType(XElement xe) { return XTypedServices.ToXTypedElement<bodyLocalType>(xe,LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
            ...
            static bodyLocalType() {
                BuildElementDictionary();
                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("position", "http://bus.gov.ru/fk/1")), new NamedContentModelEntity(XName.Get("loadNum", "http://bus.gov.ru/fk/1")));
            }
            ...
            /// <summary>
            /// <para>
            /// Инкрементальный номер выгрузки с начала года
            /// </para>
            /// <para>
            /// Occurrence: optional
            /// </para>
            ...
            /// </para>
            /// </summary>
            public System.Nullable<int> loadNum {
                get {
                    XElement x = this.GetElement(XName.Get("loadNum", "http://bus.gov.ru/fk/1"));
                    if ((x == null)) {
                        return null;
                    }
                ...
                set {
                    this.SetElementWithValidation(XName.Get("loadNum", "http://bus.gov.ru/fk/1"), value, "loadNum", loadNumLocalType.TypeDefinition);
                }
            }
            ...
            private static void BuildElementDictionary() {
                ...
                localElementDictionary.Add(XName.Get("loadNum", "http://bus.gov.ru/fk/1"), typeof(int));
            }
            ...
            private class loadNumLocalType {
    ...
    public class LinqToXsdTypeManager : ILinqToXsdTypeManager {
        ...
        public static System.Type GetRootType() {
            return elementDictionary[XName.Get("confirmation", "http://bus.gov.ru/fk/1")];
        }
    }
