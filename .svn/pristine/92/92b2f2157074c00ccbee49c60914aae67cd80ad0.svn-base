...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0004
{
    public partial class DefaultDetail : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0004_grid");
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            ReportExcelExporter1.WorksheetSubTitle = PageSubTitle.Text + (UseStack ? " (сумма с начала года с накоплением)" : String.Empty);
        ...
        private void PdfExportButton_Click(object sender, EventArgs e)
        {
            ...
            ReportPDFExporter1.PageSubTitle = PageSubTitle.Text + (UseStack ? " (сумма с начала года с накоплением)" : String.Empty);
