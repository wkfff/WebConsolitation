<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0006_0002.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0006_0002_1" %>
...
<%@ Register Src="../../../iPadBricks/FO_0004_0002_Chart.ascx" TagName="FO_0006_0002_Chart"
    TagPrefix="uc1" %>
        ...
        <table style="width: 768; height: 900; border-collapse: collapse; background-color: Black;
            ...
            <tr>
                <td style="width: 380px">
                    <uc1:FO_0006_0002_Chart ID="FO_0006_0002_Chart1" runat="server" />
                </td>
                <td>
                    <uc1:FO_0006_0002_Chart ID="FO_0006_0002_Chart3" runat="server" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 380px">
                    <uc1:FO_0006_0002_Chart ID="FO_0004_0003_Chart1" runat="server" />
                </td>
                <td>
                    <uc1:FO_0006_0002_Chart ID="FO_0004_0003_Chart3" runat="server" />
                </td>
            </tr>
            <tr>
                <td valign="top" colspan="2">
