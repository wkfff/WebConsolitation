<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0014.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0014" %>
...
<body style="background-color: black;">
    <form id="form1" runat="server">
        <div style="position: absolute; width: 768px; height: 950px; background-color: Transparent; top: 0px;
