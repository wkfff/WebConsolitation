...
namespace Krista.FM.Common.Services
{
    ...
    public static class StringParser
    {
        ...
        static StringParser()
        {
            ...
            {
                propertyObjects["exe"] = FileVersionInfo.GetVersionInfo(entryAssembly.Location);
            }
            properties["USER"] = Environment.UserName;
            properties["Version"] = FileVersionInfo.GetVersionInfo(entryAssembly.Location).FileVersion;
