<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.MD_0001_0001.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td style="width: 100%;" align="right">
                <uc6:GridSearch ID="GridSearch1" runat="server" />
            </td>
        </tr>
    </table>
    ...
    <igmisc:WebAsyncRefreshPanel ID="PanelChart1" runat="server">
        ...
        <table id="Chart2Container" runat="server" style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
            <tr>
                <td class="topleft">
                </td>
                <td class="top">
