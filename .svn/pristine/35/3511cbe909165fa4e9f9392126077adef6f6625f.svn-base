<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0004_0005.Default" Title="Индикаторы БК и КУ " %>
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="grid_Caption" runat="server" CssClass="ElementTitle" Text= "Структурный анализ предоставляемых налоговых льгот по доходным источникам, тыс.руб."></asp:Label>
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="GridCaption" runat="server" CssClass="ElementTitle" Text= "Структурный анализ предоставляемых налоговых льгот по доходным источникам, тыс.руб."></asp:Label>
                            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" EnableAppStyling="True" Height="200px"
                                OnDataBinding="UltraWebGrid1_DataBinding" OnInitializeLayout="UltraWebGrid1_InitializeLayout" OnActiveRowChange="UltraWebGrid1_ActiveRowChange"
