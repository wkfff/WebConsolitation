...
namespace Krista.FM.Server.DataPumps.GVF1Pump
{
    // ГВФ - 0001 - Форма 9 Ф (ПФ)
    public class GVF1PumpModule : CorrectedPumpModuleBase
    {
        ...
        // Показатели.ГВФ_9 Ф ПФ (d_Marks_GVF9FPF)
        ...
        // Фонды.ГВФ_9 Ф ПФ (f_Fund_GVF9FPF)
        ...
        {
            clsSourceId = AddDataSource("ГВФ", "1", ParamKindTypes.Year,
        ...
        private const string D_MARKS_GVF9FPF_GUID = "51bf8ee7-09a3-43aa-a970-f328562a1cae";
        private const string D_UNITS_OKEI_GUID = "7ef0edfd-9461-4333-8420-ccb102051826";
        private const string F_FUND_GVF9FPF_GUID = "d6062d35-0473-44f4-9c0d-15c46d3b0003";
        ...
        private int PumpXlsMarks(ExcelHelper excelDoc, ref int curRow)
        {
        ...
        private void PumpXlsSheetDate(ExcelHelper excelDoc, string fileName)
        {
            ...
            for (int curRow = 1; curRow <= rowsCount; curRow++)
                try
                {
                    ...
                    {
                        int newRow = curRow;
                        int refMarks = PumpXlsMarks(excelDoc, ref newRow);
                        if (refMarks == -1)
                            continue;
        ...
        private bool IsSkipWorksheet(ExcelHelper excelDoc)
        {
            ...
            return !worksheetName.ToUpper().Contains("СТР.2_4");
        }
