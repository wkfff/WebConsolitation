...
namespace Krista.FM.RIA.Extensions.Consolidation.Services.Forms
{
    public static class NPOIHelper
    {
        ...
        {
            { HSSFCellStyle.VERTICAL_BOTTOM, "bottom" }, /* По нижнему краю */
            { HSSFCellStyle.VERTICAL_CENTER, "middle" }, /* По центру */
            { HSSFCellStyle.VERTICAL_JUSTIFY, "baseline" }, /* По высоте */
            { HSSFCellStyle.VERTICAL_TOP, "top" }, /* По верхнему краю */
            { 4, "middle" } /* Распределенный */
        };
