<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master"
    AutoEventWireup="true" Codebehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.ORG_0003_0004.Default" %>
    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td style="width: 100px">
                    <uc1:CustomMultiCombo ID="CustomMultiComboMonthsCount" runat="server" />
                </td>
                <td style="width: 100px">
        ...
        <tr>
            ...
            <td>
                ...
                <igtbl:UltraWebGrid ID="web_grid1" runat="server" EnableAppStyling="True" OnDataBinding="web_grid1_DataBinding"
                    ...
                    OnInitializeRow="web_grid1_InitializeRow">
                    <Bands>
                        <igtbl:UltraGridBand>
