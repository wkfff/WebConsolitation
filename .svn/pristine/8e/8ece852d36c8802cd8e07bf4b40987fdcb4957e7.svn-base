...
{
    public class StringAlignmentBarHorizontalConverter : EnumConverter
    {
        const string sCenter = "По центру";
        const string sFar = "По правому краю";
        const string sNear = "По левому краю";

        public StringAlignmentBarHorizontalConverter(Type type)
            : base(type)
        {
        }
