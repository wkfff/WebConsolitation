<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0037.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
      <tr>
       <td>
         <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" Width="850px" style="font-family:Verdana; font-size:12px;">
           <asp:ListItem Selected="True">Данные месячного отчета</asp:ListItem> 
           <asp:ListItem>Сводная ведомость по кассовым выплатам</asp:ListItem>
         </asp:RadioButtonList>
       </td>
      </tr>
    </table>
