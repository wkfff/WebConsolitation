<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0013_01_Saratov.Default" %>
            ...
            <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td class="bottomright">
                            ...
                            <asp:RadioButtonList ID="kindList" runat="server" AutoPostBack="True" RepeatDirection="horizontal"
                                Width="370px">
                                <asp:ListItem Selected="True">Исполнение доходов</asp:ListItem>
                                <asp:ListItem >Исполнение расходов</asp:ListItem>
                            </asp:RadioButtonList>
