...
namespace Krista.FM.Server.Dashboards.reports.FK_0004_0003
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink2.NavigateUrl = "~/reports/FK_0004_0004/Default.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CustomCalendar1.WebCalendar.SelectedDate = CubeInfo.GetLastDate(DataProvidersFactory.SecondaryMASDataProvider, "FK_0004_0003_lastDate");
            }

            currentDate = CustomCalendar1.WebCalendar.SelectedDate;

            Page.Title = String.Format("Доходы сектора государственного управления ");
            Label1.Text = Page.Title;
            Label2.Text = String.Format("по состоянию на <b>{0:dd.MM.yyyy} г., {1}</b>", currentDate.AddDays(1), multiplierCaption);

            DynamicChartCaption.Text = String.Format("Структура доходов сектора государственного управления на {0:dd.MM.yyyy} г., {1}</b>", currentDate.AddDays(1), multiplierCaption);
        ...
        {
            string query = DataProvider.GetQueryText("FK_0004_0003_grid");
        ...
        private void DynamicChartDataBind()
        {
            ...
            DataProvidersFactory.SecondaryMASDataProvider.GetDataTableForChart(DataProvider.GetQueryText("FK_0004_0003_dynamicChart"), "Наименование показателей", dynamicChartDt);
            dynamicChartDtNormalized = new DataTable();
            DataProvidersFactory.SecondaryMASDataProvider.GetDataTableForChart(DataProvider.GetQueryText("FK_0004_0003_dynamicChart_normalized"), "Наименование показателей", dynamicChartDtNormalized);
