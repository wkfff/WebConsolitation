...
{
    public partial class FO_0735_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                UserParams.Mo.Value = "Холмский городской округ";
            }

            UserParams.Filter.Value = RegionsNamingHelper.LocalBudgetUniqueNames[UserParams.Mo.Value];

            if (UserParams.Mo.Value.ToLower().Contains("г.") || UserParams.Mo.Value.Contains("р.п.") || UserParams.Mo.Value.ToLower().Contains("город ") || UserParams.Mo.Value.ToLower().Contains("знаменск") || UserParams.Mo.Value.ToLower().Contains("город"))
            {
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_population");
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_incomes_date");
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_outcomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_credit_debts");
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0735_0015_Incomes");
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0735_0015_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
        ...
        private void InitializeBkku()
        {
            ...
            double innerDebtStartValue;
            Double.TryParse(dtInnerDebt.Rows[0][2].ToString(), out innerDebtStartValue);

            double bujetCredits;
            Double.TryParse(dtInnerDebt.Rows[1][1].ToString(), out bujetCredits);

            double bujetCreditsStartValue;
            Double.TryParse(dtInnerDebt.Rows[1][2].ToString(), out bujetCreditsStartValue);

            double creditCredits;
            Double.TryParse(dtInnerDebt.Rows[2][1].ToString(), out creditCredits);

            double creditCreditsStartValue;
            Double.TryParse(dtInnerDebt.Rows[2][2].ToString(), out creditCreditsStartValue);

            double garants;
            Double.TryParse(dtInnerDebt.Rows[3][1].ToString(), out garants);

            double garantsStartValue;
            Double.TryParse(dtInnerDebt.Rows[2][2].ToString(), out garantsStartValue);
            
            double serve;
            Double.TryParse(outcomesDebt.Rows[0][1].ToString(), out serve);

            munDebt.Text = String.Format("Всего&nbsp;<span style=\"color: white\"><b>{0:N0}</b></span>&nbsp;тыс.руб., в том числе<div style='padding-left: 20px'>{5}&nbsp;{8}&nbsp;<span style=\"color: white\"><b>{1:N0}</b></span>&nbsp;тыс.руб.<br/>{6}&nbsp;{9}&nbsp;<span style=\"color: white\"><b>{2:N0}</b></span>&nbsp;тыс.руб.<br/>{7}&nbsp;{10}&nbsp;<span style=\"color: white\"><b>{3:N0}</b></span>&nbsp;тыс.руб.</div>Обслуживание долга&nbsp;<span style=\"color: white\"><b>{4:N0}</b><span>&nbsp;тыс.руб.",
                innerDebtValue, bujetCredits, creditCredits, garants, serve, dtInnerDebt.Rows[1][0], dtInnerDebt.Rows[2][0], dtInnerDebt.Rows[3][0],
                GetArrow(bujetCreditsStartValue, bujetCredits), GetArrow(creditCreditsStartValue, creditCredits), GetArrow(garantsStartValue, garants));
        }

        private string GetArrow(double startValue, double currentValue)
        {
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0735_0015_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0735_0015_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0735_0015_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        {
            DataTable dtDate = new DataTable();
            string query = DataProvider.GetQueryText("FO_0735_0015_incomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            DataTable dtIncomes = new DataTable();
             query = DataProvider.GetQueryText("FO_0735_0015_Incomes_settlement");
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_Outcomes_settlement");
        ...
        private void InitializeSettlement()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0735_0015_settlements_count");
