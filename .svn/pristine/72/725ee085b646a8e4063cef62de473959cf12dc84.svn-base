...
namespace Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessGKH_Novosib
{
    public partial class _default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Hederglobal.Text = string.Format("Оценка неэффективных расходов в сфере жилищно-коммунального хозяйства ({0})", RegionSettings.Instance.Name);
            ...
            for (int j = 0; j < DundasMap.Shapes.Count; j++)
            {
                ...
                for (int i = 0; i < G2.Rows.Count; i++)
                {
                    try
                    {
                        ...
                        String.Format((G2.Rows[i].Cells[0].Value.ToString() + "||" + DundasMap.Shapes[j].Name));
                        ...
                        else
                        {
                            ...
                            DundasMap.Shapes[j].TextVisibility = TextVisibility.Shown;
                        }
                    }
                    catch { }
                }
