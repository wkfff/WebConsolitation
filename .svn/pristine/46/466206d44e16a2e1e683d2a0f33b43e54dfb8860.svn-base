...
{
    public partial class Oil_0007_0002 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                UserParams.Mo.Value = String.Format(".[{0}].DataMember", UserParams.Mo.Value.Replace(" район", " муниципальный район"));
            }
            else
            {
            ...
            currentRegion = UserParams.Mo.Value.Replace("Город ", String.Empty).Replace("город ", String.Empty).Replace("муниципальный район", "МР").Replace("[", String.Empty).Replace("]", String.Empty).Replace(".DataMember", String.Empty);

            DataTable dtDate = new DataTable();
            string query = DataProvider.GetQueryText("Oil_0007_0002_incomes_date");
        ...
        private void InitializeTable1()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("Oil_0007_0002_table1");
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                row[4] = String.Format("{0}<br/>{1:N2} руб.", dt.Rows[i][7].ToString().Replace("Город ", String.Empty).Replace("город ", String.Empty).Replace("муниципальный район", "МР"), dt.Rows[i][6]);
                row[5] = String.Format("{0}<br/>{1:N2} руб.", dt.Rows[i][9].ToString().Replace("Город ", String.Empty).Replace("город ", String.Empty).Replace("муниципальный район", "МР"), dt.Rows[i][8]);
        ...
        private void InitializeChart()
        {
            ...
            string query = DataProvider.GetQueryText("Oil_0007_0002_chart");
            ...
            {
                row[0] =
                    row[0].ToString().Replace("Город ", String.Empty).Replace("город ", String.Empty).Replace(
            ...
            {
                col.ColumnName =
                    col.ColumnName.Replace("Бензин марки ", String.Empty).Replace("Дизельное топливо", "ДТ");
            }
