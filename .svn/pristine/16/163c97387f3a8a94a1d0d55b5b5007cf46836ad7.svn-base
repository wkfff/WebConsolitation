...
{
    partial class PayingOffNominalPlanWizard
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.wizardParametersPage.Description = "Дата начала и окончания погашения номинальной стоимости по умолчанию проставляетс" +
                "я из таблицы текущего кредитного договора. Для изменения дат и периода, пожалуйс" +
                "та, выберите значения вручную.";
            ...
            this.nePeriodsCount.PromptChar = ' ';
            ...
            this.ultraLabel7.Text = "Количество периодов погашения номинальной стоимости:";
            // 
            // ultraLabel1
            // 
            ...
            this.ultraLabel2.Text = "Периодичность графика погашения номинальной стоимости.";
            // 
            // ultraLabel6
            // 
            ...
            this.ultraLabel6.Text = "Дата окончания - дата, до которой необходимо погасить часть основной суммы в соот" +
                "ветствии с графиком погашения";
            // 
            // ccEndDate
            // 
            ...
            this.ultraLabel3.Text = "Дата начала - дата, начиная с которой необходимо погасить часть основной суммы в " +
            ...
            this.uneDayCount.Location = new System.Drawing.Point(151, 194);
