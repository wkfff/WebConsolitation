<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.STAT_0001_0012_Sahalin._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            ...
            <td>
                ...
                <uc7:ReportPDFExporter ID="ReportPDFExporter1" runat="server" /></td>
            </td>
        </tr>
    ...
    <table>
                            ...
                            <table style="border-collapse: collapse; background-color: White; width: 100%;  
                                ...
                                <tr>
                                    ...
                                    <td style="overflow: visible;">
                                        <igchart:UltraChart ID="UltraChart4" runat="server" BackgroundImageFileName=""  
                                            ...
                                            <Axis>
                                                ...
                                                <X LineThickness="1" TickmarkInterval="0" Visible="True" TickmarkStyle="Smart" Extent="90">
                                                    <MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
                                                    <MajorGridLines Color="Gainsboro" DrawStyle="Dot" Visible="True" Thickness="1" AlphaLevel="255"></MajorGridLines>
                                                    <Labels Orientation="VerticalLeftFacing" ItemFormatString="&lt;ITEM_LABEL&gt;" FontColor="DimGray" HorizontalAlign="Near"
                                                        Font="Verdana, 7pt" VerticalAlign="Center">
                                                        ...
                                                        <SeriesLabels Orientation="Horizontal" FontColor="DimGray" 
                                                            HorizontalAlign="Center" Font="Verdana, 7pt"
                                    ...
                                    <td style="overflow: visible; " valign='top'>
                                        <asp:Label ID="lbDescription" runat="server" CssClass="PageSubTitle"></asp:Label>
                                    </td>
                                    <td class="right">
                                    </td>
                                </tr>
        ...
        <tr>
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px; margin-right: 10px;
                    margin-left: -3px">
                    <tr>
                        <td class="topleft">
                        </td>
