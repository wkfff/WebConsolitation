 ...
 *  Отчёт
 */
namespace Krista.FM.Server.Dashboards.reports.STAT_0003_0014_Novosib
{
    public partial class Default : CustomReportPage
    {
        ...
        class SetComboDay : IDataSetCombo
        {
            public override void LoadData(DataTable Table)
            {
                ...
                Table.Columns.Add("PrevMounth");

                foreach (DataRow row in Table.Rows)
                {
                    row["PrevMounth"] = LastMounthU.Replace("[1]", "[Заключительные обороты]");

                    string UniqueName = row["UniqueName"].ToString();

                    string PUniqueName = row["UniqueName"].ToString();
                    //    row["PUniqueName"].ToString();                    
                    ...
                    string TryDisplayName = "1 " + " " + CRHelper.RusMonthGenitive(CRHelper.MonthNum(Mounth)) + " " + Year + " года";

                    string DisplayNAme = this.GetAlowableAndFormatedKey(TryDisplayName, "");

                    //if (UniqueName.Contains("Заключительные обороты"))
                    //{
                    //    continue;
                    //}


                    if (TryDisplayName != DisplayNAme)
                    {
                        continue;
                    }
                    ...
                    LastMounthU = PUniqueName;

                    this.AddItem(DisplayNAme, 2, PUniqueName);
        ...
        class CoolDate
        {
            ...
            {
                return string.Format("{0:00}.{1:00}.{2:00} года", dt.Day, dt.Month, dt.Year);
        ...
        class InfoRow
        {
            ...
            public InfoRow(string BaseName)
            {
                switch (BaseName)
                {
                    ...
                    case "Среднемесячная заработная плата в расчете на одного работника предприятий и организаций (за период с начала года), руб.":
                        {
                            Caption = "Среднемесячная заработная плата в расчете на одного работника предприятий и организаций (за период с начала года)";
                            EdIzm = "руб.";
                    ...
                    case "Начисленная среднемесячная заработная плата в расчете на одного работника крупных и средних организаций - всего":
                        {
                            Caption = "Среднемесячная заработная плата в расчете на одного работника крупных и средних организаций (за период с начала года)";
                            EdIzm = "руб.";
                    ...
                    case "Суммарный объем просроченной задолженности по выплате заработной платы, тыс. руб.":
                        {
                            ReportDisplay = "Суммарный объем просроченной задолженности по выплате заработной платы, тыс. руб.";
                    ...
                    case "Численность занятых индивидуальным трудом и по найму у отдельных граждан, в % к численности трудовых ресурсов":
                        {
                            ReportDisplay = "Численность занятых индивидуальным трудом и по найму у отдельных граждан, в % к численности трудовых ресурсов";

                            Caption = "Численность занятых индивидуальным трудом и по найму у отдельных граждан, ";
                            EdIzm = "в % к численности трудовых ресурсов";
                    ...
                    case "Численность граждан, занятых в домашнем хозяйстве производством товаров и услуг для реализации, в % к численности трудовых ресурсов":
                        {
                            ReportDisplay = "Численность граждан, занятых в домашнем хозяйстве производством товаров и услуг для реализации, в % к численности трудовых ресурсов";

                            Caption = "Численность граждан, занятых в домашнем хозяйстве производством товаров и услуг для реализации";
                            EdIzm = "в % к численности трудовых ресурсов";
                    ...
                    case "Трудоспособное население в трудоспособном возрасте, не занятое в экономике и обучением, в % к численности трудовых ресурсов":
                        {
                            ReportDisplay = "Трудоспособное население в трудоспособном возрасте, не занятое в экономике и обучением, в % к численности трудовых ресурсов";

                            Caption = "Трудоспособное население в трудоспособном возрасте, не занятое в экономике и обучением";
                            EdIzm = "в % к численности трудовых ресурсов";
                    ...
                    case "Среднесписочная численность работников организаций и предприятий, в % к численности трудовых ресурсов":
                        {
                            ReportDisplay = "Среднесписочная численность работников организаций и предприятий, в % к численности трудовых ресурсов";

                            Caption = "Среднесписочная численность работников организаций и предприятий";
                            EdIzm = "в % к численности трудовых ресурсов";
        ...
        {
            PageTitle.Text = "Оплата труда работников организаций (рейтинг территорий)";
            PageSubTitle.Text = string.Format(@"Данные мониторинга заработной платы в муниципальных районах и городских округах <b>Новосибирской области</b> по состоянию на <b>{0}</b>", CurDate.ReportDate());
            //ReportDate());
            Page.Title = PageTitle.Text;

            LabelMap2.Text = string.Format("«<b>{0}</b>», <b>{1}</b> на <b>{2}</b>", GlobalNavigationInfoRow.Caption, GlobalNavigationInfoRow.EdIzm, CurDate.ReportDate());

            LabelChart1.Text = string.Format("Распределение территорий по показателю «<b>{0}</b>», <b>{1}</b> на <b>{2}</b>",
                GlobalNavigationInfoRow.Caption,
        ...
        private void FillNaviagatorPanel()
        {
            ...
            TableListForChart.AddOrGetRow("Среднемесячная заработная плата в расчете на одного работника крупных и средних организаций (за период с начала года), руб.")["Uname"]
                = "[Показатели__Рынок труда].[Показатели__Рынок труда].[Все].[Начисленная среднемесячная заработная плата в расчете на одного работника крупных и средних организаций - всего]";
        ...
        private void CustomaizeMapko()
        {
            ...
            legend.Title = SetBr(NaviagatorChart.ActiveRow[0].ToString(), 15);
            ...
            rule.LegendText = "#FROMVALUE{" + GlobalNavigationInfoRow.FormatString + "} - #TOVALUE{" + GlobalNavigationInfoRow.FormatString + "}";
        ...
        public void FillMap1Data()
        {
            ...
            foreach (Shape shape in DundasMap1.Shapes)
            {
                try
                {
                    ...
                    shape.Text = string.Format("{0}\n {1:" + Info.FormatString + "}", ShapeReportName.Replace("район", "р-н"), ShapeRow[1]);
        ...
        private void ChangeMapAndChartParam()
        {
            ...
            if (NaviagatorChart.ActiveRow[0].ToString().Contains("Среднемесячная заработная плата в "))
            {
                ChosenCurPeriod.Value = DataSetComboDay.OtherInfo[ComboCurrentPeriod.SelectedValue]["PrevMounth"];
            } 
            else
            {
                ChosenCurPeriod.Value = DataSetComboDay.OtherInfo[ComboCurrentPeriod.SelectedValue]["UniqueName"];
            }
        ...
        private void GenChart()
        {
            ...
            UltraChart1.Axis.Y.Labels.ItemFormatString = "<DATA_VALUE:" + GlobalNavigationInfoRow.FormatString + ">";
            ...
            //UltraChart1.ColumnChart.ChartText.Add(new ChartTextAppearance(UltraChart1, -2, -2, true, new Font("Verdana", 10, FontStyle.Bold), Color.Black, "<DATA_VALUE:" + GlobalNavigationInfoRow.FormatString + ">", StringAlignment.Far, StringAlignment.Center, 0));

            UltraChart1.Tooltips.FormatString = string.Format("<SERIES_LABEL><br><b><DATA_VALUE:" + GlobalNavigationInfoRow.FormatString + "></b>, {0}",
        ...
        private void PdfExportButton_Click(object sender, EventArgs e)
        {
            ...
            title.AddContent(PageTitle.Text.Replace("<b>", "").Replace("</b>", ""));
            ...
            DundasMap1.Legends[1].Dock = PanelDockStyle.Left;
            DundasMap1.Legends[1].DockAlignment = DockAlignment.Far;
            ReportPDFExporter1.Export(DundasMap1, LabelMap2.Text.Replace("<b>", "").Replace("</b>", ""), section2);
            ReportPDFExporter1.Export(UltraChart1, LabelChart1.Text.Replace("<b>", "").Replace("</b>", ""), section3);
        }
        ...
        {
            ReportExcelExporter1.WorksheetTitle = PageTitle.Text.Replace("<b>", "").Replace("</b>", "");
            ReportExcelExporter1.WorksheetSubTitle = PageSubTitle.Text.Replace("<b>", "").Replace("</b>", "").Replace("  ", " ").Replace("\n", "");
            ...
            DundasMap1.Width = 950;
            DundasMap1.Height = 550;
            UltraChart1.Width = 800;
            DundasMap1.Legends[1].Dock = PanelDockStyle.Left;
            DundasMap1.Legends[1].DockAlignment = DockAlignment.Far;
            ReportExcelExporter1.Export(UltraChart1, LabelChart1.Text.Replace("<b>", "").Replace("</b>", ""), sheet2, 3);
            ReportExcelExporter1.Export(DundasMap1, LabelMap2.Text.Replace("<b>", "").Replace("</b>", ""), sheet4, 4);

            ClearTitle(sheet2);
            MoveTitle(sheet2);

            sheet2.Rows[0].Cells[0].Value = LabelChart1.Text.Replace("<b>", "").Replace("</b>", "");

            sheet2.Rows[0].Cells[0].CellFormat.WrapText = ExcelDefaultableBoolean.True;
            sheet2.Rows[0].Height = 500;
