<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0001_Sakhalin.Default" Title="Индикаторы БК и КУ " %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top">
                <uc3:CustomMultiCombo ID="regionsCombo" runat="server"></uc3:CustomMultiCombo>
            </td>
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top" align="left">
                <table style="border-collapse: collapse; background-color: white; width: 100%; height: 100%;
                    margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="gridTd" valign="top">
      ...
      <table style="vertical-align: top;">
        <tr>
          <td valign="top">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Vertical"
                    Width="300px" style="font-family:Verdana;font-size:12px;">
                    <asp:ListItem Selected="True">В рублях</asp:ListItem>
                    <asp:ListItem>В иностранной валюте</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            <td valign="top">
                <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" RepeatDirection="Vertical"
                    Width="300px" style="font-family:Verdana;font-size:12px;">
                    <asp:ListItem Selected="True">Для юридических лиц</asp:ListItem>
                    <asp:ListItem>Для физических лиц</asp:ListItem>
                </asp:RadioButtonList>
            </td>  
        </tr>
    </table>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="ChartCaption" runat="server" CssClass="ElementTitle" Text= "Динамика банковских минимальных/максимальных средневзвешенных ставок по кредитам "></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;" runat="server" id="chartTd">
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text= "Динамика банковских минимальных/максимальных средневзвешенных ставок по депозитам "></asp:Label>
                            </td>
                            <td class="headerright">
                            </td>
                        </tr>
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="ChartCaption2" runat="server" CssClass="ElementTitle" Text= "Динамика процентных ставок по выданным ипотечным кредитам"></asp:Label>
                            </td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="overflow: visible;" runat="server" id="Td2">
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="ChartCaption3" runat="server" CssClass="ElementTitle" Text= "Динамика процентных ставок по выданным потребительским кредитам"></asp:Label>
                            </td>
                            <td class="headerright">
                            </td>
                        </tr>
