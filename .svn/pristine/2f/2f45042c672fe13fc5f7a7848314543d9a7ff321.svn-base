...
namespace Krista.FM.Server.Dashboards.reports.FO_0039_0005
{
    ...
    public partial class Default : CustomReportPage
    {
        ...
        {
            get { return indicatorName == "Итоговая оценка уровня качества ОиОБП"; }
        }
        ...
        public void SetMapSettings()
        {
            ...
            nullEmptyText = (!IsYearCompare && indicatorPeriod.ToLower() == "год")
            ...
            switch (selectedIndicatorName)
            {
                ...
                case "Средняя оценка уровня качества ОиОБП":
                    {
                        beginMapColor = Color.LightGreen;
                        middleMapColor = Color.FromArgb(250, 251, 129);
                        endMapColor = Color.Salmon;
                ...
                case "Итоговая оценка уровня качества ОиОБП":
                    {
            ...
            column = new LegendCellColumn(ValueSelected ? "Значение" : "Оценка");
            column.HeaderFont = new Font("Verdana", 8, FontStyle.Bold);
            column.HeaderTextAlignment = StringAlignment.Far;
            legend.CellColumns.Add(column);

//            legend.CellColumns.Add("Код");
//            legend.CellColumns.Add("Территория");
//            legend.CellColumns.Add("Оценка");
        ...
        public void FillMapData()
        {
            ...
            // для случаев, когда только нули и единицы
...
//                }
        ...
        protected void IndicatorDetailDataBind()
        {
            ...
            beginQualityLimit = GetDoubleDTValue(dtIndicatorDetail, "Начальная граница интервала");
            endQualityLimit = GetDoubleDTValue(dtIndicatorDetail, "Конечная граница интервала");
