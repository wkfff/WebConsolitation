<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0006_0001.Default" Title="Анализ налога на доходы физических лиц" %>
    
<%@ Register Src="../../Components/ReportExcelExporter.ascx" TagName="ReportExcelExporter" TagPrefix="uc7" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboFin" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top" align="left">
                <table style="border-collapse: collapse; background-color: White; width: 100%; height: 100%; margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                        </td>
                        <td class="top">
                    ...
                    <tr>
                        ...
                        <td class="header">
                            <asp:Label ID="Label3" runat="server" Text="Анализ доходов физических лиц по ставкам налогообложения"
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible; height: 510px;" valign="top">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px" SkinID="UltraWebGrid">
                                <Bands>
                                    <igtbl:UltraGridBand>
            ...
            <td valign="top" align="left" >
                <table style="border-collapse: collapse; background-color: White; width: 100%; height: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="header">
                            <asp:Label ID="Label4" runat="server" Text="Анализ налоговых вычетов"
                                CssClass="ElementTitle"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible; height: 510px" valign="top">
                            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" EnableAppStyling="True" Height="200px" SkinID="UltraWebGrid">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid2" runat="server" EnableAppStyling="True" Height="200px" SkinID="UltraWebGrid">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
