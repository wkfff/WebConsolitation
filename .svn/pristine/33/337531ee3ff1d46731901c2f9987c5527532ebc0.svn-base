<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FSGS_0001_0004.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboParam" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboFood" runat="server"></uc3:CustomMultiCombo>
            </td>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <asp:Label ID="GridHeader" runat="server" Text="обычный текст" CssClass="ElementTitle"></asp:Label>
            ...
            <td valign="top" align="left">
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <asp:Label ID="ChartHeader" runat="server" Text="обычный текст" CssClass="ElementTitle"></asp:Label>
