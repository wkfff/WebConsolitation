...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0003_Vologda
{
    public partial class DefaultDetail : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0003_Vologda_grid");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 2, "Назначено, тыс.руб.", "Плановые назначения на год");
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 3, "Исполнено, тыс.руб.", "Фактическое исполнение нарастающим итогом с начала года");
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 5, "Средний % наполнения бюджета",
                "Средний % наполнения бюджета за два года предыдущих отчетному");
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 6, "Доля",
                "Удельный вес статьи в общей сумме налоговых и неналоговых доходов");
            
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 7, "Исполнено прошлый год, тыс.руб.", "Исполнено за аналогичный период прошлого года");
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 8, "% наполнения бюджета", "% наполнения бюджета аналогичного периода прошлого года");
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 9, "Темп роста к прошлому году", "Темп роста исполнения к аналогичному периоду прошлого года");
