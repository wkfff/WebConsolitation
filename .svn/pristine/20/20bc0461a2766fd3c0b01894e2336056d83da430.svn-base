<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0015.Default" Title="Сравнение темпа роста доходов по субъектам РФ" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px"
                                OnDataBinding="UltraWebGrid_DataBinding" StyleSetName="Office2007Blue" SkinID="UltraWebGrid"
                                Width="125px" OnInitializeRow="UltraWebGrid_InitializeRow" OnActiveRowChange="UltraWebGrid_ActiveRowChange">
                                <Bands>
                                    <igtbl:UltraGridBand>
        ...
        <tr>
            <td style="width: 50%">
                <table runat="server" id="Table2" style="border-collapse: collapse; background-color: white;
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="Td4">
                            <igmisc:WebAsyncRefreshPanel ID="Panel1" runat="server" TriggerControlIDs="UltraWebGrid">
                                <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text=""></asp:Label>
            ...
            <td style="width: 50%">
                <table runat="server" id="Table3" style="border-collapse: collapse; background-color: white;
                    width: 100%; margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="Td5">
                            <igmisc:WebAsyncRefreshPanel ID="Panel2" runat="server">
                                <asp:Label ID="ChartCaption2" runat="server" CssClass="ElementTitle" Text=""></asp:Label>
                ...
                <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption3" runat="server" Text="Ведомственная структура расходов областного бюджета, млн.руб."
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="Td6">
