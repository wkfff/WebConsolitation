<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FST_0001_0013_Horizontal.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FST_0001_0013_Horizontal" %>
...
<body style="background-color: Black">
    ...
    <div style="position: absolute; width: 1022px; height: 100%; left: 0px;
        ...
        <table style="position: absolute; background-color: Black;
            ...
            <tr>
                <td valign="top">
                <uc1:iPadElementHeader ID="IPadElementHeader3" runat="server" Text="Динамика тарифов на электроснабжение"
                        Width="100%" />
            ...
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Электроснабжение (среднеотпускной тариф)"
                        Width="100%" />
                    <uc2:FST_0001_0003_Text ID="TagCloudFST_0001_0013_Horizontal_Text1" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Электроснабжение (тариф для населения)"
                        Width="100%" />
                    <uc2:FST_0001_0003_Text ID="TagCloudFST_0001_0013_Horizontal_Text2" runat="server" />
                </td>
            </tr>
        </table>
    </div>
