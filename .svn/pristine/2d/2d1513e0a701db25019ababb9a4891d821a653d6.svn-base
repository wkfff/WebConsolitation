    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                regionDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FO_0002_0056_regionDigest");
            ...
            selectedCondition.Value = "[Состояние__Формы сбора по паспорту МО].[Состояние__Формы сбора по паспорту МО].[Все состояния].[Утвержден]";
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_population");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_mainGrid");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_creditGrid");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_referenceGrid");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_nonEmptyQuery");
