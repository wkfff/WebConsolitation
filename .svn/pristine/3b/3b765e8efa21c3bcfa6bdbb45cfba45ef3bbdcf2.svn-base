<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SE_0001_0007.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.SE_0001_0007" %>
                ...
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Диаграмма Парето по объему производства"
                            Width="760px" />
                        <uc2:SE_0001_0007_Chart ID="UltraChartSE_0001_0007_Chart1" runat="server" QueryName="SE_0001_0007_chart1">
                        </uc2:SE_0001_0007_Chart>
                    </td>
                </tr>
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Объем производства" Width="760px" />
