 ...
 */
namespace Krista.FM.Server.Dashboards.reports.STAT_0003_0003_YANAO
{
	public partial class Default : CustomReportPage
	{
		...
		protected override void Page_PreLoad(object sender, EventArgs e)
		{
			...
			CrossLink1.NavigateUrl = "~/reports/STAT_0003_0004_YANAO/Default.aspx";
			CrossLink2.Text = "Мониторинг&nbspситуации&nbspна&nbspрынке&nbspтруда&nbspв&nbspсубъектах&nbspРФ, входящих&nbspв&nbspУрФО";
            CrossLink2.NavigateUrl = "~/reports/STAT_0001_0002/Default.aspx";
		...
		private void ExcelExportButton_Click(object sender, EventArgs e)
		{
			...
			foreach (UltraGridRow row in UltraWebGrid.Rows)
			{
				sheet1.Rows[5 + row.Index].Height = 255;
			}

            //sheet1.Rows[1].Height = 300*2;
			...
			for (int i = 0; i < UltraWebGrid.Rows.Count; i += 3)
			{
				...
				{
					sheet1.Rows[5 + i].Cells[j].CellFormat.BottomBorderStyle = CellBorderLineStyle.None;
					sheet1.Rows[6 + i].Cells[j].CellFormat.BottomBorderStyle = CellBorderLineStyle.None;
					sheet1.Rows[6 + i].Cells[j].CellFormat.TopBorderStyle = CellBorderLineStyle.None;
            ...
            sheet2.Columns[0].Width = 50000;
            sheet3.Columns[0].Width = 50000;
		}
