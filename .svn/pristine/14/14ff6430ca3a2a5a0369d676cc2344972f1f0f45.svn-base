...
{
    public partial class UFK_0017_0001_V : CustomReportPage
    {
        ...
        private void MakeRestTable()
        {
            ...
            cell.CssClass = "HtmlTableHeader";
            label = new Label();
            label.Text = "Остаток нецелевых средств";
            cell.Controls.Add(label);
            cell.ColumnSpan = 3;
            cell.VerticalAlign = VerticalAlign.Middle;
            cell.HorizontalAlign = HorizontalAlign.Center;
            ...
            cell.CssClass = "HtmlTableHeader";
            label = new Label();
            label.Text = "Изменение,<br>тыс. руб.";
            label.CssClass = "DigitsValueSmall";
            cell.Controls.Add(label);
            cell.ColumnSpan = 2;
            cell.VerticalAlign = VerticalAlign.Middle;
            ...
            for (int i = 0; i < dtGrid.Rows.Count; i++)
            {
                ...
                label.Text = string.Format("{0:N2}", dtGrid.Rows[i][1]);
                label.CssClass = "TableFont";
                cell.Width = 90;
                cell.Controls.Add(label);
                cell.VerticalAlign = VerticalAlign.Middle;
                ...
                label = new Label();
                label.Text = string.Format("{0:N2}<br>", dtGrid.Rows[i][2]);
                label.CssClass = "InformationText";
                cell.Controls.Add(label);
                
                label = new Label();
                label.Text = string.Format("{0:P2}", dtGrid.Rows[i][3]);
                label.CssClass = "InformationText";
                cell.Controls.Add(label);
