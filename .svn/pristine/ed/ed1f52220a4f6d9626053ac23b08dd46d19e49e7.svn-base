...
namespace Krista.FM.Server.Dashboards.reports.iPad
{
    public partial class Food_0001_0001_v : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            lbDescription.Text = String.Format("Розничные цены на продукты питания на&nbsp;<span class='DigitsValue'>{1:dd.MM.yyyy}</span>&nbsp;(изменение за период с&nbsp;<span class='DigitsValue'>{0:dd.MM.yyyy}</span>), руб.", lastDate, currentDate);
        ...
        void UltraWebGrid1_DataBinding(object sender, EventArgs e)
        {
            ...
            {
                dtSource.Columns.Add(new DataColumn(dt.Columns[columnCount].ColumnName.Split(';')[0].Replace("Архангельск", "Архан- гельск"), typeof(string)));
            }
