<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0001_HMAO.Default" %>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            ...
                            <igtbl:UltraWebGrid ID="grid_outcomesTotal" runat="server" EnableAppStyling="True"
                                EnableTheming="True" Height="60px" OnDataBinding="grid6_DataBinding" OnInitializeLayout="grid_InitializeLayout"
                            ...
                            <asp:Label ID="IndicationCommentLabel" runat="server" CssClass="PageSubTitle"></asp:Label>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
