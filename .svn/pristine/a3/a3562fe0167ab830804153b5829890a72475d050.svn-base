...
namespace Krista.FM.Providers.MSOracleDataAccess
{
    public class OracleDbParameter : DbParameter
    {
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (Enum.IsDefined(typeof(DbType), intType))
                        ...
                        parameter.OracleType = (OracleType)(int)value;
                }
            }
        }
        ...
        public override object Value
        {
            ...
            set
            {
                if (value != DBNull.Value && (parameter.DbType == DbType.DateTime || parameter.DbType == DbType.Date || parameter.OracleType == OracleType.DateTime))
