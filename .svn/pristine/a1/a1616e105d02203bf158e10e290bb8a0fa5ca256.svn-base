<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
   Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0003.Default" Title="Численность государственных гражданских служащих и фактические затраты на их денежное содержание" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
      ...
      <table>  
        <tr>              
            ...
            <td valign = "top">
              <uc3:CustomMultiCombo ID="ComboPost" runat="server"></uc3:CustomMultiCombo>
            </td>   
            <td valign = "top">
              <uc3:CustomMultiCombo ID="ComboPostMO" runat="server"></uc3:CustomMultiCombo>
            </td>                     
            <td valign="top">
         ...
         <tr>
             <td valign="top" >
                <asp:RadioButtonList ID="DebtKindButtonList" runat="server" AutoPostBack="True"
                    RepeatDirection="Horizontal" Width="600px" style="font-family:Verdana; font-size:12px;">
   ...
   <table>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <asp:Label ID="gridCaptionElement" runat="server" CssClass="ElementTitle"></asp:Label>
                            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="200px" Width="325px" OnDataBinding="UltraWebGrid_DataBinding" OnActiveRowChange="UltraWebGrid_ActiveRowChange"
        ...
        <tr>
            <td>
               <igmisc:WebAsyncRefreshPanel ID="chartsWebAsyncPanel" runat="server" TriggerControlIDs="UltraWebGrid1" style="width: 100%">
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                        </td>
