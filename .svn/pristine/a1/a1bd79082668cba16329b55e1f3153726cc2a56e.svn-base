    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                hiddenIndicatorLabel.Text = "[Показатели__Оценка качества ФМ_Сопоставимый].[Показатели__Оценка качества ФМ_Сопоставимый].[Все показатели].[1. Среднесрочное финансовое планирование]";
            }

            int quarterNum = ComboQuarter.SelectedIndex + 1;

            Page.Title = String.Format("Анализ оценки качества финансового менеджмента, осуществляемого главными распорядителями средств бюджета ХМАО - Югры в разрезе показателей");
        ...
        private void ActiveGridRow(UltraGridRow row)
        {
            ...
            chartCaption.Text = String.Format("Показатель «{0}»", indicatorName);
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            headerLayout.AddCell("Средняя оценка показателя исходя из его применимости к ГРБС");
            headerLayout.AddCell("ГРБС, получивший минимальную оценку");
            headerLayout.AddCell("ГРБС, получивший максимальную оценку");
            headerLayout.AddCell("ГРБС, по которому показатель не применим");
