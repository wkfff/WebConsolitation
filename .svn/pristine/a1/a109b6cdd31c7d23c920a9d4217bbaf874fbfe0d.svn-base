<%@ Control Language="C#" AutoEventWireup="true" Codebehind="Food_0001_0002_Chart.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.Food_0001_0002_Chart" %>
...
<table style="border-collapse: collapse; height: 100%">
    <tr>
        ...
        <div style="margin-top: -10px">
            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName="" BorderColor="Black" BorderWidth="1px"
                EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                SmoothingMode="Invalid" Version="9.1" SkinID="UltraWebColumnChart">
            ...
            <table style="margin-left: 49px; margin-top: -18px; border-collapse: collapse">
                <tr>
                    ...
                    <td style="width: 135px;" align="center">
                        <asp:Label ID="Label3" runat="server" SkinID="InformationText"></asp:Label>
                    </td>
                    <td style="width: 135px;" align="center">
                        <asp:Label ID="Label4" runat="server" SkinID="InformationText"></asp:Label>
                    </td>
                    <td style="width: 135px;" align="center">
                        <asp:Label ID="Label5" runat="server" SkinID="InformationText"></asp:Label>
                    </td>
                </tr>
            </table>
        </td>
