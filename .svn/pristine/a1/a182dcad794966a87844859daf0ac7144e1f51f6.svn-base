<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.PROG_0003_Sahalin.Default" %>
        ...
        <tr>
            ...
            <td style="width:100%" align="right">
                <uc4:ReportExcelExporter ID="ReportExcelExporter1" runat="server" />&nbsp;<uc5:ReportPDFExporter
                    ID="ReportPDFExporter1" runat="server" /><br><asp:HyperLink ID="WallLink" runat="server" SkinID="HyperLink"></asp:HyperLink>   
            </td>
