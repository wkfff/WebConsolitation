<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0019.Default" Title="Untitled Page" %>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="headerReport" colspan="2">
                            ...
                            <asp:Label ID="chartHeaderLabel" runat="server" CssClass="ElementTitle" Text = "Структура налоговых и неналоговых доходов областного бюджета"></asp:Label>
                        </td>
