...
namespace Krista.FM.Server.Dashboards.reports.FNS_0001_0001_Yamal
{
    public partial class DefaultKD : CustomReportPage
    {
        ...
        // для районов брать консолидированный бюджет МР и поселений
        private CustomParam useConsolidateLevel;
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            if (useConsolidateLevel == null)
            {
                useConsolidateLevel = UserParams.CustomParam("use_consolidate_budget");
            }
            ...
            RegionsLink.NavigateUrl = "~/reports/FNS_0001_0001_Yamal/DefaultRegions.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            useConsolidateLevel.Value = UseConsolidateRegionBudget ? "true" : "false";
            ...
            chartLabel2.Text = "Распределение доходных источников по росту / снижению недоимки в сравнении с прошлым годом , тыс.руб.";
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_Yamal_gridKD_split" : "FNS_0001_0001_Yamal_gridKD";
            ...
            {
                query = DataProvider.GetQueryText("FNS_0001_0001_Yamal_gridKD_monthReport");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 9)
            {
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 7,
                    String.Format("Объем поступлений* на 01.{0:00}.{1}, тыс.руб.", nextMonth, nextYear),
                    String.Format("Объем поступлений* за {0} {1} {2} года", month, CRHelper.RusManyMonthGenitive(month), year));
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_Yamal_chartKD1_split" : "FNS_0001_0001_Yamal_chartKD1";
            string query = DataProvider.GetQueryText(queryName);
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_Yamal_chartKD2_split" : "FNS_0001_0001_Yamal_chartKD2";
            string query = DataProvider.GetQueryText(queryName);
