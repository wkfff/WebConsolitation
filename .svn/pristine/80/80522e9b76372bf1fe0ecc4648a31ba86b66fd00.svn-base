<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010.LifeLevel.Default" %>
...
<asp:Label ID="page_title" runat="server"  Text="заголовок" CssClass="PageTitle"></asp:Label>
    <br /><a href="../OverallTable/default.aspx">sad</a>
<br />
...
StyleSetName="Office2007Blue" Width="355px" OnActiveRowChange="web_grid4_ActiveRowChange" Height="319px">
                <Bands>
                    <igtbl:UltraGridBand>
                        <AddNewRow View="NotSet" Visible="NotSet">
                        </AddNewRow>
    ...
    Version="4.00" ViewType="Hierarchical" CellClickActionDefault="RowSelect">
        ...
        Font-Names="Microsoft Sans Serif" Font-Size="8.25pt">
            ...
            Font-Size="11px" Height="300px" Width="200px">
                    ...
                    <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="None" BorderWidth="1px"
        Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Width="355px" Height="319px">
                    </FrameStyle>
                    <Pager MinimumPagesForDisplay="2">
                        <PagerStyle BackColor="LightGray" BorderStyle="Solid" BorderWidth="1px">
                            <BorderDetails ColorLeft="White" ColorTop="White" WidthLeft="1px" WidthTop="1px" />
        ...
        <td style="vertical-align: top;">
                    ...
                    <td style="vertical-align: top; text-align:center;">
                        <table style="width: 100%; border-collapse: collapse; background-color: white">
                            ...
                            <tr>
                                ...
                                <td>
                            <asp:Label id="Label2" runat="server" Text="Количество получателей пособия" CssClass="ElementTitle"></asp:Label>
                            <igchart:UltraChart id="Grid4Chart1" runat="server" Version="8.2" EmptyChartText="в настоящий момент данные отсутствуют"   BackgroundImageFileName="" Width="206px" OnDataBinding="Grid4Chart1_DataBinding" OnInvalidDataReceived="InvalidDataReceived" Height="310px">
                                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    ...
                    <td style="vertical-align: top; text-align:center;">
                        <table style="width: 100%; border-collapse: collapse; background-color: white">
                            ...
                            <tr>
                                ...
                                <td>
                            <asp:Label id="Label3" runat="server" Text="Размер пособия" CssClass="ElementTitle"></asp:Label>
                            <igchart:UltraChart id="Grid4Chart2" runat="server" Version="8.2" EmptyChartText="в настоящий момент данные отсутствуют"   BackgroundImageFileName="" Width="206px" OnDataBinding="Grid4Chart2_DataBinding" OnInvalidDataReceived="InvalidDataReceived" Height="310px">
                    ...
                    <td style="vertical-align: top; text-align:center;">
                        <table style="width: 100%; border-collapse: collapse; background-color: white">
                            ...
                            <tr>
                                ...
                                <td>
                                    &nbsp;<asp:Label id="Label4" runat="server" Text="Общая сумма выплат"  CssClass="ElementTitle"></asp:Label>
                            <igchart:UltraChart id="Grid4Chart3" runat="server" Version="8.2" EmptyChartText="в настоящий момент данные отсутствуют"   BackgroundImageFileName="" Width="206px" OnDataBinding="Grid4Chart3_DataBinding" OnInvalidDataReceived="InvalidDataReceived" Height="310px">
            ...
            <Y LineThickness="1" TickmarkInterval="50" Visible="True" TickmarkStyle="Smart" Extent="50">
            <MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
