<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0019_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0019_Horizontal" %>
...
<body style="background-color: black;">
    <form id="form1" runat="server">
        <div style="position: absolute; width: 1022px; height: 695px; background-color: black; top: 0px; left: 0px;
            ...
            <table style="width: 768; height: 900; border-collapse: collapse; background-color: Black; top: 0px;
                ...
                <tr>
                   ...
                   <tr>
                    ...
                    <td style="width: 315px; background-color: black;" valign="top">
                        <div style="margin-top: -10px"><igchart:UltraChart ID="UltraChart2" runat="server" SkinID="UltraWebColumnChart">
                            <DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_FK0101Gadget_#SEQNUM(100).png" />
                        </igchart:UltraChart></div>
                    </td>
                </tr>
            </table>
        </div>
