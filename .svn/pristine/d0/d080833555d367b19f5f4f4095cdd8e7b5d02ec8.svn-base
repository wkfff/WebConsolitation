<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0007.Default" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
    <tr>        
        ...
        StyleSetName="Office2007Blue" Width="50%" OnClick="web_grid_Click">
        <Bands>
            <igtbl:UltraGridBand>
        ...
        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes" BorderCollapseDefault="Separate"
            ...
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server" Width="100%" TriggerControlIDs="web_grid">
<br/>
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                <tr>
                    <td style="vertical-align: top;">
                    ...
                    <td style="vertical-align: top;">
                        <table style="border-collapse: collapse; background-color: white">
                            ...
                            <tr>
                                ...
                                <td class="headerReport">
                        <asp:Label ID="Chart1Lab" runat="server"  Text="заголовок таблицы" CssClass="ElementTitle"></asp:Label></td>
                                <td class="headerright">
                                </td>
                            </tr>
                            <tr>
                        ...
                        <igchart:UltraChart ID="Chart1" runat="server" BackgroundImageFileName=""  
                            ...
                            Version="9.1" OnDataBinding="web_grid1_DataBinding" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="100" Transform3D-XRotation="50" Transform3D-YRotation="30">
                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, единиц &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
                ...
                Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Width="350px">
                    ...
                    <td style="vertical-align: top;">
                        ...
                        <igchart:UltraChart ID="Chart2" runat="server" BackgroundImageFileName=""  
                            ...
                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, рубль &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
                            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
                            </ColorModel>
                            <Effects>
                                <Effects>
                    ...
                    <td style="vertical-align: top;">
                        <table style="border-collapse: collapse; background-color: white">
                            ...
                            <tr>
                                ...
                                <td class="headerReport">
                        <asp:Label ID="Chart4Lab" runat="server" Text="заголовок таблицы" CssClass="ElementTitle"></asp:Label></td>
                                <td class="headerright">
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td style="vertical-align: top;">
                        <table style="border-collapse: collapse; background-color: white">
                            ...
                            <tr>
                                ...
                                <td class="headerReport">
                        <asp:Label ID="Chart5Lab" runat="server" Text="заголовок таблицы" CssClass="ElementTitle"></asp:Label></td>
                                <td class="headerright">
                                </td>
                            </tr>
                            <tr>
