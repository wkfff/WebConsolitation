...
{
    public partial class Oil_0001_0001 : CustomReportPage
    {
        ...
        private string currentRegion = "Город Вологда";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("Oil_0001_0001_incomes_date");
        ...
        private void InitializeTable1()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("Oil_0001_0001_table1");
            ...
            for (int i = 0; i < dt.Rows.Count; i++ )
            {
                ...
                row[4] = String.Format("{0}<br/>{1:N2} руб.", dt.Rows[i][7].ToString().Replace("Город ", "").Replace("город ", ""), dt.Rows[i][6]);
                row[5] = String.Format("{0}<br/>{1:N2} руб.", dt.Rows[i][9].ToString().Replace("Город ", "").Replace("город ", ""), dt.Rows[i][8]);
        ...
        void UltraWebGrid1_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            GridHeaderCell headerCell = headerLayout1.AddCell("Сравнение с другими городами");
            ...
            e.Layout.Bands[0].Columns[0].Width = 204;
        ...
        private void InitializeChart()
        {
            ...
            string query = DataProvider.GetQueryText("Oil_0001_0001_chart");
