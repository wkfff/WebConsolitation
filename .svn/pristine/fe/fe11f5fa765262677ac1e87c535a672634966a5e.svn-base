<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.OMCY_0001._default" %>
        ...
        <table>
            <tr>
                <td colspan="2">
                    ...
                    <asp:RadioButton ID="PVDM" runat="server" AutoPostBack="True" Checked="True" Text="Структура расходов"
                        ValidationGroup="xz" GroupName="xz" /><br />
                    <asp:RadioButton ID="RadioButton3" runat="server" AutoPostBack="True" Text="По видам расходов"
                        ValidationGroup="xz" GroupName="xz" /><br />
                                        ...
                                        <td style="vertical-align: top; height: 360px;">
                                            <asp:Label ID="CL" runat="server" CssClass="ElementTitle"></asp:Label><igchart:UltraChart ID="C" runat="server" BackgroundImageFileName=""  
                                                ...
                                                <Axis>
                                                    ...
                                                    <Y Extent="50" TickmarkInterval="100" TickmarkStyle="Smart" Visible="True">
                                                    ...
                                                    <Y2 Extent="0" LineThickness="1" TickmarkInterval="100" TickmarkStyle="Smart" Visible="False">
                                                        <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                                            Visible="True" />
                                                        <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                                            Visible="False" />
            ...
            <tr>
                <td colspan="2"><table runat="server" style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;" id="C1Table">
                    <tr>
                        <td class="topleft">
                        </td>
                        <td class="top">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top; height: 360px;">
                            <asp:Label ID="Label1" runat="server" CssClass="ElementTitle"></asp:Label><igchart:UltraChart ID="C1" runat="server" BackgroundImageFileName=""  
                                                 EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                                Height="400px" Version="9.1" Width="500px" OnDataBinding="C1_DataBinding" ChartType="StackColumnChart">
                                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                    Font-Underline="False" FormatString="&lt;b&gt;&lt;DATA_VALUE:### ### ##0.00&gt;&lt;/b&gt; тыс. рублей" />
                                <Border Color="Transparent" />
