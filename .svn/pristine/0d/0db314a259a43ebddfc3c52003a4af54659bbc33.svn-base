...
{
    public partial class IT_0002_0005_Map : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DundasMap1.Viewport.BackColor = Color.FromArgb(168, 168, 168);
            ...
            legend1.BackColor = Color.FromArgb(168, 168, 168);
            legend1.BackSecondaryColor = Color.FromArgb(75, 168, 168, 168);
            legend1.BackGradientType = GradientType.TopBottom;
            legend1.BackHatchStyle = MapHatchStyle.None;
            legend1.BorderColor = Color.FromArgb(107, 107, 107);
                    ...
                    row[1] != DBNull.Value && row[1].ToString() != string.Empty)
                {
                    ...
                    if (RegionsNamingHelper.IsFO(RegionsNamingHelper.FullName(subject)))
                    {
                        ...
                        if (shape != null)
                        {
                            ...
                            shape.Text = string.Format("{0}\n{1:N2}", row[0], Convert.ToDouble(row[1]));
