<%@ Page Language="C#" AutoEventWireup="true" Codebehind="IT_0001_0004_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.IT_0001_0009" %>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        <table style="border-collapse: collapse; margin-left: 10px">
                            ...
                            <tr>
                                <td align="right" class="InformationTextLarge" style="text-align: right; padding-right: 5px; padding-top: 20px">
