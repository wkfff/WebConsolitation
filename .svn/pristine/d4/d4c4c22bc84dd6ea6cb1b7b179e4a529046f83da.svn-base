<%@ Control Language="C#" AutoEventWireup="true" Codebehind="FO_0002_0002_Gadget.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.DashboardNotepadFin.FO_0002_0002_Gadget" %>
