...
namespace Krista.FM.Server.Dashboards.reports.iPad
{
    ...
    public partial class Food_0006_0003 : CustomReportPage
    {
        ...
        private void InitializeDate()
        {
            ...
            string query = DataProvider.GetQueryText("Food_0006_0003_incomes_date");
		...
		private void UltraWebGrid1_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("Food_0006_0003_grid_stat");
