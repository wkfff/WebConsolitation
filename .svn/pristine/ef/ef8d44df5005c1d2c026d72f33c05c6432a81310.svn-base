<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0010.Default" %>
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                            <asp:CheckBox ID="comparePrevYear" Checked="false" runat="server" Text="Сравнение&nbsp;с&nbsp;прошлым&nbsp;годом"
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="ChartDistrictExclude" runat="server" Text="Без городских округов" AutoPostBack="true" Checked="false"
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            ...
                            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fns_01_01_1#SEQNUM(100).png" />
                            </igchart:UltraChart>
