...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0014_HMAO
{
    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                selectedIndicatorCaption.Value = defaultIndicator;
            }
            ...
            if (!indicators.ContainsKey(selectedIndicatorCaption.Value))
            {
                ComboIndicator.SetСheckedState(defaultIndicator, true);
            }
            else
            {
            ...
            string mapFolder = RegionSettingsHelper.Instance.GetPropertyValue("MapFolderName");
                ...
                case "В том числе по КОСГУ ":
                    {
                        ...
                        shareMeasure.Value = "";
                        filterIndicator.Value = RegionSettingsHelper.Instance.OutcomeFKRTotal;
                ...
                case "Общегосударственные вопросы ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ",[Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[ОБЩЕГОСУДАРСТВЕННЫЕ ВОПРОСЫ]", UserParams.FKRDimension.Value);
                ...
                case "Нац.оборона ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[НАЦИОНАЛЬНАЯ ОБОРОНА]", UserParams.FKRDimension.Value);
                ...
                case "Нац.безопасность и правоохр. деятельность ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Национальная безопасность и правоохранительная деятельность]", UserParams.FKRDimension.Value);
                ...
                case "Национальная экономика ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Национальная экономика]", UserParams.FKRDimension.Value);
                ...
                case "ЖКХ ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Жилищно-коммунальное хозяйство]", UserParams.FKRDimension.Value);
                ...
                case "Охрана окр.среды ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Охрана окружающей среды]", UserParams.FKRDimension.Value);
                ...
                case "Образование ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Образование]", UserParams.FKRDimension.Value);
                ...
                case "Культура, кинематография ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Культура, кинематография]", UserParams.FKRDimension.Value);
                ...
                case "Культура, кинематография, средства массовой информации ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Культура, кинематография, средства массовой информации]", UserParams.FKRDimension.Value);
                        mapElementCaption1.Text = "Темп роста расходов на культуру, кинематографию и СМИ";
                        mapColumnIndex1 = 5;
                        beginMapColor = Color.Green;
                        endMapColor = Color.Red;
                        nullEmptyColor = Color.LightSkyBlue;
                        nullEmptyText = "Темп роста не рассчитывается";
                        mapFormatString = "P2";
                        mapIndicatorName1 = "Темп роста расходов\nна культуру, кинематографию и СМИ";
                        coloringRule = ColoringRule.SimpleRangeColoring;
                        break;
                    }
                case "Здравоохранение ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Здравоохранение]", UserParams.FKRDimension.Value);
                ...
                case "Здравоохранение, физическая культура и спорт ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Здравоохранение, физическая культура и спорт]", UserParams.FKRDimension.Value);
                        mapElementCaption1.Text = "Темп роста расходов на здравоохранение, физическую культуру и спорт";
                        mapColumnIndex1 = 5;
                        beginMapColor = Color.Green;
                        endMapColor = Color.Red;
                        nullEmptyColor = Color.LightSkyBlue;
                        nullEmptyText = "Темп роста не рассчитывается";
                        mapFormatString = "P2";
                        mapIndicatorName1 = "Темп роста расходов\nна здравоохранение, физическую культуру и\nспорт";
                        coloringRule = ColoringRule.SimpleRangeColoring;
                        break;
                    }
                case "Социальная политика ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Социальная политика]", UserParams.FKRDimension.Value);
                ...
                case "Физическая культура и спорт ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Физическая культура и спорт]", UserParams.FKRDimension.Value);
                ...
                case "СМИ ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Средства массовой информации]", UserParams.FKRDimension.Value);
                ...
                case "Обслуживание гос. и мун. долга ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[Обслуживание государственного и муниципального долга]", UserParams.FKRDimension.Value);
                ...
                case "Межбюджетн.трансферты общего характера бюджетам субъектов РФ и МО ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[МЕЖБЮДЖЕТНЫЕ ТРАНСФЕРТЫ ОБЩЕГО ХАРАКТЕРА БЮДЖЕТАМ СУБЪЕКТОВ РОССИЙСКОЙ ФЕДЕРАЦИИ И МУНИЦИПАЛЬНЫХ ОБРАЗОВАНИЙ]", UserParams.FKRDimension.Value);
                ...
                case "Межбюджетные трансферты ":
                    {
                        gridQueryName = "FO_0002_0014_grid_outcomes";
                        shareMeasure.Value = ", [Measures].[Удельный вес]";
                        filterIndicator.Value = string.Format("{0}.[Все коды ФКР].[МЕЖБЮДЖЕТНЫЕ ТРАНСФЕРТЫ]", UserParams.FKRDimension.Value);
...
[КИФ].[Сопоставимый].[Все источники финансирования].[ИСТОЧНИКИ ВНУТРЕННЕГО ФИНАНСИРОВАНИЯ ДЕФИЦИТОВ БЮДЖЕТОВ].[Бюджетные кредиты от других бюджетов бюджетной системы Российской Федерации].[Погашение бюджетных кредитов, полученных от других бюджетов бюджетной системы Российской Федерации в валюте Российской Федерации]";
        ...
        /// </summary>
        public void FillMOIndicatorList()
        {
            bool useOldClassificator = currentDate.Year < 2011;

            indicators = new Dictionary<string, int>();
            indicators.Add("Доходы бюджета ", 0);
            indicators.Add("Налоговые и неналоговые доходы ", 1);
            indicators.Add("Налог на доходы физических лиц ", 2);
            indicators.Add("Налоги на совокупный доход ", 2);
            indicators.Add("Земельный налог ", 2);
            indicators.Add("Транспортный налог ", 2);
            indicators.Add("Налог на имущество физических лиц ", 2);
            indicators.Add("Прочие налоговые доходы ", 2);
            indicators.Add("Неналоговые доходы ", 2);
            indicators.Add("Безвозмездные поступления ", 1);
            indicators.Add("Дотации ", 2);
            indicators.Add("на выравнивание бюдж. обеспеченности ", 3);
            indicators.Add("Субвенции ", 2);
            indicators.Add("Субсидии ", 2);
            indicators.Add("Иные межбюджетные трансферты ", 2);

            indicators.Add("Расходы бюджета ", 0);

            indicators.Add("В том числе по разделам ", 1);
            indicators.Add("Общегосударственные вопросы ", 2);
            indicators.Add("Нац.оборона ", 2);
            indicators.Add("Нац.безопасность и правоохр. деятельность ", 2);
            indicators.Add("Национальная экономика ", 2);
            indicators.Add("ЖКХ ", 2);
            indicators.Add("Охрана окр.среды ", 2);
            indicators.Add("Образование ", 2);

            indicators.Add(useOldClassificator
                    ? "Культура, кинематография, средства массовой информации "
                    : "Культура, кинематография ", 2);

            indicators.Add(useOldClassificator
                    ? "Здравоохранение, физическая культура и спорт "
                    : "Здравоохранение ", 2);

            indicators.Add("Социальная политика ", 2);

            if (!useOldClassificator)
            {
                indicators.Add("Физическая культура и спорт ", 2);
                indicators.Add("СМИ ", 2);
                indicators.Add("Обслуживание гос. и мун. долга ", 2);
                indicators.Add("Межбюджетн.трансферты общего характера бюджетам субъектов РФ и МО ", 2);
            }

            indicators.Add("Межбюджетные трансферты ", 2);

            indicators.Add("В том числе по КОСГУ ", 1);
            indicators.Add("Заработная плата и начисления на выплаты по оплате труда ", 2);
            indicators.Add("Заработная плата ", 3);
            indicators.Add("Прочие выплаты ", 3);
            indicators.Add("Начисления на выплаты по оплате труда ", 3);
            indicators.Add("Оплата работ, услуг ", 2);
            indicators.Add("Услуги связи ", 3);
            indicators.Add("Транспортные услуги ", 3);
            indicators.Add("Коммунальные услуги ", 3);
            indicators.Add("Арендная плата за пользование имуществом ", 3);
            indicators.Add("Работы, услуги по содержанию имущества ", 3);
            indicators.Add("Прочие работы, услуги ", 3);
            indicators.Add("Обслуживание государственного (муниципального) долга ", 2);
            indicators.Add("Обслуживание внутреннего долга ", 3);
            indicators.Add("Безвозмездные перечисления организациям ", 2);
            indicators.Add("Безвозм. перечисления гос. и мун. организациям ", 3);
            indicators.Add("Безвозм. перечисления организациям, за исключением гос. и мун. организаций ", 3);
            indicators.Add("Безвозмездные перечисления бюджетам ", 2);
            indicators.Add("Социальное обеспечение ", 2);
            indicators.Add("Пособия по соц. помощи населению ", 3);
            indicators.Add("Пенсии, пособия, выплачиваемые организациями сектора гос. управления ", 3);
            indicators.Add("Прочие расходы ", 2);
            indicators.Add("Увеличение стоимости основных средств ", 2);
            indicators.Add("Увеличение стоимости нематериальных активов ", 2);
            indicators.Add("Увеличение стоимости материальных запасов ", 2);

            indicators.Add("Результат исполнения бюджета (дефицит/профицит) ", 0);

            indicators.Add("Кредиты кредитных организаций ", 0);
            indicators.Add("Бюджетные кредиты от других бюджетов бюджетной системы ", 0);
            indicators.Add("Муниципальный долг ", 0);
            indicators.Add("Остатки бюджетных средств ", 0);
            indicators.Add("имеющих целевое назначение ", 1);
            indicators.Add("имеющие нецелевое назначение ", 1);

            indicators.Add("Просроченная кредиторская задолженность ", 0);
            indicators.Add("по заработной плате ", 1);
            indicators.Add("по начислениям на выплаты по оплате труда ", 1);
            indicators.Add("по оплате коммунальных услуг ", 1);
            indicators.Add("по услугам связи ", 1);
            indicators.Add("по транспортным услугам ", 1);
            indicators.Add("по работам, услугам по содержанию имущества ", 1);
            indicators.Add("по прочим работам, услугам ", 1);
            indicators.Add("по безвозм. перечислениям гос. и мун-м организациям ", 1);
            indicators.Add("по безвозм. перечислениям организациям, за исключением гос. и мун. организаций ", 1);
            indicators.Add("по пособиям по соц. помощи населению ", 1);
            indicators.Add("по прочим расходам ", 1);
            indicators.Add("по оплате договоров на приобретение объектов, относящихся к основным средствам ", 1);
            indicators.Add("по оплате договоров на приобретение сырья и материалов на оказание гос. (мун-х) услуг ", 1);
        }
        ...
        public void SetMapSettings(MapControl map, int mapIndex)
        {
            ...
            if (useRegionCodes)
            {
                ...
                regionsLegend.Dock = PanelDockStyle.Left;
                ...
                if (row[0] != DBNull.Value && row[0].ToString() != string.Empty)
                {
                    ...
                    foreach (Shape shape in shapeList)
                    {
                            ...
                            RegionsNamingHelper.LocalBudgetCodes.ContainsKey(shapeName))
                        {
                            ...
                            //                            cell.Alignment = ContentAlignment.Right;
                            //                            item.Cells.Add(cell);
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            GridHeaderCell consolidateCell = gridHeaderLayout.AddCell("Бюджет гор.округа, мун.района и поселения");
        ...
        private void AddColumnGroup(GridHeaderCell parentCell)
        {
            ...
            {
                GridHeaderCell planCell = parentCell.AddCell("Уточненные годовые назначения");
        ...
        private void PdfExportButton_Click(object sender, EventArgs e)
        {
            ...
            if (twoMapVisible)
            {
                DundasMap1.Width = Unit.Pixel((int)(DundasMap1.Width.Value * 1.8));
                ReportPDFExporter1.Export(DundasMap1, mapElementCaption1.Text, section1);

                ISection section3 = report.AddSection();
                DundasMap2.Width = Unit.Pixel((int)(DundasMap2.Width.Value * 1.8));
                ReportPDFExporter1.Export(DundasMap2, mapElementCaption2.Text, section3);
            }
            else
            {
                DundasMap1.Width = Unit.Pixel((int)(DundasMap1.Width.Value * 0.9));
                ReportPDFExporter1.Export(DundasMap1, mapElementCaption1.Text, section1);
            }
