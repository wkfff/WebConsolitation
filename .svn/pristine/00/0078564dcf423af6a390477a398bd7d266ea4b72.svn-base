<%@ Page Language="C#" Title="Содержание и использование жилищного фонда" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default1.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._011.Default1" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:Label ID="Label9" runat="server" Text="Label" CssClass="PageTitle"></asp:Label><br />
        <table style="width: 100%">
            <tr>
                <td style="text-align: left">
                    <asp:Label ID="Label15" runat="server" CssClass="PageSubTitle" Text="Анализ динамики и структуры основных показателей, характеризующих содержание и использование квартир в жилищном фонде муниципального образования"></asp:Label></td>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="3">
                    ...
                    <igtbl:UltraWebGrid ID="GT0" runat="server" EnableAppStyling="True" OnClick="GT0_Click"
                        OnDataBinding="GT0_DataBinding" OnInitializeLayout="GT0_InitializeLayout" StyleSetName="Office2007Blue" OnDataBound="GT0_DataBound">
                        <Bands>
                            <igtbl:UltraGridBand>
            ...
            <tr>
                <td style="vertical-align: top">
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server" Width="100%" LinkedRefreshControlID="WebAsyncRefreshPanel_">
                        ...
                        <igchart:UltraChart ID="CT1" runat="server" OnDataBinding="CT1_DataBinding" Version="9.1" Width="351px" OnInvalidDataReceived="CT1_InvalidDataReceived" ChartType="PyramidChart3D" Transform3D-Perspective="30" Transform3D-Scale="80" Transform3D-XRotation="150" Height="317px" OnChartDrawItem="CT1_ChartDrawItem">
                ...
                <td style="vertical-align: top">
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel2" runat="server" LinkedRefreshControlID="WebAsyncRefreshPanel_" Width="100%">
                        ...
                        <igchart:UltraChart ID="CT2" runat="server" ChartType="PyramidChart" OnDataBinding="CT2_DataBinding"
                            Version="9.1" OnInvalidDataReceived="CT1_InvalidDataReceived" Height="317px" OnChartDrawItem="CT2_ChartDrawItem">
                            <PyramidChart Axis="Radius">
                                <Labels Visible="False">
                                </Labels>
                                <ChartText>
                                    <igchartprop:ChartTextAppearance ChartTextFont="Arial, 7pt" Column="-2" ItemFormatString="&lt;ITEM_LABEL&gt;, &lt;PERCENT_VALUE:0&gt;%"
                                        Row="-2" Visible="True">
                ...
                <td style="vertical-align: top">
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel3" runat="server" LinkedRefreshControlID="WebAsyncRefreshPanel_" Width="100%">
                        <table style="border-collapse: collapse; background-color: white; margin-top: 10px;">
                            <tr>
                                <td class="topleft">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                        <asp:Label ID="Label4" runat="server" Text="Label" CssClass="ElementTitle" Height="40px"></asp:Label><br />
                        <igchart:UltraChart ID="CT3" runat="server" OnDataBinding="CT3_DataBinding" Version="9.1" OnInvalidDataReceived="CT1_InvalidDataReceived" Height="317px" OnChartDrawItem="CT3_ChartDrawItem">
                            <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed">
                            </ColorModel>
                            <Effects>
                                <Effects>
            ...
            <tr>
                <td style="vertical-align: top">
                    ...
                    <asp:Label ID="Label10" runat="server"  Text="Количество зданий" CssClass="ElementTitle"></asp:Label>
                    ...
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel5" runat="server" TriggerControlIDs="GB" Width="100%">
                        <table style="border-collapse: collapse; background-color: white; margin-top: 10px;">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top; height: 380px">
                    <asp:Label ID="Label7" runat="server" Text="Label" CssClass="ElementTitle" Height="55px"></asp:Label><br />
                    ...
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel6" runat="server" LinkedRefreshControlID="WebAsyncRefreshPanel5" Width="100%">
                        <table style="border-collapse: collapse; background-color: white; margin-top: 10px;">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top; height: 380px">
                    <asp:Label ID="Label8" runat="server" Text="Label" CssClass="ElementTitle" Height="55px"></asp:Label><br />
                        <igchart:UltraChart ID="CB2" runat="server" OnDataBinding="CB2_DataBinding" Version="9.1" OnInvalidDataReceived="CT1_InvalidDataReceived">
                            <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed">
                            </ColorModel>
                            <Effects>
                                <Effects>
