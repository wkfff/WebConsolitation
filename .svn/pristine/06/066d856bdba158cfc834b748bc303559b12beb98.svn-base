<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0008_Settlement.Default" %>
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                            <asp:RadioButtonList ID="OutcomesButtonList" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                                Width="150px" style="font-family: Verdana; font-size: 12px;">
                                <asp:ListItem Selected="True">ÐçÏð</asp:ListItem>
                                <asp:ListItem>ÊÎÑÃÓ</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td valign="top" align="right" style="font-family:Verdana; font-size:12px; padding-left:20px;" colspan="2">
                            <asp:RadioButtonList ID="RubMiltiplierButtonList" runat="server" AutoPostBack="True" RepeatDirection="horizontal"
                                Width="160px" style="font-family: Verdana; font-size: 12px;">
                                <asp:ListItem>òûñ.ðóá.</asp:ListItem>
                                <asp:ListItem Selected="True">ìëí.ðóá.</asp:ListItem>
                            </asp:RadioButtonList>
                        </td> 
                    </tr>
                </table>
