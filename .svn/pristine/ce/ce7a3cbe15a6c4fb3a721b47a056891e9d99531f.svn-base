<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultDetail.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0004_NAO.DefaultDetail" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        <tr>
            <td style="width: 100%">
                <uc4:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultDetail.html" />
                &nbsp;&nbsp;
    ...
    <table style="vertical-align: top;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px"
                                SkinID="UltraWebGrid" Width="325px" OnDataBinding="UltraWebGrid_DataBinding"
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="EqualbilityHintLabel" runat="server" CssClass="PageSubTitle"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="ShareHintLabel" runat="server" CssClass="PageSubTitle"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
