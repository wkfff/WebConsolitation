...
{
    public partial class Oil_0009_0002_04 : CustomReportPage
    {
        ...
        private void InitializeTable1()
        {
            ...
            query = DataProvider.GetQueryText("Oil_0009_0002_04_incomes_federal_date");
            ...
            query = DataProvider.GetQueryText("Oil_0009_0002_04_table2");
            ...
            query = DataProvider.GetQueryText("Oil_0009_0002_04_incomes_regional_date");
            ...
            dt = new DataTable();
            query = DataProvider.GetQueryText("Oil_0009_0002_04_table1");
