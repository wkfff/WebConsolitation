...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0060_04
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.Text = "Численность&nbsp;и&nbsp;расходы&nbsp;на&nbsp;содержание&nbsp;органов&nbsp;местного&nbsp;самоуправления";
            CrossLink1.NavigateUrl = "~/reports/FO_0002_0060_03/Default.aspx";
        }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0002_0060_04_date");
                DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);

                endYear = Convert.ToInt32(dtDate.Rows[0][0]);

                string query2 = DataProvider.GetQueryText("FO_0002_0060_04_date");
            ...
            PageTitle.Text = "Численность и расходы на содержание органов государственной власти";
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0060_04_grid");
            ...
            {
                object val1 = dt.Rows[i]["Плановые расходы на одного работника органа государственной власти "];
                object val2 = dt.Rows[i]["Фактические расходы на одного работника органа государственной власти "];
            ...
            dt.Rows[indexLastRow]["Плановые расходы на одного работника органа государственной власти "] = sum1;
            dt.Rows[indexLastRow]["Фактические расходы на одного работника органа государственной власти "] = sum2;*/
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            headerLayout.AddCell("Плановые расходы на содержание органов государственной власти, тыс. руб.", "Плановые расходы на содержание ОГВ");
            headerLayout.AddCell("Фактические расходы на содержание органов государственной власти, тыс. руб.", "Фактические расходы на содержание ОГВ");
            headerLayout.AddCell("Процент исполнения плановых назначений", "Процент исполнения плана по расходам на содержание ОГВ");
            headerLayout.AddCell("Отклонение от плановых назначений, тыс. руб.", "Отклонение от плановых назначений по расходам на содержание ОГВ");
            headerLayout.AddCell("Плановая численность, чел.", "Плановая численность органов государственной власти");
            headerLayout.AddCell("Фактическая численность, чел.", "Фактическая численность органов государственной власти");
            headerLayout.AddCell("Плановые расходы на одного работника органа государственной власти, тыс. руб.", "Плановые расходы на одного работника ОГВ");
            headerLayout.AddCell("Фактические расходы на одного работника органа государственной власти, тыс. руб.", "Фактические расходы на одного работника ОГВ");
