<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultValuation.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.MFRF_0004_0003.DefaultValuation"
    Title="" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td style="width: 100%">
                <uc5:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultValuationHelp.html" />
                &nbsp;&nbsp;
    ...
    <table>
        <tr>
            <td style="padding-right: 3px">
                <table style="border-collapse: collapse; background-color: White; width: 100%; padding-right: 3px">
                    <tr>
                        <td class="topleft">
                        </td>
                        <td class="top">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_MFRF0403#SEQNUM(100).png" />
                                <Border Thickness="0" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
