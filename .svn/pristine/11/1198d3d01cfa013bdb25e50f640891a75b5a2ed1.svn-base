<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SGM_0006_h.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.SGM_0006_h" %>
        ...
        <table style="border-right: 0px solid; border-top: 0px solid; left: 0px; border-left: 0px solid;
            ...
            <tr>
                <td style="width: 480px; height: 20px" align="left" valign="top">
                    <igtbl:ultrawebgrid id="grid" runat="server" height="3px" skinid="UltraWebGrid"
                        width="442px" OnInitializeLayout="grid_InitializeLayout" OnInitializeRow="grid_InitializeRow"><Bands>
<igtbl:UltraGridBand>
...
<FrameStyle BorderWidth="1px" BorderColor="InactiveCaption" BorderStyle="Solid" Font-Size="8.25pt" Font-Names="Microsoft Sans Serif" BackColor="Window" Width="442px" Height="3px"></FrameStyle>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
            ...
            <tr>
                    <td style="width: 480px; padding-right: 0px; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px; height: 30px;" valign="top">
                 ...
                 <tr><td style="width: 297px; border-right: 0px solid; border-top: 0px solid; background-image: url(../../../images/servePane.gif); border-left: 0px solid; border-bottom: 0px solid; background-repeat: repeat-x; border-collapse: collapse; height: 25px; padding-left: 5px; left: 0px; margin-left: 0px; position: static; top: 408px;" align="left" valign="top" colspan="" rowspan="">
                     ...
                     <asp:Table ID="Table1" runat="server">
                         <asp:TableRow ID="TableRow1" runat="server">
                             ...
                             <asp:Label ID="LabelGenerated2" runat="server" Font-Names="Arial" ForeColor="#BFBFBF"
                    Text="Label" SkinID="ServeText"></asp:Label><br/><asp:Label ID="LabelGenerated1" runat="server" Font-Names="Arial" ForeColor="#BFBFBF"
