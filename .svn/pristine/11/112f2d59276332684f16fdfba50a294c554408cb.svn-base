...
{
    public partial class FO_0003_0005_Horizontal : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0003_0005_Horizontal_date");
            ...
            SetupGrid(UltraWebGridIncomes, "FO_0003_0005_Horizontal_incomes");
        ...
        void UltraWebGridIncomes_InitializeRow(object sender, RowEventArgs e)
        {
                ...
                e.Row.Cells[0].Value.ToString().Contains("дефицит ("))
            {
                ...
                iPadBricks.iPadBricks.iPadBricksHelper.SetConditionCorner(e, 8);
                iPadBricks.iPadBricks.iPadBricksHelper.SetConditionCorner(e, 9);
