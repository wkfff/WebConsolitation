<%@ Page Language="C#"  MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.EO.EO_0011._default" %>
    ...
    <td class="right">
        ...
        <table id="TabChart"  runat="server" style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="height: 100%">
                            <asp:Label ID="DemChartCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                            <igchart:UltraChart ID="Chart" runat="server" ChartType="StackColumnChart" 
...
<X Visible="True" TickmarkInterval="0">
...
<SeriesLabels FormatString="" HorizontalAlign="Far" VerticalAlign="Center" Orientation="Horizontal"></SeriesLabels>
</Labels>
</Y>
...
<SeriesLabels FormatString="" HorizontalAlign="Near" VerticalAlign="Center" Orientation="Horizontal"></SeriesLabels>
</Labels>
</Y2>
...
<SeriesLabels HorizontalAlign="Far" VerticalAlign="Center" Orientation="VerticalLeftFacing"></SeriesLabels>
</Labels>
</X2>
...
<SeriesLabels HorizontalAlign="Near" VerticalAlign="Center" Orientation="Horizontal"></SeriesLabels>
                                ...
                                <Tooltips FormatString="&lt;ITEM_LABEL&gt;, &lt;DATA_VALUE:0.##&gt;" />
