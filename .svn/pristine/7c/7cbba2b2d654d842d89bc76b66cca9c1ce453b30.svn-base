<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0020.Default " Title="Untitled Page" %>
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                <DMWC:MapControl ID="DundasMap" runat="server" BackColor="White" ResourceKey="#MapControlResKey#DundasMap1#"
                    ImageUrl="../../TemporaryImages/map_fo_02_20#SEQ(300,3)" RenderingImageUrl="../../TemporaryImages/">
                    <NavigationPanel>
