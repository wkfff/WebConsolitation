...
namespace Krista.FM.Server.Dashboards.reports.Sahalin_ARC._0001   
{
    ...
    {
        string page_title = "Анализ заболеваемости населения";
        ...
        protected void Chart1_DataBinding(object sender, EventArgs e)
        {
            ...
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(DataProvider.GetQueryText("chart1"), "chart1", dt);
        ...
        protected void Grid_DataBinding(object sender, EventArgs e)
        {
           /*
                ...
                DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(DataProvider.GetQueryText("grid"), "chart1", dt);
