<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0735_0015.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0735_0015" %>
                                ...
                                <table style="border-collapse: collapse;">
                                    <tr>
                                        <td style="overflow: visible; background-color: Black">
                                            <div runat="server" id="HeraldImageContainer" style="float: left; margin-left: 32px; margin-right: -10px">
                                            </div>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <table style="border-collapse: collapse; background-color: Black; width: 100%; height: 100%;
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 18px; font-family: Verdana; color: White; background-image: url(../../../images/iPadContainer/containerheader.gif);
                                            background-color: Black; background-repeat: repeat-x; margin-left: -5px; margin-right: -5px;
                                            padding-left: 3px; height: 36px; text-align: center; vertical-align: middle;">
                                            <asp:Label ID="Label7" runat="server" CssClass="ElementTitle" Text="Муниципальный долг"></asp:Label>
                                        </td>
                                        <td style="background: white url(../../../images/iPadContainer/headerright.gif);
                                            background-repeat: no-repeat; width: 1px; height: 36px; background-color: Black;">
                                        </td>
                                ...
                                <table>
                                    <tr>
                                        <td style="overflow: visible; background-color: Black">
                                            <asp:Label ID="munDebt" runat="server" SkinID="InformationText" Text="Количество нарушений требований бюджетного кодекса РФ"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <table style="border-collapse: collapse; background-color: Black; width: 100%; height: 100%;
                                ...
                                <table style="border-collapse: collapse; background-color: Black; width: 100%; height: 100%;"
                                    runat="server" id="settlementHeader">
                                    <tr>
                                        <td style="background-image: url(../../../images/iPadContainer/LeftTop.gif); background-repeat: no-repeat;
                                            width: 1px;">
                                        </td>
                                ...
                                <igtbl:UltraWebGrid ID="UltraWebGridSettlements" runat="server" Height="200px" Width="315px"
                                    SkinID="UltraWebGrid">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                            <AddNewRow View="NotSet" Visible="NotSet">
