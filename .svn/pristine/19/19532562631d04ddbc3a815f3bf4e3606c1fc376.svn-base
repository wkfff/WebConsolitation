<%@ Page Language="C#" MasterPageFile="~/Reports.Master" ClientTarget="uplevel" AutoEventWireup="true"
    Codebehind="Default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.STAT_0001_0006.Default"
    Title="Соотношение численности экономически активного населения и финансовой помощи" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td colspan="1" style="width: 100%;">
                <uc5:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="Default.html" Visible="false" />
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboRegiones" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <asp:Label ID="chartLabel" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label>
                            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                                ...
                                <Axis>
                                    ...
                                    <Z2 LineThickness="1" TickmarkInterval="0" Visible="False" TickmarkStyle="Smart">
                                        <MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
                                        <MajorGridLines Color="Gainsboro" DrawStyle="Dot" Visible="True" Thickness="1" AlphaLevel="255"></MajorGridLines>
                                        <Labels Orientation="Horizontal" ItemFormatString="" FontColor="Gray" HorizontalAlign="Near" Font="Verdana, 7pt"
                                            VerticalAlign="Center">
                                            <Layout Behavior="Auto">
                                            </Layout>
                                            <SeriesLabels Orientation="Horizontal" FontColor="Gray" HorizontalAlign="Center" Font="Verdana, 7pt"
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_STAT0106_1#SEQNUM(100).png" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igmisc:WebAsyncRefreshPanel ID="WebAsyncPanel" runat="server">
                                <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" EnableAppStyling="True" Height="200px" OnDataBinding="UltraWebGrid1_DataBinding"
                                    OnInitializeLayout="UltraWebGrid1_InitializeLayout" StyleSetName="Office2007Blue" SkinID="UltraWebGrid"
