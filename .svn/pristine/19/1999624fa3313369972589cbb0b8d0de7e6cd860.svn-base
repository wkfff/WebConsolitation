<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0535_0015.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0535_0015" %>
...
<body style="background-color: black;">
    <form id="form1" runat="server">
        < style="position: absolute; width: 768px; height: 950px; background-color: black; top: 0px; left: 0px;
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                          <td>
                                           <asp:Label ID="commentLabel" runat="server" SkinID="InformationText" Text="<*> - недоимка с учетом неурегулированной задолженности по всем категориям налогоплательщиков"></asp:Label>
                                          </td>
                                        </tr>
                                    </table>
