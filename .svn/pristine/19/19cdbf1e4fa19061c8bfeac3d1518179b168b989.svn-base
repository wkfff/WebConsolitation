...
namespace Krista.FM.Server.Dashboards.reports.FNS_0002_0001
{
    public partial class DefaultAllocation : CustomReportPage
    {
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0002_0001_allocation_regionsChart_split" : "FNS_0002_0001_allocation_regionsChart";
            string query = DataProvider.GetQueryText(queryName);
            ...
            queryName = fns28nSplitting ? "FNS_0002_0001_allocation_KDChart_split" : "FNS_0002_0001_allocation_KDChart";
            ...
            queryName = fns28nSplitting ? "FNS_0002_0001_allocation_OKVDChart_split" : "FNS_0002_0001_allocation_OKVDChart";
            query = DataProvider.GetQueryText(queryName);
            dtChart = new DataTable();
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Dummy", dtChart);
            if (dtChart.Rows.Count != 0)
