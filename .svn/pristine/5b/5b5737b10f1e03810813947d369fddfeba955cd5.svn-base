...
namespace Krista.FM.Client.Reports
{
    ...
    {
        /// <summary>
        /// ОТЧЕТ 002 СПИСОК МО, ОТ КОТОРЫХ НЕ ПОСТУПИЛИ ДАННЫЕ ПО ПОКАЗАТЕЛЯМ ДЕЯТЕЛЬНОСТИ МУП
        /// </summary>
        public DataTable[] GetMOFO0027Report002Data(Dictionary<string, string> reportParams)
        {
            ...
            {
                new QFilter(QFIndexProfit.Keys.Day, GetUNVYearPlanLoBound(year))
            };

            var groupFields = new List<Enum> { QFIndexProfit.Keys.Okato };
