...
{
    public partial class FST_0001_0013_Horizontal : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            base.Page_Load(sender, e);

            string measureName = "руб./кВт.ч.";
            ...
            string query = DataProvider.GetQueryText("FST_0001_0013_Horizontal_Chart");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
            UltraChartGrownTemp.DataSource = dtChart;
            UltraChartGrownTemp.DataBind();

            TagCloudFST_0001_0013_Horizontal_Text2.TaxName = "тариф для населения";

            SetChart(TagCloudFST_0001_0013_Horizontal_Text1, "1", measureName);
            SetChart(TagCloudFST_0001_0013_Horizontal_Text2, "2", measureName);
        }
        ...
        private void SetChart(Dashboard.FST_0001_0003_Text textElement, string filter, string measure)
        {
            ...
            string chartQuery = DataProvider.GetQueryText(String.Format("FST_0001_0013_Horizontal_gauge{0}", filter));
            string textQuery = DataProvider.GetQueryText(String.Format("FST_0001_0013_Horizontal_text{0}", filter));            
