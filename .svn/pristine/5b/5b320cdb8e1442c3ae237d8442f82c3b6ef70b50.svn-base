<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0035_0003_2_HMAO.Default" Title="Исполнение кассового плана" %>
    ...
    <table>
        <tr>
            ...
            <td align="right" rowspan="2" style="width: 100%;">
                ...
                <asp:HyperLink ID="Link2" runat="server" SkinID="HyperLink"></asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td valign="top">
