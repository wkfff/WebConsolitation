<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EO_0001_0002.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.EO_0001_0002" %>
...
<body link="White" vlink="White" style="background-color: black;">
    ...
    <div style="position: absolute; width: 768px; background-color: black;
        top: 0px; left: 0px; z-index: 2; overflow: visible; text-align:left;">
       <uc1:iPadElementHeader ID="CommonGridCaption" runat="server" Width="100%" />
       <asp:Label ID="CustomerCaption" runat="server" Font-Names="Arial" ForeColor="#D1D1D1" Font-Size="16px"></asp:Label> 
