...
{
    public partial class FO_0035_0038 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            lbDescription.Text = String.Format("Кредиторская задолженность бюджетов муниципальных образований Новосибирской области по состоянию на&nbsp;<span class=\"DigitsValue\">{0:dd.MM.yyyy}</span>&nbsp;г., тыс.руб.",
                new DateTime(currentDate.Year + 1, 1, 1));
            
            #region Настройка диаграммы

            UltraChart.BrowserSizeAdapting = false;
            UltraChart.Width = 775;
            UltraChart.Height = 300;
        ...
        {
            string queryText = DataProvider.GetQueryText("FO_0035_0038_chart");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0035_0038_grid");
