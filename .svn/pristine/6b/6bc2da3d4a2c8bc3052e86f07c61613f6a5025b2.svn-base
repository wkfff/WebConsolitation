<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0008.Default" Title="Индикаторы БК и КУ " %>
                ...
                <table runat="server" id="ChartTable1" style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text="Объем доходов бюджетов"></asp:Label>
                        </td>
            ...
            <td>
                ...
                <table runat="server" id="Table1" style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption2" runat="server" CssClass="ElementTitle" Text="Объем расходов бюджетов"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
