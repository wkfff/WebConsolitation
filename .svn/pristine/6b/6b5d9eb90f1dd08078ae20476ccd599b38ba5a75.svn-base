...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0030_Yaroslavl
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                grbsDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "YaroslavlList", CRHelper.BasePath);
            ...
            if (ComboBudget.SelectedValue == "Консолидированный бюджет субъекта")
            {
                ...
                typeDocument.Value = "[ТипДокумента].[СКИФ].[Все].[Консолидированная отчетность и отчетность внебюджетных территориальных фондов]";
                levelBudget.Value = "[Уровни бюджета].[СКИФ].[Все].[Конс.бюджет субъекта]";
                selectedBudget.Value = ",[Районы].[Сопоставимый].[Все районы].[Консолидированный бюджет Ярославской области]";
                levelSubjectBudget.Value = "[Уровни бюджета].[СКИФ].[Все].[Бюджет субъекта]";
            }
            else
            {
                tempMeasures.Value = "[Measures].[Темп к прошлому году_По субъекту]";
                ...
                typeDocument.Value = "[ТипДокумента].[СКИФ].[Тип документа ]";
                levelBudget.Value = "[Уровни бюджета].[СКИФ].[Уровень бюджета ]";
                selectedBudget.Value = string.Format(",{0}", grbsDigest.GetMemberUniqueName(ComboBudget.SelectedValue));
                levelSubjectBudget.Value = "[Уровни бюджета].[СКИФ].[Все].[Бюджет поселения]";
            }
        ...
        protected void UltraWebGrid1_DataBinding(object sender, EventArgs e)
        {
            if (ComboBudget.SelectedValue != "Консолидированный бюджет субъекта")
           {
                ...
                if (dtType.Rows.Count > 0)
                {
                  if (dtType.Rows[0][1].ToString() == "1") // муниципальные районы
                    {
                        flag = true;
                        orgGosVlast.Value ="[Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[на заработную плату] , [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[на начисления на выплаты по оплате труда], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[расходы по содержанию органов местного самоуправления, направленные на выполнение полномочий Российской Федерации].[на заработную плату], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[расходы по содержанию органов местного самоуправления, направленные на выполнение полномочий Российской Федерации].[на начисления на выплаты по оплате труда] ";
                        typeDocument.Value = "[ТипДокумента].[СКИФ].[Все].[Данные конс. отчета субъекта в разрезе городов, районов и поселений (5+6+7+8)] ";
                        levelBudget.Value = " [Уровни бюджета].[СКИФ].[Уровень бюджета ]  ";
                    }
                  else
                  {
                      ...
                      if (dtType.Rows[0][1].ToString() == "2") // городские округа
                      {
                          orgGosVlast.Value = "[Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[на заработную плату] ,[Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[на начисления на выплаты по оплате труда], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[расходы по содержанию органов местного самоуправления, направленные на выполнение полномочий Российской Федерации].[на заработную плату], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[расходы по содержанию органов местного самоуправления, направленные на выполнение полномочий Российской Федерации].[на начисления на выплаты по оплате труда]";
                          typeDocument.Value = "[ТипДокумента].[СКИФ].[Все].[Данные конс. отчета субъекта в разрезе городов, районов и поселений (5+6+7+8)]";
                          levelBudget.Value = "               [Уровни бюджета].[СКИФ].[Все].[Бюджет гор.округа] ";
                      }
                      else if (dtType.Rows[0][1].ToString() == "0") // бюджет субъекта
                      {
                          orgGosVlast.Value =  "[Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов государственной власти субъекта Российской Федерации, всего].[на заработную плату] , [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов государственной власти субъекта Российской Федерации, всего].[на начисления на выплаты по оплате труда], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов государственной власти субъекта Российской Федерации, всего].[расходы по содержанию органов государственной власти субъекта Российской Федерации, направленные на выполнение полномочий Российской Федерации].[на начисления на выплаты по оплате труда], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[на заработную плату] , [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов местного самоуправления, всего].[на начисления на выплаты по оплате труда] ";
                          typeDocument.Value = "[ТипДокумента].[СКИФ].[Все].[Консолидированная отчетность и отчетность внебюджетных территориальных фондов]";
           ...
           if (ComboBudget.SelectedValue == "Консолидированный бюджет субъекта")
           {
               orgGosVlast.Value = " [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов государственной власти субъекта Российской Федерации, всего].[на заработную плату], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов государственной власти субъекта Российской Федерации, всего].[на начисления на выплаты по оплате труда], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов государственной власти субъекта Российской Федерации, всего].[расходы по содержанию органов государственной власти субъекта Российской Федерации, направленные на выполнение полномочий Российской Федерации].[на заработную плату], [Показатели].[СопМесОСпРасх].[Все показатели].[Расходы по содержанию органов государственной власти субъекта Российской Федерации, всего].[расходы по содержанию органов государственной власти субъекта Российской Федерации, направленные на выполнение полномочий Российской Федерации].[на начисления на выплаты по оплате труда]";}
            ...
            if (ComboBudget.SelectedValue == "Консолидированный бюджет субъекта" || flag)
            {
                ...
                currentMonth.Value = string.Format("+ {2} [Период].[Период].[Данные всех периодов].{0}{3} * {2}[Measures].[Исполнено на 1_консолидированный бюджет],{1}{3}", prevMonth.Value, lastYearMeasures.Value,"{","}");
            }
            else
            {
          ...
          if (ComboBudget.SelectedValue == "Консолидированный бюджет субъекта")
            {
               ...
               if (dtCount.Rows.Count > 0)
                ...
                // тип долга
                dolg.Value = "[Показатели].[СопМесОСпВнтД].[Государственный долг субъекта], [Показатели].[СопМесОСпВнтД].[Муниципальный долг]"; 
            ...
            else
            {
                    ...
                    if (dtType.Rows.Count > 0)
                    {
                        if (dtType.Rows[0][1].ToString() == "1" || dtType.Rows[0][1].ToString() == "2") // Муниципальные районы или городские округа
                        {
                            ...
                            indication.Value = "[Показатели__Сопоставимый для оперативных].[Все показатели].[Аналитика по налогам].[Земельный налог].[Численность, тыс. чел.]";
                            ...
                            //тип долга
                            dolg.Value = "[Показатели].[СопМесОСпВнтД].[Муниципальный долг]"; 
                            query = DataProvider.GetQueryText("FO_0002_0030_GosDolg");
                            DataTable dtGosDolg = new DataTable();
                            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Наименование показателей", dtGosDolg);
                            if (dtGosDolg.Rows.Count > 0)
                        ...
                        else if (dtType.Rows[0][1].ToString() == "0") // бюджет субъекта
                        {
                            ...
                            //тип долга
                            dolg.Value = "[Показатели].[СопМесОСпВнтД].[Государственный долг субъекта]";
                            query = DataProvider.GetQueryText("FO_0002_0030_GosDolg");
                            DataTable dtGosDolg = new DataTable();
                            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Наименование показателей", dtGosDolg);
                            if (dtGosDolg.Rows.Count > 0)
        ...
        protected void UltraWebGrid1_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            cell3.AddCell(indication || flag ? "Темп уточненного плана к пред. году (конс.бюджет), %" : "Темп уточненного плана к пред. году, %");
            ...
            {
                cell3.AddCell(string.Format("Исполнено с начала года на 1 февраля"));
            }

            cell3.AddCell(string.Format("Исполнено за {0}", CRHelper.RusMonth(CRHelper.MonthNum(ComboMonth.SelectedValue))));

                GridHeaderCell cell5 =
                    cell3.AddCell(string.Format("Исполнено с начала года на 1 {0}",
                                                CRHelper.RusMonthGenitive(numMonth + 1)));
                if (ComboBudget.SelectedValue == "Консолидированный бюджет субъекта")
                {
        ...
        protected void UltraWebGrid1_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            if (e.Row.Cells[e.Row.Cells.Count - 2]!= null)
            {
