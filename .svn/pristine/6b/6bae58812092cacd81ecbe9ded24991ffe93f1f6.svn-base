...
{
    public partial class Oil_0001_0002_v : CustomReportPage
    {
        ...
        {
            UserParams.Oil.Value = "Бензин марки АИ-80";
            string query = DataProvider.GetQueryText("Oil_0001_0002_chart_v");
        ...
        {
            UserParams.Oil.Value = "Бензин марки АИ-92";
            string query = DataProvider.GetQueryText("Oil_0001_0002_chart_v");
            DataTable dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
        ...
        {
            UserParams.Oil.Value = "Бензин марки АИ-95";
            string query = DataProvider.GetQueryText("Oil_0001_0002_chart_v");
            DataTable dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
        ...
        {
            UserParams.Oil.Value = "Бензин марки АИ-98";
            string query = DataProvider.GetQueryText("Oil_0001_0002_chart_v");
            DataTable dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
        ...
        {
            UserParams.Oil.Value = "Дизельное топливо";
            string query = DataProvider.GetQueryText("Oil_0001_0002_chart_v");
            DataTable dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
