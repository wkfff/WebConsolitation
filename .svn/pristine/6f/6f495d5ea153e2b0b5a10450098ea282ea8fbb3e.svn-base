<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true"
    Codebehind="Default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.MFRF_0003_0001.Default"
    Title="Государственный долг субъектов" %>
    ...
    <table width="100%">
        <tr>
            <td colspan="1" style="width: 100%;">
                <uc5:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="Help.html" Visible="true" />
                &nbsp;&nbsp;
                <asp:Label ID="Label1" runat="server" Text="Label" CssClass="PageTitle"></asp:Label>&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td valign="top">
             ...
             <td valign="top" style="font-family:Verdana; font-size:12px;">
                <asp:RadioButtonList ID="DebtKindButtonList" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                    Width="380px">
                    <asp:ListItem Selected="True">Государственный долг</asp:ListItem>
                    <asp:ListItem>Муниципальный долг</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
    </table>
