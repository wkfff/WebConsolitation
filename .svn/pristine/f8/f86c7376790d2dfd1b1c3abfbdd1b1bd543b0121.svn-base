<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0035_0026.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0026" %>
...
<body link="White" vlink="White" style="background-color: #a8a8a8">
    ...
    <table style="width: 765; height: 900; border-collapse: collapse; background-color: #a8a8a8;
