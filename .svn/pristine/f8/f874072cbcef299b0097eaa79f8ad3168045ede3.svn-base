...
{
    public partial class FO_0002_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
          ...
          //  CustomParams.MakeMoParams("22", "id");
            ...
            lbPageTitle.Text = string.Format("{0}", "Местные бюджеты");
       ...
       protected void OutcomesGrid_DataBinding(object sender, EventArgs e)
        {
           string query = DataProvider.GetQueryText("FO_0002_0015_Grid3");
