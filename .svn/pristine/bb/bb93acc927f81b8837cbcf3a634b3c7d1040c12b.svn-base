<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0004.Default" Title="Индикаторы БК и КУ " %>
                ...
                <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption" runat="server" CssClass="ElementTitle" Text="Структурная динамика среднегодовой численности занятого населения по видам деятельности, чел."></asp:Label>
                        </td>
            ...
            <td>
                <table runat="server" id="ChartTable1" style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle" Text="Структурная динамика числа безработных граждан в разрезе видов деятельности, чел."></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
            ...
            <td valign="top" align="left">
                <table style="border-collapse: collapse; background-color: white; width: 100%; height: 100%;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label5" runat="server" CssClass="ElementTitle" Text="Среднегодовая численность занятого населения по видам деятельности, чел."></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
            ...
            <td valign="top" align="left">
                <table runat="server" id="GridTable1" style="border-collapse: collapse; background-color: white; width: 100%; height: 100%;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle" Text="Число безработных граждан в разрезе видов деятельности, чел."></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
