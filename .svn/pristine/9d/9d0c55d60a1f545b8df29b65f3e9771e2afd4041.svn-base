<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FNS_0001_0006_v.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FNS_0001_0006_v" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <table style="width: 320px; height: 360px; border-right: 0px solid; border-top: 0px solid;
                left: 0px; border-left: 0px solid; border-bottom: 0px solid; position: absolute;
                top: 0px; border-collapse: collapse;">
                <tr>
                    <td align="left" valign="top" style="left: 0px; width: 111px; position: static; top: 45px;
                        border-collapse: collapse; height: 150px; background-color: black">
                        <asp:Label ID="Label3" runat="server" Text="Label" SkinID="InformationText"></asp:Label><br />
                        <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="223px" Width="312px"
