<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0009.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            ...
            <td valign="top">
                <uc1:RefreshButton ID="RefreshButton1" runat="server" />
                    ...
                    <asp:ListItem Selected="True">Кредиты</asp:ListItem>
                    <asp:ListItem>Депозиты, р/c и вклады</asp:ListItem>
                </asp:RadioButtonList>
    ...
    <table style="vertical-align: top; margin-top: -3px">
            ...
            <td valign="top" align="left">
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <asp:Label ID="HeaderCaption" runat="server" CssClass="ElementTitle" Text=""></asp:Label>
        ...
        <tr>
                    ...
                    <asp:ListItem Selected="True">Юридические лица</asp:ListItem>
                    <asp:ListItem>Физические лица</asp:ListItem>
                </asp:RadioButtonList>
                        <asp:RadioButtonList ID="RadioButtonList3" runat="server" AutoPostBack="True"  
                    RepeatDirection="horizontal" Width="700px">
                    <asp:ListItem Selected="True">Депозиты юр. лиц</asp:ListItem>
                    <asp:ListItem>Вклады физ. лиц (включая карточные счета)</asp:ListItem>
                    <asp:ListItem>Расчетные счета клиентов</asp:ListItem>
                </asp:RadioButtonList>
        </tr>
        <table style="vertical-align: top;">
        <tr>
         <td valign="top">
                <uc3:CustomMultiCombo ID="ComboYearChart" runat="server">
                </uc3:CustomMultiCombo>
            </td>
            <td valign="top">
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td style="overflow: visible;">
              ...
              <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle"></asp:Label>
        ...
        <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
         ...
         <tr>
            ...
            <td style="overflow: visible;">
                 <igmisc:WebAsyncRefreshPanel ID="radioGroupPanel" runat="server">
                 <asp:Label ID="ChartCaption2" runat="server" CssClass="ElementTitle"></asp:Label>
