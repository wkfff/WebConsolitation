<%@ Page Language="C#" MasterPageFile="~/Reports.Master"  AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.FM_Gubkinski_001._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        ...
        <table style="vertical-align: top">
            <tr>
                <td valign="top">
                    <uc2:CustomMultiCombo ID="ComboYear" runat="server" Title="Μερÿφ" />
                </td>
                <td valign="top">
 ...
 <table style="width: 100%;  border-collapse: collapse; background-color: white; height: 100%;">
                                ...
                                <tr>
                                    ...
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue" ondatabinding="Grid_DataBinding1">
                                                <Bands>
                                                    <igtbl:UltraGridBand>
