<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oil_0009_0002_04.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.Oil_0009_0002_04" %>
...
<body link="White" vlink="White" style="background-color: black;">
    ...
    <div style="position: absolute; width: 768px; background-color: black;
       ...
       <uc1:iPadElementHeader ID="OilHeader1" runat="server" Text="Цены на дизельное топливо по данным Росстата" Width="100%" />
       ...
       <uc1:iPadElementHeader ID="OilHeader2" runat="server" Text="Цены на дизельное топливо по сплошному методу учета" Width="100%" />
