...
namespace Krista.FM.Server.Dashboards.reports.OMCY_0003.Grant
{
    public partial class _default : CustomReportPage
    {
        ...
        private void DataBindGrid()
        {
            ...
            foreach (DataRow BaseRow in BaseTable.Rows)
            {
                ...
                else
                {
                    ...
                    NewRow["Region"] = BaseRow["Region"] + " муниципальный район";
                }
        ...
        private void SetHeaderReport()
        {
            ...
            Label2.Text = "Порядок распределения грантов городским округам и муниципальным районам на основании значения показателя оценки эффективности деятельности органов местного самоуправления, в соответствии с постановлением Губернатора ХМАО-Югры от 24 марта 2009 г. N 36 (с учетом изменений)";
