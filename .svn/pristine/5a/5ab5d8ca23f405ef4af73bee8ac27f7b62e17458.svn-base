...
{
    public partial class Oil_0007_0002_v : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText(String.Format("Oil_0007_0002_chart1_v"));
        ...
        {
            string query = DataProvider.GetQueryText(String.Format("Oil_0007_0002_chart2_v"));
            DataTable dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
        ...
        {
            string query = DataProvider.GetQueryText(String.Format("Oil_0007_0002_chart3_v"));
            DataTable dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
        ...
        {
            string query = DataProvider.GetQueryText(String.Format("Oil_0007_0002_chart5_v"));
            DataTable dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
