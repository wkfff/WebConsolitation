...
' * @version         SVN: $Id: ip_address.asp 150 2008-04-27 19:17:20Z weppos $
' */
		...
		%>		  
		  <tr class="smalltext" bgcolor="<%= strAsgSknTableContBgColour %>">
			...
			<td background="<%= strAsgSknPathImage & strAsgSknTableContBgImage %>" align="left">&nbsp;<%
				...
				Else
					Response.Write(vbCrLf & "				<img src=""" & strAsgSknPathImage & "tracking_small.gif"" alt=""" & strAsgTxtShowIpInformation & """ border=""0"" align=""absmiddle"" />")
				End If
				'// Chiudi Link
				Response.Write("</a>&nbsp;")
				...
				%>
						...
						'Tracking IP
						'// Link PopUp
						Response.Write(vbCrLf & "						<a href=""JavaScript:openWin('http://geotool.servehttp.com/?ip=" & objAsgRs("IP") & "','Tracking','toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=1,width=1000,height=640')"" title=""Show on map"">")
						'// Icona espansa se Corrisponde
