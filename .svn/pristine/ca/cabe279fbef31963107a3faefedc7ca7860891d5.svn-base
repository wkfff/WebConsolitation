<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0003_Sakhalin.Default" Title="Индикаторы БК и КУ " %>
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="ChartCaption2" runat="server" CssClass="ElementTitle" Text= "Структурное соотношение объемов ипотечных и потребительских кредитов"></asp:Label>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="ChartCaption" runat="server" CssClass="ElementTitle" Text= ""></asp:Label>
                            </td>
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="ChartCaption3" runat="server" CssClass="ElementTitle" Text= "Объемы потребительских и ипотечных кредитов в разрезе субъектов, млн. руб."></asp:Label>
                            </td>
                            <td class="headerright">
                            </td>
                        </tr>
