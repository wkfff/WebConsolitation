<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Sport_0001_0007.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Sport_0001_0007" %>
		...
		<div style="position: absolute; width: 768px; height: 950px; background-color: black; top: 0px; left: 0px; z-index: 2;">			
			...
			<div style="margin: 0 10px 25px 10px; width: 748px;">	
				...
				<div style="float: left;">
					<uc:UltraChartItem ID="UltraChartStaffSporter" runat="server"></uc:UltraChartItem>
				</div>
