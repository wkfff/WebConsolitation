<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0008_0001.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
             ...
             <td valign="top">
                <uc3:CustomMultiCombo ID="ComboCSR" runat="server"></uc3:CustomMultiCombo>
            </td>
        ...
        <tr>
             ...
             <td style="overflow: visible;" align="left" colspan="3">
                          <asp:CheckBox ID="CheckBox1" runat="server" Text="СубКОСГУ"
                          ...
                          <asp:CheckBox ID="CheckBox2" runat="server" Text="Целевая статья"
                                        AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" />
                          <asp:CheckBox ID="CheckBox3" runat="server" Text="Генподрядчик"
                                        AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" />
            ...
            <td valign="top" align="left" style="font-family:Verdana; font-size:12px; padding-left:20px;" >
                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="horizontal"
                                Width="470px">
                                <asp:ListItem Selected="True">Общий вид</asp:ListItem>
                                <asp:ListItem>Расшифровка</asp:ListItem>
                                <asp:ListItem>Справка по МО</asp:ListItem>
                                <asp:ListItem>Газификация</asp:ListItem>
                            </asp:RadioButtonList>
           </td>
        </tr>
    </table>
