<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FST_0001_0032_Horizontal.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FST_0001_0032_Horizontal" %>
...
<body style="background-color: Black">
    ...
    <div style="position: absolute; width: 1018px; height: 100%; top: 0px; left: 0px;
        ...
        <table style="background-color: Black; top: 0px; left: 0px; overflow: hidden">
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Теплоснабжение (среднеотпускной тариф)"
                        Width="100%" />
                    <uc1:FST_0001_0001_Horizontal_Chart ID="UltraChartFST_0001_0001_Chart1" runat="server" />
                </td>
            </tr>
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader3" runat="server" Text="Теплоснабжение (тариф для населения)"
                        Width="100%" />
                    <uc1:FST_0001_0001_Horizontal_Chart ID="UltraChartFST_0001_0001_Chart2" runat="server" />
                </td>
            </tr>
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader4" runat="server" Text="Теплоснабжение (тариф для бюджетных потребителей)"
                        Width="100%" />
                    <uc1:FST_0001_0001_Horizontal_Chart ID="UltraChartFST_0001_0001_Chart3" runat="server" />
                </td>
            </tr>
            <tr>
                <td><uc1:iPadElementHeader ID="IPadElementHeader5" runat="server" Text="Теплоснабжение (тариф для прочих потребителей)"
                        Width="100%" />
