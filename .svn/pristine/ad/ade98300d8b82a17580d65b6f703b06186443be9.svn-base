 ...
 */
namespace Krista.FM.Server.Dashboards.reports.ORG_0001_0004
{
	public partial class Default : CustomReportPage
	{
        ...
        private const string PageTitleCaption = "Максимальные и минимальные розничные цены в автономном округе";
		private const string PageSubTitleCaption = "Анализ максимальных и минимальных розничных цен на продукты питания на основании данных еженедельного мониторинга предприятий торговли, Ханты-Мансийский автономный округ - Югра, по состоянию на {0}";
