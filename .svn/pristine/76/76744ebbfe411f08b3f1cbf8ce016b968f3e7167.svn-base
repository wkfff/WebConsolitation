<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EO_0001_0001.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.EO_0001_0001" %>
...
<body link="White" vlink="White" style="background-color: black;">
    <form id="form1" runat="server">
        <touchelementbounds src="../../../TemporaryImages/EO_0001_0001/TouchElementBounds.xml"></touchelementbounds>
                    ...
                    <table style="width: 100%; height:35px; text-align:right;vertical-align:middle">
                       <tr>
                          <td style="width: auto; text-align:left; vertical-align:bottom;">
                             <asp:Label ID="CommonGridCaption" runat="server" Font-Names="Arial" ForeColor="#D1D1D1" Font-Size="16px"></asp:Label> 
                          </td>
                          <td style="width: 200px">
                             <asp:Label ID="CrossLink" runat="server" Font-Names="Arial" ForeColor="#D1D1D1" Font-Size="14px"></asp:Label>
                          </td>
                          <td style="width: 37px">
                             <a href='webcommand?showReport=EO_0001_0003'>
                                <img  width='30px' height='35px' src='../../../images/50percent.png' alt=""/>
                             </a>
                          </td>
                       </tr>
                    </table>

                    <uc5:UltraGridBrick ID="CommonGridBrick" runat="server"></uc5:UltraGridBrick>
                </td>
            </tr>
        </table>   
