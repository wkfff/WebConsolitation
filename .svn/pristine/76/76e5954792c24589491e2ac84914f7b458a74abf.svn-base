<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Food_0002_0003.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.Food_0002_0003" %>
        ...
        <table style="border-collapse: collapse; background-color: Black; top: 0px; left: 0px;">
            <tr>
                <td align="left" valign="top">
                    ...
                    <asp:Label ID="Label1" runat="server" Text="* - МО с досрочным завозом продуктов питания"
                            SkinID="InformationText"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
