 ...
 */
namespace Krista.FM.Server.Dashboards.reports.BC_0001_0018
{
    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            try
            {
                ...
                Label3.Text = "Динамика показателя";
                Label4.Text = "Темп роста показателя";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {   // опрерации которые должны выполняться при только первой загрузке страницы
                    ...
                    last_year.Value = getLastDate("ОРГАНИЗАЦИЯ РИТУАЛЬНЫХ УСЛУГ И СОДЕРЖАНИЕ МЕСТ ЗАХОРОНЕНИЯ");
        ...
        private void webGrid1ActiveRowChange(int index, bool active)
        {
            try
            {
                ...
                Label2.Text = String.Format(chart2_title_caption, row.Cells[1].Value.ToString());
