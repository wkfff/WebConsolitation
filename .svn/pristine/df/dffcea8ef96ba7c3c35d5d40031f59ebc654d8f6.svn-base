...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0003_HMAO
{
    public partial class DefaultDetail : CustomReportPage
    {
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            cell.AddCell(String.Format("Уточненные годовые назначения, {0}", multiplierCaption), "Плановые назначения на год");
            cell.AddCell(String.Format("Исполнено, {0}", multiplierCaption), "Фактическое исполнение нарастающим итогом с начала года");
            ...
            cell.AddCell(String.Format("Исполнено прошлый год, {0}", multiplierCaption), "Исполнено за аналогичный период прошлого года");
