<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0635_0005.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0635_0005" %>
            ...
            <tr>
                <td style="width: 775px; text-align: left; background-color: Black; padding-left: 4px"
                    ...
                    <uc3:iPadElementHeader ID="IPadElementHeader4" runat="server" Text="Расходы по главным распорядителям"
                        Width="764px" MultitouchReport="FO_0635_0007" />
                </td>
            </tr>
            <tr>
