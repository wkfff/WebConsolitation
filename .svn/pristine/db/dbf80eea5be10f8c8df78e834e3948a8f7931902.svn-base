<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0002_0002.Default" Title="Сравнение расходов субъектов Сибирского федерального округа по разделам/подразделам классификации расходов" %>
