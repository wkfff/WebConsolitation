...
{
    public partial class FO_0335_0015_v : CustomReportPage
    {
        ...
        private void InitializeCreditDebts()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0335_0015_credit_debts");
        ...
        private static DataTable GetBudetDataSource()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0335_0015_budget_incomes_v");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0335_0015_budget_outcomes_all_v");
            ...
            query = DataProvider.GetQueryText("FO_0335_0015_budget_outcomes_v");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0335_0015_budget_deficite_v");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        private void InitializeBudgetSettlement()
        {
            ...
            query = DataProvider.GetQueryText("FO_0335_0015_settlements_list");
        ...
        protected void UltraWebGridBudgetSettlement_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0335_0015_settlement_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0335_0015_settlement_outcomes_all");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0335_0015_settlement_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0335_0015_settlement_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
