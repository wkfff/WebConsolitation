<%@ Control Language="C#" AutoEventWireup="true" Codebehind="IT_0002_0001_IncomesGrid.ascx.cs" Inherits="Krista.FM.Server.Dashboards.iPhone.IT_0002_0001.reports.iPhone.IT_0002_0001.IT_0002_0001_IncomesGrid" %>
        ...
        <td>
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label1" runat="server" CssClass="InformationText" Text=""></asp:Label>
                    </td>
                </tr>
            </table>
