...
namespace Krista.FM.Server.Dashboards.reports.STAT_0003_0010
{
    public partial class _default : CustomReportPage
    {
        ...
        private string sub_page_title = "Данные ежегодного мониторинга видов проведенных операций в Сахалинской области, {0} год";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            baseRegion.Value = "[Территории__РФ].[Территории__РФ].[Все территории].[Российская Федерация].[Дальневосточный федеральный округ].[Сахалинская область].[Сахалинская обл.]";
            if (!Page.IsPostBack)
            {
        ...
        protected void Grid_DataBinding(object sender, EventArgs e)
        {
            ...
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(DataProvider.GetQueryText("Grid"), "Виды операций", dt);
            if (dt.Rows.Count > 1)
            {
        ...
        public void FillMapData()
        {
            ...
            for (int j = 0; j < dtMap.Rows.Count; j++)
            {
                ...
                foreach (Shape shape in shapeList)
                {
                    ...
                    {
                        shape.ToolTip = String.Format(shapeHint, String.Format("{0:0}", Convert.ToDouble(dtMap.Rows[j].ItemArray[1]))) + ", " + subject.Replace("р-н", String.Empty);
                            //+ "МР";
                    }
        ...
        protected void FormText()
        {
            Label4.Text = "";
            string buf = "";
            string str1 = "Общее {0} в целом по Сахалинской области в <b>{1} году</b> ";
            ...
            Label4.Text = Label4.Text.Replace("Общее", "<br>&nbsp;&nbsp;&nbsp;Общее").Replace("умерло", "число умерших").Replace("Сахалинской области", "Сахалинской области");
