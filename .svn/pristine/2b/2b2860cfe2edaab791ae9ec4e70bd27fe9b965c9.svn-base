<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0004_0008.Default" Title="Untitled Page" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right" style="width: 100%;">
                ...
                <br />
                <asp:HyperLink ID="CrossLink1" runat="server" SkinID="HyperLink">
                </asp:HyperLink>
                <br />
                <asp:HyperLink ID="CrossLink2" runat="server" SkinID="HyperLink">
                </asp:HyperLink>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td valign="top" align="left" style="font-family: Verdana; font-size: 12px;">
                <asp:RadioButtonList ID="RubMiltiplierButtonList" runat="server" AutoPostBack="True"
                    ...
                    <asp:ListItem>млрд.руб.</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
    </table>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="headerReport" style="overflow: visible;">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle" Text="Исполнение доходов федерального бюджета по основным источникам поступлений по состоянию на {0:dd.MM.yyyy} года"></asp:Label>
                        </td>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="headerReport" style="overflow: visible;">
                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle" Text="Исполнение доходов федерального бюджета Главными администраторами доходов бюджета по состоянию на {0:dd.MM.yyyy} года"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <uc5:ultragridbrick id="UltraGridBrick1" runat="server"></uc5:ultragridbrick>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
