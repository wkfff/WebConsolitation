...
{
    public partial class FO_0035_0021_h : CustomReportPage
    {
        ...
        private void MakeHtmlTable()
        {
            ...
            for (int i = startIndex; i < dtData.Rows.Count; i++)
            {
                ...
                //if (dtData.Rows[i][0].ToString() == "Остаток средств на начало квартала")
                //{
                //    dtData.Rows[i][0] = "Остаток средств на начало года";
                //}

                //if (dtData.Rows[i][0].ToString() == "Остаток средств на конец квартала")
                //{
                //    dtData.Rows[i][0] = "Остаток средств ";
                //}
