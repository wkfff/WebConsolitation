<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultAllocation.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0003.DefaultAllocation" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td colspan="1" style="width: 100%" valign="top">
             <uc4:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultAllocation.html" />
                &nbsp;&nbsp;
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <asp:CheckBox ID="allRegionsCheckBox" runat="server" Text="Субъекты&nbsp;одного&nbsp;федер.&nbsp;округа" Style="font-family: Verdana; font-size: 10pt;"
                ...
                <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel" runat="server" TriggerControlIDs="SubmitButton">
                    ...
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;"><igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
