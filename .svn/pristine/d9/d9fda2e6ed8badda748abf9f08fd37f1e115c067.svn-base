<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0007_XMAO.Default" Title="јнализ среднемес€чной заработной платы" %>
                        ...
                        <td valign="top">
                         ...
                         <td valign="top">
                             <asp:RadioButtonList ID="DebtKindButtonList" runat="server" AutoPostBack="True"
                                ...
                                <asp:ListItem Selected="True">ќрганы государственной власти</asp:ListItem> 
                                <asp:ListItem>ќрганы местного самоуправлени€</asp:ListItem>
                             </asp:RadioButtonList>
                        </td>
