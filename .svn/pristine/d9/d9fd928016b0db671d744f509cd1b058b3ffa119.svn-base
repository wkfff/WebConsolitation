...
{
    public partial class Food_0002_0001_h : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            TextBox1.Text = "Розничные цены на продукты питания";
            TextBox2.Text = "на";
            TextBox3.Text = String.Format("{0:dd.MM.yyyy}", currentDate);
            TextBox4.Text = "(изменение за период с";
            TextBox5.Text = String.Format("{0:dd.MM.yyyy}", lastDate);
            TextBox6.Text = ")";
        ...
        void UltraWebGrid1_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            e.Layout.Bands[0].Columns[0].Width = 273;
