<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0016_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0016_Horizontal" %>
...
<body style="background-color: black;">
    ...
    <touchelementbounds src="TouchElementBounds.xml"></touchelementbounds>
        <div style="position: absolute; width: 1020px; height: 690px; background-color: black; top: 0px; left: 0px;
