<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0003_0015_Novosib.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                            <uc1:CustomMultiCombo ID="ComboTypePeriod" runat="server">
                            </uc1:CustomMultiCombo>
                        </td>
                        <td valign="top">
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                <igtbl:UltraWebGrid ID="Grid" runat="server" Height="200px" Width="325px"
                    SkinID="UltraWebGrid">
                    <Bands>
                        <igtbl:UltraGridBand>
                    ...
                    <DisplayLayout ViewType="OutlookGroupBy" Version="4.00" AllowSortingDefault="NotSet"
                        StationaryMargins="Header" AllowUpdateDefault="Yes"
                        StationaryMarginsOutlookGroupBy="True" HeaderClickActionDefault="NotSet" Name="UltraWebGrid1"
                        BorderCollapseDefault="Separate" AllowDeleteDefault="Yes" RowSelectorsDefault="No"
                        TableLayout="Fixed" RowHeightDefault="20px"
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
          ...
          <table id = "BootomChartTable" runat=server style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        <tr>
            <td class="topleft">
            </td>
            <td class="top">
