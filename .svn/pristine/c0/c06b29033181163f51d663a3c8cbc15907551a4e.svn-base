    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("STAT_0002_0003_date");
            ...
            UserParams.Region.Value = "[Уральский федеральный округ].[Тюменская область]";
            ...
            DataProvidersFactory.SecondaryMASDataProvider.GetDataTableForPivotTable(query1, dateGrid);
            ...
            switch (regionsCombo.SelectedValue)
            {
                ...
                case "Ханты-Мансийский автономный округ":
                    {
                        region = "Ханты-Мансийского автономного округа";
                        break;
                    }
                case "Ямало-Ненецкий автономный округ":
                    {
                        region = "Ямало-Ненецкого автономного округа";
                        break;
                    }
           ...
           ChartCaption1.Text = String.Format("Соотношение выданных объемов потребительских кредитов {0} с другими субъектами УрФО", region);
           ...
           ChartCaption3.Text = String.Format("Соотношение выданных объемов ипотечных кредитов {0} с другими субъектами УрФО", region);
           Page.Title = "Потребительские и ипотечные кредиты";
           Label1.Text = Page.Title;
           Label2.Text = "<br/>Анализ динамики процентных ставок и выданных объёмов по потребительским и ипотечным кредитам в субъектах Российской Федерации, входящих в состав Уральского федерального округа (млн. руб.)";
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
                ...
                string query = DataProvider.GetQueryText("STAT_0002_0003_compare_Grid");
