...
{
    public partial class FO_0038_0002_V : CustomReportPage
    {       
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label3.Text = String.Format("Структура собственных доходов консолидированного бюджета ВологО<br/>за {0} {1} {2} г.", monthNum, CRHelper.RusManyMonthGenitive(monthNum), yearNum);
        ...
        protected void UltraChart1_DataBinding(object sender, EventArgs e)
        {
            ...
            foreach (DataRow row in dtChart1.Rows)
            {
                ...
                {
                    row[0] = DataDictionariesHelper.GetShortKDName(row[0].ToString().TrimEnd(' ')).Replace(' ', '\n');
                }
            }
