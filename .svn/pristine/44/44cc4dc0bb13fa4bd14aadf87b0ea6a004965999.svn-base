...
{
    public partial class FO_0005_0002 : CustomReportPage
    {
        ...
        void UltraChart1_FillSceneGraph(object sender, FillSceneGraphEventArgs e)
        {
            ...
            for (int i = 0; i < columnsX.Count; i++)
            {
                ...
                int yPos = columnsValues[columnsX[i]] > 0 ? 350 - columnsHeights[columnsX[i]] : 480 + columnsHeights[columnsX[i]];
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0005_0001_rests_date");
            ...
            Label16.Text = String.Format("Результат исполнения областного бюджета Новосибирской области<br/>в динамике на&nbsp;{0:dd.MM.yyyy}, тыс.руб.",
                    date.AddMonths(1));
        }
