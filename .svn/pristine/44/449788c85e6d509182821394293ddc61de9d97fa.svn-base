    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            */
            ...
            UltraChart1.Axis.Y.Margin.Far.Value = 3;
            UltraChart1.Axis.Y.Margin.Near.Value = 3;
            UltraChart1.Axis.Y.Labels.ItemFormatString = "Квартал <DATA_VALUE:N0>";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            quarts.Value = string.Format("[Период__Период].[Период__Период].[Данные всех периодов].[{0}].[Полугодие 1].[Квартал 1], [Период__Период].[Период__Период].[Данные всех периодов].[{0}].[Полугодие 1].[Квартал 2], [Период__Период].[Период__Период].[Данные всех периодов].[{0}].[Полугодие 2].[Квартал 3], [Период__Период].[Период__Период].[Данные всех периодов].[{0}].[Полугодие 2].[Квартал 4] ", year);

            date = string.Format("{0} квартал {1} года", quarter, year);

            Page.Title = String.Format("Ежеквартальная оценка инвестиционной привлекательности муниципальных образований Сахалинской области");
            PageTitle.Text = Page.Title;
            //chart1Label.Text = "Распределение по объему профицита(+)/дефицита(-) местных бюджетов";
            PageSubTitle.Text = string.Format("Оценка инвестиционной привлекательности муниципальных образований за {0}", date);

            headerLayout1 = new GridHeaderLayout(UltraWebGrid);
            UltraWebGrid.Bands.Clear();
            UltraWebGrid.DataBind();
            UltraChart1.DataBind();
            Label2.Text =  string.Format("Интегральный индекс инвестиционной привлекательности за {0}", date); 
            UltraChart.DataBind();
            Label3.Text = string.Format("Интегральный и частные индексы инвестиционной привлекательности муниципальных образований за {0}", date);
                            ...
                            if (IsCalloutTownShape(shape))
                             {
                                 ...
                                 //shape.ToolTip = string.Format("{2} \n ранг по Сахалинской области: {0:N0} \n инвестиционная \n привлекательность: {1:N1}", investmentsRank, investmentsBeauty, shapeName);
                             }
                             else
                             {
                                 ...
                                 if (shapeText.Contains("Углегорский") || shapeText.Contains("Тамаринский") || shapeText.Contains("Холмский") || shapeText.Contains("Невельский"))
                                 {
                                     shape.CentralPointOffset.X = -1;
                                 }
                                 if (shapeText.Contains("Долинский") || shapeText.Contains("Вахрушев") || shapeText.Contains("Южно - Сахалинск"))
                                 {
                                     shape.CentralPointOffset.X = 1;
                                 }
                             }
