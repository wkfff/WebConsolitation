<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.ORG_0001_0006_YANAO.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc1:CustomMultiCombo ID="ComboDateCompare" runat="server"></uc1:CustomMultiCombo>
            </td>
            <td valign="top">
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="cbPrice" runat="server" Text="Средняя розничная цена" AutoPostBack="true"
                    Checked="true" Style="font-family: Verdana; font-size: 10pt;" />
                <asp:CheckBox ID="cbDelta" runat="server" Text="Изменение цены к дате для сравнения"
