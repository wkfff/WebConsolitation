...
namespace Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._0001
{
    public partial class Default : CustomReportPage
    {
        ...
        private static String chart3_title_caption = "Количество инвентарного жилья на&nbsp;{0}&nbsp;год, единица";
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            try
            {
                ...
                //ИМХО, пытатся подогнать такую вещь как красота есть высшее извращение...
            }
            catch (Exception)
            {
        ...
        protected void Chart1_DataBinding(object sender, EventArgs e)
        {
            ...
            catch (Exception exception) // блок для обработки исключений
            {
                ...
                Chart1.Axis.Y.RangeMin = 0;
                 ...
                 //<ITEM_LABEL>, километры <b><DATA_VALUE:###,##0.##></b>
