<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.Sahalin_ARC.investment._default" %>
        ...
        <table>
            <tr>
                <td style="width: 100%">
                    ...
                    &nbsp;<asp:Label ID="Hederglobal" runat="server" CssClass="PageTitle">Мониторинг иностранных инвестиций </asp:Label><br />
                    <asp:Label ID="PageSubTitle" runat="server" CssClass="PageSubTitle">Ежеквартальный мониторинг иностранных инвестиций в Ханты-Мансийском автономном округе</asp:Label></td>
        ...
        <table style="vertical-align: top">
            <tr>
                <td valign="top" colspan="2">
                    <uc2:CustomMultiCombo ID="ComboQuart" runat="server" Title="Выберите квартал" 
                        Width="150" />
                </td>
                <td colspan="1" valign="top">
                    <uc2:CustomMultiCombo ID="ComboTypePeriod" runat="server" Title="Выберите период для сравнения" 
                        Visible="true" Width="150" />
                </td>
                <td colspan="1" valign="top">
                    <uc2:CustomMultiCombo ID="ComboOKVED_or_REGION" runat="server" 
                        Title="Выберите разрезность" Visible="true" Width="150" />
                </td>
                <td valign="top">
