...
{
    public partial class FST_0001_0003_Horizontal : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            base.Page_Load(sender, e);
                        
            SetChart(TagCloudFST_0001_0003_Horizontal_Text1, "электрическую энергию", "руб./кВт.ч.");
            SetChart(TagCloudFST_0001_0003_Horizontal_Text2, "тепловую энергию", "руб./Гкал.");
            SetChart(TagCloudFST_0001_0003_Horizontal_Text3, "водоснабжение", "руб./куб.м.");
            ...
            IPadElementHeader1.MultitouchReport = String.Format("fst_0001_0013_{0}_Horizontal", CustomParams.GetSubjectIdByName(UserParams.StateArea.Value));
            IPadElementHeader2.MultitouchReport = String.Format("fst_0001_0023_{0}_Horizontal", CustomParams.GetSubjectIdByName(UserParams.StateArea.Value));
            IPadElementHeader3.MultitouchReport = String.Format("fst_0001_0033_{0}_Horizontal", CustomParams.GetSubjectIdByName(UserParams.StateArea.Value));
            IPadElementHeader4.MultitouchReport = String.Format("fst_0001_0043_{0}_Horizontal", CustomParams.GetSubjectIdByName(UserParams.StateArea.Value));
            //IPadElementHeader3.MultitouchReport = "FST_0001_0031";

            string filename = HttpContext.Current.Server.MapPath("~/TemporaryImages/FST_0001_0003_Horizontal/") + "TouchElementBounds.xml";
            Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/TemporaryImages/FST_0001_0003_Horizontal/"));
            File.WriteAllText(filename, String.Format("<?xml version=\"1.0\" encoding=\"UTF-8\"?><touchElements><element id=\"fst_0001_0013_{0}_Horizontal\" bounds=\"x=0;y=0;width=625;height=235\" openMode=\"loaded\"/><element id=\"fst_0001_0023_{0}_Horizontal\" bounds=\"x=0;y=235;width=625;height=235\" openMode=\"loaded\"/><element id=\"fst_0001_0033_{0}_Horizontal\" bounds=\"x=0;y=470;width=625;height=235\" openMode=\"loaded\"/><element id=\"fst_0001_0043_{0}_Horizontal\" bounds=\"x=625;y=0;width=395;height=545\" openMode=\"loaded\"/></touchElements>", CustomParams.GetSubjectIdByName(UserParams.StateArea.Value)));
        }
        ...
        private void SetChart(Dashboard.FST_0001_0003_Text textElement, string filter, string measure)
        {
            ...
            string chartQuery = DataProvider.GetQueryText("FST_0001_0003_Horizontal_chart");
            string textQuery = DataProvider.GetQueryText("FST_0001_0003_Horizontal_text");
        ...
        {
            string query = DataProvider.GetQueryText("FST_0001_0003_Horizontal_grid");
        ...
        protected void OutcomesGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            e.Layout.Bands[0].Columns[0].Width = 297;
            e.Layout.Bands[0].Columns[0].CellStyle.HorizontalAlign = HorizontalAlign.Left;
            e.Layout.Bands[0].Columns[0].CellStyle.Wrap = true;

            e.Layout.Bands[0].Columns[1].Width = 97;
