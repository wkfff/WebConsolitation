...
namespace Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessHealth_Novosib
{
    public partial class _default : CustomReportPage
    {
        ...
        {            
            ...
            Hederglobal.Text = string.Format(Hederglobal.Text, 
            ...
            {
                G.Rows[i].Cells[1].RowSpan = ((i!=0)&(i!=3))?3:1;
            }
            ...
            ActiveRow(G3, 24);
            ActiveRow(G4, 31);
            Label6.Text = RegionSettingsHelper.Instance.GetPropertyValue("RegionSubTitle");
        }
...
объема неэффективных расходов в сфере здравоохранения  на общий объем расходов консолидированного бюджета и умножения на 100%"
        ...
        string[] ColumnFormula2 =
            {"Р1 = (Р11 х Чн)/10000",
                "Чн",
                @"P11 =Рвр + Рср + Рпр ",
                @"Рвр = (Чвр - Чсвр x Кс) x (ЗПрвр x (1+ ЕСН ) x 12 мес.)",
                @"Чвр",
                @"Чсвр",
                @"ЗПрвр",
                @"Кс",
                @"Рср = (Чср - Чсср x Кс) x (ЗПрср x (1+ ЕСН ) x 12 мес.)",
                @"Чср",
                @"Чсср",
                @"ЗПрср",
                @"Кс",
                @"Рпр = (Чпр - 0,4 x (Чсвр + Чсср) x Кс) x (ЗПрпр x (1+ ЕСН ) x 12 мес.)",
                @"Чпр",
                @"Чсвр",
                @"Чсср",
                @"ЗПрпр",
