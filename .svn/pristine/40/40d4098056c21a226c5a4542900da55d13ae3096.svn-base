<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.OMCY_0003.REGION_01_Novosib._default" %>
        ...
        <table style="vertical-align: top">
            <tr>
                ...
                <td align="right" style="width: 100%" valign="top">
                    ...
                    NavigateUrl="~/reports/OMCY_0003/REGION_Novosib/default.aspx">Оценка эффективности деятельности ОМСУ по Новосибирской области</asp:HyperLink>
                    </td>
            </tr>
        </table>
        <table>
