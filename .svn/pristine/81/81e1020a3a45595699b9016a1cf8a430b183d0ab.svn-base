<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0001.Default" %>
...
<br/>  
   ...
   <igmisc:WebPanel ID="WebPanel1" runat="server" EnableAppStyling="True" ExpandEffect="None"
        StyleSetName="Office2007Blue" BackColor="White" Width="100%">
    ...
    <table style="margin-top: 5px; border-collapse: collapse; background-color: white; width: 100%;">
        <tr>
            <td class="topleft">
            </td>
        ...
        StyleSetName="Office2007Blue" OnClick="web_grid_Click" Width="100%">
        <Bands>
            <igtbl:UltraGridBand>
        ...
        <td style="vertical-align: top;">
            <table style="margin-top: 0px; border-collapse: collapse; background-color: white">
                ...
                <tr>
                    ...
                    <td>
           <asp:Label ID="Label1" runat="server" Text="заголовок таблицы" Height="50px" Width="100%" CssClass="ElementTitle"></asp:Label><br />
        ...
        <td style="vertical-align: top;"> 
            <table style="margin-top: 0px; border-collapse: collapse; background-color: white">
                ...
                <tr>
                    ...
                    <td>
            <asp:Label ID="Label2" runat="server" BorderStyle="None" Text="заголовок таблицы" Height="50px" Width="100%" CssClass="ElementTitle"></asp:Label><br />
            ...
            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, км. &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
            </ColorModel>
            <Effects>
                <Effects>
        ...
        <td style="vertical-align: top;"> 
            <table style="margin-top: 0px; border-collapse: collapse; background-color: white">
                ...
                <tr>
                    ...
                    <td>
            <asp:Label ID="Label3" runat="server"  Text="заголовок таблицы" Height="50px" Width="100%" CssClass="ElementTitle"></asp:Label><br />
            ...
            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, тысячи м&lt;sup&gt;2&lt;/sup&gt; &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
            </ColorModel>
            <Effects>
                <Effects>
                                ...
                                <td style="vertical-align: top;">
                                    <table style="vertical-align: top; width: 100%; border-collapse: collapse;
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top">
                                    <asp:Label ID="Chart2Lab" runat="server" Text="заголовок таблицы" CssClass="ElementTitle" Height="45px"></asp:Label>
                                ...
                                <td style="vertical-align: top; padding-left: 3px;">
                                    <table style="vertical-align: top; width: 100%; border-collapse: collapse;
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top">
                                    <asp:Label ID="Chart3Lab" runat="server" Text="заголовок таблицы" CssClass="ElementTitle" Height="45px"></asp:Label>
