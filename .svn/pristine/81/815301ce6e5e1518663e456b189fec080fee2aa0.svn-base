<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessEducation_YANAO._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table>
            <tr>
                <td style="width: 100%">
                    ...
                    <asp:Label ID="Hederglobal" runat="server" CssClass="PageTitle">Оценка неэффективных расходов в сфере жилищно-коммунального хозяйства</asp:Label><br />
                    <asp:Label ID="Label5" runat="server" CssClass="PageSubTitle">Оценка проведена в соответствии с постановлением Правительства Российской Федерации от 15 апреля 2009 г. № 322 «О мерах по реализации Указа Президента Российской Федерации от 28 июня 2007 г. № 825» в редакции постановления Правительства Российской Федерации от 26 июля 2010 г. № 542</asp:Label></td>
                <td>
    ...
    <table>
        ...
        <table style="width: 100%; border-collapse: collapse; height: 10%">
            <tr>
                <td colspan="2" style="vertical-align: top; height: 98%;">
                    ...
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 100%; height: 100%">
                                <asp:Label ID="Label1" runat="server" CssClass="ElementTitle">Неэффективные  расходы консолидированного бюджета в сфере общего образования</asp:Label><igtbl:UltraWebGrid ID="G" runat="server" OnDataBinding="G_DataBinding" SkinID="UltraWebGrid"
        ...
        <tr>
                ...
                <table style="vertical-align: top; width: 100%; border-collapse: collapse; background-color: white">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="Label8" runat="server" CssClass="ElementTitle" Height="45px">Динамика долей неэффективных расходов на общее образование, %  </asp:Label><igchart:UltraChart ID="C1" runat="server" BackgroundImageFileName=""
                                    ...
                                    OnDataBinding="C1_DataBinding" Version="9.1" OnFillSceneGraph="C1_FillSceneGraph">
                                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;SERIES_LABEL&gt;&lt;br&gt; &lt;b&gt;&lt;DATA_VALUE:### ##0.##&gt;&lt;/b&gt;%" />
                                    <Border Thickness="0" />
                                    <Data SwapRowsAndColumns="True">
                                    </Data>
                                    <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart11_#SEQNUM(100).png" />
                                    <LineChart>
                                        <ChartText>
                                    ...
                                    <Axis>
                                        ...
                                        <X Extent="56" LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True">
                                            <Margin>
                                                <Near Value="3" />
                                                <Far Value="3" />
                                            </Margin>
                                    ...
                                    <Legend Font="Microsoft Sans Serif, 9pt" Location="Bottom" SpanPercentage="23" Visible="True" FormatString=".">
                                    </Legend>
                                </igchart:UltraChart>
            ...
            <td style="vertical-align: top"><table style="vertical-align: top; width: 100%; border-collapse: collapse; background-color: white">
                ...
                <tr>
                    ...
                    <td>
                        <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server" Width="100%"><asp:Label id="Label2" runat="server" CssClass="ElementTitle" Height="45px">Структура расходов консолидированного бюджета в сфере общего образования, %</asp:Label><igchart:UltraChart id="C2" runat="server" OnDataBinding="C2_DataBinding" Version="9.1" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ChartType="StackColumnChart" BackgroundImageFileName="">
<Tooltips FormatString="&lt;SERIES_LABEL&gt;&lt;br&gt; &lt;b&gt;&lt;DATA_VALUE:### ##0.##&gt;&lt;/b&gt; тыс. рублей" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></Tooltips>

<Border Thickness="0"></Border>

<StackChart StackStyle="Complete"></StackChart>

<Data SwapRowsAndColumns="True"></Data>

<DeploymentScenario ImageURL="../../../../TemporaryImages/Char11t_#SEQNUM(100).png" FilePath="../../../../TemporaryImages"></DeploymentScenario>
...
<X Visible="True" LineThickness="1" TickmarkStyle="Smart" TickmarkInterval="0" Extent="56">
<Margin>
<Near Value="3"></Near>
...
<Labels ItemFormatString="&lt;ITEM_LABEL&gt;" Font="Verdana, 7pt" FontColor="DimGray" HorizontalAlign="Near" VerticalAlign="Far" Orientation="VerticalLeftFacing">
...
<Y Visible="True" LineThickness="1" TickmarkInterval="100" Extent="50">
<MajorGridLines Visible="True" DrawStyle="Dot" Color="Gainsboro" Thickness="1" AlphaLevel="255"></MajorGridLines>

<MinorGridLines Visible="False" DrawStyle="Dot" Color="LightGray" Thickness="1" AlphaLevel="255"></MinorGridLines>

<Labels ItemFormatString="&lt;DATA_VALUE:N0&gt;%" Font="Verdana, 7pt" FontColor="DimGray" HorizontalAlign="Far" VerticalAlign="Center" Orientation="Horizontal">
...
<Legend Visible="True" Location="Bottom" SpanPercentage="23" Font="Microsoft Sans Serif, 9pt"></Legend>
            ...
            <td colspan="2" style="vertical-align: top">
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top; width: 100%; height: 100%">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle">Расчет неэффективных расходов консолидированного бюджета  на управление наполняемостью классов в общеобразовательных учреждениях</asp:Label>
                            <igtbl:UltraWebGrid ID="G3" runat="server" OnDataBinding="G3_DataBinding" SkinID="UltraWebGrid"
                                    StyleSetName="Office2007Blue" OnInitializeLayout="G_InitializeLayout" OnInitializeRow="G_InitializeRow" OnDataBound="G3_DataBound" OnDblClick="G_DblClick">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
