<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0003_0013_Novosib.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Textovko" runat="server" CssClass="PageSubTitle"></asp:Label>
            </td>
            <td class="right">
            </td>
        </tr>
        ...
        <tr><td class="left"></td>
            <td style="overflow: visible;">
                <igtbl:UltraWebGrid ID="GridBottom" runat="server" Height="200px" Width="325px"
                    SkinID="UltraWebGrid">
                    <Bands>
                        <igtbl:UltraGridBand>
                            <AddNewRow View="NotSet" Visible="NotSet">
                ...
                <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ...
                        <Skin ApplyRowWise="False">
                            <PEs>
                                <igchartprop:PaintElement ElementType="Hatch" Fill="Coral" 
                                    FillStopColor="Coral" Hatch="Default" />
                                <igchartprop:PaintElement ElementType="Hatch" Fill="ControlText" 
                                    FillStopColor="Coral" Hatch="BackwardDiagonal" />
                            </PEs>
                        </Skin>
                    </ColorModel>
                    <Effects>
                    ...
                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fo_40000_01#SEQNUM(100).png" />
                </igchart:UltraChart>
            </td>
            <td class="right">
            </td>
            ...
            <td>
                ...
                <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ...
                        <Skin ApplyRowWise="False">
                            <PEs>
                                <igchartprop:PaintElement ElementType="Gradient" Fill="LightGreen" 
                                    FillStopColor="DarkGreen" Hatch="Default" 
    ...
    <table id = "table3chart" runat="server" style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        <tr>
            <td class="topleft">
            </td>
            <td class="top">
        ...
        <tr>
            ...
            <td>
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td>
                <asp:Label ID="PieLabel" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                        <td>
                <asp:Label ID="StackLabel" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                <igchart:UltraChart ID="PieChart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    Version="9.1" ChartType="PieChart">
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ModelStyle="CustomSkin">
                        <Skin ApplyRowWise="False">
                            <PEs>
                                <igchartprop:PaintElement ElementType="Hatch" Fill="Yellow" 
                                    FillStopColor="Yellow" Hatch="Default" />
                                <igchartprop:PaintElement ElementType="Hatch" Fill="Green" 
                                    FillStopColor="Green" Hatch="Default" />
                                <igchartprop:PaintElement ElementType="Hatch" Fill="Blue" FillStopColor="Blue" 
                                    Hatch="Default" />
                            </PEs>
                        </Skin>
                    </ColorModel>
                    ...
                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fo_40_01#SEQNUM(100).png" />
                        ...
                        <td>
                <igchart:UltraChart ID="StackChart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    Version="9.1" ChartType="StackColumnChart">
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ModelStyle="CustomSkin">
                        <Skin ApplyRowWise="False">
                    ...
                    <tr>
                        <td colspan="2">
                <igchart:UltraChart ID="LegendChart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    Version="9.1" ChartType="LineChart">
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ModelStyle="CustomSkin">
                        <Skin ApplyRowWise="False">
                    ...
                    <Legend Visible="True" Location="Bottom" SpanPercentage="100"></Legend>
                    <Effects>
                        <Effects>
                            <igchartprop:GradientEffect>
                            </igchartprop:GradientEffect>
    ...
    <table id = "table3chart0" runat="server" 
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="PieSubjectLabel" runat="server" CssClass="ElementTitle"></asp:Label>
                <igchart:UltraChart ID="PieSubject" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    Version="9.1" ChartType="PieChart">
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ModelStyle="CustomSkin">
                        <Skin ApplyRowWise="False">
