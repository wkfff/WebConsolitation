<%@ Page Language="C#" AutoEventWireup="true" Codebehind="IT_0002_0001_v.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.IT_0002_0001_v" %>
...
<body style="background-color: Black">
    <form id="form1" runat="server">
        <div style="position: absolute; width: 768px; height: 2400px; top: 0px; left: 0px; z-index: 2; overflow: hidden;">
                ...
                <tr>
                    <td>
                        <uc1:IT_0002_0002_DetailGrid ID="IT_0002_0002_DetailGrid1" runat="server" Width="758px" Text="Доходы за 1 полугодие 2010 года"
                            QueryName="IT_0002_0002"></uc1:IT_0002_0002_DetailGrid>
                    </td>
                </tr>
                <tr>
                    <td>
                        <uc2:IT_0002_0003_DetailGrid ID="IT_0002_0003_DetailGrid1" runat="server" Width="758px" Text="Расходы за 1 полугодие 2010 года"
                            QueryName="IT_0002_0003"></uc2:IT_0002_0003_DetailGrid>
                    </td>
                </tr>
                <tr>
                    <td>
                        <uc3:IT_0002_0004_DetailGrid ID="IT_0002_0004_DetailGrid1" runat="server" Width="758px" Text="Среднедневные остатки"
                            QueryName="IT_0002_0004"></uc3:IT_0002_0004_DetailGrid>
                    </td>
                </tr>
                <tr>
                    <td>
                        <uc4:IT_0002_0004_Chart ID="UltraChartIT_0002_0004_Chart1" runat="server" QueryName="IT_0002_0004_Chart"></uc4:IT_0002_0004_Chart>
                    </td>
                </tr>
            </table>
        </div>
