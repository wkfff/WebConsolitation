<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0007_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0017" %>
...
<body link="White" vlink="White" style="background-color: black;">
    <form id="form1" runat="server">
        <table style="border-collapse: collapse; background-color: Black; width: 1010px; height: 100%">
            <tr>
            ...
            <tr>
                <td valign="top" style="padding-top: 0px;" colspan="3">
                    <asp:Table ID="detailTable" runat="server" BackColor="Black" BorderColor="#323232" BorderStyle="Solid"
                        BorderWidth="1px" GridLines="Both" Width="1010px">
                    </asp:Table>
                </td>
            </tr>
        </table>
