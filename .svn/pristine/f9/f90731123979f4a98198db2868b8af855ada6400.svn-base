<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.FO_BOR_0001_004_0001.Default._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td colspan="1" style="width: 100%;">
                ...
                &nbsp;&nbsp;<br />
                <asp:Label ID="Label2" runat="server" Text="Анализ исходных показателей для получения индикаторов результативности достижения целей ОИВ" CssClass="PageSubTitle"></asp:Label>
            </td>
            <td style="width: 100%">
    ...
    <table style="vertical-align: top; width: 100%;">
          ...
          <tr>
            <td valign="top" align="left" style="text-align: center; widht: 100%;" colspan="2">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label7" runat="server" CssClass="PageSubTitle" Font-Bold="True" Width="300px"></asp:Label></td>
                        <td>
                            <table runat="server" id="GridTable1" style="border-collapse: collapse; background-color: white;
                                ...
                                <tr>
                                    ...
                                    <td style="overflow: visible;" runat="server" id="Td2" valign="top">
                                        <table style="vertical-align: baseline; text-align: center">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label1" runat="server" CssClass="PageSubTitle" Font-Bold="True" Width="370px">Общая результативность достижения целей</asp:Label></td>
                                                <td>
                                                    <asp:Label ID="Label4" runat="server" CssClass="PageTitle" Width="110px"></asp:Label></td>
                                                <td>
                                                    <asp:Label ID="Label5" runat="server" CssClass="PageTitle" Width="70px"></asp:Label></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="right">
        ...
        <tr>
            <td align="left" colspan="2" style="vertical-align: top" valign="top">
                <asp:CheckBox ID="CheckBox1" runat="server" Text="Показывать раcчёт" AutoPostBack="True" /></td>
        </tr>
        <tr>
