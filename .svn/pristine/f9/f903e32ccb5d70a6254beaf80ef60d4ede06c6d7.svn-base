...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
    public partial class FO_1035_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                UserParams.Mo.Value = "Беломорский МР";
            }

            if (UserParams.Mo.Value == "Костомукшский ГО")
            {
            ...
            else if (UserParams.Mo.Value == "Петрозаводский ГО")
            {
                UserParams.Filter.Value =
            ...
            {
                UserParams.Filter.Value = String.Format("[Территории__Сопоставимый].[Территории__Сопоставимый].[Все территории].[Российская  Федерация].[Северо-Западный федеральный округ].[Республика Карелия].[{0}]",
                        UserParams.Mo.Value.Replace("МР", "муниципальный район"));
            }
            ...
            if (UserParams.Mo.Value.Contains("ГО") || UserParams.Mo.Value.Contains("г.") || UserParams.Mo.Value.Contains("р.п.") || UserParams.Mo.Value.ToLower().Contains("город ") || UserParams.Mo.Value.ToLower().Contains("знаменск"))
            {
