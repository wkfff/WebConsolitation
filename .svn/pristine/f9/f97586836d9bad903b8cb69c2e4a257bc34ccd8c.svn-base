<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0011.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>
               &nbsp;<asp:HyperLink id="HyperLink1" runat="server" SkinID="HyperLink">Страница 1</asp:HyperLink> 
            </td>                        
            <td>
               &nbsp;<asp:HyperLink id="HyperLink2" runat="server" NavigateUrl="default1.aspx" SkinID="HyperLink">Страница 2</asp:HyperLink> 
            </td>       
        </tr>
     </table>        
            ...
            <tr>
                <td style="vertical-align: top">
                    ...
                    <asp:Label id="Label2" runat="server" Text="Label" CssClass="ElementTitle"></asp:Label><br />
                        <igchart:UltraChart id="C1" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C1_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Height="316px">
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel3" runat="server"
                        ...
                        <igchart:UltraChart id="C3" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C3_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel6" runat="server"
                        ...
                        <igchart:UltraChart id="C4" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C4_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
            ...
            <tr>
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel4" runat="server"
                        ...
                        <igchart:UltraChart id="C21" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C21_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" ChartType="DoughnutChart" Height="316px">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel5" runat="server"
                        ...
                        <igchart:UltraChart id="C22" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C22_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    ...
                    <igchart:ultrachart id="C23" runat="server" backgroundimagefilename=""  
                        ...
                        version="9.1" OnDataBinding="C23_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    ...
                    <igchart:ultrachart id="C24" runat="server" backgroundimagefilename=""  
                         emptycharttext="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                        version="9.1" OnDataBinding="C24_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
