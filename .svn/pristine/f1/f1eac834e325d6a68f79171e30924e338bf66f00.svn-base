...
namespace Krista.FM.Server.Dashboards.reports.STAT_0003_0007
{
    public partial class _default : CustomReportPage
    {
        ...
        protected void Grid_DataBinding(object sender, EventArgs e)
        {
            ...
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(DataProvider.GetQueryText("Grid"), "Период", dt);
        ...
        protected void Chart_DataBinding(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(DataProvider.GetQueryText("Chart"), "Диаграмма", dt);
            if (dt.Rows.Count < 1)
            {
