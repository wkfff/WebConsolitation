...
namespace Krista.FM.Server.Dashboards.reports.SKK.SKK_001
{
	public partial class Default : CustomReportPage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			PageTitle.Text = "Санитарно-карантинный контроль на выбранной территории";
			Page.Title = PageTitle.Text;
			PageSubTitle.Text = String.Format("Санитарно-карантинный контроль на территории \"<b>{0}</b>\" за <b>{1} {2} года</b> в сравнении с <b>{3} {4} года</b>, направление: <b>{5}</b>, вид международного сообщения: <b>{6}</b>",
			...
			selectedDetail.Value = checkDetailPP.CheckDetailPP_GetDetailTerra();
		...
		private void SetDataHelpers()
		{
			...
			gridUpDownHelper.SetData("skk_001_grid");
		}
