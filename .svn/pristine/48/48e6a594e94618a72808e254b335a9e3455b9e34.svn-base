    ...
    public partial class FK_0001_0003_Gadget : GadgetControlBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                ExecuteAvgLabel.Text = String.Format("Бюджетные расходы на душу населения, тыс.руб./чел.: ");
