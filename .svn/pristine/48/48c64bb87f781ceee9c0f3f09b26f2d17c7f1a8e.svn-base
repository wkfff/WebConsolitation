<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0035_0030.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0030" %>
        ...
        <table style="width: 765; height: 950; border-collapse: collapse; background-color: Black;
            ...
            <td valign="top" colspan="3">
                <table class="InformationText">
                    <tr>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" CssClass="InformationText" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lbFIO" runat="server" CssClass="InformationText" Font-Names="Arial"
                                            Style="margin-top: 10px;"></asp:Label><br />
                                        <!--<asp:Label ID="lbDirector" runat="server" CssClass="InformationText" Font-Names="Arial" Text="√убернатор ярославской области, руководитель правительства ярославской области"></asp:Label><br />-->
                                        <asp:Label ID="lbPhone" runat="server" Font-Names="Arial" CssClass="InformationText"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" CssClass="InformationText" Style="margin-top: 10px;"
                                            Font-Names="Arial" Text="E-mail:"></asp:Label>&nbsp;<asp:HyperLink ID="HyperLinkMail"
                                                runat="server" CssClass="TableFont">HyperLink</asp:HyperLink>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="lbDescription" CssClass="InformationText" Font-Names="Arial" runat="server"
                                Text=""></asp:Label>
                        </td>
                    </tr>
                </table>
