<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FO_0004_0002_Chart.ascx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.FO_0004_0002_Chart" %>
...
<table style="border-collapse: collapse; height: 100%">
    <tr>
        <td valign="bottom">
            ...
            <table style="margin-left: 50px; margin-top: -18px">
                <tr>
