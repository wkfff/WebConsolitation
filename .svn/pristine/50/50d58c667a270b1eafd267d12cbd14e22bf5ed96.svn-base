...
{
    public partial class FO_0435_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            query = DataProvider.GetQueryText("FO_0435_0015_population");
            ...
            query = DataProvider.GetQueryText("FO_0435_0015_incomes_date");
            ...
            query = DataProvider.GetQueryText("FO_0435_0015_outcomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            query = DataProvider.GetQueryText("FO_0435_0015_credit_debts");
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0435_0015_Incomes");
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0435_0015_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
        ...
        private void InitializeBkku()
        {
            ...
            munDebt.Text = String.Format("Всего&nbsp;<span style=\"color: white\"><b>{0:N2}</b></span>&nbsp;тыс.руб., в том числе<div style='padding-left: 20px'>{5}&nbsp;{8}&nbsp;<span style=\"color: white\"><b>{1:N2}</b></span>&nbsp;тыс.руб.<br/>{6}&nbsp;{9}&nbsp;<span style=\"color: white\"><b>{2:N2}</b></span>&nbsp;тыс.руб.<br/>{7}&nbsp;{10}&nbsp;<span style=\"color: white\"><b>{3:N2}</b></span>&nbsp;тыс.руб.</div>Обслуживание долга&nbsp;<span style=\"color: white\"><b>{4:N2}</b><span>&nbsp;тыс.руб.",
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0435_0015_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0435_0015_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0435_0015_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0435_0015_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        {
            DataTable dtDate = new DataTable();
            string query = DataProvider.GetQueryText("FO_0435_0015_incomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            DataTable dtIncomes = new DataTable();
             query = DataProvider.GetQueryText("FO_0435_0015_Incomes_settlement");
            ...
            query = DataProvider.GetQueryText("FO_0435_0015_Outcomes_settlement");
        ...
        private void InitializeSettlement()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0435_0015_settlements_count");
