<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.OMCY_0003.Grant_Novosib._default" %>
        ...
        <table>
            <tr>
                <td style="width: 100%">
                    ...
                    <asp:Label ID="Hederglobal" runat="server" CssClass="PageTitle"></asp:Label>
                    <br />
                    ...
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="Label5" runat="server" CssClass="ElementTitle"></asp:Label>
                                <br />
                                <br />
                            <asp:Label ID="Label6" runat="server" CssClass="PageSubTitle"></asp:Label>
                                <br />
                                <igtbl:UltraWebGrid
                                    ID="GGO" runat="server"
                            ...
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle"></asp:Label>
                                <br />
                                <br />
                            <asp:Label ID="Label7" runat="server" CssClass="PageSubTitle"></asp:Label>
                                <br />
                                <igtbl:UltraWebGrid
                                    ID="GMR" runat="server"
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue">
