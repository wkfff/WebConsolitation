<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0004_0003.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top" align="left">
                <uc3:CustomMultiCombo ID="ComboMOGroup" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top" align="left">
                <uc1:RefreshButton ID="RefreshButton1" runat="server" />
            </td>
            <td valign="top" align="left" style="font-family: Verdana; font-size: 12px;">
                <asp:CheckBox ID="withSettlementsCheckBox" runat="server" Width="200px" Text="с&nbsp;поселениями"
                    AutoPostBack="true" />
            </td>
        </tr>
    </table>
     <table style="width: 100%">
                    <tr>
                        <td align="center">
                            <asp:Label ID="Group1Label" runat="server" CssClass="PageDescription"></asp:Label>
                        </td>
                        <td align="center">
                            <asp:Label ID="Group2Label" runat="server" CssClass="PageDescription"></asp:Label>
                        </td>
                        <td align="center">
                            <asp:Label ID="Group3Label" runat="server" CssClass="PageDescription"></asp:Label>
                        </td>
                        <td align="center">
                            <asp:Label ID="Group4Label" runat="server" CssClass="PageDescription"></asp:Label>
                        </td>
                        <td align="right">
