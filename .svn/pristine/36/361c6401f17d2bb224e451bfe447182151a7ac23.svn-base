...
<styleLibrary>
  <annotation>
    <lastModified>2008-05-08T08:35:31</lastModified>
  </annotation>
  <styleSets defaultStyleSet="Default">
    <styleSet name="Default" buttonStyle="FlatBorderless" viewStyle="OfficeXp" useFlatMode="True">
      ...
      <styles>
        <style role="Base">
          <states>
            <state name="Normal" backColor="250, 250, 250" borderColor="Silver" fontName="" textVAlign="Middle" backGradientStyle="None" themedElementAlpha="Transparent" backHatchStyle="None" />
          </states>
        </style>
        <style role="Button">
          <states>
  ...
  <gridPropertys>
    ...
    <rows>
      <style>
        <colors backColorStart="White" backColorEnd="White" borderColor="Gray"/>
        <font sfont="Arial; 10pt"/>
        <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
      </style>
      <memPropNameStyle>
