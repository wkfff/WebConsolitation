<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.OMCY_0003.REGION_Sahalin._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" Font-Size="Small" 
                    NavigateUrl="~/reports/OMCY_0003/REGION_01_Sahalin/default.aspx">Оценка эффективности деятельности ОМСУ (по муниципальным образованиям)</asp:HyperLink>&nbsp;&nbsp;
                    </td>
            </tr>
        </table>
        <table>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top;">
                                ...
                                <asp:Label ID="Label6" runat="server" CssClass="ElementTitle" Font-Bold="True" Font-Italic="True"
                                    Font-Names="Arial" Font-Size="9pt" ForeColor="#404040">г.Ханты-Мансийск исключен из расчетов в сфере «Обеспечение здоровья» ввиду отсутствия в городе муниципальных учреждений здравоохранения (за исключением скорой медицинской помощи). Для оценки эффективности деятельности ОМСУ уровень эффективности берется как среднее значений других МО ХМАО-Югры.</asp:Label>
                                </td>
                            <td class="right">
                            </td>
                        </tr>
            ...
            <tr>
                <td colspan="2" style="vertical-align: top">
                    ...
                    <DeploymentScenario FilePath="../../../TemporaryImages" 
                                    ImageURL="../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                    ...
                    <Axis>
                        ...
                        <Y Extent="30" LineThickness="1" TickmarkInterval="50" TickmarkStyle="Smart" 
                            Visible="True">
                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                Visible="True" />
                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
