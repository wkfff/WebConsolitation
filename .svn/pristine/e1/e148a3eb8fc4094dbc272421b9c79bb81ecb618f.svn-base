<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0006_0002.Default" Title="Индикаторы БК и КУ " %>
        ...
        <tr>
            ...
            <td valign="top">
                <asp:RadioButtonList ID="RadioList" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                            Width="200px" Style="font-family: Verdana; font-size: 12px;" OnSelectedIndexChanged="RadioList_SelectedIndexChanged">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="headerReport" colspan="3">
                          <asp:Label ID="GridCaption" runat="server" CssClass="ElementTitle" Text=""></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" EnableAppStyling="True" Height="200px"
                                ...
                                OnInitializeRow="UltraWebGrid1_InitializeRow" StyleSetName="Office2007Blue" SkinID="UltraWebGrid"
                                Width="325px">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
