<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0035_0010.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top">
                <uc2:CustomCalendar ID="CustomCalendar" runat="server">
                </uc2:CustomCalendar>
            </td>
            <td valign="top">
    ...
    <table style="vertical-align: top; margin-top: -3px">
        ...
        <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
            ...
            <tr>
                ...
                <td style="overflow: visible;">
                    <uc9:PeriodStackAreaChartBrick ID="chartBrick1" runat="server"></uc9:PeriodStackAreaChartBrick>
                </td>
                <td class="right">
                </td>
            </tr>
        ...
        <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
            ...
            <tr>
                ...
                <td style="overflow: visible;">
                    <uc9:PeriodStackAreaChartBrick ID="chartBrick2" runat="server"></uc9:PeriodStackAreaChartBrick>
                </td>
                <td class="right">
                </td>
            </tr>
