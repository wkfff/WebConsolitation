<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.FO_0035_0009.Default" Title="Untitled Page" %>
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="middle" align="left" style="width: 100%">
                <asp:CheckBox ID="GRBSCheckBox" runat="server" Text="ÃÐÁÑ" AutoPostBack="true" Checked="true"
                    Style="font-family: Verdana; font-size: 10pt;" />
                &nbsp;<asp:CheckBox ID="KOSGUCheckBox" runat="server" Text="ÊÎÑÃÓ" AutoPostBack="true"
