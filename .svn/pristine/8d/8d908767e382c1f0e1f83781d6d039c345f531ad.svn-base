...
namespace Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._0260
{
    public partial class _default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            { }
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    Chart.DataBind();
                    Label2.Text = String.Format(RegionSettingsHelper.Instance.GetPropertyValue("chart1_title"), Pokaz.Value, "единица");
        ...
        protected void TopGrid_ActiveRowChange(object sender, RowEventArgs e)
        {
            ...
            Label2.Text = String.Format(RegionSettingsHelper.Instance.GetPropertyValue("chart1_title"), Pokaz.Value, _GetString_(e.Row.Cells[0].Text));
            Chart.DataBind();
      ...
      //  public bool eror = false;
        ...
        protected void Chart_DataBinding(object sender, EventArgs e)
        {
            ...
            DataTable dt = GetDSForChart("Chart");
...
min = double.Parse(dt.Rows[0].ItemArray[1].ToString());
            ...
            Chart.DataSource = dt;
            Chart.Axis.Y.RangeMax = max * 1.2;
            Chart.Axis.Y.RangeMin = min * 0.8;
