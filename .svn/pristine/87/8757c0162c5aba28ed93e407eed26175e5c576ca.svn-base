...
{
    public partial class FO_0006_0001_1 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            FO_0004_0002_Chart1.Caption = "План";
            FO_0004_0002_Chart3.Caption = "Факт";
            ...
            FO_0004_0002_Chart1.PercentFormat = "N1";
            FO_0004_0002_Chart1.CurrencyFormat = "N0";
            FO_0004_0002_Chart3.PercentFormat = "N1";
            FO_0004_0002_Chart3.CurrencyFormat = "N0";
            ...
            query = DataProvider.GetQueryText("FO_0006_0001_population");
            ...
            SetupGrid(UltraWebGrid, "FO_0006_0001_table_incomes");
            SetupGrid(UltraWebGrid1, "FO_0006_0001_table_outcomes");

            //UltraWebGrid1.DisplayLayout.Bands[0].HeaderLayout.Clear();

            DataTable dtText = new DataTable();
            query = DataProvider.GetQueryText("FO_0006_0001_text");
            ...
            Label1.Text =
                String.Format(
                    "Бюджетные доходы на душу населения&nbsp;<span class='DigitsValue'>{0:N0}</span>&nbsp;тыс.руб./чел", dtText.Rows[0]["Среднедушевые доходы конс бюджет"]);

            Label2.Text =
                String.Format(
                    "Бюджетные расходы на душу населения&nbsp;<span class='DigitsValue'>{0:N0}</span>&nbsp;тыс.руб./чел", dtText.Rows[0]["Среднедушевые расходы конс бюджет"]);
        }
