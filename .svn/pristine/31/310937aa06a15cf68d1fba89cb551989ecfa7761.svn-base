<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0014.Default" %>
           ...
           <asp:Label ID="chart1_caption" runat="server"  Text="заголовок" CssClass="ElementTitle"></asp:Label></td>
            ...
            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                ...
                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" FormatString="&lt;SERIES_LABEL&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
    <tr>        
        ...
        <td style="vertical-align: top;">
            <table id="Tabel1" style="width: 100%; border-collapse: collapse; background-color: white">
                <tr>
                    <td class="topleft">
                    </td>
                    <td class="top">
            ...
            <igGauge:UltraGauge ID="UltraGauge1" runat="server" BackColor="White" ForeColor="ControlLightLight"
                Height="350px" Width="396px" BorderColor="Transparent" BorderWidth="1px">
