...
{
    public partial class Oil_0008_0003 : CustomReportPage
    {
        ...
        private static string regionPeriodCurDate;
        private static string regionPeriodLastDate;
        private static string regionPeriodFirstYear;
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            detalizationIconDiv.InnerHtml = String.Format("<table><tr><td><a href='webcommand?showPinchReport=Oil_0008_0005_OIL={1}'>{0}</a></td>", multitouchIcon, HttpContext.Current.Session["CurrentOilID"]);
            detalizationIconDiv.InnerHtml += String.Format("<td><a href='webcommand?showPinchReport=Oil_0008_0004_OIL={1}'><img src='../../../images/lock.png'></a></td></tr></table>", multitouchIcon, HttpContext.Current.Session["CurrentOilID"]);

            string filename = HttpContext.Current.Server.MapPath("~/TemporaryImages/Oil_0008_0003/") + "TouchElementBounds.xml";
            Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/TemporaryImages/Oil_0008_0003/"));
            File.WriteAllText(filename, String.Format("<?xml version=\"1.0\" encoding=\"UTF-8\"?><touchElements><element id=\"Oil_0008_0005_OIL={0}\" bounds=\"x=0;y=700;width=768;height=100\" openMode=\"incomes\"/><element id=\"Oil_0008_0004_OIL={0}\" bounds=\"x=0;y=800;width=768;height=230\" openMode=\"outcomes\"/></touchElements>", HttpContext.Current.Session["CurrentOilID"]));

            IPadElementHeader4.Text = String.Format("Динамика розничных цен на {0} по ХМАО-Югре", CRHelper.ToLowerFirstSymbol(UserParams.Oil.Value));
        ...
        void UltraChart1_DataBinding(object sender, EventArgs e)
        {
            ...
            UserParams.PeriodCurrentDate.Value = regionPeriodCurDate;
            UserParams.PeriodLastDate.Value = regionPeriodLastDate;
            UserParams.PeriodFirstYear.Value = regionPeriodFirstYear;

            string query = DataProvider.GetQueryText(String.Format("Oil_0008_0003_chart1"));
        ...
        private void InitializeTable1()
        {
            ...
            string query = DataProvider.GetQueryText("Oil_0008_0003_incomes_regional_date");
            ...
            UserParams.PeriodCurrentDate.Value = regionPeriodCurDate = dtDate.Rows[2][1].ToString();
            UserParams.PeriodLastDate.Value = regionPeriodLastDate = dtDate.Rows[1][1].ToString();
            UserParams.PeriodFirstYear.Value = regionPeriodFirstYear = dtDate.Rows[0][1].ToString();

            shortPeriodFirstYearString = String.Format("{0:dd.MM.yy}", CRHelper.DateByPeriodMemberUName(UserParams.PeriodFirstYear.Value, 3));

            dt = new DataTable();
            query = DataProvider.GetQueryText("Oil_0008_0003_table1");
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, " ", dt);

            dt.Rows[0][0] = String.Format("<table style='border-collapse: collapse; margin-top: -3px; margin-bottom: -3px'><tr><td align='left' style='border: none; text-align:left'>Ханты-Мансийский автономный округ&ndash;Югра</td></tr><tr><td align='right' style='border: none'><span style='DigitsValue'>на {0:dd.MM.yyyy}</td></tr></table>", currentDateRegional);

            InitializeChart();

            dtDate = new DataTable();
            query = DataProvider.GetQueryText("Oil_0008_0003_incomes_federal_date");
            ...
            query = DataProvider.GetQueryText("Oil_0008_0003_table2");
        ...
        void UltraWebGrid1_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            headerCell.AddCell("к прошлому периоду");
            headerCell.AddCell("к концу прошлого года");
        ...
        private void InitializeChart()
        {
            ...
            string query = DataProvider.GetQueryText("Oil_0008_0003_chart");
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "Dummy", dtChart);
