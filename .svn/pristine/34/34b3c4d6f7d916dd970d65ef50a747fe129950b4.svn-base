<%@ Page Language="C#" MasterPageFile="~/Reports.Master"  AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.STAT_0003_0010._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 100%">
        ...
        <uc1:CustomMultiCombo ID="ComboDate" runat="server" />
            ...
            <td>
            <uc1:CustomMultiCombo ID="comboOperationType" runat="server" />
            </td>
