...
{
    public partial class Oil_0008_0002 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                UserParams.Mo.Value = String.Format(".[{0} муниципальный район].DataMember", UserParams.Mo.Value);
            }
            else
            {
            ...
            if (dtDate.Rows.Count < 3)
            {
                UserParams.Mo.Value = ".[Белоярский муниципальный район]";
                query = DataProvider.GetQueryText("Oil_0008_0002_incomes_date");
                DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, " ", dtDate);
            }
        ...
        private void InitializeTable1()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("Oil_0008_0002_table1");
        ...
        private void InitializeChart()
        {
            ...
            string query = DataProvider.GetQueryText("Oil_0008_0002_chart");
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "Территория", dtChart);
