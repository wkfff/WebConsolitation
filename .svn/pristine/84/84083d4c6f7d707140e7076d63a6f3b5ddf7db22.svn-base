<%@ Page Language="C#" Title="Оценка экономического развития" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="defaultMO.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.MO.MO_0002._0004.default2" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
               &nbsp;<asp:HyperLink id="HyperLink2" runat="server" NavigateUrl="default.aspx" SkinID="HyperLink" Visible="False">Городские округа</asp:HyperLink> 
            </td>                                    
        </tr>
     </table>
...
<asp:Label ID="chart1_caption" runat="server" BorderStyle="None" Font-Bold="True" Font-Names="Arial" Font-Size="Small" Text="заголовок таблицы"></asp:Label>
 ...
 <igchart:UltraChart
            ...
            Height="420px" OnDataBinding="Chart1_DataBinding" OnInvalidDataReceived="InvalidDataReceived"
            Transform3D-Perspective="20" Transform3D-Scale="80" Transform3D-XRotation="118"
       ...
       <br/>
        <div style="padding-left: 3px">
            ...
            Height="800px" ResourceKey="#MapControlResKey#MapControl1#" Width="1024px" ImageUrl="../../../../TemporaryImages/MapPic_#SEQ(300,3)" BorderLineWidth="1" BorderLineColor="Black">
            <NavigationPanel>
                <Location X="0" Y="0" />
