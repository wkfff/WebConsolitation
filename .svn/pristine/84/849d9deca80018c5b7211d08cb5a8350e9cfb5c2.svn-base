<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultDetail_budget.aspx.cs"
    Title="Группы субъектов по доле межбюджетных трансфертов" Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0005.DefaultDetail_budget" %>
