<%@ Control Language="C#" AutoEventWireup="true" Codebehind="IT_0002_0002_DetailGrid.ascx.cs" Inherits="Krista.FM.Server.Dashboards.iPhone.IT_0002_0002.reports.iPhone.IT_0002_0002.IT_0002_0002_DetailGrid" %>
