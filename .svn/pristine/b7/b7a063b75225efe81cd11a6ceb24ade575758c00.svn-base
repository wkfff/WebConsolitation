 ...
 */
namespace Krista.FM.Server.Dashboards.reports.BC_0001_0025
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            try
            {
                ...
                UltraChart3.Width = (int)((screen_width - 55) * 0.67);
        ...
        private void webGrid1ActiveRowChange(int index, bool active)
        {
            try
            {
                ...
                Label2.Text = String.Format(chart1_title_caption, row.Cells[0].Value.ToString());
                Label3.Text = String.Format(chart2_title_caption, row.Cells[0].Value.ToString());
            }
            catch (Exception)
            {
        ...
        private void webGrid2ActiveRowChange(int index, bool active)
        {
            try
            {
                ...
                Label1.Text = String.Format(chart3_title_caption, row.Cells[1].Value.ToString());
            }
            catch (Exception)
            {
                // выбор сторки пошел с ошибкой ...
