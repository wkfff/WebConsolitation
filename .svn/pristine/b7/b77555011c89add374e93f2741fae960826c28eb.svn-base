...
{
	public class F_F_MonthRepInFin : FactTable
	{
		public static readonly string Key = "2366942c-fbc9-43d8-9c23-6e8d4bf7fb84";
		...
		public virtual D_SIF_MonthRep RefSIF { get; set; }
