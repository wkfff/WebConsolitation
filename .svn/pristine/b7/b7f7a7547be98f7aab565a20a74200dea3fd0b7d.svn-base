...
{
    public partial class EO_0002_0001_Sakhalin : CustomReportPage
    {
        #region Поля
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            currentDate = CubeInfo.GetLastDate(DataProvidersFactory.PrimaryMASDataProvider, "FK_0004_0006_lastDate");
        ...
        private void BindInfoText()
        {
            ...
            string query = DataProvider.GetQueryText("EO_0002_0001_Sakhalin_info");
        ...
        {
            string query = DataProvider.GetQueryText("EO_0002_0001_Sakhalin_grid");
        ...
        protected string GetGaugeUrl(object oValue, string alt)
        {
            ...
            if (value > 100)
                value = 100;
            string path = "EO_0002_0001_Sakhalin_gauge_" + value.ToString("N0") + ".png";
