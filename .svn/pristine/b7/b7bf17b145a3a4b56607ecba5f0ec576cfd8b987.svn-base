<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0005.Default" Title="Untitled Page" %>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
         ...
         <tr>
            ...
            <td style="overflow: visible;">
            <asp:RadioButtonList ID="KindList" runat="server" AutoPostBack="True"  
                    RepeatDirection="horizontal" Width="900px">
                    <asp:ListItem Selected="True">Общий объем вкладов</asp:ListItem>
                    <asp:ListItem>Общий объем вкладов на душу населения</asp:ListItem>
                </asp:RadioButtonList>
