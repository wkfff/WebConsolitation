...
namespace Krista.FM.Server.Dashboards.reports.FO_0035_0013
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                DateTime lastCubeDate = CubeInfo.GetLastDate(DataProvidersFactory.PrimaryMASDataProvider, "FO_0035_0013_lastDate");
            ...
            Page.Title = "Информация по объектам дорожной инфраструктуры муниципальной собственности";
        ...
        {
            string query = DataProvider.GetQueryText("FO_0035_0013_grid");
        ...
        protected void Grid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            headerLayout.AddCell("Наименование направлений и объектов", "Объекты дорожной инфраструктуры");
