...
{
    public partial class FO_0635_0015 : CustomReportPage
    {
        private int worseRank = 33;
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            //lbDate.Text = String.Format("На&nbsp;<span style=\"color: white\"><b>1 {0} {1}</b></span>&nbsp;года", CRHelper.RusMonthGenitive(currentDate.Month), currentDate.Year);

            if (UserParams.Mo.Value == null ||
                UserParams.Mo.Value == String.Empty)
            {
                UserParams.Mo.Value = "Азовский МР";
            }

            UserParams.Filter.Value = RegionsNamingHelper.LocalBudgetUniqueNames[UserParams.Mo.Value];

            if (UserParams.Mo.Value.Contains("г.") ||
                UserParams.Mo.Value.Contains("р.п.") ||
                UserParams.Mo.Value.ToLower().Contains("город ") ||
                UserParams.Mo.Value.ToLower().Contains("знаменск"))
            {
                settlementHeader.Visible = false;
                UltraWebGridSettlements.Visible = false;
                settlementsDiv.Visible = false;
                lbIncomesRankFO.Text = "Ранг МО по %исп.&nbsp;";
                lbOutcomesRankFO.Text = "Ранг МО по %исп.&nbsp;";
                lbIncomesRankFOAverage.Text = "Ранг МО по дох. на душу населения&nbsp;";
                lbOutcomesRankFOAverage.Text = "Ранг МО по расх. на душу населения&nbsp;";
                worseRank = 28;
            }
            else
            {
            ...
            string query = DataProvider.GetQueryText("FO_0335_0015_population_date");
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_population");
            ...
            lbPopulation.Text = String.Format("Численность постоянного населения&nbsp;<span style=\"color: white\"><b>{0:N0}</b></span>&nbsp;чел.", population);
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_incomes_date");
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_outcomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_credit_debts");
        ...
        private void InitializePopulation()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0635_0015_population_allMO");
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0635_0015_Incomes");
            ...
            if (UserParams.Filter.Value != "[Районы].[Сопоставимый].[Все районы].[г.Омск]")
            {
               lbIncomesRankFOValue.Text = String.Format("{0:N0}{1}&nbsp;", dt.Rows[0]["Ранг процент"], img1);
            }
            else
            {
                lbIncomesRankFOValue.Text = "&nbsp;&nbsp;&nbsp;";
                lbIncomesRankFO.Text = "&nbsp;&nbsp;&nbsp;";
            }

           // lbIncomesRankFO.Style.Add("line-height", "40px");
            lbIncomesRankFOValue.Style.Add("line-height", "40px");
            
            DataTable dtIncomesAllMo = new DataTable();
            query = DataProvider.GetQueryText("FO_0635_0015_Incomes_allMO");
            ...
            img1 = String.Empty;
            if (calc.GetRank(Convert.ToDouble(dt.Rows[0]["Годовые назначения"]) / Convert.ToDouble(dt.Rows[0]["Численность постоянного населения"].ToString())) == 1)
            {
                img1 = string.Format("<img src=\"../../../images/starYellow.png\">");
            }
            else if (calc.GetRank(Convert.ToDouble(dt.Rows[0]["Годовые назначения"]) / Convert.ToDouble(dt.Rows[0]["Численность постоянного населения"].ToString())) == worseRank)
            {
                img1 = string.Format("<img src=\"../../../images/starGray.png\">");
            }
            ...
            if (UserParams.Filter.Value != "[Районы].[Сопоставимый].[Все районы].[г.Омск]")
            {
                lbIncomesRankFOAverageValue.Text = String.Format("{0:N0}{1}&nbsp;",
                                                                 calc.GetRank(
                                                                     Convert.ToDouble(dt.Rows[0]["Годовые назначения"])/
                                                                     Convert.ToDouble(
                                                                         dt.Rows[0]["Численность постоянного населения"]
                                                                             .ToString())), img1);
            }
            else
            {
                lbIncomesRankFOAverageValue.Visible= false;
                lbIncomesRankFOAverage.Visible = false;
            }
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0635_0015_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
            ...
            else
            {
                ...
                lbOutcomesRankFOValue.Text = "&nbsp;&nbsp;&nbsp;";
            }
            
           
            DataTable dtOutcomesAllMo = new DataTable();
            query = DataProvider.GetQueryText("FO_0635_0015_Outcomes_allMO");
            ...
            if (UserParams.Filter.Value != "[Районы].[Сопоставимый].[Все районы].[г.Омск]")
            {
                lbOutcomesRankFOAverageValue.Text = String.Format("{0:N0}{1}&nbsp;",
                                                                  calc.GetRank(
                                                                      Convert.ToDouble(dt.Rows[0]["Годовые назначения"])/
                                                                      Convert.ToDouble(
                                                                          dt.Rows[0]["Численность постоянного населения"
            ...
            {
                lbOutcomesRankFOAverage.Visible = false;
                lbOutcomesRankFOAverageValue.Visible = false;
            }
        ...
        private void InitializeBkku()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0635_0015_Inner_Debt");
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_Incomes_without_BP");
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_inner_fin_source");
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_Deficite");
            ...
            double moGroupValue;
            Double.TryParse(moGroup.Rows[0][1].ToString().Replace(",", "."), out moGroupValue);
        ...
        private void BindServeIndicator(double bpValue, double outcomesServeValue, double outcomesAllValue)
        {
            ...
            string serveDescription = outcomesServeValue == 0 ? String.Format("Расходы бюджета МО на обслуживание долга<br/>по плану на {0} год по состоянию на {1:dd.MM.yyyy} г. отсутствуют", year, date) : String.Format("Расходы бюджета МО на обслуживание долга<br/>по плану на {0} год по состоянию на {1:dd.MM.yyyy} г.&nbsp;<b>{2:N2}</b>&nbsp;тыс.руб.", year, date, outcomesServeValue / 1000);

            string debtOutcomesTooltip = String.Format("<b>Соблюдение ограничения расходов на обслуживание долга</b><br/>Приведены данные по собственному бюджету,<br/>без учета поселений.<br/>Расходы бюджета МО на обслуживание<br/>долга не должны превышать 15% от общей суммы<br/>расходов (без учета расходов за счет<br/>финансовой помощи от других бюджетов)<br/><br/>Значение индикатора:&nbsp;<b>{0:P2}</b><br/><b>{1}</b><br/>{2}<br/>Предельный размер расходов на обслуживание долга:&nbsp;<b>{3:N2}</b> тыс.руб.",
        ...
        private void BindDeficiteIndicator(double incomesWithoutBpValue, double restsChangeValue, double sellIncomesValue, double deficiteProficiteValue, double budjetCreditPlanValue, double moGroupValue)
        {
            ...
            double indicator = deficiteValue > 0 ? (deficiteValue - restsChangeValue - sellIncomesValue - budjetCreditPlanValue) / incomesWithoutBpValue : 0;
            ...
            double deficiteLimit = deficiteValue < 0 ? 0 : incomesWithoutBpValue * deficiteCoeff + restsChangeValue + sellIncomesValue + budjetCreditPlanValue;
            ...
            {
                deficiteDescription = String.Format("Бюджет на {0} год сбалансированный<br/>Предельный дефицит (с учетом изменения остатков<br/>и поступлений от продажи акций):&nbsp;<b>{0:N2}</b>&nbsp;тыс.руб.", deficiteLimit / 1000, year);
            }
            else if (deficiteProficiteValue > 0)
            {
                deficiteDescription = String.Format("Профицит бюджета МО<br/>по плану на {0} год:&nbsp;<b>{1:N2}</b>&nbsp;тыс.руб.<br/>Предельный дефицит (с учетом изменения остатков<br/>и поступлений от продажи акций):&nbsp;<b>{2:N2}</b>&nbsp;тыс.руб.", year, deficiteProficiteValue, deficiteLimit / 1000);
            }
            else
            {
                deficiteDescription =
                    String.Format(
                        "Дефицит бюджета МО<br/>по плану на {0} год:&nbsp;<b>{1:N2}</b>&nbsp;тыс.руб.<br/>предельный дефицит:&nbsp;<b>{2:N2}</b>&nbsp;тыс.руб.",
            ...
            string deficiteTooltip = String.Format("<b>Соблюдение ограничения дефицита бюджета</b><br/>Приведены данные по собственному бюджету,<br/>без учета поселений.<br/>Группа МО по доле МБТ&nbsp;<b>{3:N0}</b><br/>Дефицит бюджета МО (с учетом изменения остатков<br/>и поступлений от продажи акций)<br/>не может превышать 10% (для МО группы 3 по доле МБТ 5%)<br/>утвержденного годового объема доходов без учета<br/>безвозмездных поступлений и доходов,<br/>полученных по дополнительному нормативу от НДФЛ<br/><br/>Значение индикатора:&nbsp;<b>{0:P2}</b><br/><b>{1}</b><br/>{2}",
                                                      indicator, GetCrime(crime), deficiteDescription, moGroupValue);
        ...
        private void BindDebtIndicator(double innerDebtValue, double incomesWithoutBpValue, double budjetCreditValue, double moGroupValue)
        {
            ...
            string debtDescription = innerDebtValue == 0 ? "Муниципальный долг&nbsp;<b>отсутствует</b>" : String.Format("Объем долга МО {0}:&nbsp;<b>{1:N2}</b>&nbsp;тыс.руб.", String.Format("за {0} месяцев {1} года", month, year), innerDebtValue / 1000);

            string debtTooltip = String.Format("<b>Соблюдение ограничения на объем долга,<br/>установленного БК РФ</b><br/>Приведены данные по собственному бюджету,<br/>без учета поселений.<br/>Группа МО по доле МБТ&nbsp;<b>{4:N0}</b><br/>Объем долга МО не может превышать утвержденный<br/>годовой объем доходов без учета безвозмездных<br/>поступлений и доходов, утвержденных<br/>по дополнительному нормативу от НДФЛ<br/>(для МО 3 группы по доле МБТ не более 50% от доходов)<br/><br/>Значение индикатора:&nbsp;<b>{0:P2}</b><br/><b>{1}</b><br/>{2}<br/>Предельное значение<br/>объема долга МО:&nbsp;<b>{3:N2}</b>&nbsp;тыс.руб.",
            ...
            else
            {
                ...
                text1 = debtIndicator == 0 ? "нет" : String.Format("{0:P2}", debtIndicator);
            }
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0635_0015_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0635_0015_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0635_0015_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        {
            DataTable dtDate = new DataTable();
            string query = DataProvider.GetQueryText("FO_0635_0015_incomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_Incomes_settlement");
            ...
            query = DataProvider.GetQueryText("FO_0635_0015_Outcomes_settlement");
        ...
        private void InitializeSettlement()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0635_0015_settlements_count");
