<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.ORG_0001_0001.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <igmisc:WebAsyncRefreshPanel ID="PanelChart1Caption" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="ZPrice" runat="server" Text="Закупочная цена" AutoPostBack="true"
                    Checked="true" Style="font-family: Verdana; font-size: 10pt;" />
                <asp:CheckBox ID="RPrice" runat="server" Text="Розничная цена" AutoPostBack="true"
    ...
    <igmisc:WebAsyncRefreshPanel ID="PanelChart2" runat="server">
        <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
            <tr>
                <td class="topleft">
                </td>
