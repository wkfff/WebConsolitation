<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0020.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0020" %>
                ...
                <table style="border-right: 0px solid; border-top: 0px solid; left: 0px; border-left: 0px solid;
                    ...
                    <tr>
                        <td style="padding-left: 5px; padding-top: 10px;" valign="top">
                            <asp:Label ID="Label6" runat="server" Text="Доходы - всего и ИФДБ" CssClass="InformationText"></asp:Label>&nbsp;
                    ...
                    <tr>
                        <td colspan="2" valign="top" style="padding-left: 5px; padding-top: 0px;">
                            <asp:Label ID="Label7" runat="server" CssClass="InformationText" Text="график на месяц"></asp:Label>&nbsp;
                            <asp:Label ID="lbPlanIncomes" runat="server" CssClass="DigitsValueLarge"></asp:Label><br/>
                            <asp:Label ID="Label9" runat="server" CssClass="InformationText" Text="исполнено с начала месяца"></asp:Label>&nbsp;
                    ...
                    <tr>
                        <td valign="top" style="padding-left: 5px; padding-top: 6px;">
                            ...
                            <asp:Label ID="lbExecutedOutcomes" runat="server" Text="Label" CssClass="DigitsValueLarge"></asp:Label></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding-left: 5px; padding-top: 0px;" valign="top">
                            <asp:Label ID="Label5" runat="server" CssClass="InformationText" Text="график на месяц"></asp:Label>&nbsp;
                            <asp:Label ID="lbPlanOutcomes" runat="server" CssClass="DigitsValueLarge"></asp:Label><br/>
                            <asp:Label ID="Label10" runat="server" CssClass="InformationText" Text="исполнение графика"></asp:Label>&nbsp;
                    ...
                    <tr>
                        <td valign="top" style="padding-left: 5px; padding-top: 6px;" colspan="2">
                            <asp:Label ID="Label1" runat="server" CssClass="InformationText" Text="Отклонение доходов от расходов"></asp:Label>
                            <br />
                            <asp:Label ID="Label11" runat="server" CssClass="InformationText" Text="график на месяц&nbsp;"></asp:Label>
                            <asp:Label ID="lbRestStartPlan" runat="server" CssClass="DigitsValueLarge"></asp:Label><br/>
                            <asp:Label ID="Label13" runat="server" CssClass="InformationText" Text="исполнение графика&nbsp;"></asp:Label>
