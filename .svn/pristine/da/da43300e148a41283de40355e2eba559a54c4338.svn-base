<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0003_0002.Default" Title="Индикаторы БК и КУ " %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboOKV" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
    ...
    <table style="vertical-align: top;">
        ...
        <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel" runat="server">                          
                <table runat="server" id="ChartTable" style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                        </td>
                        <td class="top">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption" runat="server" CssClass="ElementTitle" Text="Поступление по налогу"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
