...
{
    public partial class Oil_0010_0002 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            OilHeader1.Text = String.Format("Цены на {0} по данным Росстата", CustomParam.CustomParamFactory("oil_federal").Value.ToLowerFirstSymbol());
            OilHeader2.Text = String.Format("Цены на {0} по сплошному методу учета", UserParams.Oil.Value.Replace("Бензин ", "Бензин автомобильный ").ToLowerFirstSymbol());
        ...
        {
            string query;
            if (UserParams.Oil.Value.Contains("АИ-98"))
            {
                OilHeader1.Visible = false;
                UltraWebGrid1.Visible = false;
            }
            else
            {
                UltraWebGrid1.Visible = true;
                OilHeader1.Visible = true;
                ...
                query = DataProvider.GetQueryText("Oil_0010_0002_incomes_federal_date");
                ...
                query = DataProvider.GetQueryText("Oil_0010_0002_table2");
            ...
            query = DataProvider.GetQueryText("Oil_0010_0002_incomes_regional_date");
            ...
            dt = new DataTable();
            query = DataProvider.GetQueryText("Oil_0010_0002_table1");
