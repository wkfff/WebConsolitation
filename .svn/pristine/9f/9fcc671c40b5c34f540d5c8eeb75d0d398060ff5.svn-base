<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oil_0006_0004_03.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Oil_0006_0004_03" %>
...
<body link="White" vlink="White" style="background-color: black;">
    ...
    <div style="position: absolute; width: 768px; top: 0px; left: 0px; overflow: hidden;
        ...
        <table style="width: 765; height: 950; border-collapse: collapse; background-color: Black;
			...
			<tr>
			    <uc3:iPadElementHeader ID="IPadElementHeader1" runat="server" Text=""
                    Width="761px" />
			</tr>
            <tr>
                <td align="left">
