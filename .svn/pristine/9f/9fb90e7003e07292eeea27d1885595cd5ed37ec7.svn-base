<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0042_0001_HMAO.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            ...
            <td valign="top" style="font-family: Verdana; font-size: 12px;">
                <asp:RadioButtonList ID="MeasureButtonList" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                    Width="220px">
                    <asp:ListItem Selected="True">Оценка</asp:ListItem>
                    <asp:ListItem>Значение</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            <td align="right" rowspan="2" style="width: 100%;">
    ...
    <table style="vertical-align: top;">
       ...
       <tr>
         <td>
            <asp:Label ID="lbComment" runat="server" Text="* - показатель не рассчитывается и не оценивается, вес показателя в группе (группы в итоговой оценке) распределяется пропорционально по другим показателям (группам показателей)." CssClass="InformationText"></asp:Label>
         </td>
       <tr/>
    </table>
</asp:Content>
