...
namespace Krista.FM.Server.Dashboards.reports.BC_0001_0011
{
    public partial class Default1 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    Lastdate.Value = ELV(getLastDate("СОДЕРЖАНИЕ И ИСПОЛЬЗОВАНИЕ ЖИЛИЩНОГО ФОНДА И НЕЖИЛЫХ ПОМЕЩЕНИЙ"));
                ...
                Label9.Text = "Содержание и использование жилищного фонда";
        ...
        protected void GT0_DataBinding(object sender, EventArgs e)
        {
            ...
            Label1.Text = "Показатели жилищного фонда (в разрезе типа жилых строений)";
        }
        ...
        protected void GB_DataBinding(object sender, EventArgs e)
        {
            ...
            Label6.Text = "Общая площадь жилых помещений и количество комнат в общежитиях";
        }
        ...
        protected void CC_DataBinding(object sender, EventArgs e)
        {
            ...
            Label11.Text = "Структурная динамика показателя"; 
        ...
        {
            param.Value = "Общая площадь жилых помещений (по формам собственности)";
        ...
        {
            param.Value = "Количество комнат в общежитиях города";
