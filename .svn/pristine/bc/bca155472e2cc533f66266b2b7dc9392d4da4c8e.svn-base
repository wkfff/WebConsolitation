<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0003_0001.Default" Title="Индикаторы БК и КУ " %>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="gridTd" valign="top">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px"
                                OnDataBinding="UltraWebGrid_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout" OnActiveRowChange="UltraWebGrid_ActiveRowChange"
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="ChartCaption" runat="server" CssClass="ElementTitle" Text= "Динамика поступлений собственных доходов"></asp:Label>
                            <igmisc:WebAsyncRefreshPanel runat="server" ID="chartWebAsyncPanel" TriggerControlIDs="UltraWebGrid">
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text= "Сравнение темпа роста поступлений собственных доходов в каждом финансовом году, %"></asp:Label>
                            <td valign="top">
                <asp:RadioButtonList ID="periodList" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                    Width="300px" style="font-family:Verdana;font-size:12px;">
                    <asp:ListItem Selected="True">Нарастающим итогом</asp:ListItem>
                    <asp:ListItem>За месяц</asp:ListItem>
                </asp:RadioButtonList>
            </td>  
