...
namespace Krista.FM.Server.Dashboards.reports.FO_0045_0003_Yaroslavl
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink2.NavigateUrl = "~/reports/FO_0045_0002_Yaroslavl/Default.aspx";
        }
...
//            AddMapLayer(DundasMap, mapFolderName, "Выноски", CRHelper.MapShapeType.CalloutTowns);
        ...
        private void PdfExportButton_Click(object sender, EventArgs e)
        {
            ...
            string caption = string.Format("{0} {1}", mapCaption.Text, PageSubTitle.Text);
            DundasMap.NavigationPanel.Visible = false;
            DundasMap.ZoomPanel.Visible = false;
            ...
            ReportPDFExporter1.Export(DundasMap,caption,section2);
        }
