...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
    public partial class FO_0032_0001 : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            dtSource.Rows[3][0] = String.Format("План на {0} год", dtDate.Rows[0][0]);
            dtSource.Rows[4][0] = String.Format("Всего за {0} год", dtDate.Rows[0][0]);
            dtSource.Rows[5][0] = String.Format("Исполнено за {0} год", dtDate.Rows[0][0]);
