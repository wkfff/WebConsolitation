<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0045_0003.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <td valign="top" colspan="1" style="width: 100%;">
                <uc4:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="Default.html"
                    Visible="true" />
                &nbsp;&nbsp;
                <asp:Label ID="PageTitle" runat="server" Text="Label" CssClass="PageTitle"></asp:Label>&nbsp;&nbsp;<asp:Label ID="PageSubTitle" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label><br/><asp:Label ID="CommentTitle" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label>
            </td>
    ...
    <table style="vertical-align: top;"> 
        <tr>
            ...
            <td id="radioButtonListTD" runat="server" valign=""top" align="left" style="font-family:Verdana; font-size:12px;">
                <asp:RadioButtonList ID="MeasureButtonList" runat="server" AutoPostBack="True" RepeatDirection="horizontal"
                    Width="130px" Font="Verdana">
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td class="headerReport">
                <asp:Label ID="mapCaption" runat="server" CssClass="ElementTitle"></asp:Label>
            </td>
            ...
            <tr>
                ...
                <td style="overflow: visible;">
                            <DMWC:MapControl ID="DundasMap" runat="server" BackColor="White" ResourceKey="#MapControlResKey#MapControl1#"
                                ImageUrl="../../TemporaryImages/map_fo_45_01_#SEQ(300,3)" RenderingImageUrl="../../TemporaryImages/">
                                <NavigationPanel>
