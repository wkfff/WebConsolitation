...
namespace Krista.FM.Server.Dashboards.reports.SKK.SKK_003
{
	public partial class Default : CustomReportPage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			PageTitle.Text = "Санитарно-карантинный контроль на выбранном участке Государственной границы РФ. Анализ по видам международного сообщения";
			Page.Title = PageTitle.Text;
			PageSubTitle.Text = String.Format("Санитарно-карантинный контроль на участке Государственной границы РФ \"<b>{0}</b>\" за <b>{1} {2} года</b> в сравнении с <b>{3} {4} года</b>, направление: <b>{5}</b>",
			...
			selectedDetail.Value = checkDetailPP.CheckDetailPP_GetDetailTransport();
		...
		private void SetDataHelpers()
		{
			...
			gridUpDownHelper.SetData("skk_003_grid");
		}
