...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0056_03
{
    public partial class Default : CustomReportPage
    {
        ...
        // имя региона по логину
        private CustomParam regionName;

        private CustomParam comboRegionValue;
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            comboRegionValue = UserParams.CustomParam("combo_region_value");
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            conditionDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FO_0002_0056_03_conditionDigest");

            if (!Page.IsPostBack)
            {
                comboRegionValue.Value = "г.Нефтеюганск";
                ...
                ComboCondition.SetСheckedState("На редактировании", true);
            }

            ComboRegion.Visible = false;
            regionName.Value = GetRegionName();
            ComboRegion.ClearNodes();
            ComboRegion.Title = "МО";
            ComboRegion.Width = 300;
            ComboRegion.MultiSelect = false;
            regionDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FO_0002_0056_03_regionDigest");
            ...
            ComboRegion.SetСheckedState(comboRegionValue.Value, true);
           
            comboRegionValue.Value = ComboRegion.SelectedValue;
        ...
        {
            string regionName = HttpContext.Current.Session[CustomReportConst.currentUserDescriptionKeyName].ToString();
            return RegionsNamingHelper.LocalBudgetUniqueNames.ContainsKey(regionName) || regionName == "Неуказанный территориальный признак" ? regionName : " ";
        }
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_03_population");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_03_mainGrid");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_03_creditGrid");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_03_referenceGrid");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0056_03_nonEmptyQuery");
