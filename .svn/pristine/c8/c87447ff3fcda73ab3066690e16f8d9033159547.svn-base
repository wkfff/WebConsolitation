<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0014_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0010" %>
...
<body style="background-color: black;">
    <form id="form1" runat="server">
        <div style="position: absolute; width: 1022px; height: 702px; top: 0px; left: 0px; overflow: hidden;
            ...
            <table style="border-collapse: collapse; background-color: Black; width: 1000px; height: 100%;">
            <tr>
            ...
            <tr>
                ...
                <td style="font-size: 18px; font-family: Verdana; color: White; background-image: url(../../../images/iPadContainer/containerheader.gif);
                    ...
                    <asp:Label ID="Label16" runat="server" CssClass="ElementTitle" Text="Кассовые выплаты"></asp:Label>
                </td>
