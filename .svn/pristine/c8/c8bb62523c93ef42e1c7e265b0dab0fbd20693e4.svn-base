...
namespace Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._011
{
    public partial class Default1 : CustomReportPage
    {
        ...
        private void conf_Chart(int sizePercent, Infragistics.WebUI.UltraWebChart.UltraChart chart, bool leg, Infragistics.UltraChart.Shared.Styles.ChartType typ)
        {
            ...
            chart.Tooltips.Font.Size = FontUnit.Medium;
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    GList.Width = (int)((screen_width - 50) * 0.33);
            ...
            finally
            {
                ...
                Pokaz.Value = GT0.Columns[GT0.Columns.Count-1].Header.Key;
                CT1.DataBind();
                CT2.DataBind();
                CT3.DataBind();
                ...
                GList.Rows[0].Activate();
                GList.Rows[0].Activated = 1 == 1;
                GList.Rows[0].Selected = 1 == 1;

                GB.Rows[GB.Rows.Count - 1].Selected = 1 == 1;
                GB.Rows[GB.Rows.Count - 1].Activated = 1 == 1;
                GB.Rows[GB.Rows.Count - 1].Activate();

                GList.DisplayLayout.RowSelectorsDefault = RowSelectors.No;
                GList.Rows.Add();
                GList.Rows[GList.Rows.Count - 1].Cells[0].Text = RegionSettingsHelper.Instance.GetPropertyValue("GList_mark_6");
                    //Page.Title = 
                    //new UltraGridRow(RegionSettingsHelper.Instance.GetPropertyValue("GList_mark_6")));
                Page.Title = Label9.Text;
                    }
        ...
        protected void CT1_DataBinding(object sender, EventArgs e)
        {
            ...
            Label2.Text = string.Format("Структура использования жилых зданий на {0} год, %", Pokaz.Value);
        ...
        protected void CT2_DataBinding(object sender, EventArgs e)
        {
            ...
            Label3.Text = string.Format("Распределение количества проживающих в жилых зданиях на {0} год, %",Pokaz.Value);
        ...
        protected void CT3_DataBinding(object sender, EventArgs e)
        {
            ...
            Label4.Text = String.Format("Структура общей площади жилых помещений на {0} год, %",Pokaz.Value);
        ...
        protected void CC_DataBinding(object sender, EventArgs e)
        {
            ...
            Label5.Text =RegionSettingsHelper.Instance.GetPropertyValue("chart4_title1")+" "+'"' + Pokaz.Value + '"' + ", " + ed.ToLower();
            //Label5.Text = RegionSettingsHelper.Instance.GetPropertyValue("chart4_title1"); 
        ...
        protected void CB1_DataBinding(object sender, EventArgs e)
        {
           ...
           Label7.Text = string.Format("Распределение общей площади жилых помещений по формам собственности на {0} год, %", Pokaz.Value);
        ...
        protected void CB2_DataBinding(object sender, EventArgs e)
        {
            ...
            Label8.Text = String.Format("Распределение количества комнат в общежитиях города по формам собственности на ({0}) год, %", Pokaz.Value);
        ...
        protected void GT0_Click(object sender, ClickEventArgs e)
        {
            ...
            GT0.Columns[CellIndex].Selected = 1 == 1;
            CT1.DataBind();
            CT2.DataBind();
            CT3.DataBind();
        }
        ...
        protected void GB_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (BN == "IE")
            {
                e.Layout.Bands[0].Columns[0].Width = (int)((GW * coef) * 0.13);
                e.Layout.Bands[0].Columns[1].Width = (int)((GW * coef) * 0.43);
                e.Layout.Bands[0].Columns[2].Width = (int)((GW * coef) * 0.43);
            }
            if (BN == "FIREFOX")
            {
                e.Layout.Bands[0].Columns[0].Width = (int)((GW * coef) * 0.13);
            ...
            if (BN == "APPLEMAC-SAFARI")
            {
                e.Layout.Bands[0].Columns[0].Width = (int)((GW * coef) * 0.15);
                e.Layout.Bands[0].Columns[1].Width = (int)((GW * coef) * 0.45);
                e.Layout.Bands[0].Columns[2].Width = (int)((GW * coef) * 0.45);
            }
        ...
        protected void GList_DataBinding(object sender, EventArgs e)
        {
           ...
           GList.Rows.Add();
                ...
                //    try
                //    {
                //        // val = { RegionSettingsHelper.Instance.GetPropertyValue("GList_mark_" + i.ToString()) };
                //        Row1 = new UltraGridRow(val);
                //        Row1.Cells[0].Text = val[0].ToString();
                //        GList.Rows.Add(Row1);
                //    }
                //    catch { }
                ...
                //val[0] = RegionSettingsHelper.Instance.GetPropertyValue("GList_mark_6");
                //UltraGridRow Row7 = new UltraGridRow();
                //Row7.Cells[0].Text = val[0].ToString();
                //GList.Rows.Add(Row7);
                //Ultraweb

                //GList.Bands[0].Columns[0].Width = 500;
                //GList.Columns[0].Width = 300;          
        ...
        {
            Pokaz.Value = e.Row.Cells[0].Text.Split(',')[0];
        ...
        protected void CT1_ChartDataClicked(object sender, Infragistics.UltraChart.Shared.Events.ChartDataEventArgs e)
        {

        }
        int addY = 0;
        protected void CT1_ChartDrawItem(object sender, Infragistics.UltraChart.Shared.Events.ChartDrawItemEventArgs e)
        {
            {
                addY = 0;
                UltraChart C = CT1;
                ...
                if ((text != null) && !(string.IsNullOrEmpty(text.Path)) && text.Path.EndsWith("Legend"))
                {
                    ...
                    widthLegendLabel -= C.Legend.Margins.Left + C.Legend.Margins.Right;
        ...
        protected void CT2_ChartDrawItem(object sender, Infragistics.UltraChart.Shared.Events.ChartDrawItemEventArgs e)
        {
            {
                addY = 0;
                UltraChart C = CT2;
        ...
        protected void CT3_ChartDrawItem(object sender, Infragistics.UltraChart.Shared.Events.ChartDrawItemEventArgs e)
        {
            {
                addY = 0;
                UltraChart C = CT3;
        ...
        protected void GList_InitializeRow(object sender, RowEventArgs e)
        {
            //Pokaz.Value = e.Row.Cells[0].Text;
            //if (e.Row.Index == 5) { CC.Transform3D.Scale = 40; } else { CC.Transform3D.Scale = 60; }
            //if ((e.Row.Index == 2) || (e.Row.Index == 0) || (e.Row.Index == 4)) { ed = "Единица"; } else { ed = "Тысяча квадратных метров"; }
            //e.Row.Cells[0].Value = e.Row.Cells[0].Value.ToString() + ", " + ed;
            //CC.DataBind();

        }

        protected void GT0_DataBound(object sender, EventArgs e)
        {
