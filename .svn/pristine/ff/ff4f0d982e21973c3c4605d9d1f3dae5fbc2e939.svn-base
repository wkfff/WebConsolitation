...
{
    public partial class FST_0001_0032_Horizontal : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText("FST_0001_0032_Horizontal_Grid");
            ...
            query = DataProvider.GetQueryText("FST_0001_0031_Grid");
            ...
            for (int i = 1; i < dtGrid1.Rows.Count; i++)
            {
                ...
                {
                    double taxValue;
                    if (dtGrid1.Rows[i]["Среднеотпускной тариф на водоснабжение"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Среднеотпускной тариф на водоснабжение"].ToString(), out taxValue) &&
                        taxValue != 0)
                    {
                        notZeroCountRF++;
                        foAvgRF += taxValue;
                    ...
                    double taxDemosValue;
                    if (dtGrid1.Rows[i]["Тариф на водоснабжение для населения"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Тариф на водоснабжение для населения"].ToString(), out taxDemosValue) &&
                        taxDemosValue != 0)
                    {
                        notZeroDemosCountRF++;
                    ...
                    double taxBujetValue;
                    if (dtGrid1.Rows[i]["Тариф на водоснабжение для бюджетных потребителей"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Тариф на водоснабжение для бюджетных потребителей"].ToString(), out taxBujetValue) &&
                        taxBujetValue != 0)
                    {
                        notZeroBujetCountRF++;
                    ...
                    double taxOthersValue;
                    if (dtGrid1.Rows[i]["Тариф на водоснабжение для прочих потребителей"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Тариф на водоснабжение для прочих потребителей"].ToString(), out taxOthersValue) &&
                        taxOthersValue != 0)
                    {
                    ...
                    double grownValue;
                    if (dtGrid1.Rows[i]["Рост тарифа на водоснабжение"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Рост тарифа на водоснабжение"].ToString(), out grownValue) &&
                        grownValue != -0)
                    {
                        notZeroGrownCountRF++;
                    ...
                    double grownDemosValue;
                    if (dtGrid1.Rows[i]["Рост тарифа на водоснабжение для населения"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Рост тарифа на водоснабжение для населения"].ToString(), out grownDemosValue) &&
                        grownDemosValue != -0)
                    {
                    ...
                    double grownBujetValue;
                    if (dtGrid1.Rows[i]["Рост тарифа на водоснабжение для бюджетных потребителей"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Рост тарифа на водоснабжение для бюджетных потребителей"].ToString(), out grownBujetValue) &&
                        grownBujetValue != -0)
                    {
                    ...
                    double grownOthersValue;
                    if (dtGrid1.Rows[i]["Рост тарифа на водоснабжение для прочих потребителей"] != DBNull.Value &&
                        Double.TryParse(dtGrid1.Rows[i]["Рост тарифа на водоснабжение для прочих потребителей"].ToString(), out grownOthersValue) &&
                        grownOthersValue != -0)
                    {
            ...
            UltraChartFST_0001_0001_Chart3.RfMiddleLevel = notZeroGrownBujetCountRF == 0 ? 0 : (foGrownBujetAvgRF / notZeroGrownBujetCountRF) - 1;
            ...
            UltraChartFST_0001_0001_Chart4.RfMiddleLevel = notZeroGrownOthersCountRF == 0 ? 0 : (foGrownOthersAvgRF / notZeroGrownOthersCountRF) - 1;
