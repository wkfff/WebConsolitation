<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0023.Default" Title="Untitled Page" %>
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top" style="font-family: Verdana; font-size: 12px;">
                <asp:CheckBox ID="UseConsodiataLevelCheckBox" runat="server" Text="Консолидированный&nbsp;бюджет&nbsp;МО" AutoPostBack="true" Width="300px"  />
            </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FO_02_23#SEQNUM(100).png" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
                        </td>
