...
{
    public partial class FO_0035_0009 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Label3.Visible && !Label4.Visible && !Label5.Visible && !Label6.Visible && !Label7.Visible)
            {
                Label1.Text = String.Format("<span style=\"color: White\"><b>{0:dd.MM.yyyy}г.</b></span>&nbsp;поступлений не было.", date);
            }
