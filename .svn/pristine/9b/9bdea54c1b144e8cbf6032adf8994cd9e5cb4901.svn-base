...
{
    public partial class FK_0001_0003_wm2 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string pointStr = (UserParams.ShortStateArea.Value == "АгинБурАО") ? string.Empty : ".";
            LabelTitle.Text = string.Format("Расходы {0} за {1} {2} {3}г{4}",
            ...
            for (int i = 0; i < dt.Columns.Count; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 8:
                        {
                            k = 0.001;
                            caption = "<div style=\"line-height:15px;\">Коэффициент бюджетной обеспеченности,<br />тыс.руб./чел.</div>";
                            break;
                        }
                    case 13:
                        {
        ...
        {
            int fontSize = 9;//CRHelper.fontFK0003O;
            ...
            for (int i = 0; i < dtGrid.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    CRHelper.AddDataCellR(row, cellText, fontSize, mainColumnColor);
                    ...
                    if (i == 0 || i == 7 || i == 4) CRHelper.SetCellHBorder(row, true);
                }
