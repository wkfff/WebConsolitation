...
{
    public partial class Oil_0007_0004 : CustomReportPage
    {   
        ...
        private void InitializeTable1()
        {
            ...
            if (HttpContext.Current.Session["CurrentOilID"].ToString() != "5")
            {
                ...
                query = DataProvider.GetQueryText("Oil_0007_0004_incomes_federal_date");
                ...
                query = DataProvider.GetQueryText("Oil_0007_0004_table2");
            ...
            query = DataProvider.GetQueryText("Oil_0007_0004_incomes_regional_date");
            ...
            dt = new DataTable();
            query = DataProvider.GetQueryText("Oil_0007_0004_table1");
        ...
        void UltraWebGrid1_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            {
                if (!e.Row.Cells[0].Value.ToString().ToLower().Contains("федера") && !e.Row.Cells[0].Value.ToString().ToLower().Contains("янао"))
                {
