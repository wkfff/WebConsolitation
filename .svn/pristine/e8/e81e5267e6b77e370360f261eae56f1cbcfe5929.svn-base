<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0005.Default" Title="Фактические затраты на денежное содержание лиц, замещающих должности государственной гражданской службы в государственных органах." %>
                    ...
                    <tr>
                        ...
                        <td>
                          <asp:RadioButtonList ID="DebtKindButtonList" runat="server" AutoPostBack="True"
                              ...
                              <asp:ListItem Selected="True">Форма_14</asp:ListItem> 
                              <asp:ListItem>Форма_14 МО</asp:ListItem>
                           </asp:RadioButtonList>
                        </td>
