...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0034_01
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                hiddenIndicatorLabel.Text = "Расходы в сфере реального сектора экономики ";
            ...
            administratorDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FO_0002_0034_01_administratorDigest");
            ...
            Page.Title = "Удельный вес расходов областного бюджета в сфере реального сектора экономики";
        ...
        private DateTime GetLastYearDay()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0034_01_date");
        ...
        private void GenerateQuery(int yearNum)
        {
            DescendantsGenerator descendantsGenerator = new DescendantsGenerator("[Расходы__АС Бюджет].[Расходы__АС Бюджет]",
               String.Format("ФО\\0001 АС Бюджет - УФиНП {0}", yearNum), "Расходы уровень 8", "SELF_AND_BEFORE");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0034_01_grid_plan");
            ...
            {
                query = DataProvider.GetQueryText("FO_0002_0034_01_grid_fact");
        ...
        private void ActivateGridRow(UltraGridRow row)
        {
            ...
            bool isTotalRow = indicatorName.ToLower().Contains("расходы в сфере реального сектора экономики");
            ...
            chartCaption.Text = String.Format("{0}, удельный вес в общем объеме расходов областного бюджета", isTotalRow ? "Реальный сектор экономики" : indicatorName.TrimEnd('_').TrimEnd(' '));
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0034_01_chart_plan");
            ...
            query = DataProvider.GetQueryText("FO_0002_0034_01_chart_fact");
