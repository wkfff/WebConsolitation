<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0053.Default" Title="Untitled Page" %>
                ...
                <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel" runat="server">
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;">
                                <uc10:PeriodStackAreaChartBrick ID="DynamicChartBrick" runat="server">
                                </uc10:PeriodStackAreaChartBrick>
                            </td>
                            <td class="right">
                            </td>
                        </tr>
