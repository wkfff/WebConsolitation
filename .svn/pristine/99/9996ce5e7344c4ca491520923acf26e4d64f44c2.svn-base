<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FST_0001_0022.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FST_0001_0022" %>
...
<body style="background-color: Black">
    ...
    <div style="position: absolute; width: 768px; height: 950px; top: 0px; left: 0px;
        ...
        <table style="background-color: Black; top: 0px; left: 0px; overflow: hidden">
            <tr>
                <td>
                <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Теплоснабжение (среднеотпускной тариф)"
                        Width="100%" />
            ...
            <tr>
                <td>
                <uc1:iPadElementHeader ID="IPadElementHeader3" runat="server" Text="Теплоснабжение (тариф для населения)"
                        Width="100%" />
        ...
        <table style="background-color: Black; top: 0px; left: 0px; overflow: hidden">
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Теплоснабжение"
                        Width="100%" />
