<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0002_0007_HMAO_v.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0002_0007_HMAO_v" %>
...
<body>
    ...
    <div>
        ...
        <tr><td align="left" valign="top" style="left: 0px; width: 110px; position: static; top: 45px; border-collapse: collapse; height: 150px; background-color: black; padding-left: 4px;">
            <asp:Label ID="Label3" runat="server" Text="Label" SkinID="InformationText"></asp:Label><br />
            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="223px" Width="312px" OnDataBinding="UltraWebGrid_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout" OnInitializeRow="UltraWebGrid_InitializeRow" SkinID="UltraWebGrid"><Bands>
<igtbl:UltraGridBand>
...
<FrameStyle BorderWidth="1px" BorderColor="InactiveCaption" BorderStyle="Solid" Font-Size="8.25pt" Font-Names="Microsoft Sans Serif" BackColor="Window" Width="312px" Height="223px"></FrameStyle>
