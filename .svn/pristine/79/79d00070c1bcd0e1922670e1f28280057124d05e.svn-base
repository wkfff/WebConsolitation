<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0015_02.Default" Title="Untitled Page" %>
    ...
    <table>
        <tr>
            ...
            <td align="right" valign="top">
                ...
                <br /> <asp:HyperLink ID="CrossLink1" runat="server" SkinID="HyperLink"></asp:HyperLink>
            </td>
        </tr>
    </table>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="mbtCaption" runat="server" CssClass="ElementTitle"></asp:Label><asp:Label ID="regionCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
