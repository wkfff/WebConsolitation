...
{
    public partial class PayingOffNominalPlanWizard : Form
    {
        ...
        public PayingOffNominalPlanWizard(CapitalServer capitalServer, DataRow masterRow, PayPeriodicity payPeriodicity)
        {
            InitializeComponent();
            ...
            AddEnumItemsToCombo(typeof(PayPeriodicity));
        ...
        #region Настройка грида с другой периодичностью
        ...
        private void ParametersPage_ValueChanged(object sender, EventArgs e)
        {
            ...
            Server.PayPeriodicity payPeriod = (Server.PayPeriodicity)Enum.Parse(typeof(Server.PayPeriodicity),
            ...
            if (payPeriod == PayPeriodicity.Single)
            {
                ...
                Server.Utils.GetPeriodCount(startDate, endDate,payPeriod, this.dataSet.Tables[0], Convert.ToInt32(uneDayCount.Value)) :
                Server.Utils.GetPeriodCount(startDate, endDate, payPeriod, this.dataSet.Tables[0]);
        }
        ...
        private void wizard_Next(object sender, Krista.FM.Client.Common.Wizards.WizardForm.EventNextArgs e)
        {
            ...
            if (e.CurrentPage == wizardCustomPeriodsPage)
            {
                ...
                {
                    MessageBox.Show("Добавте хотя бы один период", "План погашения номинальной стоимости", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    e.Step = 1;
                }
                else
                    wizardFinalPage.Description2 = CalculateAcquittanceMainPlan();
        ...
        private string CalculateAcquittanceMainPlan()
        {
            try
            {
                ...
                return "План погашения номинальной стоимости успешно заполнен.";
            }
