...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
    public partial class FST_0001_0033 : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            TagCloudFST_0001_0033_Text2.TaxName = "тариф для населения";
            TagCloudFST_0001_0033_Text3.TaxName = "тариф для бюджетных потребителей";
            TagCloudFST_0001_0033_Text4.TaxName = "тариф для прочих потребителей";
