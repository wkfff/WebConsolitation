...
namespace Krista.FM.Server.Dashboards.reports.FO_0021_0002
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = String.Format("Рейтинг муниципальных районов и городских округов Вологодской области по результатам оценки качества управления муниципальными финансами");
