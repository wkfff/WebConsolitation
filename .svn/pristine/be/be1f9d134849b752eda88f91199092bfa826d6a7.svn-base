<%@ Control Language="C#" AutoEventWireup="true" Codebehind="SE_0001_0002_Chart.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.SE_0001_0002_Chart" %>
...
<table style="border-collapse: collapse; height: 100%">
    <tr>
        <td>
            <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" />
        </td>
    </tr>
    <tr>
        <td style="height: 135px" valign="top">
           <div style="margin-top: -7px"><asp:Label ID="lbDescription" runat="server" SkinID="InformationText"></asp:Label></div></td>
    </tr>
    <tr>
        <td valign="bottom">
