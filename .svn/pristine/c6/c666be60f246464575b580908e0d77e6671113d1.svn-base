        ...
        <tr>
            ...
            <td style="overflow: visible;">
                ...
                <asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" 
                    Checked="True" GroupName="chicken" 
                    Text="Уровень зарегистрированной безработицы, процент " 
                    ValidationGroup="chicken" />
                <br />
                <asp:RadioButton ID="RadioButton2" runat="server" AutoPostBack="True" 
                    GroupName="chicken" 
                    Text="Численность безработных граждан, зарегистрированных в органах службы занятости, человек" 
                    ValidationGroup="chicken" />
            ...
            <td>
                ...
                <igchart:UltraChart ID="UltraChart1" runat="server" 
                    ...
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ...
                        <Skin>
                            <PEs>
                                <igchartprop:PaintElement ElementType="Gradient" Fill="Salmon" 
                                    FillGradientStyle="BackwardDiagonal" FillStopColor="Sienna" />
                                <igchartprop:PaintElement ElementType="Hatch" Fill="SlateGray" FillOpacity="50" 
                                    FillStopColor="SkyBlue" FillStopOpacity="91" Hatch="ForwardDiagonal" />
                            </PEs>
                        </Skin>
                    </ColorModel>
                    <Effects>
