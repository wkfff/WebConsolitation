<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_1035_0015.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_1035_0015" %>
                                    ...
                                    <table style="border-collapse: collapse;">
                                        <tr>
                                            <td style="overflow: visible; background-color: Black">
                                                <div runat="server" id="HeraldImageContainer" style="float: left; width: 100px; margin-left: 32px">
                                                </div>
                                                ...
                                                <div style="margin-left: 15px; margin-top: -1px">
                                                    <div style="margin-top: -1px">
                                                        ...
                                                        <asp:Label ID="lbIncomesAverageTitle" runat="server" SkinID="InformationText" Text="Бюдж.&nbsp;дох.&nbsp;на&nbsp;душу&nbsp;насел.&nbsp;"></asp:Label>
