...
{
    public partial class Oil_0006_0004_02 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            currentDate = CubeInfo.GetLastDate(DataProvidersFactory.SecondaryMASDataProvider, "Oil_0006_0004_02_lastDate");
            ...
            IPadElementHeader1.Text = "Бензин АИ-95";
            InitializeTable1();
        }
        ...
        {
            dt = new DataTable();
            string query = DataProvider.GetQueryText("OIL_0006_0004_02_Grid");
