<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0016_02.Default" Title="Доходы по субъектам РФ" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td style="width: 100%">
                <uc4:PopupInformer ID="PopupInformer" runat="server" HelpPageUrl="Default.html" />
                <span runat="server" id="HelpSpan" class="help_sp" title="Справка"><a href="Default.doc">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/getHelp.gif" /></a></span>
                &nbsp;&nbsp;<asp:Label ID="PageTitle" runat="server" Text="Label" CssClass="PageTitle"></asp:Label></td>
            <td align="right">
            ...
            <td valign="top" align="left">
                    ...
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                ...
                                <asp:Label ID="hiddenLabel" runat="server" CssClass="PageSubTitle" Visible="false"></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;">
                                <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                                    ...
                                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FK001_16_2_1#SEQNUM(100).png" />
                                </igchart:UltraChart>
                            </td>
                            <td class="right">
                            </td>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="stackChartElementCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="StackChart" runat="server" BackgroundImageFileName=""  
                                 EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                OnDataBinding="StackChart_DataBinding" Version="8.2">
                                <Tooltips Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False"
                                    Font-Bold="False"></Tooltips>
                                <ColorModel ModelStyle="CustomLinear" ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink">
                                </ColorModel>
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FK001_16_2_2#SEQNUM(100).png" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <DMWC:MapControl ID="DundasMap" runat="server" BackColor="White" ResourceKey="#MapControlResKey#MapControl1#"
                                ImageUrl="../../TemporaryImages/map_fk_01_15_#SEQ(300,3)" RenderingImageUrl="../../TemporaryImages/">
                                <NavigationPanel>
