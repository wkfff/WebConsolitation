<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0007.Default" Title="Индикаторы БК и КУ " %>
                ...
                <table runat="server" id="GridTable1" style="border-collapse: collapse; background-color: white; width: 100%; height: 100%;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle" Text="Анализ сумм начисленных и поступивших платежей, тыс.руб."></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="Td2" valign="top">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px"
                             ...
                             <br/>
                            <asp:Label ID="LabelDesc" runat="server" CssClass="ElementSubTitle" Text=""></asp:Label>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
            ...
            <td>
                ...
                <table runat="server" id="ChartTable1" style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text="Сравнение начисленных и поступивших платежей в разрезе территорий, тыс.руб."></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
