...
{
    public partial class FO_0002_0007_HMAO_v : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label3.Text = string.Format("Процент исполнения плана по расходам и бюджетные расходы на душу населения (тыс.руб./чел.) за {0}&nbsp;{1}&nbsp;{2}&nbsp;года по {3}.",
                                        monthNum,
                                        monthStr,
                                        yearNum,
        ...
        {
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0002_0007_HMAO_v");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 6)
            {
                ...
                AddColumnHeader(e.Layout, "Бюдж.расх. на душу населения", 0, 3, 2);
