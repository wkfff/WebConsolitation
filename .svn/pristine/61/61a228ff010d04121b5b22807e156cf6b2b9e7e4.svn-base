...
namespace Krista.FM.Server.Dashboards.reports.FNS_0001_0001_Omsk
{
    public partial class DefaultKD : CustomReportPage
    {
        ...
        private bool useMonthReportData;
        ...
        // использовать Конс.бюджет МО для районов
        private CustomParam useConsMO;
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            useConsMO = UserParams.CustomParam("use_cons_mo");
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                budgetLevelDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FNS_0001_0001_Omsk_climaticZoneList");
            ...
            selectedRegion.Value = budgetLevelDigest.GetMemberUniqueName(ComboBudgetLevel.SelectedValue);
            string level = budgetLevelDigest.GetMemberType(ComboBudgetLevel.SelectedValue);

            useMonthReportData = !level.Contains("Бюджет поселения");

            useConsMO.Value = "false";
            ...
            chartLabel1.Text = string.Format("Прирост/снижение недоимки по видам налогов с начала {0} года",
                                             ComboYear.SelectedValue);
            chartLabel2.Text =
                "Распределение доходных источников по росту / снижению недоимки в сравнении с прошлым годом , тыс.руб.";
            ...
            string selectedBudget = UseConsolidateRegionBudget && regionSelected
                                        ? String.Format("{0} (Консолидированный бюджет МО)",
        ...
        {
            string queryName = "FNS_0001_0001_Omsk_gridKD_split";
            string query = DataProvider.GetQueryText(queryName);
            ...
            if (dtGrid.Rows.Count > 0)
            {
                ...
                if (useMonthReportData)
                {
                    query = DataProvider.GetQueryText("FNS_0001_0001_Omsk_gridKD_split_monthReport");
        ...
        {
            string queryName = "FNS_0001_0001_Omsk_chartKD1_split";
            string query = DataProvider.GetQueryText(queryName);
...
//            }
        ...
        {
            string queryName = "FNS_0001_0001_Omsk_chartKD2_split";
            string query = DataProvider.GetQueryText(queryName);
