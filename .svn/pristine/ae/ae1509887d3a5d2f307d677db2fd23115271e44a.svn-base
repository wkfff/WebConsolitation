...
{
    public partial class FST_0002_0003 : CustomReportPage
    {
        ...
        {
            Dictionary<String, String> RegionsRF = new Dictionary<string, string>();
            ...
            string query2 = DataProvider.GetQueryText("FST_0002_0003_RegionsRF");
            ...
            if (gridRegionsRF.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < gridRegionsRF.Rows.Count; i++)
                {
                    ...
                    query2 = DataProvider.GetQueryText("FST_0002_0003_Table");
        ...
        private HtmlTableCell GetNameCellFirstLevel(string RegionName)
        {
            ...
            lb.Text = String.Format("<a href='webcommand?showReport=FST_0002_0001_{0}'>&nbsp;{1}&nbsp;</a>", IDSettlement, RegionName);
            //lb.Text = RegionName;
