<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0039_0003.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="WithoutQualityDegree" runat="server" Text="Без степени качества"
                                AutoPostBack="true" Checked="true" Style="font-family: Verdana; font-size: 10pt;" />
                            <asp:CheckBox ID="WithQualityDegree" runat="server" Text="Со степенью качества" AutoPostBack="true"
    ...
    <table runat="server" id="SummaryGridTable" style="vertical-align: top;">
        <tr>
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="SummaryGrid" runat="server" Height="200px" Width="325px"
                                OnDataBinding="SummaryGrid_DataBinding" OnInitializeLayout="SummaryGrid_InitializeLayout"
                                OnInitializeRow="SummaryGrid_InitializeRow" SkinID="UltraWebGrid">
                                <Bands>
                                    <igtbl:UltraGridBand>
    ...
    <table runat="server" id="UltraWebGridTable" style="vertical-align: top;">
        <tr>
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    <tr>
