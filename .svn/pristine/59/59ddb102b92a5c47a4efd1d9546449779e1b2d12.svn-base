<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="DefaultMap.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0002_NAO.DefaultMap"
    ...
    <table width="100%">
        <tr>
            <td colspan="1" style="width: 100%;">
                <uc5:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultMap.html" />
                &nbsp;&nbsp;
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <DMWC:MapControl ID="DundasMap" runat="server" BackColor="White" ResourceKey="#MapControlResKey#MapControl1#"
                                ImageUrl="../../TemporaryImages/map_fk_01_03_#SEQ(300,3)" RenderingImageUrl="../../TemporaryImages/">
                                <NavigationPanel>
