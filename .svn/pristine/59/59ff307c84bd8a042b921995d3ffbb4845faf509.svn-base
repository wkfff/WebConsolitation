<%@ Page Language="C#" Title="“ерритори€ муниципального образовани€" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._0001.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 100%">
        <tr>
            <td>
                ...
                <asp:Label ID="Label10" runat="server" CssClass="PageTitle" Text="Label"></asp:Label><br />
    <asp:Label ID="Label11" runat="server" Text="јнализ динамики и структуры основных показателей, характеризующих территорию муниципального образовани€." CssClass="PageSubTitle"></asp:Label></td>
            <td style="text-align: right">
                <a href="../OverallTable/default.aspx?pok=EnclaveMO" style="font-size: 10pt">—водный
                    отчет</a></td>
        </tr>
    </table>
    <br/>  
   ...
   <igmisc:WebPanel ID="WebPanel1" runat="server" EnableAppStyling="True" ExpandEffect="None"
        ...
        <Header Text="ѕо данным на" TextAlignment="Left">
            <ExpandedAppearance>
        ...
        <Template>
            <asp:Label ID="ReportText" runat="server" BorderStyle="None" Font-Bold="False" Font-Names="Arial"
                Font-Size="Small" Text="“екст отчЄта"></asp:Label>
        </Template>
    </igmisc:WebPanel>
    <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
        ...
        <tr>
            ...
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel6_" runat="server" Width="100%">
            <asp:Label ID="grid_caption" runat="server"  Text="заголовок таблицы" CssClass="ElementTitle" Width="800px"></asp:Label>
        ...
        StyleSetName="Office2007Blue" OnClick="web_grid_Click" Width="100%" OnActiveCellChange="web_grid_ActiveCellChange1" OnClickCellButton="web_grid_ClickCellButton">
        <Bands>
            <igtbl:UltraGridBand>
        ...
        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes" BorderCollapseDefault="Separate"
            Name="webxgrid" NoDataMessage="в насто€щий момент данные отсутствуют" RowHeightDefault="20px"
    ...
    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel2" runat="server" Width="100%" LinkedRefreshControlID="WebAsyncRefreshPanel6_">
        ...
        <td style="vertical-align: top;">
            <table style="margin-top: 0px; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="background-color: white">
           <asp:Label ID="Label1" runat="server" Text="заголовок таблицы" Height="72px" Width="100%" CssClass="ElementTitle"></asp:Label><br />
            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                            ...
                            Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="100" Transform3D-XRotation="50" Transform3D-YRotation="30" Height="350px" OnDataBinding="UltraChart1_DataBinding" OnFillSceneGraph="UltraChart1_FillSceneGraph">
            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, гектар &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
            ...
            <Legend Visible="True" Location="Bottom" SpanPercentage="35" FormatString="&lt;ITEM_LABEL&gt;                                                                                                     ."></Legend>
        ...
        <td style="vertical-align: top;"> 
            <table style="margin-top: 0px; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="background-color: white">
            <asp:Label ID="Label2" runat="server" BorderStyle="None" Text="заголовок таблицы" Height="72px" Width="100%" CssClass="ElementTitle"></asp:Label><br />
            ...
            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, километры &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
            </ColorModel>
            <Effects>
                <Effects>
        ...
        <td style="vertical-align: top;"> 
            <table style="margin-top: 0px; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="background-color: white">
            <asp:Label ID="Label3" runat="server"  Text="заголовок таблицы" Height="72px" Width="100%" CssClass="ElementTitle"></asp:Label><br />
            ...
            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, тыс€чи квадратных метров &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
            </ColorModel>
            <Effects>
                <Effects>
            ...
            <tr>
                <td style="vertical-align: top; width: 33%;">
                    <table style="vertical-align: top; width: 100%; border-collapse: collapse; height: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; background-color: white; height: 100%;">
                    <asp:Label ID="Grid1Label" runat="server" Text="заголовок таблицы" CssClass="ElementTitle" style="margin-top: 3px"></asp:Label>
                        ...
                        Width="350px" OnAddRowBatch="web_grid1_AddRowBatch" OnInitializeRow="web_grid1_InitializeRow">
                        <Bands>
                            <igtbl:UltraGridBand>
                                <AddNewRow View="NotSet" Visible="NotSet">
                                </AddNewRow>
                        ...
                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes" BorderCollapseDefault="Separate" CellClickActionDefault="RowSelect" Name="webxgrid1" NoDataMessage="в насто€щий момент данные отсутствуют"
                ...
                <td style="vertical-align: top;">
                    ...
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server" Width="100%" TriggerControlIDs="web_grid1">
                        <asp:Label ID="Chart1Lab" runat="server"  Text="заголовок таблицы" CssClass="ElementTitle" Height="50px"></asp:Label></igmisc:WebAsyncRefreshPanel>                                            
    ...
    <asp:Label ID="Grid2Label" runat="server" CssClass="ElementTitle" Style="margin-top: 4px;
        vertical-align: bottom" Text="заголовок таблицы"></asp:Label>
                    <igtbl:UltraWebGrid ID="web_grid2" runat="server" EnableAppStyling="True"
                        ...
                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes" BorderCollapseDefault="Separate" CellClickActionDefault="RowSelect" Name="webxgrid2" NoDataMessage="в насто€щий момент данные отсутствуют"
                            RowHeightDefault="20px" SelectTypeRowDefault="Extended" StationaryMargins="Header"
                            StationaryMarginsOutlookGroupBy="True" TableLayout="Fixed" Version="4.00" ViewType="Hierarchical">
                            <GroupByBox Hidden="True" Prompt="ѕеретащите сюда колонку дл€ группировки">
                                <BoxStyle BackColor="ActiveBorder" BorderColor="Window">
                    ...
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel3" runat="server" Width="100%" TriggerControlIDs="web_grid2">
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;">
                                ...
                                <td style="vertical-align: top;">
                                    <table style="vertical-align: top; width: 100%; border-collapse: collapse; height: 100%; margin-right: 4px;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top; background-color: white; height: 100%;">
                                    <asp:Label ID="Chart2Lab" runat="server" Text="заголовок таблицы" CssClass="ElementTitle" Height="60px"></asp:Label><igchart:UltraChart ID="Chart2" runat="server" BackgroundImageFileName=""  
                            ...
                            Version="9.1" OnDataBinding="Chart2_DataBinding" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="100" Transform3D-XRotation="50" Transform3D-YRotation="30">
                                ...
                                <td style="vertical-align: top;"><table style="vertical-align: top; width: 100%; border-collapse: collapse; height: 100%;">
                                    <tr>
                                        <td class="topleft">
                                        </td>
                                        <td class="top">
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; background-color: white; height: 100%;">
                                    <asp:Label ID="Chart3Lab" runat="server" Text="заголовок таблицы" CssClass="ElementTitle" Height="60px"></asp:Label><igchart:UltraChart ID="Chart3" runat="server" BackgroundImageFileName=""  
                             ChartType="DoughnutChart" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                            Version="9.1" OnDataBinding="Chart3_DataBinding" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="100" Transform3D-XRotation="50" Transform3D-YRotation="30" OnFillSceneGraph="Chart3_FillSceneGraph">
                                        <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, гектар &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
                                        <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed">
                                        </ColorModel>
                                        ...
                                        <Legend Visible="True" Location="Bottom" FormatString="&lt;ITEM_LABEL&gt;                                                                       ." MoreIndicatorText="40"></Legend>
                                        <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                                        <DoughnutChart InnerRadius="30" OthersCategoryPercent="0">
                                        </DoughnutChart>
                                        <Border Color="Transparent" />
