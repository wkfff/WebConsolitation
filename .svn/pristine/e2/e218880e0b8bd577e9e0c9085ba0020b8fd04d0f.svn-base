...
namespace Krista.FM.Server.Dashboards.reports.STAT_0003_0004
{
	public partial class Default : CustomReportPage
	{
		...
		private const string PageSubTitleCaption = "Данные еженедельного мониторинга задолженности по заработной плате в Сахалинской области по состоянию на {0}";
		...
		protected override void Page_PreLoad(object sender, EventArgs e)
		{
			...
			#region Ссылки
			CrossLink1.Text = "Задолженность&nbspпо&nbspоплате&nbspтруда&nbsp(по&nbspмуниципальным&nbspобразованиям Сахалинской области)";
			CrossLink1.NavigateUrl = "~/reports/STAT_0003_0003_Sahalin/Default.aspx";
        ...
        {
            return p.Replace(" район", "").Replace(" городской округ", "").Replace("поселок ", "").Replace("\"", "").Replace("городской округ ", "");
        }
		...
		private void PdfExportButton_Click(object sender, EventArgs e)
		{
            ...
            DundasMap1.Height = Unit.Pixel((int)(CustomReportConst.minScreenWidth * 0.6));
		...
		private void ExcelExportButton_Click(object sender, EventArgs e)
		{
			...
			DundasMap1.Height = Unit.Pixel((int)(CustomReportConst.minScreenHeight * 1.5));
