<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessHealth._default" %>
                                    ...
                                    <LineChart>
                                        <ChartText>
                                            <igchartprop:ChartTextAppearance ChartTextFont="Arial, 7pt, style=Bold" Column="-2"
                                                Row="-2" VerticalAlign="Far" Visible="True" ItemFormatString="&lt;DATA_VALUE:### ### ##0.00&gt;">
