...
{
    public partial class FO_0004_0001_1 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label1.Text =
                String.Format(
                    "Среднедушевые доходы&nbsp;<span class='DigitsValue'>{0:N2}</span>&nbsp;тыс.руб./чел", dtText.Rows[0]["Среднедушевые доходы конс бюджет"]);

            Label2.Text =
                String.Format(
                    "Бюджетные расходы на душу населения&nbsp;<span class='DigitsValue'>{0:N2}</span>&nbsp;тыс.руб./чел", dtText.Rows[0]["Среднедушевые расходы конс бюджет"]);
        }
