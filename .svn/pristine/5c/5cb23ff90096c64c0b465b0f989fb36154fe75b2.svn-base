...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0005_Altai
{
    public partial class DefaultCompare : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.Text = "Диаграмма&nbsp;распределения&nbsp;МО по&nbsp;доходам&nbsp;на&nbsp;душу&nbsp;населения<br />м";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ComboKD.SelectedValues.Count == 1)
            {
                kdList = string.Format("[КД].[Сопоставимый].[{0}],", ComboKD.SelectedValues[0]);
            }
            else if (ComboKD.SelectedValues.Count > 1)
            {
              for (int i=0; i< ComboKD.SelectedValues.Count-1; i++)
              {
                  kdList += string.Format("[КД].[Сопоставимый].[{0}],", ComboKD.SelectedValues[i]);
              }
            }

            kdGroupName.Value = kdList.TrimEnd(',');
        ...
        public static Dictionary<string, int> FillFullKDIncludingList()
        {
            ...
            valuesDictionary.Add("Земельный налог, п/п 1 п. 1 статьи 394 НКРФ ", 3);
            valuesDictionary.Add("Земельный налог п/п 2 п. 1 статьи 394 НКРФ ", 3);
            ...
            valuesDictionary.Add("Налог, в котором объект налогообложения доходы ", 3);
            valuesDictionary.Add("Налог, в котором объект налогообложения доходы, уменьшенные на величину расходов ", 3);
            valuesDictionary.Add("Минимальный налог ", 3);
            ...
            valuesDictionary.Add("Плата в части, превышающей мин.размер арендной платы и мин.размер платы по договору купли-продажи лес.насаждений  ", 3);
            valuesDictionary.Add("Плата в части, превышающей мин.размер платы по договору купли-продажи лес.насаждений ", 4);
            valuesDictionary.Add("Плата в части, превышающей мин.размер арендной платы ", 4);
            valuesDictionary.Add("Плата по договору купли-продажи лес.насаждений для соб.нужд ", 3);
