<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
	Inherits="Krista.FM.Server.Dashboards.reports.SKK.SKK_005.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="ParamsWrapper">
		<div class="Param"><uc3:CustomMultiCombo ID="comboTerra" runat="server" /></div>
	...
	<div class="SpaceWrapper">
		<!-- по ФО / субъектам / пунктам пропуска -->
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartTerra" runat="server">
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk051#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div></div></div>
		...
		<div class="SpaceFloat2Items">
			<div class="RoundedTop"><div><div></div></div></div>
			<div class="SpaceHeader"><div><div>
				<asp:Label ID="LabelChartBorder" runat="server" CssClass="ElementTitle" />
			</div></div></div>
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartBorder" runat="server">
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk052#SEQNUM(100).png" />
				</igchart:UltraChart>
				<div class="SpaceGrid" id="GridBorderPlace" runat="server">
					<uc5:UltraGridBrick ID="GridSimpleBorder" runat="server"/>				
				</div>
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>
		</div>
	...
	<div class="SpaceWrapper">
		<div class="RoundedTop"><div><div></div></div></div>
		<div class="SpaceHeader"><div><div>
			<asp:Label ID="LabelGridGroups" runat="server" CssClass="ElementTitle" />
		</div></div></div>
		<div class="RoundedCenter"><div><div>
			<div class="SpaceGrid">
				<uc5:UltraGridBrick ID="GridGroups" runat="server"/>			
			</div>
		</div></div></div>
		<div class="RoundedBottom"><div><div></div></div></div>
	</div>

	<!-- по группам товаров, диаграммы -->
	<div class="SpaceWrapper">
		<div class="SpaceFloat2Items">
			<div class="RoundedTop"><div><div></div></div></div>
			<div class="SpaceHeader"><div><div>
				<asp:Label ID="LabelChartCount" runat="server" CssClass="ElementTitle" />
			</div></div></div>
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartGroupsCount" runat="server">
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk053#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>
		</div>
		<div class="SpaceFloat2Items">
			<div class="RoundedTop"><div><div></div></div></div>
			<div class="SpaceHeader"><div><div>
				<asp:Label ID="LabelChartCapacity" runat="server" CssClass="ElementTitle" />
			</div></div></div>
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartGroupsVolume" runat="server">
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk054#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>
		</div>
	...
	<div class="SpaceWrapper">
		<div class="RoundedTop"><div><div></div></div></div>
		<div class="SpaceHeader"><div><div>
			<asp:Label ID="LabelTransportGroup" runat="server" CssClass="ElementTitle" />
		</div></div></div>
		<div class="RoundedCenter"><div><div>			
			<div class="SpaceFloat2Items">
				<div class="SpaceGrid">	
			...
			<div class="SpaceFloat2Items">
				<igchart:UltraChart ID="ChartTransport" runat="server">
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk055#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div>
			<div class="clear"></div>						
		</div></div></div>
