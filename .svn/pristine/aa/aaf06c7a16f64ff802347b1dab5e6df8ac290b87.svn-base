...
{
    public partial class FO_0035_0029 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0035_0029_date");
            ...
            lbDescription.Text = String.Format("Зарегистрированные бюджетные обязательства и остатки по лимитам бюджетных обязательств в разрезе КОСГУ по состоянию на&nbsp;<b><span class='DigitsValue'>{0:dd.MM.yyyy}</span></b>, тыс.руб.", date);
        }
        ...
        {
            string query = DataProvider.GetQueryText("FO_0035_0029_Grid");
