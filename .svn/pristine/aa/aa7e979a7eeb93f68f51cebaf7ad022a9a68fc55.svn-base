<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultCompare.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0003_Omsk.DefaultCompare"
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="middle">
                <asp:CheckBox ID="comparableStandandCheckBox" Checked="false" runat="server" Text="В&nbsp;сопоставимых&nbsp;нормативах"
                    AutoPostBack="true" style="font-size:12px;font-family:Verdana;" Width="250px" />
            </td>                      
