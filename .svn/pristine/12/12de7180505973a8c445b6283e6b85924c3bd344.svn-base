<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0002_0063.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0002_0063_1" %>
        ...
        <table style="width: 768; height: 900; border-collapse: collapse; background-color: Black;
            ...
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    ...
                    Ц максимальна€ дол€ расходов на содержание ќ√¬
                </td>
            </tr>
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    ...
                    background-repeat: no-repeat; background-position: 2% center; padding-left: 58px;">
                    Ц минимальна€ дол€ расходов на содержание ќ√¬
                </td>
            </tr>
            <tr>
                <td>
