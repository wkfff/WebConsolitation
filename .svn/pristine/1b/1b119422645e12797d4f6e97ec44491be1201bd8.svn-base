namespace MDXParser
{
    ...
    internal class Formatter
    {
        ...
        internal string Prefix()
        {
            ...
            if (this.m_Options.Output == OutputFormat.RTF)
            {
                return "{\\rtf1\\ansi\\ansicpg1252\\deff0\\deflang1033{\\fonttbl{\\f0\\fmodern\\fprq1\\fcharset0 Courier New;}}\r\n{\\colortbl ;\\red0\\green0\\blue255;\\red0\\green128\\blue0;\\red255\\green0\\blue0;}{\\f1\\fs20 ";
            }
            return "";
        }
