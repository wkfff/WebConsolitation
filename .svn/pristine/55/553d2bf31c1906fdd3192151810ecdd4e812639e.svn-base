<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.MFRF_0001_0005.Default" Title="Распределение средств федеральных фондов между субъектами РФ" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1"  runat="server">
 ...
 <table>
  <tr>
    ...
    <td valign="top">
     <uc3:CustomMultiCombo ID="ComboFF" runat="server"> </uc3:CustomMultiCombo>
    </td >
           ...
           <table style="border-collapse:collapse; background-color:white; width:100%; margin-top:10px;">
            ...
            <tr>
              ...
              <td style="overflow:visible;">
                <igchart:UltraChart ID="UltraChartFF" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    OnDataBinding="UltraChartFF_DataBinding" Version="8.2">
