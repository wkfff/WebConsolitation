<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultSettlement.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0001_HMAO.DefaultSettlement" %>
    ...
    <table width="100%">
        <tr>
            <td valign="top" colspan="5" style="width: 100%;">
                <uc4:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultSettlement.html" />
                &nbsp;&nbsp;
            ...
            <td valign="top">
                <table>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td valign="top" align="left" style="font-family:Verdana; font-size:12px;" colspan="4">
                                    ...
                                    <td style="overflow: visible;">
                                        <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel" runat="server">
                                            <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                                ...
                                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fns_02_01_settle1#SEQNUM(100).png" />
                                            </igchart:UltraChart>
                                ...
                                <tr>
                                    ...
                                    <td style="overflow: visible;">
                                        <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                            ...
                                            <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fns_02_01_settle2#SEQNUM(100).png" />
                                        </igchart:UltraChart>
                                    </td>
                                    <td class="right">
                                    </td>
