...
namespace Krista.FM.Server.Dashboards.reports.FK_0001_0004_Vologda
{
    public partial class DefaultDetail : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText("FK_0001_0004_Vologda_grid");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 10)
            {
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 9, "% наполнения бюджета", "Процент наполнения бюджета за аналогичный период прошлого года");
        ...
        protected void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
            for (int i = 0; i < e.Row.Cells.Count; i++)
            {
                ...
                if (i == 8 && e.Row.Cells[i].Value != null && e.Row.Cells[i].Value.ToString() != string.Empty)
                {
