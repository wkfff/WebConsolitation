<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.CTAT.CTAT_0002._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        <br />
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="16pt"
            Text="Основные показатели экологии в субъекте РФ Саратовская обл."></asp:Label><br />
        <asp:DropDownList ID="DropDownList1" runat="server">
        </asp:DropDownList>
        <asp:DropDownList ID="DropDownList2" runat="server">
        </asp:DropDownList>
        <asp:Button ID="Button1" runat="server" Text="Обновить" />&nbsp;<br />
            ...
            <ZoomPanel BackColor="150, 255, 255, 255" BackSecondaryColor="150, 224, 238, 208"
                ...
                ThumbBorderColor="88, 95, 41" TickBorderColor="88, 95, 41" Visible="True" TickCount="20">
        ...
        <table>
            ...
            <tr>
                <td>
                    <igmisc:WebAsyncRefreshPanel ID="BPanel" runat=server LinkedRefreshControlID="WebAsyncRefreshPanel4" RefreshTargetIDs="Label2,Label3">
                    <igchart:UltraChart ID = "TLC" runat =server OnDataBinding="TLC_DataBinding" ChartType="StackBarChart" BackgroundImageFileName=""   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnInvalidDataReceived="TLC_InvalidDataReceived" Version="9.1">
                ...
                <td>
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel2" runat=server LinkedRefreshControlID="WebAsyncRefreshPanel4"><igchart:UltraChart ID = "TRC" runat =server OnDataBinding="TRC_DataBinding1" BackgroundImageFileName=""   ChartType="StackBarChart" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" Version="9.1" OnInvalidDataReceived="TLC_InvalidDataReceived">
                        <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            Font-Underline="False" />
                        <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" ModelStyle="CustomLinear">
                        </ColorModel>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="Показатели использования водных ресурсов"></asp:Label></td>
                <td>
                    &nbsp;<asp:Label ID="Label5" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td style="vertical-align: top"><igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat=server LinkedRefreshControlID="WebAsyncRefreshPanel4" RefreshTargetIDs="Label4,Label5">
                
                <igtbl:UltraWebGrid ID = "G" runat =server OnDataBinding="G_DataBinding" SkinID="UltraWebGrid" StyleSetName="Office2007Blue" Height="200px" OnActiveRowChange="G_ActiveRowChange" OnInitializeLayout="G_InitializeLayout" Width="325px">
                    <Bands>
                        <igtbl:UltraGridBand>
                    ...
                    <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                        ...
                        TableLayout="Fixed" Version="4.00" ViewType="OutlookGroupBy" CellClickActionDefault="RowSelect">
                        <GroupByBox>
                ...
                <td>
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel3" runat=server RefreshTargetIDs="Label4,Label5">
                    <igchart:UltraChart ID = "BC" runat =server OnDataBinding="TRC_DataBinding" BackgroundImageFileName=""   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" Version="9.1" OnInvalidDataReceived="TLC_InvalidDataReceived" ChartType="StackAreaChart">
                        <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            Font-Underline="False" />
                        <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" ModelStyle="CustomLinear">
                        </ColorModel>
