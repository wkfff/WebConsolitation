...
{
    public partial class Oil_0006_0004_03 : CustomReportPage
    {
       private DateTime currentDate;
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            currentDate = CubeInfo.GetLastDate(DataProvidersFactory.SecondaryMASDataProvider, "Oil_0006_0004_03_lastDate");
            ...
            IPadElementHeader1.Text = "Дизельное топливо";
            InitializeTable1();
        }
        ...
        {
            dt = new DataTable();
            string query = DataProvider.GetQueryText("OIL_0006_0004_03_Grid");
...
//                e.Row.Cells[1].Style.CustomRules = "background-repeat: no-repeat; background-position: left center; margin: 2px";
                e.Row.Cells[1].Value = String.Format("<img src='../../../images/ballRedBB.png' style='margin:0px'>&nbsp;{0:N2}", value);
            }
        }
