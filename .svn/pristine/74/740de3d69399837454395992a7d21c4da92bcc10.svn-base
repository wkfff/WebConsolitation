...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0058
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = "Мониторинг показателей эффективности деятельности Министерства строительства и жилищно-коммунального хозяйства Новосибирской области (квартальный)";
            Label1.Text = Page.Title;
            int yearNum = Convert.ToInt32(ComboYear.SelectedValue);
            date = new DateTime(yearNum, 01, 1).AddMonths(1);
            Label2.Text = String.Format("Данные ежеквартального мониторинга основных показателей эффективности деятельности Министерства строительства и жилищно-коммунального хозяйства Новосибирской области за {0} год (нарастающим итогом с начала года)",
                    ...
                    case 0:
                        {
                            switch (i)
                            {
                                ...
                                case 4:
                                    {
                                        undercell = headerLayout.AddCell(String.Format("1 полугодие {0} года", ComboYear.SelectedValue));
                                        break;
                                    }
                                case 6:
                                    {
                                        undercell = headerLayout.AddCell(String.Format("9 месяцев {0} года", ComboYear.SelectedValue));
                                        break;
                                    }
                                case 8:
                                    {
