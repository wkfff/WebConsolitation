<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OIL_0001_0001_Chart.ascx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.OIL_0001_0001_Chart" %>
<%@ Register Assembly="Infragistics35.WebUI.UltraWebChart.v11.1, Version=11.1.20111.2036, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb"
    Namespace="Infragistics.WebUI.UltraWebChart" TagPrefix="igchart" %>
<%@ Register Assembly="Infragistics35.WebUI.UltraWebChart.v11.1, Version=11.1.20111.2036, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb"
    Namespace="Infragistics.UltraChart.Resources.Appearance" TagPrefix="igchartprop" %>

    <table style="vertical-align: top;" runat="server" id="Chart2Table">
        <tr>
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                           <asp:Label ID="chartElementCaption" runat="server" CssClass="PageSubTitle"></asp:Label>
