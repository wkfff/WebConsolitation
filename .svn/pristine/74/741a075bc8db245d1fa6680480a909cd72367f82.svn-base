...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0060_02
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.Text = "Расходы&nbsp;на&nbsp;оплату&nbsp;труда&nbsp;в&nbsp;органах&nbsp;местного&nbsp;самоуправления";
            CrossLink1.NavigateUrl = "~/reports/FO_0002_0060_01/Default.aspx";
        }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query2 = DataProvider.GetQueryText("FO_0002_0060_02_date");
            ...
            PageTitle.Text = "Расходы на оплату труда в органах государственной власти";
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0060_02_grid");
