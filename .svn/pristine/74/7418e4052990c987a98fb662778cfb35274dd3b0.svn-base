...
{
    public partial class FO_0135_0012 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label2.Text = String.Format("Остаток средств на&nbsp;<span style=\"color: White\"><b>{0:dd.MM.yyyy}г.</b></span> по окружному бюджету&nbsp;", date);
