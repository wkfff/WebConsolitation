                            ...
                            <tr>
                                <td align="left">
                                    <uc1:IT_0002_0001_IncomesGrid ID="IT_0002_0001_IncomesGrid1" runat="server" Width="377px" Text="Доходы за 1 полугодие 2010 года"
                                        QueryName="IT_0004_0001_incomes" ImageUrl="../Images/Incomes.png" DescriptionText="Доходы консолидированного бюджета составляют&nbsp;<span style='color: White'><b>{0:N0}</b></span>&nbsp;тыс.руб.">
                                ...
                                <td align="left">
                                    <uc1:IT_0002_0001_IncomesGrid ID="IT_0002_0001_IncomesGrid2" runat="server" Width="377px" Text="Расходы за 1 полугодие 2010 года"
                                        QueryName="IT_0004_0001_outcomes" ImageUrl="../Images/Outcomes.png" DescriptionText="Расходы консолидированного бюджета составляют&nbsp;<span style='color: White'><b>{0:N0}</b></span>&nbsp;тыс.руб.">
                                    </uc1:IT_0002_0001_IncomesGrid>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td>
                        <uc8:IT_0004_0001_AdminOutcomesGrid ID="IT_0004_0001_AdminOutcomesGrid1" runat="server" QueryName="IT_0004_0001_AdminOutcomesGrid"
                            Text="Затраты на административно-управленческий персонал" Width="760px" />
                    </td>
                </tr>
                <tr>
                    <td>
