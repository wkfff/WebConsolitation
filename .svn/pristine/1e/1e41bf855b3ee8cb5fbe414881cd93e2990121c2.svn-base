    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                periodDigest = new MemberAttributesDigest(DataProvidersFactory.SpareMASDataProvider, "FST_0002_0001_Yamal_periodDigest");
                ...
                periodCompareDigest = new MemberAttributesDigest(DataProvidersFactory.SpareMASDataProvider, "FST_0002_0001_Yamal_periodDigest");
                ...
                serviceDigest = new MemberAttributesDigest(DataProvidersFactory.SpareMASDataProvider, "FST_0002_0001_Yamal_serviceDigest");
            ...
            selectedSubject.Value = "[Территории__РФ].[Территории__РФ].[Ямало-Ненецкий автономный округ]";
            selectedService.Value = serviceDigest.GetMemberUniqueName(ComboService.SelectedValue);

            Page.Title = "Тарифы на коммунальные услуги ЯНАО";
        ...
        private void GridDataBind()
        {
            ...
            string query = DataProvider.GetQueryText("FST_0002_0001_Yamal_grid");
