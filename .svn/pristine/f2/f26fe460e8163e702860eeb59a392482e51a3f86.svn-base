<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultAssessment.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0007.DefaultAssessment"
    Title="Доходы по субъектам РФ" %>
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td align="right" valign="top" style="width: 100%;">
                <uc2:GridSearch ID="GridSearch1" runat="server" Visible="false" />
            </td>
        </tr>
    </table>
    <asp:RadioButtonList ID="CalculationButtonList" runat="server" AutoPostBack="True"
        RepeatDirection="vertical" Width="1000px" style="font-family:Verdana; font-size:12px;">
        <asp:ListItem Selected="True">с учетом поступлений от продажи акции ИЛИ снижения остатков средств бюджета</asp:ListItem>
        <asp:ListItem>с учетом поступлений от продажи акции И снижения остатков средств бюджета (в соответствии с Приказом Минфина от 29.12.2008 №676)</asp:ListItem>
    </asp:RadioButtonList>
    <table style="vertical-align: top;">
        <tr>
            <td valign="top" align="left">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FK0107_2#SEQNUM(100).png" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
                        </td>
