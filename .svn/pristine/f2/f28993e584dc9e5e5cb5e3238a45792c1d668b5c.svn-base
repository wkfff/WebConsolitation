<%@ Page Language="C#" Title="Организация и содержание муниципальной информационной службы" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._0230.Default" %>
        ...
        <table style="width: 100%">
            <tr>
                <td style="text-align: left">
                    <asp:Label ID="Label5" runat="server" CssClass="PageSubTitle" Text="Анализ динамики и структуры основных показателей, характеризующих организацию информационной службы в муниципальном образовании"></asp:Label></td>
                <td style="text-align: right">
...
<Layout Behavior="Auto"></Layout>
                            ...
                            <PieChart3D OthersCategoryPercent="0" BreakDistancePercentage="20" OthersCategoryText="Прочие" RadiusFactor="100" StartAngle="1">
                            </PieChart3D>
