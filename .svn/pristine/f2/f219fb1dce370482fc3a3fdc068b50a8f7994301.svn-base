<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0004_0001.Default" Title="Структура расходов бюджетов" %>
                    ...
                    <tr>
                       ...
                       <td valign="top">
                             <asp:RadioButtonList ID="DebtKindButtonList1" runat="server" AutoPostBack="True"
                                ...
                                <asp:ListItem Selected="True">Исполнено</asp:ListItem> 
                                <asp:ListItem>Бюджетные назначения</asp:ListItem>
