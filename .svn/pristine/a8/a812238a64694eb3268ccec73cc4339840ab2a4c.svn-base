...
namespace Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_0001._00080
{
    public partial class Default1 : CustomReportPage
	{
        private string page_title = "Основные показатели капитального строительства, сводная таблица";
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
            ...
            Grid.Height = Grid.Rows.Count * 31;
		}
        ...
        protected void Grid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            {
                e.Layout.Bands[0].Columns[0].Width = CRHelper.GetColumnWidth(CustomReportConst.minScreenWidth * 0.271);
