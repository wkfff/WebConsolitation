...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0034_03
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                hiddenIndicatorLabel.Text = "Расходы на оказание государственных услуг по типам учреждений ";
            ...
            administratorDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FO_0002_0034_03_administratorDigest");
            ...
            Page.Title = "Удельный вес расходов областного бюджета на оказание государственных услуг по типам учреждений";
        ...
        private DateTime GetLastYearDay()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0034_03_date");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0034_03_grid_plan");
            ...
            {
                query = DataProvider.GetQueryText("FO_0002_0034_03_grid_fact");
        ...
        private void ActivateGridRow(UltraGridRow row)
        {
            ...
            bool isTotalRow = indicatorName.ToLower().Contains("расходы на оказание государственных услуг по типам учреждений");
    ...
    isTotalRow ? "Оказание государственных услуг по типам учреждений" : indicatorName.TrimEnd('_').TrimEnd(' '));
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0034_03_chart_plan");
            ...
            query = DataProvider.GetQueryText("FO_0002_0034_03_chart_fact");
