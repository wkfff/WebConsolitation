...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0060_06
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.Text = "Удельный&nbsp;вес&nbsp;расходов&nbsp;на&nbsp;содержание&nbsp;органов&nbsp;местного&nbsp;самоуправления";
            CrossLink1.NavigateUrl = "~/reports/FO_0002_0060_05/Default.aspx";
        }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query2 = DataProvider.GetQueryText("FO_0002_0060_06_date");
            ...
            PageTitle.Text = "Удельный вес расходов на содержание органов государственной власти в расходах главных распорядителей областного бюджета";
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0060_06_grid");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            headerLayout.AddCell("Итого расходов, тыс. руб.", "Общая сумма расходов по ОГВ");
            GridHeaderCell costs = headerLayout.AddCell("Расходы по содержанию органов государственной власти, тыс. руб.");
            costs.AddCell("Всего", "Общая сумма расходов по содержанию органов государственной власти");
            ...
            GridHeaderCell specificGravity = headerLayout.AddCell("Удельный вес расходов на содержание ОГВ в общем объеме расходов главного распорядителя");
            specificGravity.AddCell("Всего", "Удельный вес расходов на содержание ОГВ в общем объеме расходов областного бюджета");
            GridHeaderCell IncludingSpecificGravity = specificGravity.AddCell("В том числе");
            IncludingSpecificGravity.AddCell("Оплата труда", "Удельный вес расходов на оплату труда в общем объеме расходов областного бюджета");
            IncludingSpecificGravity.AddCell("Материальные затраты", "Удельный вес материальных затрат в общем объеме расходов областного бюджета");
            headerLayout.AddCell("Удельный вес расходов на содержание ОГВ в общем объеме расходов областного бюджета");
