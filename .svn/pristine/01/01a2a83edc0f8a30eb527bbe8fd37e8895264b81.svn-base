    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected void grid1Manual_ActiveCellChange(int CellIndex)
        {
            try
            {
                ...
                chart4_caption.Text = String.Format(RegionSettingsHelper.Instance.GetPropertyValue("chart4_title"), selected_year.Value);
                ...
                try
                {
                    ...
                    chart5_caption.Text = String.Format(RegionSettingsHelper.Instance.GetPropertyValue("gauge_title"), selected_year.Value);
                }
                catch
                {
