<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.ORG_0001_0009._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td colspan="2">
        <table id = "tabletext" runat=server style="margin-top: 6px; margin-bottom: 2px; width: 100%; border-collapse: collapse;">
            <tr>
                <td class="topleft">
                </td>
                <td class="top">
        ...
        <asp:Label ID="Textovka" runat="server" CssClass="PageSubTitle" Text="Label"></asp:Label>
                </td>
                <td class="right">
                </td>
            </tr>
