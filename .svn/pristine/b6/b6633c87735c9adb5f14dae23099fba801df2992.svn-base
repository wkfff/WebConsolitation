<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FZ_0083_0001_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FZ_0083_0001_Horizontal" %>
...
<body style="background-color: black;" link="white">
    ...
    <div style="position: absolute; width: 768px; top: 0px; left: 0px; z-index: 2;">
        <table style="width: 765px; height: 950px; border-collapse: collapse; background-color: Black;
            ...
            <tr>
                <td>
                    <igtbl:UltraWebGrid ID="UltraWebGridRF" runat="server" Height="200px"
                        OnInitializeLayout="UltraWebGridRF_InitializeLayout" SkinID="UltraWebGridChart"
