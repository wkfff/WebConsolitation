...
namespace Krista.FM.Server.Dashboards.SkkSupport
{
	public class Query
	{
		public static readonly string queriesPath = HttpContext.Current.Server.MapPath("~/reports/SKK/");

		private string name;
		public Dictionary<string, QueryTemplate> Templates { set; get; }


		public Query(string name)
		{
			this.name = name;
			Templates = new Dictionary<string, QueryTemplate>();
		}
