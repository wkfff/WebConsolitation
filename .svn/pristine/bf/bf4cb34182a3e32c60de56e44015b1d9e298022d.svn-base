<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FO3201Gadget.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.FO3201Gadget" %>
...
<div class="GadgetTopDate">
    <asp:Label ID="topLabel" runat="server"></asp:Label></div>
    ...
    <table border="0" cellspacing="0" Height="100%" width="100%" >
        <tr>
            <td style="width: 170px;">
              <asp:Label ID="completeLabel" runat="server" ForeColor="Black"></asp:Label>
...
<table width="90%">
    <tr>
        ...
        <td>
            <asp:Label id="Label1_1" skinid="ServeText" runat="server"></asp:Label><br />
            <div class="GadgetValueText"><asp:Label ID="Label1" runat="server"></asp:Label></div>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label id="Label2_1" skinid="ServeText" runat="server"></asp:Label><br />
            <div class="GadgetValueText"><asp:Label ID="Label2" runat="server"></asp:Label></div>
        </td>
    </tr>    
    <tr>
        <td>
            <asp:Label id="Label3_1" skinid="ServeText" runat="server"></asp:Label><br />
            <div class="GadgetValueText"><asp:Label ID="Label3" runat="server"></asp:Label></div>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label id="Label4_1" skinid="ServeText" runat="server"></asp:Label><br />
            <div class="GadgetValueText"><asp:Label ID="Label4" runat="server"></asp:Label></div>
        </td>
    </tr>    
    <tr>
        <td>
            <asp:Label id="Label5_1" skinid="ServeText" runat="server"></asp:Label><br />
            <div class="GadgetValueText"><asp:Label ID="Label5" runat="server"></asp:Label></div>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label id="Label6_1" skinid="ServeText" runat="server"></asp:Label><br />
            <div class="GadgetValueText"><asp:Label ID="Label6" runat="server"></asp:Label></div>
        </td>
    </tr>        
</table>
            </td>
