<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0001.Default" Title="Индикаторы БК и КУ " %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
      ...
      <table style="vertical-align: top;">
        <tr>
          <td valign="top">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="False" RepeatDirection="Vertical"
            ...
            <td valign="top">
                <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="False" RepeatDirection="Vertical"
                    Width="300px" style="font-family:Verdana;font-size:12px;">
