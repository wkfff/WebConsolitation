...
//            UltraChart2.Axis.X.StripLines.Visible = true;
            ...
            KDLink.NavigateUrl = "~/reports/FNS_0001_0001/DefaultKD.aspx";
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_regions_grid_split" : "FNS_0001_0001_regions_grid";
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_regions_chart1_split" : "FNS_0001_0001_regions_chart1";
            string query = DataProvider.GetQueryText(queryName);
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_regions_chart2_split" : "FNS_0001_0001_regions_chart2";
            string query = DataProvider.GetQueryText(queryName);
        ...
        private void PdfExporter_EndExport(object sender, Infragistics.WebUI.UltraWebGrid.DocumentExport.EndExportEventArgs e)
        {
            ...
            title.Style.Font = new Infragistics.Documents.Reports.Graphics.Font(font);
            title.AddContent(PageSubTitle.Text);
            UltraChart2.Width = Unit.Pixel((int)(CustomReportConst.minScreenWidth * 1.2));
            ...
            title.Style.Font = new Infragistics.Documents.Reports.Graphics.Font(font);
            title.AddContent(PageSubTitle.Text);
            UltraChart1.Width = Unit.Pixel((int)(CustomReportConst.minScreenWidth * 1.2));
