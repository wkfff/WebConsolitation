<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="DefaultOKVD.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0005.DefaultOKVD" Title="Информация по налоговым доходам ФНС в разрезе ОКВЭД" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
     ...
     <tr> 
        <td>
         <table width="100%"><tr><td><nobr><b>Информация по налоговым доходам ФНС в разрезе ОКВЭД</b></nobr></td>
                <td><a style="font-size: 10px; font-family: Verdana" runat="server" id="MainIndexRef">Список&nbsp;отчетов</a></td>
                        <td align="right">
                           ...
                           <br/>
                            <a href="../FNS_0001_0003/Default.aspx" style="font-size: 10px; font-family: Verdana" runat="server" id="A2">по&nbsp;районам&nbsp;и&nbsp;поселениям</a>
                           <br/>
                           <a href="../FNS_0001_0004/Default.aspx" style="font-size: 10px; font-family: Verdana" runat="server" id="A3">по&nbsp;показателям</a>
                           <br/>
                        </td>  
                </tr>  
         </table>
                   ...
                   <tr>
                      <td>
                          <uc1:DimensionTree ID="Period" runat="server" CubeName="ФНС_28н_с расщеплением"
                                                ...
                                                MultipleChoice="false" EnableTheming="true" Height="250" Width="200"/>
                      </td>
                      <td>
                          <uc1:DimensionTree ID="Code" runat="server" CubeName="ФНС_28н_с расщеплением"
