<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0042_0003_Gub._default" %>
                ...
                <tr>
                    ...
                    <td style="overflow: visible;">
                        <igtbl:UltraWebGrid ID="Grid" runat="server" Height="200px" Width="325px"
                            OnDataBinding="Grid_DataBinding" OnInitializeLayout="Grid_InitializeLayout"
                            OnInitializeRow="Grid_InitializeRow" SkinID="UltraWebGrid">
                            <Bands>
                                <igtbl:UltraGridBand>
            ...
            <tr>
                ...
                <td style="overflow: visible;">
                    ...
                    <igchart:UltraChart ID="Chart" runat="server" BackgroundImageFileName="" 
                        ...
                        <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fo_42_03#SEQNUM(100).png" />
                    </igchart:UltraChart>
                </td>
                <td class="right">
                </td>
