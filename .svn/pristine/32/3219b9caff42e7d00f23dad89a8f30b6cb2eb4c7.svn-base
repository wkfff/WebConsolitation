...
namespace Krista.FM.Common
{
    ...
    public sealed class Check
    {
        ...
        public static void Require(bool assertion, string message)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Precondition: " + message);
            }
        }
        ...
        public static void Require(bool assertion)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Precondition failed.");
            }
        }
        ...
        public static void Ensure(bool assertion, string message)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Postcondition: " + message);
            }
        }
        ...
        public static void Ensure(bool assertion)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Postcondition failed.");
            }
        }
        ...
        public static void Invariant(bool assertion, string message)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Invariant: " + message);
            }
        }
        ...
        public static void Invariant(bool assertion)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Invariant failed.");
            }
        }
        ...
        public static void Assert(bool assertion, string message)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Assertion: " + message);
            }
        }
        ...
        public static void Assert(bool assertion)
        {
            ...
            {
                System.Diagnostics.Trace.Assert(assertion, "Assertion failed.");
            }
        }
