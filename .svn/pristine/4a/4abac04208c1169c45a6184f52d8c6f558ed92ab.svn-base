<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FK_0001_0002.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FK_0001_0002" %>
...
<body>
    ...
    <div>
        ...
        <tr><td valign="top" style="padding-left: 5px; width: 332px">
            ...
            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="200px" Width="309px" OnDataBinding="UltraWebGrid_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout" SkinID="UltraWebGrid" OnInitializeRow="UltraWebGrid_InitializeRow"><Bands>
<igtbl:UltraGridBand>
...
<FrameStyle BorderWidth="1px" BorderColor="InactiveCaption" BorderStyle="Solid" Font-Size="8.25pt" Font-Names="Microsoft Sans Serif" BackColor="Window" Width="309px" Height="200px"></FrameStyle>
