...
{
    public partial class FO_0035_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0035_0015_population_date");
            ...
            query = DataProvider.GetQueryText("FO_0035_0015_population");
            ...
            query = DataProvider.GetQueryText("FO_0035_0015_incomes_date");
            ...
            query = DataProvider.GetQueryText("FO_0035_0015_outcomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            query = DataProvider.GetQueryText("FO_0035_0015_credit_debts");
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0035_0015_Incomes");
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0035_0015_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0035_0015_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0035_0015_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0035_0015_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0035_0015_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        protected void UltraWebGridBudget_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            {
                e.Row.Cells[0].Style.Padding.Top = 4;
                e.Row.Cells[1].Style.Padding.Top = 4;
                e.Row.Cells[2].Style.Padding.Top = 4;
                e.Row.Cells[3].Style.Padding.Top = 4;

                e.Row.Cells[0].Style.Padding.Bottom = 4;
                e.Row.Cells[1].Style.Padding.Bottom = 4;
                e.Row.Cells[2].Style.Padding.Bottom = 4;
                e.Row.Cells[3].Style.Padding.Bottom = 4;
        ...
        void UltraWebGridSettlements_DataBinding(object sender, EventArgs e)
        {
            ...
            query = DataProvider.GetQueryText("FO_0035_0015_Incomes_settlement");
            ...
            query = DataProvider.GetQueryText("FO_0035_0015_Outcomes_settlement");
