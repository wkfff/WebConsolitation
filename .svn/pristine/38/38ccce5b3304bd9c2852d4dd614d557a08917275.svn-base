...
{
    public partial class FO_0035_0007 : CustomReportPage
    {
        ...
        private TableCell GetNameCell(string name, bool child)
        {
            ...
            cell.CssClass = "HtmlTableCompact";
            lb = new Label();
            lb.Text = String.Format("<a href='webcommand?showPopoverReport=fo_0035_0008_GRBS={1}&width=690&height=530&fitByHorizontal=true'>{0}</a>", name, CustomParams.GetGrbsIdByName(name));
