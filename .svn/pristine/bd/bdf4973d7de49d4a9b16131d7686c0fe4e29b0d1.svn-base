...
namespace Krista.FM.Server.Dashboards.reports.FK_0001_0002_NAO
{
    public partial class DefaultCompare : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText("FK_0001_0002_NAO_compare_Grid");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            SetColumnParams(e.Layout, 0, 2, "N2", 85, false);
            SetColumnParams(e.Layout, 0, 3, "N2", 85, false);
            SetColumnParams(e.Layout, 0, 4, "P2", 70, false);
            SetColumnParams(e.Layout, 0, 5, "N0", 50, false);
            SetColumnParams(e.Layout, 0, 6, "N0", 62, true);
            SetColumnParams(e.Layout, 0, 7, "N0", 50, false);
            SetColumnParams(e.Layout, 0, 8, "N0", 70, true);
            SetColumnParams(e.Layout, 0, 9, "N2", 95, false);
            SetColumnParams(e.Layout, 0, 10,"N2", 95, false);
            SetColumnParams(e.Layout, 0, 11,"N0", 80, false);
            SetColumnParams(e.Layout, 0, 12,"N0", 80, true);
            SetColumnParams(e.Layout, 0, 13,"N0", 80, false);
            SetColumnParams(e.Layout, 0, 14,"N0", 80, true);
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 4, "Исполн. %", "Процент выполнения назначений. Оценка равномерности исполнения (1/12 годового плана в месяц)");
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 10, "Среднедуш. доходы, руб./чел.", "Сумма доходов выбранного вида на душу населения");
