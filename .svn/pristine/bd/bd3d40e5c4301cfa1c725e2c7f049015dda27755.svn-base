<%@ Page Language="C#" MasterPageFile="~/Reports.Master"  AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.OMCY_0002.Default.reports.OMCY_002._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        <table>
            <tr>
                <td style="width: 100%">
                    ...
                    <asp:Label ID="SubHeaderGlobal" runat="server" CssClass="PageSubTitle"></asp:Label></td>
                <td>
                    &nbsp;<uc5:UltraGridExporter ID="UltraGridExporter1" runat="server" Visible="true" />
                    <script type='text/javascript' language='JavaScript'>
                        function showTable(x) {
                            t = document.getElementById('tableP')
                        ...
                        <span onclick='showTable(this)' 
                            style="color: #1572b4; text-decoration: underline">
                            &gt;&gt;&gt;</span>
                        <div style="position: fixed; visibility: hidden; left: 490px; top: 100px; height: 535px;"
                            id="tableP">
                            <span class="help_sp">
                            
                            <table class="helpTable" style="height: 530px; width: 100%; border-collapse: collapse;
                                ...
                                <tr>
                                    <td style="vertical-align: top;" id="Td1">
                                        <table>
                                            <tr>
                                                <td>
                                                    <uc2:CustomMultiCombo ID="ComboExcelScope" runat="server" Title="Год" />
                                                </td>
                                                <td>
                                                <div onclick='showTable(this)'>
        ...
        <table style="vertical-align: top">
            <tr>
                <td valign="top">
                    <uc2:CustomMultiCombo ID="DataSources" runat="server" Title="Месяц" />
                </td>
                <td valign="top">
                ...
                <td valign="top"><asp:CheckBox ID="CheckBox3" runat="server" AutoPostBack="True" 
