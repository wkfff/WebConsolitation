...
{
    public partial class Oil_0009_0002_02 : CustomReportPage
    {
        ...
        private void InitializeTable1()
        {
            ...
            query = DataProvider.GetQueryText("Oil_0009_0002_02_incomes_federal_date");
            ...
            query = DataProvider.GetQueryText("Oil_0009_0002_02_table2");
            ...
            query = DataProvider.GetQueryText("Oil_0009_0002_02_incomes_regional_date");
            ...
            dt = new DataTable();
            query = DataProvider.GetQueryText("Oil_0009_0002_02_table1");
