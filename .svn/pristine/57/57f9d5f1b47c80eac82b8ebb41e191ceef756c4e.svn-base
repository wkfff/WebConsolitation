<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="DefaultOKVD.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0001.DefaultOKVD" %>
            ...
            <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top" align="right">
                                <asp:CheckBox ID="HideGridNoCodeOKVD" runat="server" Text="Без значения «Нет кода ОКВЭД»"
                ...
                <tr>
                    ...
                    <td style="overflow: visible;">
                       <igmisc:WebAsyncRefreshPanel ID="gridtWebAsyncPanel" runat="server">
