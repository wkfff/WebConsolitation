<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0037_0001_H.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0037_0001_H" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="left: 0px; position: absolute; top: 0px; border-collapse: collapse;">
                <tr>
                    <td style="width: 480px; height: 360px; border-right: lime 0px solid; border-top: lime 0px solid; border-left: lime 0px solid;
                        border-bottom: lime 0px solid; position: relative; background-color: black; left: 0px; top: 0px;
                        padding-left: 0px; border-collapse: collapse;" align="left" valign="top" colspan="" rowspan="">
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="InformationText" ReadOnly="True" SkinID="TextBoxInformationText"
                            Width="470px"></asp:TextBox> 
                                             
                        <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="200px" Width="477px" OnDataBinding="UltraWebGrid1_DataBinding"
                            OnInitializeLayout="UltraWebGrid1_InitializeLayout" SkinID="UltraWebGrid" OnInitializeRow="UltraWebGrid1_InitializeRow">
                            <Bands>
                                <igtbl:UltraGridBand>
                            ...
                            <DisplayLayout ViewType="OutlookGroupBy" Version="4.00" AllowSortingDefault="OnClient" StationaryMargins="Header"
                                ...
                                <FrameStyle BorderWidth="1px" BorderColor="InactiveCaption" BorderStyle="Solid" Font-Size="8.25pt" Font-Names="Microsoft Sans Serif"
                                    BackColor="Window" Width="477px" Height="200px">
                                </FrameStyle>
                        ...
                        <br />
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="InformationText" ReadOnly="True" SkinID="TextBoxInformationText"
                            Width="470px"></asp:TextBox>
                        <igtbl:UltraWebGrid ID="UltraWebGrid3" runat="server" Height="200px" Width="477px" OnDataBinding="UltraWebGrid2_DataBinding"
                            OnInitializeLayout="UltraWebGrid2_InitializeLayout" SkinID="UltraWebGrid" OnInitializeRow="UltraWebGrid1_InitializeRow">
                            <Bands>
                                <igtbl:UltraGridBand>
                                    <AddNewRow View="NotSet" Visible="NotSet">
                                    </AddNewRow>
