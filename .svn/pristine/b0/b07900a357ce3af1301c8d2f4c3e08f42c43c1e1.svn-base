...
Const strAsgRegionCaption = "Region"
Const strAsgCityCaption = "City"

'-----------------------------------------------------------------------------------------
'Login caption text
'-----------------------------------------------------------------------------------------
Const strAsgLoginCaption = "Login"
Const strAsgTxtLoginTracking = "Track login"
...
Const strAsgTxtShowLoginInformation = "Show login information"
...
Const strAsgTxtLoginContent = "Contains login data"
Const strAsgTxtCityContent = "Contains city data"
Const strAsgTxtRegionContent = "Contains region data"
...
Const strAsgTxtIPMapTracking = "IP map tracking"
