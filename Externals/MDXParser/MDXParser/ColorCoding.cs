namespace MDXParser
{
    ...
    public class ColorCoding : List<ColorSegment>
    {
        ...
        internal void ApplyColor(SSLexLexeme lexeme, Color color)
        {
            ...
            item.Start = (lexeme.index() - lexeme.length()) - 1;
            item.Length = lexeme.length();
            item.Color = color;
            base.Add(item);
        }
                ...
                else
                {
                    if (item.Start <= segment2.Start)
                    {
                        ...
                        else
                        {
                            ...
                            segment4.Start = item.End + 1;
                            segment4.End = segment2.End;
                    ...
                    if (item.Start > segment2.Start)
                    {
                        ...
                        segment5.Start = segment2.Start;
                        segment5.Color = Color.Black;
                        ...
                        else
                        {
                            ...
                            segment6.Start = item.Start;
                            segment6.End = segment2.End;
