...
namespace Itenso.Configuration
{
	...
	public class UserConfig
	{
		...
		{
			get { return new FileInfo( this.configuration.FilePath ).Name; }
		} // FileName
		...
		public List<ClientSettingsSection> Sections
		{
			get 
			{
				...
				foreach ( ConfigurationSectionGroup sectionGroup in this.configuration.SectionGroups )
				{
		...
		public void RemoveAllSections()
		{
			...
			this.configuration.SectionGroups.Remove( userSettingsGroup.SectionGroupName );
		} // RemoveAllSections
		...
		public bool HasSameSettings( UserConfig compareUserConfig )
		{
			...
			if ( this.configuration.SectionGroups.Count != compareUserConfig.configuration.SectionGroups.Count )
			{
				return false;
			}
			...
			foreach ( ConfigurationSectionGroup compareSectionGroup in compareUserConfig.configuration.SectionGroups )
			{
				...
				UserSettingsGroup userSettingsGroup = this.configuration.SectionGroups[ compareSectionGroup.Name ] as UserSettingsGroup;
		...
		{
			this.configuration.SaveAs( fileName );
		} // SaveAs
		...
		public void Import( UserConfig importUserConfig, bool overwriteSettings )
		{
			...
			foreach ( ConfigurationSectionGroup importSectionGroup in importUserConfig.configuration.SectionGroups )
			{
				...
				UserSettingsGroup userSettingsGroup = this.configuration.SectionGroups[ importSectionGroup.Name ] as UserSettingsGroup;
				if ( userSettingsGroup == null )
				{
					userSettingsGroup = new UserSettingsGroup();
					this.configuration.SectionGroups.Add( importSectionGroup.Name, userSettingsGroup );
				}
