...
<styleLibrary>
  <annotation>
    <lastModified>2010-05-07T06:33:51</lastModified>
  </annotation>
  <styleSets defaultStyleSet="Default">
    <styleSet name="Default" buttonStyle="FlatBorderless" viewStyle="OfficeXp" useFlatMode="True">
      ...
      <styles>
        <style role="Base">
          <states>
            <state name="Normal" backColor="250, 250, 250" borderColor="Silver" backGradientStyle="None" themedElementAlpha="Transparent" backHatchStyle="None" />
          </states>
        </style>
        <style role="Button">
          <states>
        ...
        <style role="UltraFormattedTextEditor">
          <states>
            <state name="Normal" backColor="Transparent" borderColor="DarkGray" backGradientStyle="None" backHatchStyle="None" />
          </states>
        </style>
  ...
  <resources>
    ...
    <resource name="groupHeaderClaymation_Normal" foreColor="Black" borderColor="Transparent" imageBackgroundStyle="Stretched" imageBackgroundStretchMargins="4, 14, 4, 4">
      <imageBackground></imageBackground>
    </resource>
  ...
  <expertBaseElementsColors border="128; 128; 128" panel="255; 255; 255" darkpanel="192; 192; 192"/>
  <gridPropertys>
    <comments>
      <style>
    ...
    <filtersCaptions>
      <style>
        <colors backColorStart="White" backColorEnd="White" borderColor="DarkGray"/>
    ...
    <rows>
      ...
      <memPropNameStyle>
        <colors backColorStart="228; 236; 247" backColorEnd="228; 236; 247" borderColor="DarkGray" foreColor="Gray"/>
        <font sfont="Arial; 8pt"/>
      </memPropNameStyle>
      <memPropValueStyle>
        <colors backColorStart="228; 236; 247" backColorEnd="228; 236; 247" borderColor="DarkGray" foreColor="Black"/>
        <font sfont="Arial; 8pt"/>
      </memPropValueStyle>
    </rows>
    <columns>
    ...
    <measuresData>
      ...
      <totalsStyle>
        <colors backColorEnd="White" borderColor="DarkGray"/>
        <font sfont="Arial; 10pt; style=Bold"/>
        <stringFormat hAligment="Far" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
      </totalsStyle>
	  <dummyStyle>
        <colors backColorStart="WhiteSmoke" backColorEnd="WhiteSmoke" borderColor="DarkGray" foreColor="Black"/>
        <font sfont="Arial; 10pt"/>
        <stringFormat hAligment="Far" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
      </dummyStyle>
    </measuresData>
  ...
  <MDXToolbar>
    <reportElement>
      <elementCaptionStyles columnCount="5">
        <styleGroup name="Стили заголовка отчета">
          ...
          <style text="Заголовок" width="100" height="20">
            <colors backColorStart="White" backColorEnd ="White" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Center" vAligment="Center" trimming="EllipsisCharacter"/>
          </style>
          <style text="Заголовок" width="100" height="20">
            <colors backColorStart="240; 240; 240" backColorEnd ="240; 240; 240" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Center" vAligment="Center" trimming="EllipsisCharacter"/>
          </style>
          <style text="Заголовок" width="100" height="20">
            <colors backColorStart="88; 136; 195" backColorEnd ="88; 136; 195" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Center" vAligment="Center" trimming="EllipsisCharacter"/>
          </style>
          <style text="Заголовок" width="100" height="20">
            <colors backColorStart="192; 80; 77" backColorEnd ="192; 80; 77" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Center" vAligment="Center" trimming="EllipsisCharacter"/>
          </style>
        </styleGroup>
      ...
      <elementCommentStyles columnCount="5">
        <styleGroup name="Стили комментария отчета">
          ...
          <style text="Комментарий" width="100" height="20">
            <colors backColorStart="Info" backColorEnd ="Info" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter"/>
          </style>
          <style text="Комментарий" width="100" height="20">
    ...
    <table>
      <tabs>
        <propertiesTab backColor="250; 250; 250"/>
      </tabs>
	  <cellStyles columnCount="6">
        <styleGroup name="Стили">
          ...
          <style text="Текст" width="100" height="20">
            <colors backColorStart="242; 221; 220" backColorEnd="242; 221; 220" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="234; 241; 221" backColorEnd="234; 241; 221" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="229; 224; 236" backColorEnd="229; 224; 236" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="219; 238; 243" backColorEnd="219; 238; 243" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
		  <style>
          ...
          <style text="Текст" width="100" height="20">
            <colors backColorStart="195; 211; 234" backColorEnd="195; 211; 234" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="230; 185; 184" backColorEnd="230; 185; 184" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="215; 228; 188" backColorEnd="215; 228; 188" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="204; 192; 218" backColorEnd="204; 192; 218" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="182; 221; 232" backColorEnd="182; 221; 232" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
		  <style>
			<colors backColorStart="LightGray" backColorEnd="LightGray" borderColor="DarkGray" foreColor="Black"/>
			<font sfont="Arial; 10pt"/>
			<stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
		  </style>

          <style text="Текст" width="100" height="20">
            <colors backColorStart="167; 193; 227" backColorEnd="167; 193; 227" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="217; 151; 149" backColorEnd="217; 151; 149" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="194; 214; 154" backColorEnd="194; 214; 154" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="178; 161; 199" backColorEnd="178; 161; 199" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="147; 205; 221" backColorEnd="147; 205; 221" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
		  <style>
			<colors backColorStart="DarkGray" backColorEnd="DarkGray" borderColor="DarkGray" foreColor="White"/>
			<font sfont="Arial; 10pt"/>
			<stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
		  </style>
          ...
          <style text="Текст" width="100" height="20">
            <colors backColorStart="155; 187; 89" backColorEnd="155; 187; 89" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="128; 100; 162" backColorEnd="128; 100; 162" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="75; 172; 198" backColorEnd="75; 172; 198" borderColor="DarkGray" foreColor="White"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
		  <style>
			<colors backColorStart="DimGray" backColorEnd="DimGray" borderColor="DarkGray" foreColor="White"/>
			<font sfont="Arial; 10pt"/>
			<stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
		  </style>
        </styleGroup>
        ...
        <styleGroup name="Стили с градиентом">
          <style text="Текст" width="100" height="20">
            <colors backColorStart="228; 236; 247" backColorEnd="88; 136; 195" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="242; 221; 220" backColorEnd="192; 80; 77" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="234; 241; 221" backColorEnd="155; 187; 89" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="229; 224; 236" backColorEnd="128; 100; 162" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
          <style text="Текст" width="100" height="20">
            <colors backColorStart="219; 238; 243" backColorEnd="75; 172; 198" borderColor="DarkGray" foreColor="Black"/>
            <font sfont="Arial; 10pt"/>
            <stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
          </style>
		  <style>
			<colors backColorStart="WhiteSmoke" backColorEnd="DimGray" borderColor="DarkGray" foreColor="Black"/>
			<font sfont="Arial; 10pt"/>
			<stringFormat hAligment="Near" vAligment="Near" trimming="EllipsisCharacter" formatFlags="LineLimit" />
		  </style>
        </styleGroup>
