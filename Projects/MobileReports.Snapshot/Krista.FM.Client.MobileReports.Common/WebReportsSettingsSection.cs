...
using Krista.FM.Client.WebReportsCommon.ConfigElement;

namespace Krista.FM.Client.WebReportsCommon
{
    public class WebReportsSettingsSection : ConfigurationSection
    {
        private static bool _displayIt = false;

        public WebReportsSettingsSection()
        {
        }
        ...
        [ConfigurationProperty("reportExtension")]
        public ReportExtensionConfigElement BootloaderReportExtension
        {
            get { return (ReportExtensionConfigElement)base["reportExtension"]; }
            set { base["reportExtension"] = value; }
        }
