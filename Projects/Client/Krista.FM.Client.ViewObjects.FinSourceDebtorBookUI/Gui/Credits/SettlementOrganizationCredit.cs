...
{
    internal class SettlementOrganizationCredit : Credit
    {
        internal SettlementOrganizationCredit(IEntity entity)
            : base(entity)
        {
        }
        ...
        {
            return string.Concat(base.GetFileName(), "_От кредитных организаций_Поселения");
        }
