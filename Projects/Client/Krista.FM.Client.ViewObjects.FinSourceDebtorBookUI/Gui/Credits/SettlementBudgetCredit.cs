...
{
    internal class SettlementBudgetCredit : Credit
    {
        internal SettlementBudgetCredit(IEntity entity)
            : base(entity)
        {
        }
        ...
        {
            return string.Concat(base.GetFileName(), "_От других бюджетов_Поселения");
        }
