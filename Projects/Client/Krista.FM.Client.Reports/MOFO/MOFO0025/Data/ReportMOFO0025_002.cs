...
namespace Krista.FM.Client.Reports
{
    ...
    {
        /// <summary>
        /// ОТЧЕТ 002 СПИСОК МО, ОТ КОТОРЫХ НЕ ПОСТУПИЛИ ДАННЫЕ О ПРОГНОЗИРУЕМЫХ НАЧИСЛЕНИЯХ ЗЕМЕЛЬНОГО НАЛОГА НА ОФГ И ПП
        /// </summary>
        public DataTable[] GetMOFO0025Report002Data(Dictionary<string, string> reportParams)
        {
            ...
            var groupFields = new List<Enum> {QFMarksLandTax.Keys.Okato};
