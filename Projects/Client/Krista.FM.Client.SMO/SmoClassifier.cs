...
{
    public class SmoClassifier : SmoDataSourceDividedClass, IClassifier
    {
        public SmoClassifier(IClassifier serverObject)
            : base(serverObject)
        {
        }

        public SmoClassifier(SMOSerializationInfo cache)
            : base(cache)
        {
        }
        ...
        public IDimensionLevelCollection Levels
        {
            get {
                return
                    cached
                        ? (IDimensionLevelCollection)
                          SmoObjectsCache.GetSmoObject(typeof (SmoDimensionLevelCollection), GetCachedObject("Levels"))
