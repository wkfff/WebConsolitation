<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PeriodAreaChartBrick.ascx.cs" Inherits="Krista.FM.Server.Dashboards.Components.ChartBricks.PeriodAreaChartBrick" %>
