<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PeriodStackAreaChartBrick.ascx.cs" Inherits="Krista.FM.Server.Dashboards.Components.Components.ChartBricks.PeriodStackAreaChartBrick" %>
