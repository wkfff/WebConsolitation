<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ColumnChartBrick.ascx.cs" Inherits="Krista.FM.Server.Dashboards.Components.ChartBricks.ColumnChartBrick" %>
