<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BarImageChartBrick.ascx.cs" Inherits="Krista.FM.Server.Dashboards.Components.Components.ChartBricks.BarImageChartBrick" %>
