...
namespace Krista.FM.Server.Dashboards.reports.FO_0035_0014
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                DateTime lastCubeDate = CubeInfo.GetLastDate(DataProvidersFactory.PrimaryMASDataProvider, "FO_0035_0014_lastDate");
            ...
            Page.Title = "Информация по объектам капитального строительства государственной собственности";
        ...
        {
            string query = DataProvider.GetQueryText("FO_0035_0014_grid");
