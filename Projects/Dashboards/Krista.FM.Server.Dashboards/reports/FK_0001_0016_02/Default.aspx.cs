...
namespace Krista.FM.Server.Dashboards.reports.FK_0001_0016_02
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            StackChart.Legend.Margins.Right = Convert.ToInt32(UltraChart.Width.Value / 3);
            ...
            legend.Title = "Уровень эффективности бюджетных расходов\nв сфере организации гос. и муниц. управления";
            ...
            CrossLink.Text = "Неэффективные&nbsp;расходы&nbsp;на&nbsp;ЖКХ";
            CrossLink.NavigateUrl = "~/reports/FK_0001_0016_01/Default.aspx";
            /*
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FK_0001_0016_02_date");
            ...
            {
                PageTitle.Text = "Оценка неэффективных расходов в сфере организации государственного и муниципального управления";
                ...
                mapElementCaption.Text = "Уровень эффективности расходования бюджетных средств в сфере организации гос. и муниц. управления";
                stackChartElementCaption.Text = String.Format("Структура расходов консолидированных бюджетов субъектов {0} в сфере организации гос. и муниц. управления",
                    currentFoShortName);
        ...
        private void ActiveGridRow(UltraGridRow row)
        {
            ...
            {
                chartElementCaption.Text = string.Format("Помесячная динамика доли неэффективных расходов в сфере организации гос. и муниц. управления ({0})", regionName);
        ...
        {
            string query = DataProvider.GetQueryText("FK_0001_0016_02_grid");
            ...
            if (dtGrid.Rows.Count > 0)
            {
                foreach (DataColumn column in dtGrid.Columns)
                {
                    ...
                    {
                        case "Расходы консолидированного бюджета на содержание ОИВ и ОМСУ":
                            {
                                column.ColumnName = "Расходы консолидированного бюджета на содержание ОИВ и ОМСУ, тыс.руб.";
                                break;
                            }
                        ...
                        case "Численность постоянного населения":
                            {
                                column.ColumnName = string.Format("Численность постоянного населения {0}, тыс.чел.", populationDate);
                                break;
                            }
                        case "Коэффициент масштаба":
                            {
                                column.ColumnName = "Коэффициент масштаба";
                                break;
                            }
                        case "Объем неэффективных расходов полож":
                            {
                                column.ColumnName = "Объем неэффективных расходов в сфере государственного и муниципального управления, тыс.руб.";
                                break;
                            }
                        case "Доля неэффективных расходов в общей сумме расходов на государственное и муниципальное управление":
                            {
                                column.ColumnName = "Доля неэффективных расходов в общей сумме расходов на государственное и муниципальное управление";
                                break;
                            }
                        case "Доля неэффективных расходов в общей сумме расходов бюджета":
                            {
                        ...
                        case "Уровень эффективности бюджетных расходов":
                            {
                                column.ColumnName = "Уровень эффективности бюджетных расходов в сфере организации гос. и муниц. управления";
                                break;
                            }
                    }
                }
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            cellsFormulasCaption.Add("Ргос");
            cellsFormulasCaption.Add("Робщ");
            cellsFormulasCaption.Add("Чн");
            cellsFormulasCaption.Add("Км = 0,7 + 0,05 * ((Чфо / Кол-во субФО) / Чн)");
            cellsFormulasCaption.Add("РгосН = Ргос - РгосФО / РобщФО * Робщ * Км");
            cellsFormulasCaption.Add("Дгос = РгосН / Ргос * 100%");
            cellsFormulasCaption.Add("Дгос общ = РгосН / Робщ * 100%");
            cellsFormulasCaption.Add("Ид = (максДгос общ - Дгос общ) / (Макс Дгос общ - МинДгос общ)");
            ...
            /* CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 1, cellsFormulasCaption[1], "");
             ...
             CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 5, cellsFormulasCaption[5], "");
             CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 6, cellsFormulasCaption[6], "");
             CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 8, cellsFormulasCaption[7], "");
             CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 10, cellsFormulasCaption[8], "");

             ColumnHeader ch = CRHelper.AddHierarchyHeader(e.Layout.Grid, 0, "Расходы консолидированного бюджета на содержание ОИВ и ОМСУ, тыс.руб.", 1, 0, 1, 1);
             ch.Title = PlanSelected
                            ? "Плановый объем расходов на содержание органов исполнительной власти и органов местного самоуправления"
                            : "Фактический объем расходов на содержание органов исполнительной власти и органов местного самоуправления";
             ...
             ch = CRHelper.AddHierarchyHeader(e.Layout.Grid, 0, string.Format("Численность постоянного населения {0}, тыс.чел.", populationDate), 3, 0, 1, 1);
             ch.Title = "Численность постоянного населения субъекта РФ";

             ch = CRHelper.AddHierarchyHeader(e.Layout.Grid, 0, "Коэффициент масштаба", 4, 0, 1, 1);
             ch.Title = "Корректирующий коэффициент масштаба";

             ch = CRHelper.AddHierarchyHeader(e.Layout.Grid, 0, "Объем неэффективных расходов в сфере государственного и муниципального управления, тыс.руб.", 5, 0, 1, 1);
             ch.Title = "Объем неэффективных расходов в сфере организации государственного и муниципального управления";
            
             ch = CRHelper.AddHierarchyHeader(e.Layout.Grid, 0, "Доля неэффективных расходов в общей сумме расходов на государственное и муниципальное управление", 6, 0, 1, 1);
             ch.Title = "Доля неэффективных расходов в общем объеме расходов консолидированного бюджета субъекта РФ на организацию государственного и муниципального управления";

             ch = CRHelper.AddHierarchyHeader(e.Layout.Grid, 0, "Доля неэффективных расходов в общей сумме расходов", 7, 0, 1, 1);
             ch.Title = "Доля неэффективных расходов в сфере организации государственного и муниципального управления в общем объеме расходов консолидированного бюджета субъекта РФ";

             ch = CRHelper.AddHierarchyHeader(e.Layout.Grid, 0, "Уровень эффективности бюджетных расходов в сфере организации гос. и муниц. управления", 8, 0, 1, 1);
             ch.Title = "Уровень эффективности расходования бюджетных средств";
             */

            headerlayout.AddCell("Субъект РФ");
            GridHeaderCell cell = headerlayout.AddCell("Расходы консолидированного бюджета на содержание ОИВ и ОМСУ, тыс.руб.", PlanSelected
                           ? "Плановый объем расходов на содержание органов исполнительной власти и органов местного самоуправления"
                           : "Фактический объем расходов на содержание органов исполнительной власти и органов местного самоуправления");
            ...
            cell = headerlayout.AddCell(string.Format("Численность постоянного населения {0}, тыс.чел.", populationDate), "Численность постоянного населения субъекта РФ");
            cell.AddCell(cellsFormulasCaption[3]);
            cell = headerlayout.AddCell("Коэффициент масштаба", "Корректирующий коэффициент масштаба");
            cell.AddCell(cellsFormulasCaption[4]);
            cell = headerlayout.AddCell("Объем неэффективных расходов в сфере государственного и муниципального управления, тыс.руб.",
                "Объем неэффективных расходов в сфере организации государственного и муниципального управления");
            cell.AddCell(cellsFormulasCaption[5]);
            cell = headerlayout.AddCell("Доля неэффективных расходов в общей сумме расходов на государственное и муниципальное управление",
                "Доля неэффективных расходов в общем объеме расходов консолидированного бюджета субъекта РФ на организацию государственного и муниципального управления");
            cell.AddCell(cellsFormulasCaption[6]);
            cell = headerlayout.AddCell("Доля неэффективных расходов в общей сумме расходов",
                "Доля неэффективных расходов в сфере организации государственного и муниципального управления в общем объеме расходов консолидированного бюджета субъекта РФ");
            cell.AddCell(cellsFormulasCaption[7]);
            cell = headerlayout.AddCell("Уровень эффективности бюджетных расходов в сфере организации гос. и муниц. управления",
                "Уровень эффективности расходования бюджетных средств");
            cell.AddCell(cellsFormulasCaption[8]);
                ...
                if (rank)
                {
                    if (e.Row.Cells[i].Value != null && e.Row.Cells[i + 3].Value != null)
                    {
                        ...
                        switch (i)
                        {
                            case 6:
                                {
                                    hint = "доля неэффективных расходов на государственное и муниципальное управление";
                                    break;
                                }
                            case 7:
                                {
                        ...
                        {
                            e.Row.Cells[i].Style.BackgroundImage = i == 8 ? "~/images/starYellowBB.png" : "~/images/starGrayBB.png";
                            e.Row.Cells[i].Title = string.Format("Максимальная {0}", hint);
                        }
                        else if (e.Row.Cells[i + 3].Value.ToString() == "min")
                        {
                            e.Row.Cells[i].Style.BackgroundImage = i == 8 ? "~/images/starGrayBB.png" : "~/images/starYellowBB.png";
        ...
        {
            string query = DataProvider.GetQueryText("FK_0001_0016_02_chart");
        ...
        {
            string query = DataProvider.GetQueryText("FK_0001_0016_02_stackChart");
        ...
        public void FillMapData(MapControl map)
        {
            ...
            string query = DataProvider.GetQueryText("FK_0001_0016_02_map");
...
/*
        ...
        private void ExcelExporter_EndExport(object sender, EndExportEventArgs e)
        {
            ...
            e.CurrentWorksheet.Columns[0].Width = 210 * 37;
            ...
            for (int i = 1; i < columnCount; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 4:
                        {
                            formatString = "#,####0.0000;[Red]-#,####0.0000";
                            break;
                        }
                    case 6:
                    case 7:
        ...
        private void PdfExportButton_Click(object sender, EventArgs e)
        {
            ...
            ReportPDFExporter1.HeaderCellHeight = 75;
            ...
            title.Style.Font = new Infragistics.Documents.Reports.Graphics.Font(font);
            title.AddContent(mapElementCaption.Text);
            section4.PageMargins.Top = 35;
            section4.PageMargins.Left = 30;
            ...
            image = (new Bitmap(imageStream)).ScaleImageIg(1);

            section4.PageOrientation = PageOrientation.Landscape;
            section4.AddImage(image);
