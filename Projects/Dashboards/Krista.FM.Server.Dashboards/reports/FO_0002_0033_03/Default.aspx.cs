...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0033_03
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = "Динамика исполнения областного бюджета по кодам операций сектора государственного управления";
            Label1.Text = Page.Title;
            Label2.Text = String.Format("Динамика исполнения областного бюджета по состоянию на {0:dd.MM.yyyy}, {1}, {2}, тыс. руб.", currentDate, ComboMeans.SelectedValue, ComboKOSGU.SelectedValue);
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            CRHelper.SaveToErrorLog(string.Format("год {0}", lastYear));
            CRHelper.SaveToErrorLog(string.Format("год {0}", currentMonth));
            CRHelper.SaveToErrorLog(string.Format("год {0}", finDay));
        ...
        private static string GetColumnFormat(string columnName)
        {
            ...
            if (columnName.Contains("Тип средств") || columnName.Contains("КОСГУ"))
            {
                return "";
            }
           return "N2";
