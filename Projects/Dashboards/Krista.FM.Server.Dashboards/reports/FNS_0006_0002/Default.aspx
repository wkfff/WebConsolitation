<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0006_0002.Default" Title="Индикаторы БК и КУ " %>
                ...
                <table runat="server" id="GridTable1" style="border-collapse: collapse; background-color: white; width: 100%; height: 100%;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle" Text="Анализ начисленных сумм"></asp:Label>
                        </td>
            ...
            <td>
                ...
                <table runat="server" id="ChartTable1" style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text="Начисления по категориям налогоплательщиков в разрезе территорий"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
                     <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="GO" runat="server" Text="без ГО" AutoPostBack="true" Checked="true"
