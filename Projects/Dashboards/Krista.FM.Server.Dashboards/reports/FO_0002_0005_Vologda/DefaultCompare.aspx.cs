    ...
    public partial class DefaultCompare : CustomReportPage
    {
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 4,
                String.Format("Ранг % {0}", GridRegionsSetCaption),
                String.Format("Ранг (место) бюджета по проценту исполнения назначений среди бюджетов {0}", GridRegionsSetCaption));
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 6, "Численность постоянного населения, тыс.чел.", "Численность постоянного населения");
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 7, "Среднедушевые доходы, руб./чел.", "Сумма доходов выбранного вида на душу населения");
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 8,
                String.Format("Ранг среднедуш. {0}", GridRegionsSetCaption),
                String.Format("Ранг (место) бюджета по среднедушевым доходам среди бюджетов {0}", GridRegionsSetCaption));
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 10,
                String.Format("Доля {0}, %", GridRegionsSetCaption),
                String.Format("Доля доходов бюджета в общей сумме доходов бюджетов {0}, %", GridRegionsSetCaption));
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 12, "% наполнения бюджета", "Процент наполнения бюджета за аналогичный период прошлого года");
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 13, "Средний % наполнения бюджета", "Средний процент наполнения бюджета за два года предыдущих отчетному");
        }
