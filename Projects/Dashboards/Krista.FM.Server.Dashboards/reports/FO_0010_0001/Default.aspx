<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0010_0001.Default" %>
    ...
    <table width="100%">
        <tr  >
            <td valign="top" style="width: 100%; vertical-align: top;">
                ...
                &nbsp;&nbsp;
                <asp:Label ID="PageTitle" runat="server" CssClass="PageTitle"></asp:Label>&nbsp;&nbsp;<asp:Label ID="PageSubTitle" runat="server" CssClass="PageSubTitle"></asp:Label><br/>
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboRegionCode" runat="server"></uc3:CustomMultiCombo>
                        </td>                                             
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboRegionType" runat="server"></uc3:CustomMultiCombo>
                        </td>     
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboRegion" runat="server"></uc3:CustomMultiCombo>
                        </td>    
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboMainIndicator" runat="server"></uc3:CustomMultiCombo>
                        </td>  
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboDetailIndicator" runat="server"></uc3:CustomMultiCombo>
                        </td>                                                                                                                                  
                        <td valign="top">
