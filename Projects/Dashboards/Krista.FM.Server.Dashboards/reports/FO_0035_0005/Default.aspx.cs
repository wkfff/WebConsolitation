...
namespace Krista.FM.Server.Dashboards.reports.FO_0035_0005
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0035_0005_date");
            ...
            dtDate = new DataTable();
            string lastMonthQuery = DataProvider.GetQueryText("FO_0035_0005_lastMonth");
            ...
            Page.Title = "Годовой кассовый план исполнения областного бюджета Самарской области";
            PageTitle.Text = Page.Title;
            PageSubTitle.Text = String.Format("Кассовый план на {1} год, данные приводятся по состоянию на {0:dd.MM.yyyy}", nextMonthDate, currentDate.Year);
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0035_0005_grid_incomes");
            ...
            query = DataProvider.GetQueryText("FO_0035_0005_grid_outcomes");
            ...
            query = DataProvider.GetQueryText("FO_0035_0005_grid_incomes");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            headerLayout.AddCell("Итого за год, тыс.руб.", "Кассовый план на год");

            int quarterIndex = 1;
            for (int i = 2; i < e.Layout.Bands[0].Columns.Count; i = i + 2)
            {
                headerLayout.AddCell(String.Format("{0} квартал, тыс.руб.", GetRomanDigit(quarterIndex)), String.Format("Кассовый план на {0} квартал", quarterIndex));
                headerLayout.AddCell("Удельный вес, %", String.Format("Удельный вес плана на {0} квартал по отношению к плану на год", quarterIndex));
                quarterIndex++;
            }
