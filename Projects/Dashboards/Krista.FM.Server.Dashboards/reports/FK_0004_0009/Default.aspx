<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0004_0009.Default" Title="Untitled Page" %>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport" style="overflow: visible;">
                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle">Исполнение федерального бюджета по государственным программам и непрограммам</asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left" style="padding-top: 4px">
                            <asp:CheckBox ID="ShowAll" runat="server" Text="Показать подпрограммы и мероприятия" AutoPostBack="true"
                                Checked="false" CssClass="InformationText" Visible="false"/>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
