...
//            UltraChart2.Axis.X.StripLines.Visible = true;
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = string.Format("Прирост {0} по муниципальным районам и городским округам", nameIndex);
            ...
            PageSubTitle.Text = String.Format("{3}{4} за {0} {1} {2} года", month, CRHelper.RusManyMonthGenitive(month), year, ComboKD.SelectedValue.TrimEnd(' '),
            ...
            chart1Label1.Text = String.Format("Прирост/снижение н{1} по местным бюджетам с начала {0} года", ComboYear.SelectedValue, genStr);
            chart1Label2.Text = string.Format("Распределение территорий по росту/снижению н{0} по местным бюджетам в сравнении с прошлым годом", genStr);
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_HMAO_regions_grid_split" : "FNS_0001_0001_HMAO_regions_grid";
            string query = DataProvider.GetQueryText(queryName);
            ...
            if (dtGrid.Rows.Count > 0)
            {
                if (UseMonthReport)
                {
                    query = DataProvider.GetQueryText("FNS_0001_0001_HMAO_regions_grid_monthReport");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 14)
            {
                ...
                SetColumnParams(e.Layout, 0, 5, "P2", 70, false);
                ...
                SetColumnParams(e.Layout, 0, 11, "N2", 95, false);
                SetColumnParams(e.Layout, 0, 12, "P2", width, false);
                SetColumnParams(e.Layout, 0, 13, "N0", 78, false);
                SetColumnParams(e.Layout, 0, 14, "N0", 78, true);
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 1, String.Format("Н{2} на 01.{0:00}.{1}, тыс.руб.", nextMonth, nextYear - 1, nomStr), String.Format("Н{3} за {0} {1} {2} года.", month, CRHelper.RusManyMonthGenitive(month), year - 1,genStr));
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 2, String.Format("Н{2} на 01.{0:00}.{1}, тыс.руб.", nextMonth, nextYear,nomStr), String.Format("Н{3} за  {0} {1} {2} года", month, CRHelper.RusManyMonthGenitive(month), year, genStr));
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 12, String.Format("Удельный вес н{0} в общем объеме поступлений, %", genStr), String.Format("Удельный вес н{3} в общем объеме поступлений, % за {0} {1} {2} года", month, CRHelper.RusManyMonthGenitive(month), year, genStr));
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 13, String.Format("Ранг по удельному весу"), "Ранг по удельному весу недоимки в общем объеме поступлений*"); 
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_HMAO_regions_chart1_split" : "FNS_0001_0001_HMAO_regions_chart1";
            string query = DataProvider.GetQueryText(queryName);
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_HMAO_regions_chart2_split" : "FNS_0001_0001_HMAO_regions_chart2";
            string query = DataProvider.GetQueryText(queryName);
