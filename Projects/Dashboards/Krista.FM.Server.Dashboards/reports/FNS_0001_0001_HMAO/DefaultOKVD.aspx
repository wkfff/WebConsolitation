<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="DefaultOKVD.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0001_HMAO.DefaultOKVD" %>
    ...
    <table width="100%">
        <tr>
            <td valign="top" style="width: 100%; vertical-align: top;">
                <uc4:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultOKVD.html" />
                &nbsp;&nbsp;
        ...
        <tr>
            <td>
                <table style="vertical-align: top;">
                    ...
                    <tr runat="server" id="checkboxTR">
                        <td runat="server" id="checkboxTD" valign="middle" align="left" style="font-family: Verdana;
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top" align="right">
                                ...
                                <asp:CheckBox ID="HideNoCodeOKVD2" runat="server" Text="Без значения «Нет кода ОКВЭД»"
                        ...
                        <td style="overflow: visible;" colspan="2">
                            <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel2" runat="server">
                                <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    ...
                                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fns_02_01_okvd1#SEQNUM(100).png" />
                                </igchart:UltraChart>
            ...
            <td valign="top" align="left">
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="HideNoCodeOKVD1" runat="server" Text="Без значения «Нет кода ОКВЭД»"
                                AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" />
                        </td>
                        <td class="right">
                        </td>
                        ...
                        <td style="overflow: visible;" colspan="2">
                            <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel1" runat="server">
                                <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    ...
                                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fns_01_01_okvd2#SEQNUM(100).png" />
                                </igchart:UltraChart>
                            </igmisc:WebAsyncRefreshPanel>
                        </td>
                        <td class="right">
