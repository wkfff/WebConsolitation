...
<root>
  ...
  <query id="FO_0002_0014_Yamal_date">
    <![CDATA[
-- FO_0002_0014_Yamal_date
with
...
from  [ФО_МесОтч_Доходы]
  ...
  <query id="FO_0002_0014_Yamal_grid_incomes">
    <![CDATA[
-- FO_0002_0014_Yamal_grid_incomes
With 
...
where  
  ...
  <query id="FO_0002_0014_Yamal_grid_outcomes">
    <![CDATA[
-- FO_0002_0014_Yamal_grid_outcomes
With 
    member [Уровни бюджета].[СКИФ].[Бюджет гор.округа, мун.района и поселения] 
    as '<%consolidate_region_budget_level%>' 
    member [Уровни бюджета].[СКИФ].[Конс.бюджет мун.образования] 
...
where  
  ...
  <query id="FO_0002_0014_Yamal_grid_deficit">
    <![CDATA[
-- FO_0002_0014_Yamal_grid_deficit
With 
    member [Уровни бюджета].[СКИФ].[Бюджет гор.округа, мун.района и поселения] 
    as '<%consolidate_region_budget_level%>' 
    member [Уровни бюджета].[СКИФ].[Конс.бюджет мун.образования] 
...
where  
  ...
  <query id="FO_0002_0014_Yamal_grid_credit">
    <![CDATA[
-- FO_0002_0014_Yamal_grid_credit
With 
    member [Уровни бюджета].[СКИФ].[Бюджет гор.округа, мун.района и поселения] 
    as '<%consolidate_region_budget_level%>' 
    member [Уровни бюджета].[СКИФ].[Конс.бюджет мун.образования] 
...
where  
  ...
  <query id="FO_0002_0014_Yamal_grid_innerDebtsMO">
    <![CDATA[
-- FO_0002_0014_Yamal_grid_innerDebtsMO
With 
    member [Уровни бюджета].[СКИФ].[Бюджет гор.округа, мун.района и поселения] 
    as '<%consolidate_region_budget_level%>' 
    member [Уровни бюджета].[СКИФ].[Конс.бюджет мун.образования] 
...
where  
  ...
  <query id="FO_0002_0014_Yamal_grid_budgetarySurpluses">
    <![CDATA[
-- FO_0002_0014_Yamal_grid_budgetarySurpluses
With 
    member [Уровни бюджета].[СКИФ].[Бюджет гор.округа, мун.района и поселения] 
    as '<%consolidate_region_budget_level%>' 
    member [Уровни бюджета].[СКИФ].[Конс.бюджет мун.образования] 
...
where  
  ...
  <query id="FO_0002_0014_Yamal_grid_creditDebts">
    <![CDATA[
-- FO_0002_0014_Yamal_grid_creditDebts
With 
    member [Уровни бюджета].[СКИФ].[Бюджет гор.округа, мун.района и поселения] 
    as '<%consolidate_region_budget_level%>' 
    member [Уровни бюджета].[СКИФ].[Конс.бюджет мун.образования] 
