<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0014_Yamal.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="mapElementCaption1" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <DMWC:MapControl ID="DundasMap1" runat="server" BackColor="White" ResourceKey="#MapControlResKey#DundasMap1#"
                                ImageUrl="../../TemporaryImages/map_fo_02_14_01#SEQ(300,3)" RenderingImageUrl="../../TemporaryImages/">
                                <NavigationPanel>
            ...
            <td>
                <table runat="server" id="map2Table" style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                        </td>
                        <td class="top">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="mapElementCaption2" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <DMWC:MapControl ID="DundasMap2" runat="server" BackColor="White" ResourceKey="#MapControlResKey#DundasMap2#"
                                ImageUrl="../../TemporaryImages/map_fo_02_14_02#SEQ(300,3)" RenderingImageUrl="../../TemporaryImages/">
                                <NavigationPanel>
                                    <Location X="0" Y="0"></Location>
                                    <Size Height="90" Width="90"></Size>
                                </NavigationPanel>
