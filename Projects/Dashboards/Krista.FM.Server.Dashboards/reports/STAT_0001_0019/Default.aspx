<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0001_0019.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="chart1ElementCaption" runat="server" CssClass="ElementTitle"></asp:Label><br/><br/>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="chart2ElementCaption" runat="server" CssClass="ElementTitle"></asp:Label><br/><br/>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="chart3ElementCaption" runat="server" CssClass="ElementTitle"></asp:Label><br/><br/>
