...
namespace Krista.FM.Server.Dashboards.reports.STAT_0001_0020_Sakhalin
{
    /// <summary>
    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                FillComboRegion(ComboRegion, "STAT_0001_0020_Sakhalin_list_of_regions");
                GetQuarters(firstQuarter, lastQuarter, "STAT_0001_0020_Sakhalin_quarters");
            }
            ...
            if (ComboRegion.SelectedValue == "Сахалинская область")
            {
        ...
        {
            string query = DataProvider.GetQueryText("STAT_0001_0020_Sakhalin_grid");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, Infragistics.WebUI.UltraWebGrid.LayoutEventArgs e)
        {
            ...
            for (int i = 0; i < e.Layout.Bands[0].Columns.Count; ++i)
            {
                ...
                e.Layout.Bands[0].Columns[i].Width = i < 2 ? CRHelper.GetColumnWidth(columnWidth) : CRHelper.GetColumnWidth(columnWidth + 15);
        ...
        {
            string query = DataProvider.GetQueryText("STAT_0001_0020_Sakhalin_chart");
        ...
        protected bool IsEmptySeries(NumericSeries series)
        {
            bool result = true;
            foreach (NumericDataPoint ndp in series.Points)
            {
                result &= ndp.Value == 0;
            }
            return result;
            ...
            for (int i = 0; i < e.SceneGraph.Count; ++i)
            {
                ...
                if (primitive is Box)
                {
                    ...
                    if (b.rect.Height < 1)
                    {
                        ...
                        if (primitive.Series != null && primitive.Series.Label == "Нет данных")
                        {
                            DeleteList.Add(primitive);
                        }
                }
        ...
        private void PdfExportButton_Click(object sender, EventArgs e)
        {
            ...
            ReportPDFExporter1.Export(UltraChart, String.Format("{0}, {1}", LabelChart.Text, ComboRegion.SelectedValue), section2);
        }
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = sheet2.MergedCellsRegions.Count - 1; i >= 0; --i)
            {
                ...
                if (wmcr.FirstColumn == 0 && wmcr.FirstRow < 3)
                {
        ...
        protected void FillComboRegion(CustomMultiCombo combo, string queryName)
        {
            ...
            string query = DataProvider.GetQueryText(queryName);
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "Регион", dtRegion);
            ...
            {
                string region = dtRegion.Rows[row]["Регион"].ToString();
                ...
                dictRegion.Add(region, dtRegion.Rows[row]["Имя региона"].ToString());
            }
            combo.FillDictionaryValues(dict);
            combo.SetСheckedState("Сахалинская область", true);
        }
