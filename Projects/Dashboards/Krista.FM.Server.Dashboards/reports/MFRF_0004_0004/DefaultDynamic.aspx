<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultDynamic.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.MFRF_0004_0004.DefaultDynamic"
    Title="" %>
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;">
                                <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                                    ...
                                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_MFRF0404#SEQNUM(100).png" />
                                    <Border Thickness="0" />
                                </igchart:UltraChart>
                            </td>
                            <td class="right">
