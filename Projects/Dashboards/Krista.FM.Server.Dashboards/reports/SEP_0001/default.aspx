<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_0001._default" %>
                                ...
                                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; height: 360px;">
                                            <asp:Label ID="CL" runat="server" CssClass="ElementTitle"></asp:Label>
                                            <igchart:UltraChart ID="C" runat="server" BackgroundImageFileName=""  
                                                 EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                                Height="400px" OnDataBinding="C_DataBinding" Version="9.1" Width="500px" OnFillSceneGraph="C_FillSceneGraph">
                                                ...
                                                <Axis>
                                                    ...
                                                    <X Extent="0" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True">
                                                        <Margin>
                                                        ...
                                                        <Labels Font="Verdana, 8pt" FontColor="DimGray" HorizontalAlign="Near" ItemFormatString="&lt;ITEM_LABEL&gt;"
                                                            Orientation="VerticalLeftFacing" OrientationAngle="89" VerticalAlign="Near" Visible="False">
                                                    ...
                                                    <Y Extent="50" TickmarkInterval="40" TickmarkStyle="Smart" Visible="True">
