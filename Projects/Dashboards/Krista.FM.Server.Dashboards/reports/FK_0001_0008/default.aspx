<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0008.FK_0001_0008Form" Title="Картограмма: доходы по субъектам РФ"%>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <table style="width: 655px">
            ...
            <tr>
                <td style="width: 59px">
                    <asp:Label ID="LabelParamClassifier" runat="server" SkinID="ParamChooseTitle" Text="Доходы"></asp:Label></td>
                <td style="width: 168px">
            ...
            <tr>
                <td colspan="2">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/reports/FK_0001_0009/Default.aspx"
                        SkinID="HyperLink" Width="301px">Картограмма: расходы по субъектам РФ</asp:HyperLink></td>
                <td style="width: 167px">
                </td>
                <td style="width: 3px">
                </td>
