<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0017_02.Default" Title="Доходы по субъектам РФ" %>
    ...
    <table>
        <tr>
            <td style="width: 100%">
                ...
                <asp:Label ID="PageSubTitle" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label><br/>
            <td align="right">
