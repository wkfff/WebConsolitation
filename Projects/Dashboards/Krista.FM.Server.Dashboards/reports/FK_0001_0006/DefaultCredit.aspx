<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultCredit.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0006.DefaultCredit" %>

<%@ Register Src="../../Components/ContainerPanel.ascx" TagName="ContainerPanel"
    TagPrefix="uc5" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td colspan="2">
                <asp:Label ID="chartLabel1" runat="server" CssClass="ElementSubTitle" Style="line-height: 25px;"></asp:Label><br />
                <asp:Label ID="chartLabel2" runat="server" CssClass="ElementSubTitle" Style="line-height: 25px;"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 3px;">
                    <tr>
                        <td class="topleft">
                        </td>
                        <td class="top">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                OnDataBinding="UltraChart2_DataBinding" Version="8.2">
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FK0106_2#SEQNUM(100).png" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
                        </td>
