<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Title="Помесячная динамика поступления доходов"
    Codebehind="DefaultDetail.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.MFRF_0003_0002.DefaultDetail" %>
                ...
                <td>
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;">
                                <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="200px" OnInitializeRow="UltraWebGrid_InitializeRow"
