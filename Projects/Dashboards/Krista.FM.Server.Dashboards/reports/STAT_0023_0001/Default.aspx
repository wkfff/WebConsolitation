<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0023_0001.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboOrg" runat="server">
                </uc3:CustomMultiCombo>
            </td>
            <td valign="top">
    ...
    <asp:Label ID="OrganizationCaption" runat="server" CssClass="ElementTitle"></asp:Label>
        ...
        <tr>
            ...
            <td style="overflow: visible;">
             <asp:Label ID="ChartCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                <uc9:PeriodStackAreaChartBrick ID="ChartBrick" runat="server">
                </uc9:PeriodStackAreaChartBrick>
            </td>
            <td class="right">
            </td>
        </tr>
