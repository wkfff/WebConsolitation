<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0008.Default" Title="Индикаторы БК и КУ " %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboFNS65n" runat="server"></uc3:CustomMultiCombo>
                        </td>
            <td valign="top">
                ...
                <table runat="server" id="GridTable1" style="border-collapse: collapse; background-color: white; width: 100%; height: 100%;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="tableCaption" runat="server" CssClass="ElementTitle" Text="Анализ сумм начисленных и поступивших платежей, тыс.руб."></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="Td2" valign="top">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px"
                                ...
                                StyleSetName="Office2008Blue" SkinID="UltraWebGrid" Width="325px" OnInitializeRow="UltraWebGrid_InitializeRow" >
                                <Bands>
                                    <igtbl:UltraGridBand>
