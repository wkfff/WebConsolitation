...
namespace Krista.FM.Server.Dashboards.reports.FNS_0001_0008
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            if (fns65n == null)
            {
                fns65n = UserParams.CustomParam("fns65n");
            }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string queryName = "FNS_0001_0008_date";
                ...
                ComboFNS65n.Width = 320;
                ComboFNS65n.Title = "Показатель ФНС 65н";
                ComboFNS65n.MultiSelect = false;
                ComboFNS65n.ParentSelect = true;
                ComboFNS65n.FillDictionaryValues(CustomMultiComboDataHelper.FillFNS65nList());
                ComboFNS65n.SetСheckedState("Начислено - всего", true);
           ...
           Label1.Text = "Анализ сумм начисленных и поступивших платежей и иных показателей 65н в разрезе доходных источников"; 
           ...
           fns65n.Value = ComboFNS65n.SelectedValue;
           ...
           Label2.Text = String.Format("<br/>{0} {1} года, {2}, {3}, {4}, тыс.руб.", titlemonth,ComboYear.SelectedValue,ComboBudgetLevel.SelectedValue.ToLower(),ComboRegion.SelectedValue,
               ComboFNS65n.SelectedValue);
           string patternValue = UserParams.StateArea.Value;
           tableCaption.Text = String.Format("Анализ сумм по показателю «{0}», тыс.руб.", ComboFNS65n.SelectedValue.ToLower());
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FNS_0001_0008_compare_Grid");
        ...
        {
            string query = DataProvider.GetQueryText("FNS_0001_0008_compare_Chart1_1");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            if (e.Layout.Bands[0].Columns.Count > 0)
            {
                ...
                {
                    e.Layout.Bands[0].Columns[k].Width = 156;
                ...
                e.Layout.Bands[0].Columns[1].Header.Caption = "Муниципальные образования";
        ...
        private void ExcelExporter_EndExport(object sender, Infragistics.WebUI.UltraWebGrid.ExcelExport.EndExportEventArgs e)
        {
            ...
            e.CurrentWorksheet.Columns[1].CellFormat.Alignment = HorizontalCellAlignment.Left;
            for (int i = 3; i < 4; i++)
            {
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            Worksheet sheet1 = workbook.Worksheets.Add("Нач. и пост. платежи ");
            UltraGridExporter1.ExcelExporter.DownloadName = "report.xls";
