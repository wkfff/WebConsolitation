<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessGKH_Novosib._default" %>
                    ...
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 100%; height: 100%">
                                <asp:Label ID="Label1" runat="server" CssClass="ElementTitle">Неэффективные расходы консолидированного бюджета  в сфере жкх</asp:Label><igtbl:UltraWebGrid ID="G" runat="server" OnDataBinding="G_DataBinding" SkinID="UltraWebGrid"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="Label8" runat="server" CssClass="ElementTitle" Height="45px">Динамика доли неэффективных расходов, %</asp:Label><igchart:UltraChart ID="C1" runat="server" BackgroundImageFileName=""                                      EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    OnDataBinding="C1_DataBinding" Version="9.1" OnFillSceneGraph="C1_FillSceneGraph" Width="1024px">
                                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;&lt;br&gt; &lt;b&gt;&lt;DATA_VALUE:### ##0.00&gt;&lt;/b&gt;%" />
                                    <Border Thickness="0" />
                                    <Data SwapRowsAndColumns="True">
                                    </Data>
                                    <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chaart11_#SEQNUM(100).png" />
                                    ...
                                    <Axis>
                                        ...
                                        <Y Extent="50" LineThickness="1" TickmarkInterval="20" TickmarkStyle="DataInterval" Visible="True">
                                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                                Visible="True" />
                                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                                Visible="False" />
                                    ...
                                    <Legend Font="Microsoft Sans Serif, 9pt" Location="Bottom" SpanPercentage="12" Visible="True" FormatString="                                                                                                  ." FontColor="Transparent">
            ...
            <td colspan="2" style="vertical-align: top">
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top; width: 100%; height: 100%">
                            <asp:Label ID="Label2" runat="server" CssClass="ElementTitle">Уровень эффективности расходования бюджетных средств в сфере ЖКХ на (2009), %</asp:Label>
                            <igtbl:UltraWebGrid ID="G2" runat="server" OnDataBinding="G2_DataBinding" SkinID="UltraWebGrid"
                                    StyleSetName="Office2007Blue" OnInitializeLayout="G2_InitializeLayout" OnInitializeRow="G2_InitializeRow" OnDblClick="G2_DblClick">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible">
                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle">Уровень эффективности расходования бюджетных средств в сфере ЖКХ на (2009), %</asp:Label><DMWC:MapControl ID="DundasMap" runat="server" BackColor="White" ImageUrl="../../../../TemporaryImages/map_MO00_128_#SEQ(300,3)"
