<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessEducation_Novosib_._default" %>
            ...
            <tr>
                <td colspan="2" style="vertical-align: top; height: 98%;">
                    <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged"
                        Text="Показать расчеты" Style="font-family: Verdana; font-size: 10pt;"/>
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport" style="vertical-align: top; width: 100%; height: 100%">
                                <asp:Label ID="Label1" runat="server" CssClass="ElementTitle">Неэффективные  расходы консолидированного бюджета в сфере общего образования</asp:Label></td>
                ...
                <table style="vertical-align: top; width: 100%; border-collapse: collapse; background-color: white">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label8" runat="server" CssClass="ElementTitle">Динамика долей неэффективных расходов на общее образование, %  </asp:Label></td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <igchart:UltraChart ID="C1" runat="server" BackgroundImageFileName="" ChartType="LineChart" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
...
<PE ElementType="None"></PE>
                                    ...
                                    <Legend Font="Microsoft Sans Serif, 9pt" Location="Bottom" SpanPercentage="24" Visible="True" FormatString=".">
                                    </Legend>
                                </igchart:UltraChart>
            ...
            <td style="vertical-align: top"><table style="vertical-align: top; width: 100%; border-collapse: collapse; background-color: white">
                ...
                <tr>
                    ...
                    <td class="headerReport">
                        <asp:Label id="Label2" runat="server" CssClass="ElementTitle">Структура расходов в сфере общего образования, тыс. рублей</asp:Label></td>
                    <td class="headerright">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server" Width="100%"><igchart:UltraChart id="C2" runat="server" OnDataBinding="C2_DataBinding" Version="9.1" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ChartType="StackColumnChart" BackgroundImageFileName="" OnChartDrawItem="C2_ChartDrawItem">
            ...
            <td colspan="2" style="vertical-align: top">
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport" style="vertical-align: top; width: 100%; height: 100%">
                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle">Расчет неэффективных расходов консолидированного бюджета на управление кадровыми ресурсами</asp:Label></td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
            ...
            <td colspan="2" style="vertical-align: top">
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport" style="vertical-align: top; width: 100%; height: 100%">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle">Расчет неэффективных расходов консолидированного бюджета  на управление наполняемостью классов в общеобразовательных учреждениях</asp:Label></td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="vertical-align: top; width: 100%; height: 100%">
                            <igtbl:UltraWebGrid ID="G3" runat="server" OnDataBinding="G3_DataBinding" SkinID="UltraWebGrid"
                                    StyleSetName="Office2007Blue" OnInitializeLayout="G_InitializeLayout" OnInitializeRow="G_InitializeRow" OnDataBound="G3_DataBound">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
