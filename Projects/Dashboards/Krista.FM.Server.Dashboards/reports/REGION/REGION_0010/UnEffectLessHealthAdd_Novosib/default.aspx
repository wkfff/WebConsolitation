<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessHealthAdd_Novosib._default" %>
                    ...
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 100%; height: 100%">
                                <asp:Label ID="Label1" runat="server" CssClass="ElementTitle">Дополнительные неэффективные расходы консолидированного бюджета  в сфере здравоохранения</asp:Label><igtbl:UltraWebGrid ID="G" runat="server" OnDataBinding="G_DataBinding" SkinID="UltraWebGrid"
                ...
                <table style="vertical-align: top; width: 100%; border-collapse: collapse; background-color: white">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="Label8" runat="server" CssClass="ElementTitle" Height="45px">Динамика дополнительных неэффективных расходов бюджета на здравоохранение, тыс. рублей  </asp:Label><igchart:UltraChart ID="C1" runat="server" BackgroundImageFileName=""  
                                     EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    OnDataBinding="C1_DataBinding" Version="9.1" OnFillSceneGraph="C1_FillSceneGraph">
                                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;&lt;br&gt; &lt;b&gt;&lt;DATA_VALUE:### ##0.##&gt;&lt;/b&gt; тыс. рублей" />
                                    <Border Thickness="0" />
                                    ...
                                    <Axis>
                                        ...
                                        <Y Extent="50" LineThickness="1" TickmarkInterval="40" TickmarkStyle="Smart" 
                                            Visible="True">
                                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                                Visible="True" />
                                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                    ...
                                    <Legend Font="Microsoft Sans Serif, 9pt" Location="Bottom" SpanPercentage="31" Visible="True" FormatString=".">
                                        <Margins Right="0" Bottom="0" Left="0" Top="0" />
                                    </Legend>
                                <ColumnChart>
                                    <ChartText>
                                        <igchartprop:ChartTextAppearance ChartTextFont="Arial, 9pt" Column="-2" ItemFormatString="&lt;DATA_VALUE: ### ### ##0.00&gt;"
            ...
            <td colspan="2" style="vertical-align: top">
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 10%;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top; width: 100%; height: 100%">
                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle">Расчет дополнительных неэффективных расходов консолидированного бюджета   в сфере здравоохранения </asp:Label>
