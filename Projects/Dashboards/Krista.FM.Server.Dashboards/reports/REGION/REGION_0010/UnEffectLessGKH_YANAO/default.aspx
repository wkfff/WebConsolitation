<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessGKH_YANAO._default" %>
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible">
                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle">Уровень эффективности расходования бюджетных средств в сфере ЖКХ на (2009), %</asp:Label><DMWC:MapControl ID="DundasMap" runat="server" BackColor="White" ImageUrl="../../TemporaryImages/map_MO_128_#SEQ(300,3)"
