...
"Ид =(Дгоси общ макс – Дгоси общ) / (Дгоси общ макс – Дгоси общ мин)"};
            ...
            G.Rows[5 * 3 + 2].Hidden = true; 
            G.Rows[6 * 3 + 2].Hidden =  true;
            //G.Rows[7 * 3 + 2].Hidden = true; 
...
"
        ...
        private void ExcelExporter_EndExport(object sender, EndExportEventArgs e)
        {
            ...
            e.CurrentWorksheet.Rows[22].Hidden = 1 == 1;
            e.CurrentWorksheet.Rows[25].Hidden = 1 == 1;
