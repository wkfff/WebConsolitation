<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.GKH_0003._default" %>
    ...
    <div>
        ...
        <table style="vertical-align: top" runat = "server" id ="tableparam">
            <tr>
                ...
                <td valign="top">
                    <uc2:CustomMultiCombo ID="ComboComapraDate" runat="server" Title="Товар" 
                        Visible="true" Width="150" />
                </td>
                <td colspan="1" valign="top">
                    <uc2:CustomMultiCombo ID="ComboYslyga" runat="server" Title="Товар" 
                        Visible="true" Width="150" />
                </td>
                <td valign="top">
                ...
                <td align="right" style="width: 100%" valign="top">
                    <asp:HyperLink ID="Link1" runat="server" SkinID="HyperLink">[Link1]</asp:HyperLink></td>
            </tr>
        </table>
        <table>
            <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" Checked="True"
                                    ...
                                    font-family: Verdana" Text="При наличии приборов учета" 
                                    ValidationGroup="Chart2" />
                                &nbsp;
                                <asp:RadioButton ID="RadioButton2" runat="server" AutoPostBack="True" 
                                    GroupName="Chart2" Style="font-size: 11pt;
                                    font-family: Verdana"
                                     ValidationGroup="Chart2" 
                                    Text="При отсутствии приборов учета" />
                                <br />
                                <br />
        ...
        <igchart:UltraChart ID="ColChart" runat="server" ChartType="LineChart" 
