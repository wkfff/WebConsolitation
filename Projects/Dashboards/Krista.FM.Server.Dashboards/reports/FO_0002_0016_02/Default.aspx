<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0016_02.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top">
                <uc5:CustomCalendar ID="CustomCalendar1" runat="server"></uc5:CustomCalendar>
            </td>
            <td valign="top">
                    ...
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="mbtCaption" runat="server" CssClass="ElementTitle"></asp:Label><asp:Label
                                    ID="regionCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                            </td>
