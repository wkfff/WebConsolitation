<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultAllocation_budget.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0004.DefaultAllocation_budget" %>
        ...
        <tr>
            <td>
                    <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                        ...
                        <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_FK0104_budget_1#SEQNUM(100).png" />
                    </igchart:UltraChart>
            </td>
        </tr>
    </table>
