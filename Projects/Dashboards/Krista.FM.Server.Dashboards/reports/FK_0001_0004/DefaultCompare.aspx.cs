    ...
    public partial class DefaultCompare : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
               ...
               // ComboFO.SetСheckedState(UserParams.Filter.Value, true);
                ...
                {
                    ComboFO.SetСheckedState(UserParams.StateArea.Value, true);
                }
                else*/
            ...
            Page.Title = string.Format("Темп роста доходов ({0})", ComboFO.SelectedIndex == 0 ? "РФ" :
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            for (int i = 2; i < e.Layout.Bands[0].Columns.Count; i = i + 5)
            {
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i , "Исполнено прошлый год, млн.руб.", "Исполнено за аналогичный период прошлого года");
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i + 1, "Исполнено, млн.руб.", "Фактическое исполнение нарастающим итогом с начала года");
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i + 3, "Доля в прошлом году", "Доля дохода в общей сумме фактических доходов в прошлом году");
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i + 4, "Доля", "Доля дохода в общей сумме доходов выбранного субъекта");
