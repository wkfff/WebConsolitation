...
namespace Krista.FM.Server.Dashboards.reports.SKK.SKK_015
{
	public partial class Default : CustomReportPage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			PageTitle.Text = "Досмотр транспортных средств на выбранном участке Государственной границы РФ";
			Page.Title = PageTitle.Text;
			PageSubTitle.Text = String.Format("Досмотр транспортных средств на участке Государственной границы РФ \"<b>{0}</b>\" за <b>{1} {2} года</b> в сравнении с <b>{3} {4} года</b>, направление: <b>{5}</b>",
			...
			LabelGridUpDown.Text = "Досмотр ТС на выбранном участке границы";
			LabelChartTerra.Text = "";
			LabelChartCompare.Text = "Досмотр ТС на выбранном участке границы";
			LabelTransport.Text = "Досмотр ТС по видам международного сообщения";
		...
		private void SetDataHelpers()
		{
			...
			gridUpDownHelper.SetData("skk_015_grid_updown");
			...
			if (comboBorder.SelectedValue.Trim().ToLower().Equals("всего"))
			{
				...
				chartTerraHelper.SetData("skk_015_chart_districts");
			}
			else
			{
				// по пунктам пропуска
				...
				chartTerraHelper.SetStyle(SKKHelper.default2ItemsWidth, SKKHelper.defaultChartHeight);
				chartTerraHelper.SetData("skk_015_chart_points");
			}
