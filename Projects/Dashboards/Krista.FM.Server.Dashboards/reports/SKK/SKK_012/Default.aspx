<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
	Inherits="Krista.FM.Server.Dashboards.reports.SKK.SKK_012.Default" %>
		...
		<div class="RoundedCenter"><div><div>
			...
			<div style="float: left;">
				<igchart:UltraChart ID="Chart" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk120#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div>
			<div class="clear"></div>
		</div></div></div>
