<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
	Inherits="Krista.FM.Server.Dashboards.reports.SKK.SKK_010.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="SpaceWrapper">	
		<div class="RoundedTop"><div><div></div></div></div>
		<div class="SpaceHeader"><div><div>
			<asp:Label ID="labelChartDistricts" runat="server" CssClass="ElementTitle" />
		</div></div></div>
		<div class="RoundedCenter"><div><div>
			<igchart:UltraChart ID="ChartDistricts" runat="server" >
				<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk101#SEQNUM(100).png" />
			</igchart:UltraChart>				
		</div></div></div>
		<div class="RoundedBottom"><div><div></div></div></div>
	</div>	
	...
	<div class="SpaceWrapper">
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartCompare" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk102#SEQNUM(100).png" />
				</igchart:UltraChart>				
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>	
		</div>
		<div class="SpaceFloat2Items">
			<div class="RoundedTop"><div><div></div></div></div>
			<div class="SpaceHeader"><div><div>
				<asp:Label ID="labelChartBorders" runat="server" CssClass="ElementTitle" />
			</div></div></div>
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartBorders" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk103#SEQNUM(100).png" />
				</igchart:UltraChart>
