<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
	Inherits="Krista.FM.Server.Dashboards.reports.SKK.SKK_009.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="SpaceWrapper">
		...
		<div class="SpaceHeader"><div><div>
			<asp:Label ID="LabelGrid" runat="server" CssClass="ElementTitle" />
		</div></div></div>
	...
	<div class="SpaceWrapper">
		...
		<div class="RoundedCenter"><div><div>
			<igchart:UltraChart ID="ChartTerra" runat="server" >
				<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk091#SEQNUM(100).png" />
			</igchart:UltraChart>
		</div></div></div>
		<div class="RoundedBottom"><div><div></div></div></div>
	</div>
		...
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartCompare" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk092#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>
		</div>
		...
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartBorder" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk093#SEQNUM(100).png" />
				</igchart:UltraChart>
		...
		<div class="RoundedCenter"><div><div>			
			...
			<div class="SpaceFloat2Items">
				<igchart:UltraChart ID="ChartTransport" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk094#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div>
			<div class="clear"></div>						
		</div></div></div>
