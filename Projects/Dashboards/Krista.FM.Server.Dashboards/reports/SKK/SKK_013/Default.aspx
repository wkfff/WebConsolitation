<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
	Inherits="Krista.FM.Server.Dashboards.reports.SKK.SKK_013.Default" %>
	...
	<div class="SpaceWrapper">
		...
		<div class="RoundedCenter"><div><div>
			<igchart:UltraChart ID="ChartTerra" runat="server" >
				<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk131#SEQNUM(100).png" />
			</igchart:UltraChart>
		</div></div></div>
		<div class="RoundedBottom"><div><div></div></div></div>
	</div>
		...
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartCompare" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk132#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div></div></div>
			<div class="RoundedBottom"><div><div></div></div></div>
		</div>
		...
		<div class="SpaceFloat2Items">
			...
			<div class="RoundedCenter"><div><div>
				<igchart:UltraChart ID="ChartBorder" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk133#SEQNUM(100).png" />
				</igchart:UltraChart>
		...
		<div class="RoundedCenter"><div><div>			
			...
			<div class="SpaceFloat2Items">
				<igchart:UltraChart ID="ChartTransport" runat="server" >
					<DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_skk134#SEQNUM(100).png" />
				</igchart:UltraChart>
			</div>
			<div class="clear"></div>						
		</div></div></div>
