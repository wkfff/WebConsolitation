<%@ Page Language="C#" Title="Оценка экономического развития" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="defaultMO.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.MO.MO_0002._0002.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
               &nbsp;<asp:HyperLink id="HyperLink1" runat="server" Font-Names="Arial" Font-Size="Small" SkinID="HyperLink" Visible="False">Муниципальные районы</asp:HyperLink> 
            </td>                        
            <td>
               &nbsp;<asp:HyperLink id="HyperLink2" runat="server" NavigateUrl="default1.aspx" Font-Names="Arial" Font-Size="Small" SkinID="HyperLink" Visible="False">Городские округа</asp:HyperLink> 
            </td>                   
    ...
    <asp:Label ID="Label2" runat="server" BorderStyle="None" Font-Bold="True" Font-Names="Arial" Font-Size="X-Small" Text="Для просмотра диаграмм (карт) по показателям выберите любое поле столбца с показателем в таблице, по которому необходимо построить диаграмму (карту). Диаграмма (карта) будет обновлена спустя 1-5 секунд."></asp:Label><br />
    <br />
    ...
    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server" Width="100%" TriggerControlIDs="web_grid1">    
                    ...
                    <table>
                        <tr>
                            ...
                            <igchart:UltraChart ID="Chart1" runat="server" BackgroundImageFileName=""  
                                    ...
                                    Transform3D-YRotation="0" Version="9.1" Width="100%" ChartType="CylinderColumnChart3D">
                                    ...
                                    <Data ZeroAligned="True" SwapRowsAndColumns="True">
                                    </Data>
                                    ...
                                    <Axis>
                                        ...
                                        <X Extent="150" LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True">
                                            ...
                                            <Labels Font="Verdana, 7pt" FontColor="DimGray" HorizontalAlign="Near" ItemFormatString="&lt;ITEM_LABEL&gt;"
                                                ...
                                                <SeriesLabels Font="Verdana, 9.75pt" FontColor="DimGray" HorizontalAlign="Near"
                                                    Orientation="VerticalLeftFacing" VerticalAlign="Center" FormatString="" Visible="False">
        ...
        <DMWC:MapControl ID="DundasMap" runat="server" BackColor="Transparent" BackSecondaryColor="Transparent"
            ...
            ResourceKey="#MapControlResKey#MapControl1#" Width="1024px" BorderLineColor="Black" BorderLineWidth="1">
            <NavigationPanel>
                <Location X="0" Y="0" />
