<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.MO.MO_0002._004._default" %>
    ...
    <div>
        ...
        <table style="vertical-align: top">
            <tr>
                ...
                <td colspan="1" valign="top">
                    <uc2:CustomMultiCombo ID="Type1" runat="server" Title="Тип расчета" Width="300" />
                </td>
                <td colspan="1" valign="top">
                            ...
                            <td style="vertical-align: top; width: 100%; height: 100%">
                                <igtbl:UltraWebGrid
                                    ...
                                    <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                        ...
                                        Version="4.00" ViewType="OutlookGroupBy" NoDataMessage="Нет данных">
                                        <GroupByBox>
