    ...
    public partial class _default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                P1.Value = RegionSettingsHelper.Instance.GetPropertyValue("param1") + ".[Значение не указано]";
                }
                C.DataBind();
        ...
        protected void G_DataBinding(object sender, System.EventArgs e)
        {
            ...
            //   try
            {
                ...
                {
                    object[] o = new object[dt1.Rows.Count * 3 + 1];
                    ...
                    for (int j = 0; j < dt1.Rows.Count; j++)
                    {
                        ...
                        //  try
                        {
                            ...
                            o[j * 3 + 1] = dt1.Rows[j].ItemArray[i];
        ...
        protected void G_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            int[] m = new int[(e.Row.Cells.Count - 1) / 3];
            ...
            for (int i = 0; i < m.Length; i++)
            {
                if (e.Row.Cells[i * 3 + 3].Value.ToString() == "1" )
                {
                    e.Row.Cells[i * 3 + 3].Text = string.Format("<img src=\"../../../../images/starYellow.png\">     ") + e.Row.Cells[i * 3 + 3].Text;
                }
                if (e.Row.Cells[i * 3 + 3].Value.ToString() == (m.Length).ToString())
                {
                    e.Row.Cells[i * 3 + 3].Text = string.Format("<img src=\"../../../../images/starGray.png\">     ") + e.Row.Cells[i * 3 + 3].Text;
                }
                if (e.Row.Cells[i * 3 + 2].Text == "_")
                {
        ...
        protected void ForCrossJoin(LayoutEventArgs e, int span)
        {
            ...
            for (int i = 0; i < (G.Columns.Count - 1) / 3; i++)
            {
                CRHelper.FormatNumberColumn(e.Layout.Bands[0].Columns[i * 3 + 2], "### ### ### ##0.000 0## ###");
            }
