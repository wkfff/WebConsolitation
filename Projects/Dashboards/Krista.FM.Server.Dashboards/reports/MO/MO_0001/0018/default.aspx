<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0018.Default" %>
            ...
            <tr>
                <td style="vertical-align: top; width: 50%;">
                    ...
                    <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                                        ...
                                        Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="83" Transform3D-XRotation="120" Transform3D-YRotation="0" ChartType="ColumnChart3D" OnDataBinding="UltraChart1_DataBinding" Width="500px" Height="500px">
                ...
                <td style="vertical-align: top; width: 50%;">
                    ...
                    <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName=""  
                                             EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                            Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="85" Transform3D-XRotation="120" Transform3D-YRotation="0" ChartType="StackAreaChart" OnDataBinding="UltraChart2_DataBinding" Width="500px" Height="500px" OnFillSceneGraph="UltraChart2_FillSceneGraph">
                                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
