...
namespace Krista.FM.Server.Dashboards.reports.BC_0001_0027
{
    ...
    public partial class Default : CustomReportPage
    {
        ...
        private static String chart2_title_caption = "Платыне улуги населению в&nbsp;{0}&nbsp;году, рубли";
        // заголовок для Chatr3
        private static String chart3_title_caption = "Розничная торговля в&nbsp;{0}&nbsp;году, рубли";
        // заголовок для Chatr4
        private static String chart4_title_caption = "Оптовай торговля в&nbsp;{0}&nbsp;году, рубли";
