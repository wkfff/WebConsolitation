<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0027.Default" %>
...
<asp:Label ID="page_title" runat="server" BorderStyle="None" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium" Text="заголовок"></asp:Label>&nbsp;</div>    
    ...
    <tr>        
        <td style="vertical-align: top; text-align:center;">
            ...
            <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName=""  
                ...
                Transform3D-YRotation="30" Version="9.1">
                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, рубли &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
                <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
    <tr>        
        ...
        <td style="vertical-align: top; padding-right: 3px;">
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel4" runat="server" Width="100%" TriggerControlIDs="web_grid4" Height="100%">
                <table style="vertical-align: top; width: 100%; border-collapse: collapse; background-color: white">
                    <tr>
                        <td class="topleft">
                        </td>
                ...
                <asp:Label ID="Label7" runat="server" Text="заголовок" CssClass="ElementTitle"></asp:Label><igchart:UltraChart ID="UltraChart7" runat="server" BackgroundImageFileName=""  
                                    ...
                                    Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="100" Transform3D-XRotation="50" Transform3D-YRotation="30" ChartType="DoughnutChart3D" OnDataBinding="UltraChart7_DataBinding" Width="500px" Height="500px">
                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, рубли &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
                            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
                            </ColorModel>
            ...
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel2" runat="server" Width="100%" TriggerControlIDs="web_grid1" Height="100%">
                <table style="vertical-align: top; width: 100%; border-collapse: collapse; background-color: white">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label14" runat="server"  CssClass="ElementTitle" Text="Динммика показателя"></asp:Label></td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
