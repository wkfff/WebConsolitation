<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.MO.MO_0001._0032._01._default" %>
        ...
        <table>
            <tr>
                <td style="width: 100%">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label></td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-bottom: 5px; border-collapse: collapse;">
            <tr>
                ...
                <td colspan="1" style="vertical-align: top; width: 50%;">
                    <table style="border-collapse: collapse; background-color: white; float: right; width: 100%; left: 0px;">
                        <tr>
                            <td class="topleft">
                            </td>
                            <td class="top">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; background-color: white;">
                                <igmisc:WebAsyncRefreshPanel ID="PanelDynamicChart" runat=server BorderWidth="0px">
                                <asp:Label ID="Label2" runat="server" CssClass="ElementTitle" Height="35px"></asp:Label>
                                    <igchart:UltraChart ID="C" runat="server" BackgroundImageFileName="" 
                                        BorderWidth="0px" ChartType="StackAreaChart" 
                                        EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" 
                                        ondatabinding="C_DataBinding" onfillscenegraph="C_FillSceneGraph1" 
                                        ...
                                        <Axis>
                                            ...
                                            <X Extent="25" LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" 
                                                Visible="True">
                                                <Margin>
                                                    <Near Value="5" />
                                                    <Far Value="5" />
                                            ...
                                            <Y Extent="40" LineThickness="1" TickmarkInterval="100" TickmarkStyle="Smart" 
                                                Visible="True">
                                                <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" 
                                                    Thickness="1" Visible="True" />
                                                <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" 
                    ...
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat=server Width="100%" LinkedRefreshControlID="PanelDynamicChart">
                        <asp:Panel ID="Panel1" runat="server" Width="100%">
                            <table style="margin-top: 5px; width: 100%; border-collapse: collapse; padding-top: 5px;">
            <tr>
                <td class="topleft">
                </td>
                <td class="top">
            ...
            <tr>
                ...
                <td style="background-color: white;">
                    <asp:Label ID="Label5" runat="server" CssClass="ElementTitle"></asp:Label><igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                                     EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    OnDataBinding="UltraChart1_DataBinding" Version="9.1" OnInvalidDataReceived="C_InvalidDataReceived" OnFillSceneGraph="chart_avg_count_FillSceneGraph" Height="250px">
                            ...
                            <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" Scaling="Decreasing">
                            </ColorModel>
                            <Effects>
                                <Effects>
                                    <igchartprop:GradientEffect>
                            ...
                            <Axis>
                                <PE ElementType="None" Fill="Cornsilk" />
                                <X Extent="33" LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True">
                                    <Margin>
                                        <Near Value="5" />
                                        <Far Value="5" />
                                    </Margin>
            ...
            <tr>
                <td class="bottomleft" style="height: 21px">
                </td>
                <td class="bottom" style="height: 21px">
                </td>
                <td class="bottomright" style="height: 21px">
                </td>
            </tr>
        </table>
                        </asp:Panel>
