<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0020.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="margin-top: 10px; width: 100%; border-collapse: collapse">
        ...
        <tr>
            ...
            <asp:Label ID="ReportText" runat="server"  Text="Текст отчёта"></asp:Label></td>
            <td class="right">
            </td>
        </tr>
        <tr>
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
    <tr>        
        <td style="vertical-align: top;"> 
            ...
            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                                    ...
                                    Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="80" Transform3D-XRotation="120" Transform3D-YRotation="0" ChartType="StackAreaChart" OnDataBinding="UltraChart1_DataBinding" Width="500px" Height="500px" OnFillSceneGraph="UltraChart1_FillSceneGraph">
    ...
    <asp:Label ID="Grid2Label" runat="server" BorderStyle="None" Font-Bold="True" Font-Names="Arial"
        Font-Size="Small" Text="заголовок таблицы" CssClass="ElementTitle" Width="100%"></asp:Label><br />
    ...
    <tr>        
        ...
        <td style="vertical-align: top; text-align:center;">
            ...
            <igchart:UltraChart ID="UltraChart4" runat="server" BackgroundImageFileName=""  
                ...
                Transform3D-YRotation="30" Version="9.1">
                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, м&lt;sup&gt;2&lt;/sup&gt; &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
                <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed">
                </ColorModel>
                <Effects>
    ...
    <tr>
        ...
        <td style="vertical-align: top;">
            ...
            <igchart:UltraChart ID="UltraChart5" runat="server" BackgroundImageFileName=""  
                ...
                Transform3D-YRotation="30" Version="9.1">
                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, шт. &lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;" EnableFadingEffect="True" Overflow="ClientArea" />
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
    <tr>        
        ...
        <td style="vertical-align: top; padding-top: 3px;"> 
            ...
            <igtbl:UltraWebGrid id="web_grid4" runat="server" StyleSetName="Office2007Blue" EnableAppStyling="True" Width="350px" OnInitializeLayout="web_grid4_InitializeLayout" OnDataBinding="web_grid4_DataBinding" OnActiveRowChange="web_grid4_ActiveRowChange">
                            <Bands>
                                <igtbl:UltraGridBand>
                                    <AddNewRow View="NotSet" Visible="NotSet">
                                    </AddNewRow>
