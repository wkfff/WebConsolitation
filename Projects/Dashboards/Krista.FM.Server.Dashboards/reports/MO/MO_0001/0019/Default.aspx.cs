        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    Postdate.Value = ELV(getLastDate("[ОРГАНИЗАЦИЯ СОДЕРЖАНИЯ МУНИЦИПАЛЬНЫХ АРХИВОВ].[Количество единиц хранения].[Управленческая документация]"));
                    Lastdate.Value = ELV(getLastDate("[ОРГАНИЗАЦИЯ СОДЕРЖАНИЯ МУНИЦИПАЛЬНЫХ АРХИВОВ]"));
                   ...
                   // WebPanel1.Header.Text = "По данным на " + Postdate.Value + " год ";
                    ...
                    User_param.Text += "<br/>";
                    Heder.Text += "Организация содержания муниципальных архивов";
                    grid.DataBind();
                    ...
                    HederTable.Text = "Основные показатели организации содержания муниципальных архивов";
                    //setFont(18, Heder);
