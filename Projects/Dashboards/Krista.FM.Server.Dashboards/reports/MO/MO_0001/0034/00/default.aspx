<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.PMO_0001_0004_00.Default" %>
                        ...
                        <tr>
                            ...
                            <td style="background-color: white">
                                ...
                                <igchart:UltraChart ID="C" runat="server" BackgroundImageFileName=""  
                                    ...
                                    OnDataBinding="C_DataBinding" Version="9.1" OnInvalidDataReceived="C_InvalidDataReceived" Transform3D-Scale="77" Transform3D-XRotation="124" Transform3D-YRotation="0" Transform3D-Perspective="70">
                    ...
                    <table style="margin-top: 6px; border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td style="background-color: white">
                                ...
                                <igtbl:UltraWebGrid
                                    ID="G2" runat="server" OnActiveRowChange="G2_ActiveRowChange1" OnDataBinding="G2_DataBinding"
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue" Width="325px" OnInitializeLayout="G_InitializeLayout" OnInitializeRow="G_InitializeRow">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                            <AddNewRow View="NotSet" Visible="NotSet">
                        ...
                        <asp:Panel ID="Panel5" runat="server" Width="100%">
                            <table style="margin-top: 6px; border-collapse: collapse; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: white">
                                        <asp:Label ID="Label10" runat="server" CssClass="ElementTitle"></asp:Label><igchart:UltraChart ID="CC" runat="server" BackgroundImageFileName=""  
                                    ...
                                    OnDataBinding="CC_DataBinding" Version="9.1" OnInvalidDataReceived="C_InvalidDataReceived" Transform3D-XRotation="30" Transform3D-YRotation="0">
                                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
