<%@ Page Language="C#" Title="Характеристика территории МО РФ" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.BC_0001_0015.Default" %>
    ...
    <tr>        
        <td style="vertical-align: top;">
            ...
            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                ...
                Height="350px" OnDataBinding="UltraChart1_DataBinding" OnInvalidDataReceived="InvalidDataReceived"
