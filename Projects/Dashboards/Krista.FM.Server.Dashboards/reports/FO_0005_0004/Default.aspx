<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0005_0004.Default" %>
        ...
        <tr>
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboYear" runat="server" AutoPostBack="True"></uc3:CustomMultiCombo>
                        </td>
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboBill" runat="server"></uc3:CustomMultiCombo>
                        </td>
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboRzPr" runat="server"></uc3:CustomMultiCombo>
                        </td>
                        <td valign="top">
                    ...
                    <tr>
                      ...
                      <td valign="top" colspan = "2">
                            <uc3:CustomMultiCombo ID="ComboVR" runat="server"></uc3:CustomMultiCombo>
                      </td>
                    </tr>
                </table>
            </td>
