...
namespace Krista.FM.Server.Dashboards.reports.FNS_0001_0001
{
    public partial class DefaultKD : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            RegionsLink.NavigateUrl = "~/reports/FNS_0001_0001/DefaultRegions.aspx";
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_gridKD_split" : "FNS_0001_0001_gridKD";
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_chartKD1_split" : "FNS_0001_0001_chartKD1";
            string query = DataProvider.GetQueryText(queryName);
...
//            }
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0001_0001_chartKD2_split" : "FNS_0001_0001_chartKD2";
            string query = DataProvider.GetQueryText(queryName);
