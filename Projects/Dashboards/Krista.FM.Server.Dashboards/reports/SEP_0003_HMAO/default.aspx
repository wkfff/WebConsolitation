<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_0003_HMAO._default" %>
    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td style="margin-right:8px; float:right; align:right">
    ...
    <table style="vertical-align: top; width: 100%; height: 100%;" runat="server" id="Table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <igchart:UltraChart ID="C1" runat="server" BackgroundImageFileName="" 
                                    ...
                                    OnFillSceneGraph="C1_FillSceneGraph" Height="380px">
                                    ...
                                    <LineChart EndStyle="RoundAnchor" Thickness="4" NullHandling="DontPlot" 
                                        HighLightLines="True" StartStyle="RoundAnchor">
                                        <LineAppearances>
                                            <igchartprop:LineAppearance Thickness="3">
                                                <IconAppearance Icon="Circle" IconSize="Small">
                                                    <PE Fill="Red" StrokeOpacity="0" />
                                                </IconAppearance>
                                            </igchartprop:LineAppearance>
                                            <igchartprop:LineAppearance Thickness="3">
                                                <LineStyle DrawStyle="Dash" />
                                                <IconAppearance Icon="Circle" IconSize="Small">
                                                    <PE Fill="Blue" StrokeOpacity="0" />
                                                </IconAppearance>
                                            </igchartprop:LineAppearance>
                                            <igchartprop:LineAppearance Thickness="3">
                                                <LineStyle DrawStyle="Dash" />
                                    ...
                                    <Axis>
                                        ...
                                        <X LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" 
                                            Visible="True" TickmarkIntervalType="Weeks">
                                            <Margin>
                                                <Near Value="5" />
                                                <Far Value="5" />
                                            </Margin>
                                            ...
                                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                                Visible="False" />
                                            <Labels Font="Verdana, 7pt" FontColor="DimGray" HorizontalAlign="Center" ItemFormatString="&lt;ITEM_LABEL&gt;"
        ...
        <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label5" runat="server" CssClass="ElementTitle" Height="65px"></asp:Label>
                                <igchart:UltraChart ID="C2" runat="server" BackgroundImageFileName=""
                                     
                                    EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" 
                                    Version="11.1" 
                                    OnInvalidDataReceived="C1_InvalidDataReceived" ChartType="Composite" 
                                    onfillscenegraph="C2_FillSceneGraph">
                                    <Border Color="Transparent" />
                                    <Legend FormatString="&lt;SERIES_LABEL&gt;" Location="Bottom" 
                                        SpanPercentage="13" Visible="True"></Legend>
                                    <Effects>
                                        <Effects>
                                            <igchartprop:GradientEffect>
                                            </igchartprop:GradientEffect>
                                    ...
                                    <Axis>
                                        <PE ElementType="None" Fill="Cornsilk" />
                                        <X Extent="65" LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" 
                                            Visible="True">
                                            <Margin>
                                                <Near Value="5" />
                                                <Far Value="5" />
                                        ...
                                        <Y Extent="60" LineThickness="1" RangeMax="1" RangeMin="-2" 
                                            TickmarkInterval="50" TickmarkStyle="Smart" Visible="True">
                                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" 
                                                Thickness="1" Visible="True" />
                                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" 
                                                Thickness="1" Visible="False" />
                                    ...
                                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                        Font-Strikeout="False" Font-Underline="False" 
                                        FormatString="&lt;ITEM_LABEL&gt;, &lt;b&gt;&lt;DATA_VALUE:### ##0.##&gt;&lt;/b&gt;, рубль" />
                                    <DeploymentScenario FilePath="../../TemporaryImages" 
                                        ImageURL="../../TemporaryImages/Chart_FK0101_2#SEQNUM(100).png" />
                                </igchart:UltraChart>
                            </td>
        ...
        <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label10" runat="server" CssClass="ElementTitle" Height="65px"></asp:Label>
                                <igchart:UltraChart ID="C3" runat="server" BackgroundImageFileName="" 
                                    ...
                                    OnInvalidDataReceived="C1_InvalidDataReceived" 
                                    onfillscenegraph="C3_FillSceneGraph">
