<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0027.Default" Title="Доходы по субъектам РФ" %>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <table>
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="thousands" runat="server" Text="тыс.руб." AutoPostBack="true" Checked="true" Style="font-family: Verdana;
                                            font-size: 10pt;" /></td>
                                    <td>
                                        <asp:CheckBox ID="millions" runat="server" Text="млн.руб." AutoPostBack="true" Checked="false" Style="font-family: Verdana;
                                            font-size: 10pt;" /></td>
                                </tr>
                            </table>
