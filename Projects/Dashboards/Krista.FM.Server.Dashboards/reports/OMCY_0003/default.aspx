<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.OMCY_0003._default" %>
        ...
        <table style="vertical-align: top">
            <tr>
                <td colspan="1" valign="top">
                    <uc2:CustomMultiCombo ID="UserMO" runat="server" Title="Год" />
                </td>
                <td valign="top" colspan="2">
                    <uc2:CustomMultiCombo ID="Sfera" runat="server" Title="Год" Width="400" />
                </td>
                <td valign="top">
                ...
                <td colspan="2" style="vertical-align: top">
                    <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport" style="vertical-align: top">
                                <asp:Label ID="Label3" runat="server" CssClass="ElementTitle">Расчет интегрального показателя эффективности деятельности органов местного самоуправления  по городским округам за {} год.</asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top;">
                                <igtbl:UltraWebGrid
                                    ID="G" runat="server"
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue" OnDataBinding="G_DataBinding" OnInitializeLayout="G_InitializeLayout1" OnInitializeRow="G_InitializeRow1" OnSortColumn="G_SortColumn">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                ...
                                <asp:Label ID="Label6" runat="server" CssClass="ElementTitle" Font-Bold="True" Font-Italic="True"
                                    Font-Names="Arial" Font-Size="9pt" ForeColor="#404040">Город Ханты-Мансийск исключен из расчета Уровня эффективности в сфере «Обеспечение здоровья» ввиду отсутствия в городе муниципальных учреждений здравоохранения (за исключением скорой медицинской помощи)</asp:Label></td>
                            <td class="right">
                            </td>
                        </tr>
                        <tr>
                ...
                <td colspan="2" style="vertical-align: top">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top; height: 421px;">
                            ...
                            <igchart:UltraChart
                             ID="C" runat="server" 
                             OnDataBinding="C_DataBinding" 
                             BackgroundImageFileName="" 
                             EmptyChartText="-"  OnFillSceneGraph="C_FillSceneGraph" Version="11.1" >
                    <Border Thickness="0" />
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; height: 360px">
                                &nbsp;<asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" Checked="True"
                                    GroupName="Chart2" OnCheckedChanged="RadioButton1_CheckedChanged1" Style="font-size: 11pt;
                                    font-family: Verdana" Text="По показателям" ValidationGroup="Chart2" />
                                &nbsp;
                                <asp:RadioButton ID="RadioButton2" runat="server" AutoPostBack="True" GroupName="Chart2" Style="font-size: 11pt;
                                    font-family: Verdana"
                                    OnCheckedChanged="RadioButton1_CheckedChanged1" ValidationGroup="Chart2" Text="По территориям" /><igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName="" 
                                EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                Version="9.1" OnDataBinding="UltraChart_DataBinding" ChartType="ScatterChart">
                                ...
                                <Axis>
                                    ...
                                    <X LineThickness="1" TickmarkInterval="5" Visible="True" TickmarkStyle="Smart">
                                        <MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
                                        <MajorGridLines Color="Gainsboro" DrawStyle="Dot" Visible="True" Thickness="1" AlphaLevel="255"></MajorGridLines>
                                    ...
                                    <Y LineThickness="1" TickmarkInterval="2" Visible="True" TickmarkStyle="DataInterval" RangeMax="23" RangeMin="1" RangeType="Custom">
                                        <MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
                                    ...
                                    <X2 LineThickness="1" TickmarkInterval="5" Visible="False" TickmarkStyle="Smart">
                                        <MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
                                        <MajorGridLines Color="Gainsboro" DrawStyle="Dot" Visible="True" Thickness="1" AlphaLevel="255"></MajorGridLines>
