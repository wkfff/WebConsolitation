...
namespace Krista.FM.Server.Dashboards.reports.OMCY_0003.Grant_Sahalin
{
    public partial class _default : CustomReportPage
    {
        ...
        private void DisplayGrid(UltraWebGrid G)
        {
            ...
            G.Columns[1].Header.Caption = "Место в итоговом рейтинге";
            //CRHelper.FormatNumberColumn(G.Columns[2], "### ### ##0");

            G.Columns[2].Header.Caption = "Размер гранта, млн. рублей";
            CRHelper.FormatNumberColumn(G.Columns[2], "### ### ##0.###");
        ...
        private void DataBindGrid()
        {
            ...
            TableGridGO.Rows.Add(new object[3] { "Анивский городской округ", "1", 3.5 });
            TableGridGO.Rows.Add(new object[3] { "Городской округ «Ногликский»", "2", 2.5 });
            TableGridGO.Rows.Add(new object[3] { "Городской округ «Город Южно-Сахалинск»", "3", 1.5 });

            TableGridMR.Rows.Add(new object[3] { "Невельский городской округ", "1", 1.5 });
        ...
        private void SetHeaderReport()
        {
            ...
            temp.Add("2010",0);
            YearCombo.FillDictionaryValues(temp);
            YearCombo.Title = "Период";
            YearCombo.Width = 200;
            ...
            Label4.Text = string.Format(" Номинация «Эффективность расходования бюджетных средств»", YearCombo.SelectedValue);

            Label5.Text = string.Format("Итоги оценки эффективности деятельности ОМСУ за 2010 год", YearCombo.SelectedValue);
