<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0039_0008.Default" %>
            ...
            <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td style="overflow: visible;">
                        <table>
                            <tr>
                                <asp:Label ID="EmptyGridText" runat="server"></asp:Label>
                                <td rowspan="2" valign="top" runat="server" id="increaseTD">
                                    <asp:Label ID="increaseGridCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                                    <igtbl:UltraWebGrid ID="IncreaseRatingGrid" runat="server" Height="200px" Width="325px"
                                ...
                                <td runat="server" id="decreaseTD">
                                    <asp:Label ID="decreaseGridCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                                    <igtbl:UltraWebGrid ID="DecreaseRatingGrid" runat="server" Height="200px" Width="325px"
                                        OnDataBinding="UltraWebGrid_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout"
                                        OnInitializeRow="UltraWebGrid_InitializeRow" SkinID="UltraWebGrid">
                                        <Bands>
                                            <igtbl:UltraGridBand>
                            ...
                            <tr>
                                <td runat="server" id="unchangedTD">
                                    <asp:Label ID="unchangedGridCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                                    <igtbl:UltraWebGrid ID="UnChangedRatingGrid" runat="server" Height="200px" Width="325px"
                                        OnDataBinding="UltraWebGrid_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout"
                                        OnInitializeRow="UltraWebGrid_InitializeRow" SkinID="UltraWebGrid">
                                        <Bands>
                                            <igtbl:UltraGridBand>
