<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0011_02.Default" %>
                ...
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <asp:CheckBox ID="quarterValuation" runat="server" Text="Поквартальная оценка" AutoPostBack="true"
    ...
    <table style="vertical-align: top;">
        <tr>
            <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td style="overflow: visible;">
                        <igmisc:WebAsyncRefreshPanel ID="GridWebAsyncRefreshPanel" runat="server" Style="width: 100%">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="200px" Width="325px"
                                ...
                                OnInitializeRow="UltraWebGrid_InitializeRow" SkinID="UltraWebGrid" OnActiveRowChange="UltraWebGrid_ActiveRowChange">
                                <Bands>
                                    <igtbl:UltraGridBand>
            ...
            <td valign="top" align="left">
                <igmisc:WebAsyncRefreshPanel ID="UltraChart1WebAsyncRefreshPanel" runat="server"
                    Style="width: 100%">
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        <tr>
                            <td class="topleft">
                        ...
                        <tr>
                            ...
                            <td class="headerReport" colspan="3">
                                <asp:Label ID="chartHeaderLabel" runat="server" CssClass="ElementTitle"></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:Label ID="SelectedKdCaption" runat="server" CssClass="ElementSubTitle"></asp:Label>
                            </td>
                            <td class="right">
                            </td>
                        </tr>                                     
                        <tr>
                            ...
                            <td style="overflow: visible;" align="center">
                                <igchart:UltraChart ID="UltraChart1_1" runat="server" BackgroundImageFileName=""
                                    EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    Version="9.1" OnDataBinding="UltraChart1_1_DataBinding">
                            ...
                            <td style="overflow: visible;" align="center">
                                <igchart:UltraChart ID="UltraChart1_2" runat="server" BackgroundImageFileName=""
                                    EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    Version="9.1" OnDataBinding="UltraChart1_2_DataBinding">
                                    <Tooltips Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False"
                                        Font-Bold="False"></Tooltips>
                                    <ColorModel ModelStyle="CustomLinear" ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink">
                                    </ColorModel>
                            ...
                            <td style="overflow: visible;">
                                <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName=""
                                    ...
                                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fo_02_08_2#SEQNUM(100).png" />
                                </igchart:UltraChart>
                            </td>
                            <td class="right">
                            </td>
