<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0003_0014_Novosib.Default" %>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                    Сравнительный анализ муниципальных районов и городских округов <b>Новосибирской 
                    области</b> по показателю:<br><asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>
            </td>
            <td class="right">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    <ColumnChart>
                        <ChartText>
                            <igchartprop:ChartTextAppearance ChartTextFont="Verdana, 8pt, style=Bold" 
                                ClipText="False" Column="-2" Row="-2" VerticalAlign="Far" Visible="True" />
                        </ChartText>
                    </ColumnChart>
                    <Axis>
