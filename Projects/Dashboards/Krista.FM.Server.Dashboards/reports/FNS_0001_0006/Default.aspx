<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0006.Default" %>
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
             ...
             <td valign="top">
                <uc3:CustomMultiCombo ID="ComboOKVED" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
            ...
            <tr>
                ...
                <td style="overflow: visible;">
                    <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                        ...
                        <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_fns_01_06_2#SEQNUM(100).png" />
                    </igchart:UltraChart>
                </td>
                <td class="right">
                </td>
