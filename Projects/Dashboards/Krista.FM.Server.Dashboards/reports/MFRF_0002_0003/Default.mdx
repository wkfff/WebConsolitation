...
<root>  
  <query id="MFRF_0002_0003_compare_Grid">
    <![CDATA[
-- MFRF_0002_0003_compare_Grid - Таблица 
with           
...
WHERE   
  ...
  <query id="MFRF_0002_0003_compare_comment">
        <![CDATA[
-- MFRF_0002_0003_compare_Grid  - комментарий к индикаторам
with       
    member Measures.[Код]       
...
WHERE       
  ...
  <query id="MFRF_0002_0003_map">
    <![CDATA[   
    --MFRF_0002_0003_map - карта
SELECT
     Filter  
    (
        Descendants  
...
WHERE    
  ...
  <query id="MFRF_0002_0003_map_hint">
    <![CDATA[   
    --MFRF_0002_0003_map_hint - хинты к карте
with   
    member Measures.[Код]   
...
WHERE 
  ...
  <query id="MFRF_0002_0003_periodDigest">
    <![CDATA[
-- MFRF_0002_0003_periodDigest
with  
    set [Периоды]    
    as 'Filter    
        (
