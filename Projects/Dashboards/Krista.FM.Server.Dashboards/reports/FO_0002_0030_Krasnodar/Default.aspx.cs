    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                grbsDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "KrasnodarList", CRHelper.BasePath);
            ...
            if (ComboBudget.SelectedValue == "Консолидированный бюджет субъекта")
            {
                ...
                selectedBudget.Value = ",[Районы__Сопоставимый].[Районы__Сопоставимый].[Все районы].[Консолидированный бюджет - Краснодарский край]";
                  ...
                  if (dtType.Rows[0][1].ToString() == "1") // муниципальные районы
                    {
                        ...
                        typeDocument.Value = "[ТипДокумента__СКИФ].[ТипДокумента__СКИФ].[Все].[Данные конс. отчета субъекта в разрезе городов, районов и поселений (5+6+7+8)] ";
                        levelBudget.Value = " [Уровни бюджета__СКИФ].[Уровни бюджета__СКИФ].[Уровень бюджета ]  ";
                    }
                  else
                  {
