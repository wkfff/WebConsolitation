<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true"
    Codebehind="Default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.STAT_0001_0011.Default"
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="AllocationChart" runat="server" BackgroundImageFileName=""
                                   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                OnDataBinding="AllocationChart_DataBinding" Version="8.2">
                                ...
                                <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_STAT0111_1#SEQNUM(100).png" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
                        </td>
                    ...
                    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="dynamicChartCaption" runat="server" CssClass="ElementTitle"></asp:Label>&nbsp;(<asp:Label
                                    ID="subjectLabel" runat="server" CssClass="ElementTitle"></asp:Label>)
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="overflow: visible;">
                                <igchart:UltraChart ID="DynamicChart" runat="server" BackgroundImageFileName=""  
                                     EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    OnDataBinding="DynamicChart_DataBinding" Version="8.2">
                                    <Tooltips Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False"
                                        Font-Bold="False"></Tooltips>
                                    <ColorModel ModelStyle="CustomLinear" ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink">
                                    </ColorModel>
                                    ...
                                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_STAT0111_2#SEQNUM(100).png" />
                                </igchart:UltraChart>
                            </td>
                            <td class="right">
                            </td>
