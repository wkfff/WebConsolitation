<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0004.Default" Title="Данные 410 по показателям"  %>
...
<%@ Register Src="../../components/DimensionTree.ascx" TagName="DimensionTree" TagPrefix="uc1" %>
    ...
    <div>
     ...
     <tr> 
        <td>
         <table  width="100%"><tr><td><nobr><B><asp:Label id="Label1" runat="server" Text="Информация по налоговым доходам ФНС в разрезе показателей" __designer:wfdid="w7" SkinID="PageTitle"></asp:Label></B></nobr></td>
        ...
        <table>
            ...
            <td valign="top" >
                    <igtbl:UltraWebGrid ID="uwGrid" runat="server" EnableAppStyling="True"
                        Height="233px" Width="600px" StyleSetName="Office2007Blue" OnDataBinding="uwGrid_DataBinding" OnInitializeLayout="uwGrid_InitializeLayout" OnInitializeRow="uwGrid_InitializeRow" SkinID="UltraWebGrid">
                        <Bands>
                            <igtbl:UltraGridBand>
