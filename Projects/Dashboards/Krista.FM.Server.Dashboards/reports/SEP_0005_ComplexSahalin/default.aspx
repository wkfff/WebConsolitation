<%@ Page Language="C#"  MasterPageFile="~/Reports.Master"  AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_0005_ComplexSahalin._default" %>
        ...
        <tr>
            ...
            <td>
                ...
                <igchart:UltraChart ID="Chart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                   Version="11.1" Height="450px" ondatabinding="Chart1_DataBinding" 
                    onfillscenegraph="Chart1_FillSceneGraph" oninvaliddatareceived="Chart1_InvalidDataReceived" 
                    >
                    ...
                    <Axis>
                        ...
                        <X Visible="True" LineThickness="1" TickmarkStyle="Smart" TickmarkInterval="0" Extent="205">
                            ...
                            <Labels ItemFormatString="&lt;ITEM_LABEL&gt;" Font="Verdana, 8pt" FontColor="DimGray"
