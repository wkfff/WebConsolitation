<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.PMO_0001_0011._default" %>
    ...
    <table width="100%" border=0 cellpadding=2 cellspacing=0>
        ...
        <td colspan=2>
            ...
            <igtbl:UltraWebGrid ID="web_grid" runat="server" EnableAppStyling="True" OnActiveRowChange="web_grid_ActiveRowChange"
                ...
                StyleSetName="Office2007Blue" Width="100%" Height="270px">
                <Bands>
                    <igtbl:UltraGridBand>
                ...
                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                    ...
                    <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="None" BorderWidth="1px"
                        Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Width="100%" Height="270px">
                    </FrameStyle>
            ...
            Font-Size="Medium" Text="Динамика показателя:"></asp:Label>
                <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server"
                    ...
                    <asp:Label ID="Label1" runat="server" BorderStyle="None" Font-Bold="True" Font-Names="Arial"
                        Font-Size="Medium" Text="заголовок"></asp:Label><igchart:UltraChart ID="chart_avg_count" runat="server" BackgroundImageFileName=""
                    BorderColor="InactiveCaption" BorderWidth="0px" ChartType="CylinderStackBarChart3D" EmptyChartText="данных не найдено"
                    OnDataBinding="chart_avg_count_DataBinding"
                    SplineAreaChart-LineDrawStyle="Solid" Version="8.2" OnChartDataClicked="chart_avg_count_ChartDataClicked" Width="100%" Transform3D-XRotation="120" Transform3D-YRotation="5" Transform3D-Scale="90" OnInit="chart_avg_count_Init" OnInvalidDataReceived="chart_avg_count_InvalidDataReceived">
                    ...
                    <Axis>
                        ...
                        <Y2 LineThickness="1" TickmarkInterval="2" TickmarkStyle="Smart" Visible="True">
                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                Visible="False" />
                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                Visible="True" />
                        ...
                        <X Extent="40" LineThickness="1" TickmarkInterval="50" TickmarkIntervalType="Hours"
                        ...
                        <Y Extent="40" LineThickness="1" TickmarkInterval="2" TickmarkStyle="Smart" Visible="True">
                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                Visible="False" />
                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                Visible="True" />
                        ...
                        <X2 LineThickness="1" TickmarkInterval="50" TickmarkIntervalType="Hours" TickmarkStyle="Smart"
                            Visible="True">
                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                Visible="False" />
                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                Visible="True" />
                            <Labels Font="Verdana, 7pt" FontColor="Gray" HorizontalAlign="Far" ItemFormatString="&lt;ITEM_LABEL:MM-dd-yy&gt;"
                        ...
                        <Data MinValue="0" SwapRowsAndColumns="True" UseMinMax="True" UseRowLabelsColumn="True" ZeroAligned="True">
                        </Data>
            ...
            <td valign=top align=center style="height: 19px">
                <asp:Label ID="Label3" runat="server" BorderStyle="None" Font-Bold="True" Font-Names="Arial"
                    Font-Size="Medium" Text="Количество проживающих в ветхом и аварийном жилье."></asp:Label></td>
            <td valign=top align=center style="height: 19px">
                <asp:Label ID="Label4" runat="server" BorderStyle="None" Font-Bold="True" Font-Names="Arial"
                    Font-Size="Medium" Text="Общая площадь жилья, приходящаяся на 1 жителя."></asp:Label></td>
            </tr>
            <tr>
            ...
            <td align=center style="height: 363px">
                ...
                <igchart:UltraChart ID="chart_pie1" runat="server" BackgroundImageFileName=""  
                    BorderWidth="0px" ChartType="SplineAreaChart" EmptyChartText="данных не найдено"
                    Height="400px" OnDataBinding="chart_pie_DataBinding" OnInit="chart_pie1_Init"
                    Version="8.2" OnInvalidDataReceived="chart_pie1_InvalidDataReceived" SplineAreaChart-LineDrawStyle="Solid">
                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" />
                    <Border Thickness="0" />
            ...
            <td align=center style="height: 363px">
                &nbsp;<igchart:UltraChart ID="chart_pie2" runat="server" BackgroundImageFileName="" BorderColor="InactiveCaption"
                    BorderWidth="0px" ChartType="SplineChart3D" EmptyChartText="данных не найдено" OnDataBinding="chart_pie2_DataBinding" Version="8.2" Width="300px" Height="400px" Transform3D-XRotation="125" Transform3D-YRotation="-10" OnInvalidDataReceived="chart_pie2_InvalidDataReceived" Transform3D-Scale="95">
                ...
                <Axis>
                    ...
                    <Y2 LineThickness="1" TickmarkInterval="40" TickmarkStyle="Smart" Visible="True">
                        <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                Visible="False" />
                        <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                Visible="True" />
