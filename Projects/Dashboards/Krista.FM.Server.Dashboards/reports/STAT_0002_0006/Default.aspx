<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0006.Default" Title = "Анализ динамики и структурного соотношения численности безработных граждан, состоящих на регистрационном учете"%>
