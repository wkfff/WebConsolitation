    ...
    public partial class Default : CustomReportPage
    {
        ...
        */
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.Text = "Еженедельный&nbsp;мониторинг&nbsp;ситуации&nbsp;на&nbsp;рынке&nbsp;труда";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            chart1ElementCaption.Text = String.Format("Уровень безработицы (от экономически активного населения), {0}", RegionsNamingHelper.ShortName(ComboRegion.SelectedValue));
            chart2ElementCaption.Text = String.Format("Численность безработных на конец месяца, {0}", RegionsNamingHelper.ShortName(ComboRegion.SelectedValue));
            chart3ElementCaption.Text = String.Format("Уровень общей безработицы по методологии МОТ, {0}", RegionsNamingHelper.ShortName(ComboRegion.SelectedValue));
            ...
            lineAppearance.Thickness = 3;
            lineAppearance.SplineTension = (float)0.3;
            if (ComboRegion.SelectedValue != "Уральский федеральный округ")
            {
        ...
        private string GetDescritionText(DateTime date)
        {
            ...
            if (ComboRegion.SelectedValue != "Уральский федеральный округ")
            {
                   ...
                   Double.TryParse(dtText.Rows[3][1].ToString(), out ufoMot))
                {
                    ...
                    string grown;
                    string middleLevel = String.Format("среднего уровня общей безработицы по УрФО на <b>{0:P2}</b>", Math.Abs(grownValue)); ;
                    if (grownValue < 0)
                    {
                        grown = "выше";
                    }
                    ...
                    description +=
                        String.Format(
                            "{0} {3} {1} (уровень безработицы по УрФО <b>{2:P2}</b>) и ", grown, middleLevel, ufoMot, GetImage(grown));
                }
            }
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            for (int mainRowNum = 0; mainRowNum < dtGrid.Rows.Count; mainRowNum++)
            {
                ...
                if (dtGrid.Rows[mainRowNum][0].ToString()[0] != '2' &&
                    ...
                    (dtOperative.Columns.Count == 6 && dtGrid.Rows[mainRowNum]["Уровень зарегистрированной безработицы УрФО "] == DBNull.Value)))
                {
                    ...
                    if (dtOperative.Columns.Count == 6 && dtGrid.Rows[mainRowNum]["Уровень зарегистрированной безработицы УрФО "] == DBNull.Value)
                    {
                        dtGrid.Rows[mainRowNum]["Уровень зарегистрированной безработицы УрФО "] =
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            else if (ComboRegion.SelectedValue == "Уральский федеральный округ")
            {
                for (int i = 1; i < e.Layout.Bands[0].Columns.Count; i++)
                {
        ...
        protected void UltraChart1_DataBinding(object sender, EventArgs e)
        {
            ...
            for (int mainRowNum = 0; mainRowNum < dtChart.Rows.Count; mainRowNum++)
            {
                ...
                if (dtChart.Rows[mainRowNum]["Уровень зарегистрированной безработицы "] == DBNull.Value ||
                    ...
                    (dtOperative.Columns.Count == 6 && dtChart.Rows[mainRowNum]["Уровень зарегистрированной безработицы УрФО "] == DBNull.Value))
                {
                    string checkingPeriod =
            ...
            dtChart.Columns["Уровень зарегистрированной безработицы "].ColumnName =
                    String.Format("{0} {1}", "Уровень зарегистрированной безработицы ", RegionsNamingHelper.ShortName(ComboRegion.SelectedValue));
            dtChart.Columns["Уровень общей безработицы по методологии МОТ "].ColumnName =
                String.Format("{0} {1}", "Уровень общей безработицы по методологии МОТ ", RegionsNamingHelper.ShortName(ComboRegion.SelectedValue));
        ...
        protected void UltraChart2_DataBinding(object sender, EventArgs e)
        {
            ...
            dtChart.Columns["Число безработных, зарегистрированных в службе занятости "].ColumnName =
                String.Format("{0} {1}", "Число безработных, зарегистрированных в службе занятости ", RegionsNamingHelper.ShortName(ComboRegion.SelectedValue));
            dtChart.Columns["Общая численность безработных по методологии МОТ "].ColumnName =
               String.Format("{0} {1}", "Общая численность безработных по методологии МОТ ", RegionsNamingHelper.ShortName(ComboRegion.SelectedValue));
            dtChart.AcceptChanges();
