<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0043.Default" Title="Untitled Page" %>
...
<%@ Register Src="../../Components/ChartBricks/PeriodAreaChartBrick.ascx" tagname="PeriodAreaChartBrick" tagprefix="uc6" %>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            ...
                            <uc6:PeriodAreaChartBrick ID="ChartBrick" runat="server"></uc6:PeriodAreaChartBrick>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
