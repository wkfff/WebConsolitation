<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0001_0005.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                    ...
                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_stat_01_05#SEQNUM(100).png" />
                </igchart:UltraChart>
            </td>
            <td class="right">
            </td>
    ...
    <table>
        <tr>
            <td valign="top">
                <table style="border-collapse: collapse; background-color: White; width: 100%; height: 640px; margin-top: 10px;">
                                <tr>
                                    <td class="topleft">
                                    </td>
                                    <td class="top">
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; height: 640px; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" valign="top">
                            ...
                            <igtbl:UltraWebGrid ID="CommentGrid" runat="server" Height="200px" Width="325px"
                                OnDataBinding="CommentGrid_DataBind" OnInitializeLayout="CommentGrid_InitializeLayout"
                                OnInitializeRow="CommentGrid_InitializeRow" SkinID="UltraWebGrid">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
                            ...
                            <asp:Label ID="CommentText3" runat="server" CssClass="PageSubTitle"></asp:Label>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                <igchart:UltraChart ID="PolarUltraChart" runat="server" BackgroundImageFileName=""
                       EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    Version="9.1" OnDataBinding="PolarUltraChart_DataBinding">
                    <Tooltips Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False"
                        Font-Bold="False"></Tooltips>
                    <ColorModel ModelStyle="CustomLinear" ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink">
                    </ColorModel>
                    ...
                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_stat_01_05_2#SEQNUM(100).png" />
                </igchart:UltraChart>
            </td>
            <td class="right">
            </td>
