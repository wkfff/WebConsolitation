<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.CTAT.CTAT_0010._default" %>
        ...
        <table>
            <tr>
                <td style="vertical-align: top">
                    <asp:Label ID="GT" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;
                    <igmisc:WebAsyncRefreshPanel ID = "PanelGrid" runat="server">
                ...
                <td rowspan="2" style="vertical-align: top">
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel2" runat="server"
                        Width="100%" LinkedRefreshControlID="PanelGrid">
                        <asp:Label ID="TCT" runat="server" Text="Label"></asp:Label>
                    <igchart:UltraChart ID="TC" runat="server" BackgroundImageFileName=""  
                        ...
                        <ColumnChart>
                            <ChartText>
                                <igchartprop:ChartTextAppearance ChartTextFont="Arial, 8pt, style=Bold" Column="-2" Row="-2"
            ...
            <tr>
                <td style="vertical-align: top">
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel1" runat="server" TriggerControlIDs="G"
                        Width="100%" RefreshTargetIDs="WebAsyncRefreshPanel2" LinkedRefreshControlID="PanelGrid">
                        <asp:Label ID="BCT" runat="server" Text="Label"></asp:Label>
