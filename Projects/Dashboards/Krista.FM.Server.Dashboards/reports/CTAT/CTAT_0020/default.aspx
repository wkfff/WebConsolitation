...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        <asp:Label ID="Label4" runat="server" Text="Данные по платным услугам в субъекте РФ (подстановка значения параметра 1)"></asp:Label><br />
        &nbsp;<asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Italic="False"
            Font-Size="10pt" Text="Год  "></asp:Label>
        <asp:DropDownList ID="DropDownList1" runat="server">
                    </asp:DropDownList>&nbsp;&nbsp;
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="10pt" Text="Месяц"></asp:Label>
        &nbsp;
        <asp:DropDownList ID="DropDownList5" runat="server">
        </asp:DropDownList>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Обновить" />
        &nbsp;&nbsp;
        <table>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="2" style="vertical-align: top">
                    <br />
                    <asp:Label ID="BCT" runat="server" Text="Объём платных услуг населению по городам и районам" Font-Bold="True" Font-Size="10pt"></asp:Label><br />
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel2" runat="server" RefreshTargetIDs="BCT" Width="100%" OnDataBinding="WebAsyncRefreshPanel2_DataBinding">
                        <table style="vertical-align: top">
                            <tr>
                                <td style="vertical-align: top">
                                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="10pt" Text="Месяц:  c"></asp:Label>&nbsp;
                                    <asp:DropDownList ID="DropDownList4" runat="server">
                                    </asp:DropDownList>&nbsp;
                                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="10pt" Text="по"></asp:Label>&nbsp;
                                    <asp:DropDownList ID="DropDownList3" runat="server">
                                    </asp:DropDownList>
                                </td>
                                <td style="vertical-align: top">
                                    &nbsp;
                                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="10pt" Text="Год"></asp:Label>
                                    &nbsp;
                                    <asp:DropDownList ID="DropDownList2" runat="server">
                                    </asp:DropDownList></td>
                                <td>
                                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Обновить" /></td>
                            </tr>
                        </table>
                        &nbsp;
