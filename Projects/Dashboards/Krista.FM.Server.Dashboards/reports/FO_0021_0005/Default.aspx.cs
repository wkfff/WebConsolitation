...
namespace Krista.FM.Server.Dashboards.reports.FO_0021_0005
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink4.NavigateUrl = "~/reports/FO_0021_0004/Default.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0021_0005_date");
                ...
                periodDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FO_0021_0005_nonEmptyPeriodList");
                ...
                ComboPeriod.SetСheckedState(String.Format("{0} год", endYear), true);
            }

            Page.Title = String.Format("Диаграмма динамики результатов оценки качества управления финансами муниципальных образований Вологодской области по отдельному показателю");
            ...
            indicatorDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "FO_0021_0005_indicatorList");
        ...
        private bool IsBooleanIndicator(string indicatorName)
        {
            ...
            return (indicatorName != "Рейтинг") && (format == "N0");
        }
        ...
        {
            string query = DataProvider.GetQueryText("FO_0021_0005_chart");
