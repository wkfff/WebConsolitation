...
namespace Krista.FM.Server.Dashboards.reports.FO_0042_0001_HMAO
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = String.Format("Результаты мониторинга качества финансового менеджмента, осуществляемого главными распорядителями средств бюджета автономного округа, главными администраторами доходов бюджета ХМАО-Югры");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            for (int i = beginIndex; i < e.Layout.Bands[0].Columns.Count; i = i + 1)
            {
                ...
                if (cell.Caption != "Итоговая оценка")
                {
                    GridHeaderCell unitCell = cell.AddCell(ValueSelected ? "Значение" : "Оценка");
                    if (indicatorUnitList.ContainsKey(cell.Caption))
                    {
                        unitCell.Hint = ValueSelected ? indicatorUnitList[cell.Caption] : "Баллы";
                    }
                }
                else
                {
