<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0009_Samara.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;"> 
        <tr>
            ...
            <td valign="top" runat="server" ID="tdMO">
                <uc3:CustomMultiCombo ID="ComboMO" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top" runat="server" ID="tdGRBS">
                <uc3:CustomMultiCombo ID="ComboGRBS" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
            ...
            <td valign="top" align="left" style="font-family:Verdana; font-size:12px;">
                <asp:RadioButtonList ID="IndicatorButtonList" runat="server" AutoPostBack="true" RepeatDirection="horizontal"
                    Width="150px">
                    <asp:ListItem Selected ="true">лн</asp:ListItem>
                    <asp:ListItem >цпая</asp:ListItem>
                </asp:RadioButtonList>
            </td>
