    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                firstYear = (RegionSettingsHelper.Instance.Name == "Ярославская область") ? 2009: 2005;
                ComboYear.Title = "Год";
                ComboYear.Width = 100;
            ...
            Page.Title = "Поступление по основным видам налоговых доходов в бюджет субъекта в разрезе видов деятельности";
