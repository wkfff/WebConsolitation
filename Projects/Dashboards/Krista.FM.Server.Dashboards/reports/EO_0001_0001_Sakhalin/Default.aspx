<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.EO_0001_0001_Sakhalin.Default" %>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                         ...
                         <td class="headerReport">
                           <asp:Label ID="Label1" runat="server" CssClass="PageTitle" Text = "Динамика интегрального индекса инвестиционной привлекательности в разрезе муниципальных образований"></asp:Label>
                        </td>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    <tr>
                     ...
                     <tr>
                         ...
                         <td class="headerReport">
                          <asp:Label ID="Label2" runat="server" CssClass="ElementTitle" Text = ""></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>  
