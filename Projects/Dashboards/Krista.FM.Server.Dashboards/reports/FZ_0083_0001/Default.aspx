<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FZ_0083_0001.Default" Title="Доходы по субъектам РФ" %>
    ...
    <table>
        <tr>
            <td valign="top" align="left">
                <uc6:CustomMultiCombo ID="kindsCombo" runat="server" />
            </td>
            <td valign="top" align="left">
                <uc6:CustomMultiCombo ID="foCombo" runat="server" />
            </td>
            <td valign="top" align="left">
        ...
        <tr>
            <td valign="top" align="left" style="font-family: Verdana; font-size: 12px;">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal">
                    ...
                    <asp:ListItem>Казенные учреждения</asp:ListItem>
                    <asp:ListItem>Бюджетные учреждения</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
    </table>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="lbGrid1Caption" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" EnableAppStyling="True" OnInitializeLayout="UltraWebGrid1_InitializeLayout"
