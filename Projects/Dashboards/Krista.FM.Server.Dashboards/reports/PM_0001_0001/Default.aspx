<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.PM_0001_0001.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <td valign="top" style="width: 100%; vertical-align: top;">
                <uc4:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="default.html"
                    Visible="true"></uc4:PopupInformer>
                &nbsp;&nbsp;
    ...
    <table>
        <tr>
            <td valign="top">
                <asp:CheckBox ID="cbState" runat="server" Text="Государственный заказ" AutoPostBack="true" Checked="true"/><br />
                <asp:CheckBox ID="cbMunicipal" runat="server" Text="Муниципальный заказ" AutoPostBack="true" Checked="false"/>
            </td>
            <td valign="middle">
