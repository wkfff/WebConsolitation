<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_001._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" 
                    NavigateUrl="~/reports/SEP_002/default.aspx" SkinID="HyperLink">Ежемесячный мониторинг социально-экономического развития</asp:HyperLink></div>
                                ...
                                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; height: 360px;">
                                            <asp:Label ID="HeaderChart" runat="server" CssClass="ElementTitle">
                                            </asp:Label><igchart:UltraChart ID="Chart" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                                ...
                                                <DeploymentScenario FilePath="../../TemporaryImages" 
                                                    ImageURL="../../TemporaryImages/Chart_sep_02_08_2.png" />
