<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0039.Default" %>
             ...
             <tr>
                <td>
                 <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="horizontal"
                   ...
                   <asp:ListItem>Детализация статей доходов</asp:ListItem>
                   <asp:ListItem>Детализация статей расходов</asp:ListItem>
                 </asp:RadioButtonList>
             </td>
             </tr>
             <tr>
               <td >
                 <asp:CheckBox ID="Check1" runat="server" Text="годовой потенциальный план"
                         AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" /> &nbsp; &nbsp; &nbsp;
                <asp:CheckBox ID="Check2" runat="server" Text="темп роста к аналогичному периоду прошлого года"
                    AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" />
               </td>
            </tr>
           </table>
