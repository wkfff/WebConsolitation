...
namespace Krista.FM.Server.Dashboards.OMCY_0002.Default.reports.OMCY_002_Sahalin
{
    public partial class _default : CustomReportPage
    {
        ...
        bool isEmpty(object o)
        {
            ...
            if (o != DBNull.Value)
            {
                CRHelper.SaveToErrorLog(o.ToString());
        ...
        protected void SettingButifulHeader()
        {
            ...
            GenerationHeader(Grid, "Отчётный период", 4, 0, 2, 1);
            SetHeaderPos(Columns.FromKey("Current").Header, 4, 1, 1, 1);
            SetHeaderPos(Columns.FromKey("Shift").Header, 5, 1, 1, 1);

            GenerationHeader(Grid, "Плановый период", 5+1, 0, 3, 1);
            SetHeaderPos(Columns.FromKey("Current+1").Header, 5+1, 1, 1, 1);
            SetHeaderPos(Columns.FromKey("Current+2").Header, 6+1, 1, 1, 1);
            SetHeaderPos(Columns.FromKey("Current+3").Header, 7+1, 1, 1, 1);

            SetHeaderPos(Columns.FromKey("Note").Header, 8+1, 0, 1, 2);
        }
        ...
        protected void SettingColWidth()
        {
            ...
            Columns.FromKey("Field").Width = OnePercentWidth * (30-4);
            ...
            Columns.FromKey("Shift").Width = OnePercentWidth * 8;
            ...
            Columns.FromKey("Note").Width = OnePercentWidth * (19-4);
        ...
        protected void SettingCellStyle()
        {
            ...
            Columns.FromKey("Shift").CellStyle.HorizontalAlign = HorizontalAlign.Right;
            Columns.FromKey("Shift").CellStyle.Padding.Right = 10;
        }
