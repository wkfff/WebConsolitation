<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.OIV_0001_0001.Default" %>
...
<%@ Register Src="../../Components/CustomMultiCombo.ascx" TagName="CustomMultiCombo"
    TagPrefix="uc3" %>
<%@ Register Src="../../Components/SaveRejectButton.ascx" TagName="SaveRejectButton"
    TagPrefix="uc4" %>
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                <div style="margin-left: -2px">
                    <uc4:SaveRejectButton ID="SaveRejectButton1" runat="server" />
                </div>
                <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="200px" Width="325px"
                    ...
                    <DisplayLayout ViewType="OutlookGroupBy" Version="4.00" AllowSortingDefault="OnClient"
                        ...
                        <ClientSideEvents AfterCellUpdateHandler="EnableSubmitButton" AfterRowInsertHandler="EnableSubmitButton" />
