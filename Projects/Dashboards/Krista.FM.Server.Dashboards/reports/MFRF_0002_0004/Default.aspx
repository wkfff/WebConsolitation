<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.MFRF_0002_0004.Default" Title="Индикаторы БК и КУ " %>
        ...
        <tr>
            ...
            <td valign="top">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                    Width="500px" style="font-family:Verdana;font-size:12px;">
                    <asp:ListItem Selected="True">По данным месячной отчётности</asp:ListItem>
                    <asp:ListItem>По данным годовой отчётности</asp:ListItem>
                </asp:RadioButtonList>
            </td>
                ...
                <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel" runat="server" TriggerControlIDs="UltraWebGrid">
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="ChartComment" runat="server" CssClass="ElementSubTitle"></asp:Label>
