<%@ Page Language="C#" Title="Физическая культура и спорт" MasterPageFile="~/Reports.Master"
    AutoEventWireup="true" Codebehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._0240.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table style="width: 100%">
            <tr>
                <td style="height: 21px">
                    &nbsp;<uc1:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="help.html"
                        Visible="true" />
                    <asp:Label ID="page_title" runat="server" Text="заголовок" CssClass="PageTitle"></asp:Label><br />
                    <asp:Label ID="page_subtitle" runat="server" CssClass="PageSubTitle" Text="заголовок"></asp:Label></td>
                <td style="text-align: right">
                    <a href="../OverallTable/default.aspx?pok=024" style="font-size: 10pt">Сводный отчет</a>
                </td>
            </tr>
        </table>
    </div>
    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
        ...
        <tr>
            ...
            <td class="right" style="height: 21px">
            </td>
        </tr>
        <tr>
            <td class="bottomleft">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: white">
                            ...
                            <igtbl:UltraWebGrid ID="web_grid1" runat="server" EnableAppStyling="True" OnActiveRowChange="web_grid1_ActiveRowChange"
                                OnDataBinding="web_grid1_DataBinding" OnInitializeLayout="web_grid1_InitializeLayout"
                                StyleSetName="Office2007Blue" Width="350px" Height="293px">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                ...
                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                    ...
                                    <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="None" BorderWidth="1px"
                                        Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Width="350px" Height="293px">
                                    </FrameStyle>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: white">
                                            ...
                                            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                                                ...
                                                Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40"
                                                Transform3D-Scale="80" Transform3D-XRotation="120" Transform3D-YRotation="0"
                                                ChartType="BarChart3D" OnDataBinding="UltraChart1_DataBinding" Width="500px"
                                                Height="300px">
                                                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                    Font-Underline="False" FormatString="&lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;"
                                                    EnableFadingEffect="True" Overflow="ClientArea" />
                                                ...
                                                <Axis>
                                                    <Z LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True" Extent="30">
    ...
    <table style="margin-top: 10px; width: 100%; border-collapse: collapse">
        ...
        <tr>
            ...
            <td style="background-color: white">
                ...
                <igtbl:UltraWebGrid ID="web_grid2" runat="server" EnableAppStyling="True" OnClick="web_grid2_Click"
                    OnDataBinding="web_grid2_DataBinding" OnInitializeLayout="web_grid2_InitializeLayout"
                    StyleSetName="Office2007Blue" Width="350px" OnInitializeRow="web_grid2_InitializeRow">
                    <Bands>
                        <igtbl:UltraGridBand>
                            <AddNewRow View="NotSet" Visible="NotSet">
                            </AddNewRow>
                        ...
                        <tr>
                            ...
                            <td style="background-color: white">
                                ...
                                <igchart:UltraChart ID="UltraChart3" runat="server" BackgroundImageFileName=""  
                                    ...
                                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;b&gt;&lt;DATA_VALUE:###,##0.##&gt;&lt;/b&gt;, единиц"
                                        EnableFadingEffect="True" Overflow="ClientArea" />
                                    <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                                    <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
                                    </ColorModel>
