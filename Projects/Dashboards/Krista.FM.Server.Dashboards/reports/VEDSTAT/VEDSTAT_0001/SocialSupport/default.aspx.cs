...
namespace Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._006
{
    public partial class Default : CustomReportPage
    {
        ...
        private static String chart6_title_caption = "Динамика показателя «{0}», {1}";
        // заголовок для Chatr7
        private static String chart7_title_caption = "Динамика показателя «{0}», {1}";
        ...
        protected void web_grid1_DataBinding(object sender, EventArgs e)
        {
            try
            {
                ...
                grid_master.Rows[0][0] = grid_master.Rows[0][0].ToString() + ", человек";
        ...
        protected void web_grid2_InitializeLayout(object sender, LayoutEventArgs e)
        {
            try
            {
                ...
                e.Layout.Bands[0].Columns[1].Header.Caption += ", человек";
                e.Layout.Bands[0].Columns[2].Header.Caption += ", человек";
            }
            catch
            {
                // ошибка инициализации
        ...
        private void webGrid3ActiveRowChange(int index, bool active)
        {
            try
            {
                ...
                Chart6.DataBind();
                chart6_caption.Text = String.Format(chart6_title_caption, GetString_(row.Cells[1].Value.ToString()), _GetString_(row.Cells[1].Value.ToString()));
            }
            catch (Exception)
            {
                // выбор сторки пошел с ошибкой ...
        ...
        private void webGrid4ActiveRowChange(int index, bool active)
        {
            try
            {
                ...
                Chart7.DataBind();
                chart7_caption.Text = String.Format(chart7_title_caption, GetString_(row.Cells[1].Value.ToString()), _GetString_(row.Cells[1].Value.ToString()));
            }
            catch (Exception)
            {
                // выбор сторки пошел с ошибкой ...
        ...
        protected void Chart7_DataBinding(object sender, EventArgs e)
        {
            ...
            Chart1.InvalidDataReceived += new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventHandler(Chart_invalid_XD);
            Chart2.InvalidDataReceived += new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventHandler(Chart_invalid_XD);
            Chart3.InvalidDataReceived += new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventHandler(Chart_invalid_XD);
            Chart4.InvalidDataReceived += new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventHandler(Chart_invalid_XD);
            Chart5.InvalidDataReceived += new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventHandler(Chart_invalid_XD);
            Chart6.InvalidDataReceived += new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventHandler(Chart_invalid_XD);
            Chart7.InvalidDataReceived += new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventHandler(Chart_invalid_XD);

            Chart1.Tooltips.Font.Size = FontUnit.Medium;
            Chart2.Tooltips.Font.Size = FontUnit.Medium;
            Chart3.Tooltips.Font.Size = FontUnit.Medium;
            Chart4.Tooltips.Font.Size = FontUnit.Medium;
            Chart5.Tooltips.Font.Size = FontUnit.Medium;
            Chart6.Tooltips.Font.Size = FontUnit.Medium;
            Chart7.Tooltips.Font.Size = FontUnit.Medium;
        ...
        {
            //CRHelper.UltraChartInvalidDataReceived(e,new Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventArgs(
        }
        protected void Chart_invalid_XD(object sender, Infragistics.UltraChart.Shared.Events.ChartDataInvalidEventArgs e)
        {
            CRHelper.UltraChartInvalidDataReceived(sender, e);
        }
