...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <br />
                    ...
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel_" runat="server">
                    <igtbl:UltraWebGrid ID="GT" runat="server" EnableAppStyling="True"
            ...
            <tr>
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel1" runat="server"
                        width="100%" LinkedRefreshControlID="WebAsyncRefreshPanel_">
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel2" runat="server"
                        width="100%" LinkedRefreshControlID="content$WebAsyncRefreshPanel_"> 
                        <table style="border-collapse: collapse; background-color: white; width: 100%;">
                            <tr>
                                <td class="topleft">
                                </td>
                    ...
                    <asp:Label id="Label3" runat="server" Text="Label" CssClass="ElementTitle"></asp:Label>
                                    <igchart:UltraChart id="C2" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C2_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" OnChartDrawItem="C2_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel3" runat="server"
                        ...
                        <igchart:UltraChart id="C3" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C3_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" Height="317px" OnChartDrawItem="C3_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel6" runat="server"
                        ...
                        <igchart:UltraChart id="C4" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C4_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C4_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
            ...
            <tr>
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel4" runat="server"
                        ...
                        <igchart:UltraChart id="C21" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C21_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" ChartType="DoughnutChart" Height="316px" Width="410px" OnChartDrawItem="C21_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    <igmisc:webasyncrefreshpanel id="WebAsyncRefreshPanel5" runat="server"
                        ...
                        <igchart:UltraChart id="C22" runat="server" Version="9.1"   EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="C22_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C22_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    ...
                    <igchart:ultrachart id="C23" runat="server" backgroundimagefilename=""  
                        ...
                        version="9.1" OnDataBinding="C23_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C23_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
...
<Layout Behavior="Auto"></Layout>
                ...
                <td style="vertical-align: top">
                    ...
                    <igchart:ultrachart id="C24" runat="server" backgroundimagefilename=""  
                         emptycharttext="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                        version="9.1" OnDataBinding="C24_DataBinding" OnInvalidDataReceived="C1_InvalidDataReceived" Width="410px" OnChartDrawItem="C24_ChartDrawItem">
<ColorModel ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink"></ColorModel>
