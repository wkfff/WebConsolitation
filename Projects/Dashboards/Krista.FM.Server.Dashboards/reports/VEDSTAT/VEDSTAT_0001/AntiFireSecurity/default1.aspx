<%@ Page Language="C#" Title="Противопожарная безопасность, сводная таблица" MasterPageFile="~/Reports.Master"  AutoEventWireup="true" CodeBehind="default1.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_0001._0260.default1" %>
