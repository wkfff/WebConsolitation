<%@ Page Language="C#" Title="Деятельность учреждений культуры" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._022.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:Label ID="Label6" runat="server" Text="Label" CssClass="PageTitle"></asp:Label><br />
        <table style="width: 100%">
            <tr>
                <td style="text-align: left">
                    <asp:Label ID="Label11" runat="server" CssClass="PageSubTitle" Text="Анализ динамики и структуры основных показателей, характеризующих организацию информационной службы в муниципальном образовании"></asp:Label></td>
                <td style="text-align: right">
                    <a href="../OverallTable/default.aspx?pok=Culture" style="font-size: 10pt">
                        Сводный отчет</a></td>
            </tr>
        </table>
        <br />
        <table style="width: 100%; border-collapse: collapse">
            ...
            <tr>
                ...
                <asp:Label ID="Texto" runat="server" Text="Текст отчёта" Font-Names="Arial" Font-Size="Small"></asp:Label></td>
                <td class="right">
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top">
                    <table style="border-collapse: collapse; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td style="background-color: white; vertical-align: top; height: 360px;">
                    <asp:Label ID="Label1" runat="server" Text="Основные показатели деятельности учреждений культуры" CssClass="ElementTitle" Height="40px"></asp:Label><br />
                    <igtbl:UltraWebGrid ID="GT" runat="server" EnableAppStyling="True" OnActiveRowChange="GT_ActiveRowChange"
                        ...
                        Width="550px" Height="291px" OnDataBound="GT_DataBound">
                        <Bands>
                            <igtbl:UltraGridBand>
                        ...
                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                            ...
                            <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="None" BorderWidth="1px"
                                Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Width="550px" Height="291px">
                            </FrameStyle>
...
<Layout Behavior="Auto"></Layout>
                            ...
                            <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                                        ...
                                        <Tooltips Font-Size="Medium" Font-Strikeout="False" />
</igchart:UltraChart>
                                </td>
                                <td class="right">
                                </td>
                ...
                <td style="vertical-align: top">
                    <table style="border-collapse: collapse; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td style="background-color: white; vertical-align: top; height: 370px;">
                    <asp:Label ID="Label2" runat="server" Text="Число посещений учреждений культурно-досугового типа" CssClass="ElementTitle" Height="40px"></asp:Label><br />
                    <igtbl:UltraWebGrid ID="GB" runat="server" EnableAppStyling="True" OnActiveCellChange="GB_ActiveCellChange"
                        ...
                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                            ...
                            <FrameStyle BackColor="Window" BorderColor="InactiveCaption" BorderStyle="None" BorderWidth="1px"
                                Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Width="550px" Height="283px">
                            </FrameStyle>
                            <Pager MinimumPagesForDisplay="2">
                                <PagerStyle BackColor="LightGray" BorderStyle="Solid" BorderWidth="1px">
                                    <BorderDetails ColorLeft="White" ColorTop="White" WidthLeft="1px" WidthTop="1px" />
...
<Layout Behavior="Auto"></Layout>
                            ...
                            <Legend FormatString="&lt;ITEM_LABEL&gt;                           ."
                                Location="Bottom" SpanPercentage="7" Visible="True"></Legend>
                                        <Border Color="Transparent" />
                    ...
                    <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel3" runat="server"
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                            ...
                            <tr>
                                ...
                                <td style="background-color: white">
                                    <asp:Label id="Label5" runat="server" Text="Label" Width="100%" CssClass="ElementTitle"></asp:Label><br />
                                    <igchart:UltraChart id="UltraChart3" runat="server" Version="9.1"   BackgroundImageFileName EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnDataBinding="UltraChart3_DataBinding" ChartType="StackAreaChart" OnFillSceneGraph="FillSceneGraph" OnInvalidDataReceived="UltraChart3_InvalidDataReceived" Width="1143px">
...
<Y2 LineThickness="1" TickmarkInterval="100" Visible="False" TickmarkStyle="Smart">
<MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
...
<Y LineThickness="1" TickmarkInterval="100" Visible="True" TickmarkStyle="Smart" Extent="35">
<MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>

<MajorGridLines Color="Gainsboro" DrawStyle="Dot" Visible="True" Thickness="1" AlphaLevel="255"></MajorGridLines>

<Labels Orientation="Horizontal" ItemFormatString="&lt;DATA_VALUE:N0&gt;" FontColor="DimGray" HorizontalAlign="Far" Font="Verdana, 7pt" VerticalAlign="Center">
<Layout Behavior="Auto"></Layout>
...
<Layout Behavior="Auto"></Layout>
                            ...
                            <AreaChart LineDrawStyle="Solid">
                                        ...
                                        <Border Color="Transparent" />
                                        <Tooltips Font-Size="Medium" Display="Never" />
</igchart:UltraChart>
                                </td>
                                <td class="right">
                                </td>
