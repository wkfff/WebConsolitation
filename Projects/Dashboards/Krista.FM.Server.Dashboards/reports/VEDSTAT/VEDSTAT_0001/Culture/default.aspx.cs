...
namespace Krista.FM.Server.Dashboards.reports.VEDSTAT.VEDSTAT_00010._022
{
    public partial class Default : CustomReportPage
    {
        ...
        string GetTexto(DataTable dt)
        {
            ...
            {
                ChildrenXZ += string.Format("&nbsp&nbsp&nbsp&nbsp{0} - <b>{1}</b> ед.<br>", dt.Rows[i][0].ToString(), dt.Rows[i][1].ToString());
            }
            string res ="";
            //string res = //@"По состоянию на <b>{0}</b> год:<br>
//1. Число общедоступных (публичных) библиотек - <b>{1}</b> ед. Из них:<br>


//2. Число учреждений культурно-досугового типа – <b>{4}</b>  ед. Из них:<br>
            ...
            //res = string.Format(res,
                ...
                res += string.Format(@"По состоянию на <b>{0}</b> год:<br>",dt.Columns[1].Caption);
            if (dt.Rows[0][1].ToString() !="")
            {
                count++;
                res +=string.Format("{0}. Число общедоступных (публичных) библиотек – <b>{1}</b> ед. Из них:<br>",count,dt.Rows[0][1].ToString());
            }
                res +=string.Format("&nbsp&nbsp&nbsp&nbspДетские библиотеки – <b>{0}</b> ед.<br>",dt.Rows[1][1].ToString());
                res +=string.Format("&nbsp&nbsp&nbsp&nbspКомпьютерные библиотеки – <b>{0}</b> ед.<br>",dt.Rows[2][1].ToString());
            if (dt.Rows[3][1].ToString() !="")
            {
                count++;
                res +=string.Format("{0}. Число учреждений культурно-досугового типа – <b>{1}</b>  ед. Из них:<br>",count,dt.Rows[3][1].ToString());
            }
            	res +=string.Format("{0}",ChildrenXZ);
            if (dt.Rows[4][1].ToString() !="")
            {
count++;
                res +=string.Format("{0}. Число музыкальных и художественных школ – <b>{1}</b> ед.<br>", count,dt.Rows[4][1].ToString());
            }
            if (dt.Rows[5][1].ToString() !="")
            {
count++;
                res +=string.Format("{0}. Численность работников общедоступных (публичных) библиотек – <b>{1}</b>  чел.<br>", count,dt.Rows[5][1].ToString());
            }
            if (dt.Rows[6][1].ToString() !="")
            {
count++;
                res +=string.Format("{0}. Численность работников сферы культуры и досуга (без аппарата управления) - <b>{1}</b> чел.", count,dt.Rows[6][1].ToString());
            }
           ...
           // try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    Label3.Text =
"Динамика показателя " + '"' + Pokaz.Value + '"' + ", тысяча экземпляров";
                    //Label8.Text = RegionSettingsHelper.Instance.GetPropertyValue("chart1_title1");
                    UltraChart1.DataBind();
                    Pokaz.Value = GB.Rows[GB.Rows.Count - 1].Cells[0].Text;
                    //e.Row.Cells[0].Text;
                    Label4.Text = string.Format("Соотношение числа посещений по видам учреждений культурно-досугового типа в {0} году, %", Pokaz.Value);//"Соотношение числа посещений по видам учреждений культурно-досугового типа в " + Pokaz.Value + " году, посещений";

                    UltraChart2.DataBind();
                    Pokaz.Value = GB.Columns[1].Header.Key;
                    Label5.Text = string.Format("Темп роста показателя «Число посещений учреждения: {0}», %", Pokaz.Value);  //"Темп роста числа посещений учреждений " + Pokaz.Value;//Label5.Text = "Темп роста числа посещений учреждений " + Pokaz.Value;
        ...
        protected void GB_Click(object sender, ClickEventArgs e)
        {
            ...
            Label5.Text = string.Format("Темп роста показателя «Число посещений учреждения: {0}», %", Pokaz.Value);  //"Темп роста числа посещений учреждений " + Pokaz.Value;//Label5.Text=String.Format(RegionSettingsHelper.Instance.GetPropertyValue("chart3_title"),Pokaz.Value);
            UltraChart3.DataBind();
        }
        ...
        protected void GB_ActiveCellChange(object sender, CellEventArgs e)
        {
            ...
            Label4.Text = string.Format("Соотношение числа посещений по видам учреждений культурно-досугового типа в {0} году, %", Pokaz.Value);//"Соотношение числа посещений по видам учреждений культурно-досугового типа в " + Pokaz.Value + " году, посещений";//Label4.Text = "Соотношение числа посещений по видам учреждений культурно-досугового типа в " + Pokaz.Value + " году, посещений";
            ...
            if (CellIndex > 0)
                ...
                Pokaz.Value = GB.Columns[CellIndex + 1].Header.Key;
            Label5.Text = string.Format("Темп роста показателя «Число посещений учреждения: {0}», %", Pokaz.Value);  //"Темп роста числа посещений учреждений " + Pokaz.Value;
            UltraChart3.DataBind();
        }
