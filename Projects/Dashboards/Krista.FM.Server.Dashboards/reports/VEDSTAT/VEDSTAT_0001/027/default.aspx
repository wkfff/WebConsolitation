...
<asp:Label ID="page_title" runat="server" BorderStyle="None" Text="заголовок" CssClass="PageTitle"></asp:Label></td>
                ...
                <tr>
                    ...
                    <td style="background-color: white">
                        <asp:Label ID="Grid3Label" runat="server"  CssClass="ElementTitle"
                            Text="заголовок таблицы"></asp:Label>
        ...
        <td style="vertical-align: top;">    
            <table style="vertical-align: top; width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="headerReport">
                        <asp:Label ID="Label8" runat="server" CssClass="ElementTitle"
                             Text="Структура показателя"></asp:Label></td>
                    <td class="headerright">
                    </td>
                </tr>
                <tr>
            ...
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel6" runat="server" Width="100%" LinkedRefreshControlID="WebAsyncRefreshPanel1">
                ...
                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, человек &lt;DATA_VALUE:###,##0.##&gt;" EnableFadingEffect="True" Overflow="ClientArea" Font-Size="10pt" />
        ...
        <td style="vertical-align: top;">  
            <table style="vertical-align: top; width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="headerReport">
                        <asp:Label ID="Label9" runat="server" CssClass="ElementTitle"
                             Text="Структура показателя"></asp:Label></td>
                    <td class="headerright">
                    </td>
                </tr>
            ...
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel5" runat="server" Width="100%" LinkedRefreshControlID="WebAsyncRefreshPanel1">
                <asp:Label ID="Label6" runat="server"   Text="заголовок таблицы" CssClass="ElementTitle"></asp:Label></igmisc:WebAsyncRefreshPanel>  
        ...
        <td style="vertical-align: top; text-align:center;">
            <table style="vertical-align: top; width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="headerReport">
                        <asp:Label ID="Label10" runat="server" CssClass="ElementTitle"
                            Text="Структура показателя"></asp:Label></td>
                    <td class="headerright">
                    </td>
                </tr>
            ...
            <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName=""  
                ...
                Height="355px" OnDataBinding="UltraChart2_DataBinding" OnInvalidDataReceived="InvalidDataReceived"
                Transform3D-Perspective="40" Transform3D-Scale="100" Transform3D-XRotation="50"
                Transform3D-YRotation="30" Version="9.1">
                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, рубли &lt;DATA_VALUE:###,##0.##&gt;" EnableFadingEffect="True" Overflow="ClientArea" Font-Size="10pt" />
                <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
        ...
        <td style="vertical-align: top; text-align:center;">
            <table style="vertical-align: top; width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="headerReport">
                        <asp:Label ID="Label11" runat="server"  CssClass="ElementTitle"
                            Text="Структура показателя"></asp:Label></td>
                    <td class="headerright">
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="background-color: white">
            <asp:Label ID="Label3" runat="server" Text="заголовок таблицы" CssClass="ElementTitle"></asp:Label>        
        ...
        <td style="vertical-align: top; text-align:center;">
            <table style="vertical-align: top; width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="headerReport">
                        <asp:Label ID="Label12" runat="server" BorderStyle="None" CssClass="ElementTitle"
                           Text="Структура показателя"></asp:Label></td>
                    <td class="headerright">
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="background-color: white">
            <asp:Label ID="Label4" runat="server" BorderStyle="None" Text="заголовок таблицы" CssClass="ElementTitle"></asp:Label>        
            <igchart:UltraChart ID="UltraChart4" runat="server" BackgroundImageFileName=""  
                ...
                Transform3D-YRotation="30" Version="9.1">
                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" FormatString="Оборот оптовой торговли, рубли &lt;DATA_VALUE:###,##0.##&gt;" EnableFadingEffect="True" Overflow="ClientArea" Font-Size="10pt" />
                <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
                </ColorModel>
                <Effects>
        ...
        <td style="vertical-align: top; width: 50%;">
            ...
            <table style="vertical-align: top; border-collapse: collapse; width: 100%; margin-right: 4px;">
                ...
                <tr>
                    ...
                    <td class="headerReport">
            <asp:Label ID="Grid4Label" runat="server" Text="заголовок таблицы" CssClass="ElementTitle"></asp:Label></td>
                    <td class="headerright">
                    </td>
                </tr>
                <tr>
            ...
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel4" runat="server" TriggerControlIDs="web_grid4" Height="100%" Width="100%">
                <table style="vertical-align: top; border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label13" runat="server"  CssClass="ElementTitle"
                                Text="Структура показателя"></asp:Label></td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="background-color: white">
                <asp:Label ID="Label7" runat="server" Text="заголовок" CssClass="ElementTitle"></asp:Label><igchart:UltraChart ID="UltraChart7" runat="server" BackgroundImageFileName=""  
                                     EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="100" Transform3D-XRotation="50" Transform3D-YRotation="30" ChartType="DoughnutChart3D" OnDataBinding="UltraChart7_DataBinding" Width="500px" Height="517px" OnFillSceneGraph="UltraChart7_FillSceneGraph">
                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;, рубли &lt;DATA_VALUE:###,##0.##&gt;" EnableFadingEffect="True" Overflow="ClientArea" Font-Size="10pt" />
                            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
                            </ColorModel>
            ...
            <igmisc:WebAsyncRefreshPanel ID="WebAsyncRefreshPanel2" runat="server" Width="100%" TriggerControlIDs="web_grid1" Height="100%">
                <table style="vertical-align: top; border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label14" runat="server"  CssClass="ElementTitle" Text="Динамика показателя"></asp:Label></td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="background-color: white">
                <asp:Label ID="Label1" runat="server" Text="заголовок" CssClass="ElementTitle"></asp:Label>
                <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                                     EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                    Version="9.1" OnInvalidDataReceived="InvalidDataReceived" Transform3D-Perspective="40" Transform3D-Scale="85" Transform3D-XRotation="120" Transform3D-YRotation="0" ChartType="CylinderColumnChart3D" OnDataBinding="UltraChart1_DataBinding" Width="500px" Height="500px">
                            <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;DATA_VALUE:###,##0.##&gt;" EnableFadingEffect="True" Overflow="ClientArea" Font-Size="10pt" />
                            <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
                            </ColorModel>
                            <Effects>
                                <Effects>
