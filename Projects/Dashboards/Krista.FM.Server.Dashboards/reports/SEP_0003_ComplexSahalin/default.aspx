<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_0003_ComplexSahalin._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
        ...
        <table  id="TableGrid" runat="server" style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="height: 100%">
                                <igtbl:UltraWebGrid
                                    ID="G" runat="server" Height="200px" 
                                    SkinID="UltraWebGrid" StyleSetName="Office2007Blue" Width="325px" 
                                    ondatabinding="G_DataBinding" oninitializelayout="G_InitializeLayout" oninitializerow="G_InitializeRow" 
                                    >
                                    <Bands>
                                        <igtbl:UltraGridBand>
