<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultAssessment.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0012.DefaultAssessment"
    Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td style="width: 100%">
                <uc4:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultAssessment.html" />
                &nbsp;&nbsp;
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboMonth" runat="server">
                </uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" EnableAppStyling="True" Height="200px"
                                SkinID="UltraWebGrid" StyleSetName="Office2007Blue" Width="325px" OnDataBinding="UltraWebGrid1_DataBinding"
                            ...
                            </igtbl:UltraWebGrid><td class="right">
                            </td>
                    </tr>
                    <tr>
                        <td class="bottomleft">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid2" runat="server" EnableAppStyling="True" Height="200px"
                                SkinID="UltraWebGrid" StyleSetName="Office2007Blue" Width="325px" OnDataBinding="UltraWebGrid2_DataBinding"
                                OnInitializeLayout="UltraWebGrid2_InitializeLayout" OnInitializeRow="UltraWebGrid2_InitializeRow">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
