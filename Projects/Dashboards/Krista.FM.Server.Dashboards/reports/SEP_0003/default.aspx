<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_0003._default" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <igchart:UltraChart ID="C2" runat="server" BackgroundImageFileName=""
                                    ...
                                    Transform3D-Scale="100" OnDataBinding="С2_DataBinding" 
                                    OnInvalidDataReceived="C1_InvalidDataReceived">
