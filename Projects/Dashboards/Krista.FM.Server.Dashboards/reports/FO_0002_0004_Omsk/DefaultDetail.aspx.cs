...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0004_Omsk
{
    public partial class DefaultDetail : CustomReportPage
    {
        ...
        // последний год для расчета в сопоставимых нормативах
        private CustomParam comparableStandardLastYear;
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            comparableStandardLastYear = UserParams.CustomParam("comparable_standard_last_year");
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0002_0004_Omsk_date");
            ...
            Page.Title = String.Format("Анализ динамики доходов");
            PageTitle.Text = Page.Title;
            PageSubTitle.Text = String.Empty;

            bool regionSelected = budgetDigest.GetMemberType(ComboRegion.SelectedValue) == "МР";

            useConsolidateRegionBudget.Visible = regionSelected;

            descendantsLevel = (QuarterValuation) ? "Квартал" : "Месяц";

            bool severalYearsSelected = false;

            Collection<string> selectedValues = ComboYear.SelectedValues;
            if (selectedValues.Count > 0)
            {
                severalYearsSelected = selectedValues.Count > 1;
                ...
                PageSubTitle.Text = String.Format("{0}, {1} за {2} {3}, {4}",
                    selectedBudget, kd, CRHelper.GetDigitIntervals(ComboYear.SelectedValuesString, ','),
                ...
                for (int i = 0; i < selectedValues.Count; i++)
                {
                    ...
                    if (i == 0)
                    {
                        comparableStandardLastYear.Value = selectedValues[i];
                    }
            ...
            else
            {
                ...
                comparableStandardLastYear.Value = "2020";
            }

            bool comparableStandatKDGroupSelected = ComboKD.SelectedValue.Contains("Налоговые и неналоговые доходы") ||
                                        ComboKD.SelectedValue.Contains("Налоговые доходы") ||
                                        ComboKD.SelectedValue.Contains("НДФЛ");
            comparableStandandCheckBox.Visible = regionSelected && comparableStandatKDGroupSelected && severalYearsSelected;
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0004_Omsk_grid");
            ...
            for (int i = 0; i < e.Row.Cells.Count; i++)
            {
                ...
                if ((i % 2 == 0 && i != 0) && e.Row.Cells[i].Value != null)
                {
                    ...
                    else if (Convert.ToDouble(e.Row.Cells[i].Value) < 100)
                    {
                        ...
                        e.Row.Cells[i].Title = "Падение к аналогичному периоду прошлого года";
                    }
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0004_Omsk_chart");
