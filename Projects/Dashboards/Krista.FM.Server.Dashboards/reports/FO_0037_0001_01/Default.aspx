<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0037_0001_01.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;&nbsp;&nbsp;<asp:Label ID="incomesGridLabel" runat="server" Text="Label" CssClass="ElementSubTitle"
            ...
            <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td style="overflow: visible;" align="right">
                         <asp:Label ID="dataItemCaption1" runat="server" CssClass="ElementSubTitle"></asp:Label>
                    </td>
                    <td class="right">
                    </td>
                </tr>
    ...
    &nbsp;&nbsp;&nbsp;<asp:Label ID="outcomesGridLabel" runat="server" Text="Label" CssClass="ElementSubTitle"
        Style="line-height: 30px;"></asp:Label>
    <table style="vertical-align: top;">
        <tr>
            <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td style="overflow: visible;" align="right">
                         <asp:Label ID="dataItemCaption2" runat="server" CssClass="ElementSubTitle"></asp:Label>
                    </td>
                    <td class="right">
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="overflow: visible;">
                        ...
                        <asp:Label ID="outcomesGridHintLabel" runat="server" CssClass="PageSubTitle"></asp:Label>
                    </td>
                    <td class="right">
                    </td>
                </tr>
