    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0021_0003_date");
            ...
            if (IsYearSelected)
            {
                ...
                prevPeriodCaption = String.Format("по итогам {0} года", selectedYear - 1);
                currPeriodCaption = String.Format("по итогам {0} года", selectedYear);
            }
            else if (IsFirstQuarterSelected)
            {
                ...
                prevPeriodCaption = String.Format("по итогам {0} года", selectedYear - 1);
                currPeriodCaption = GetShortQuarterText(selectedQuarterIndex);
            }
            else
            {
                ...
                prevPeriodCaption = GetShortQuarterText(selectedQuarterIndex - 1);
                currPeriodCaption = GetShortQuarterText(selectedQuarterIndex);
            }
        ...
        private string GetShortQuarterText(int selectedQuarter)
        {
            switch (selectedQuarter)
            {
                case 2:
        ...
        {
            string query = DataProvider.GetQueryText("FO_0021_0003_grid");
        ...
        private void IndicatorDescriptionDataBind()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0021_0003_indicatorDescription");
