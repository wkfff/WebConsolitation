<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0003_0011_Novosib.Default" %>
                ...
                <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName="" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" 
                        ...
                        <Skin ApplyRowWise="False">
                            <PEs>
                                <igchartprop:PaintElement ElementType="Hatch" Fill="SkyBlue" 
                                    FillStopColor="PowderBlue" Hatch="Default" />
                                <igchartprop:PaintElement ElementType="Hatch" Fill="MidnightBlue" 
                                    FillStopColor="Navy" Hatch="Default" />
                            </PEs>
                        </Skin>
                    </ColorModel>
                    <Effects>
