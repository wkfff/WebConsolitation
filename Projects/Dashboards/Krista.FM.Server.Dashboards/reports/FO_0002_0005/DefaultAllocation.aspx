<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="DefaultAllocation.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0005.DefaultAllocation" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <asp:CheckBox ID="useDotationCheckBox" runat="server" Text="Не&nbsp;учитывать&nbsp;дотации&nbsp;на&nbsp;выравнивание&nbsp;бюджетной&nbsp;обеспеченности"
