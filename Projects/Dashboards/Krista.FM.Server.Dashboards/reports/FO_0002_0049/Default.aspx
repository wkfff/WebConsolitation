<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0049.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboBudget" runat="server">
                </uc3:CustomMultiCombo>
            </td>
            <td valign="top">
    ...
    <igmisc:WebAsyncRefreshPanel ID="chartWebAsyncPanel" runat="server">
        ...
        <table>
            <tr>
                ...
                <tr>
                    <td>
                        <table runat="server" id="PercentChartTable" style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                            <tr>
                                <td class="topleft">
                                </td>
                                <td class="top">
                            ...
                            <tr>
                                ...
                                <td style="overflow: visible;">
                                     <asp:Label ID="PercentChartCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                                    <uc8:PieChartBrick ID="PercentChartBrick" runat="server">
                                    </uc8:PieChartBrick>
                                </td>
                                <td class="right">
                                </td>
                    ...
                    <td>
                        <table runat="server" id="StructChartTable" style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                            <tr>
                                <td class="topleft">
                                </td>
                                <td class="top">
                            ...
                            <tr>
                                ...
                                <td style="overflow: visible;">
                                    <asp:Label ID="StructChartCaption" runat="server" CssClass="ElementTitle"></asp:Label>
                                    <uc8:PieChartBrick ID="StructChartBrick" runat="server">
                                    </uc8:PieChartBrick>
                                </td>
                                <td class="right">
                                </td>
