...
namespace Krista.FM.Server.Dashboards.reports.STAT_0001_0018
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string queryName = "STAT_0001_0018_date";
            string query;
            if (ComboKinds.SelectedIndex != 1)
            {
            ...
            query = DataProvider.GetQueryText(String.Format("STAT_0001_0018_chart1_{0}", queryPostfix));
        ...
        private void FillComboRegions()
        {
            ...
            string query = DataProvider.GetQueryText("STAT_0001_0018_regions");
        ...
        private void SetSlicerParams()
        {
            ...
            switch (ComboKinds.SelectedIndex)
            {
                ...
                case (1):
                    {
                        string query = DataProvider.GetQueryText("STAT_0001_0018_date_privacyKinds");
        ...
        {
            string query = DataProvider.GetQueryText(String.Format("STAT_0001_0018_grid_{0}", queryPostfix));
        ...
        {
            string query = DataProvider.GetQueryText(String.Format("STAT_0001_0018_chart2_{0}", queryPostfix));
            dtChart = new DataTable();
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "Дата", dtChart);
