<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0006_0005.Default" %>
                ...
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                         ...
                         <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboArea" runat="server"></uc3:CustomMultiCombo>
                        </td>                   
                        <td valign="top">
                            <uc1:RefreshButton ID="RefreshButton1" runat="server" />
                        </td>
                        <td>
                          <asp:RadioButtonList ID="rubMultiplier" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" Width="200px" style="font-family:Verdana; font-size:12px;">
                   ...
                   <tr>
                      <td class="left">
                       ...
                       <td style="overflow: visible;" align="right">
                          <asp:CheckBox ID="CheckBox1" runat="server" Text="средние показатели исполнения бюджета по <районам\городам>"
                                        AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" />
                          <br>
                          <asp:CheckBox ID="CheckBox2" runat="server" Text="показатели исполнения бюджета субъекта"
                                        AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" />
                       </td>
                       <td class="right">
                       </td> 
                    ...
                    <tr>
                        ...
                        <td>
                         <table>
                           <tr> 
                             <td style="overflow: visible;">
                              <uc3:CustomMultiCombo ID="ComboActive" runat="server"></uc3:CustomMultiCombo>  
                             </td>
                             <td>
                              <uc3:CustomMultiCombo ID="ComboIncomesType" runat="server"></uc3:CustomMultiCombo>
                             </td>
                           </tr>
                         </table>
                        </td>
