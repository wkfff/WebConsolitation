...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0013
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = "Мониторинг показателей эффективности деятельности транспортного комплекса в сфере пассажирских перевозок (годовой)";
            Label1.Text = Page.Title;
            int yearNum = Convert.ToInt32(ComboYear.SelectedValue);
            date = new DateTime(yearNum, 01, 1).AddMonths(1);

            Label2.Text = String.Format("Данные ежегодного мониторинга основных показателей деятельности транспортного комплекса Новосибирской области за {0} год в сфере пассажирских перевозок",
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0013_grid");
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            ReportExcelExporter1.GridColumnWidthScale = 1.8;
