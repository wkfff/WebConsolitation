<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultValuationChart.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.MFRF_0004_0003.DefaultValuationChart"
    Title="" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td style="width: 100%">
                <uc5:PopupInformer ID="PopupInformer1" runat="server" HelpPageUrl="DefaultValuationChartHelp.html" />
                &nbsp;&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td style="overflow: visible;">
                                        <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                                            ...
                                            <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_MFRF0403_02#SEQNUM(100).png" />
                                            <Border Thickness="0" />
                                        </igchart:UltraChart>
                                    </td>
                                    <td class="right">
