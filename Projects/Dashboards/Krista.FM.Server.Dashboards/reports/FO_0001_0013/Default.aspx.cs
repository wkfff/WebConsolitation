    ...
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                ComboOutcomes.Title = "Вариант расходов";
            ...
            Page.Title = "Распределение бюджетных расходов между областным и местными бюджетами";
            ...
            Label1.Text = "Распределение бюджетных расходов между областным и местными бюджетами";
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Наименование расходов", dtGrid);
            ...
            for (int i = 0; i < e.SceneGraph.Count; i++)
            {
                ...
                if (primitive is Box)
                {
                    ...
                    if (box.DataPoint != null)
                    {
                        ...
                        {
                            lab = "сумма бюджетных назначений";
                        }
                        else
                        {
                            lab = "сумма фактического исполнения"; 
                        }
        ...
        //dtChart1.Rows[box.Column][box.Row + 1].ToString(); проценты
        //dtChart1.Rows[box.Column][0].ToString(); тип бюджета
        ...
        protected void UltraChart1_DataBinding(object sender, EventArgs e)
        {
            ...
            //UltraChart1.DataSource = dtChart1; проценты
            ...
            if (e.Layout.Bands[0].Columns.Count > 0)
            {
                ...
                if ((Convert.ToInt32(ComboYear.SelectedValue) < 2011)||(RList.SelectedIndex == 2))
                {
                    ...
                    if (RList.SelectedIndex == 0)
                    {
                        ...
                        e.Layout.Bands[0].Columns[4].Header.Caption = string.Format("Исполнено, {0}", units);
                        e.Layout.Bands[0].Columns[5].Header.Caption = "Доля";
                        e.Layout.Bands[0].Columns[1].Header.Title = "Кассовый расход нарастающим итогом с начала года";
                        e.Layout.Bands[0].Columns[2].Header.Title = "Кассовый расход нарастающим итогом с начала года";
                        e.Layout.Bands[0].Columns[3].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                        e.Layout.Bands[0].Columns[4].Header.Title = "Кассовый расход нарастающим итогом с начала года";
                        e.Layout.Bands[0].Columns[5].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                        ...
                        if (RList.SelectedIndex == 1)
                        {
                            ...
                            e.Layout.Bands[0].Columns[3].Header.Caption = "Доля";
                            e.Layout.Bands[0].Columns[4].Header.Caption = string.Format("Бюджетные назначения, {0}", units);
                            e.Layout.Bands[0].Columns[5].Header.Caption = "Доля";
                            e.Layout.Bands[0].Columns[1].Header.Title = "Плановые назначения на текущий год";
                            e.Layout.Bands[0].Columns[2].Header.Title = "Плановые назначения на текущий год";
                            e.Layout.Bands[0].Columns[3].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                            e.Layout.Bands[0].Columns[4].Header.Title = "Плановые назначения на текущий год";
                            e.Layout.Bands[0].Columns[5].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                            ...
                            if (RList.SelectedIndex == 2)
                            {
                                ...
                                e.Layout.Bands[0].Columns[3].Header.Caption = "Доля";
                                e.Layout.Bands[0].Columns[4].Header.Caption = string.Format("Проект, {0}", units);
                                e.Layout.Bands[0].Columns[5].Header.Caption = "Доля";
                                e.Layout.Bands[0].Columns[1].Header.Title = "Проект расходов";
                                e.Layout.Bands[0].Columns[2].Header.Title = "Проект расходов";
                                e.Layout.Bands[0].Columns[3].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                                e.Layout.Bands[0].Columns[4].Header.Title = "Проект расходов";
                                e.Layout.Bands[0].Columns[5].Header.Title = "Доля расхода в общей сумме расходов бюджета";

                            }

                    ColumnHeader ch = new ColumnHeader(true);
                    ch.Caption = "Консолидированный бюджет";
                    ch.Title = "";
                ...
                else
                {
                  for (int k = 1; k < e.Layout.Bands[0].Columns.Count; k++)
                    ...
                    if (RList.SelectedIndex == 0)
                    {
                        ...
                        e.Layout.Bands[0].Columns[5].Header.Caption = string.Format("Исполнено, {0}", units);
                        e.Layout.Bands[0].Columns[6].Header.Caption = "Доля";
                        e.Layout.Bands[0].Columns[1].Header.Title = "Кассовый расход нарастающим итогом с начала года";
                        e.Layout.Bands[0].Columns[2].Header.Title = "Кассовый расход нарастающим итогом с начала года";
                        e.Layout.Bands[0].Columns[3].Header.Title = "Кассовый расход нарастающим итогом с начала года";
                        e.Layout.Bands[0].Columns[4].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                        e.Layout.Bands[0].Columns[5].Header.Title = "Кассовый расход нарастающим итогом с начала года";
                        e.Layout.Bands[0].Columns[6].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                        ...
                        if (RList.SelectedIndex == 1)
                        {
                            ...
                            e.Layout.Bands[0].Columns[4].Header.Caption = "Доля";
                            e.Layout.Bands[0].Columns[5].Header.Caption = string.Format("Бюджетные назначения, {0}", units);
                            e.Layout.Bands[0].Columns[6].Header.Caption = "Доля";
                            e.Layout.Bands[0].Columns[1].Header.Title = "Плановые назначения на текущий год";
                            e.Layout.Bands[0].Columns[2].Header.Title = "Плановые назначения на текущий год";
                            e.Layout.Bands[0].Columns[3].Header.Title = "Плановые назначения на текущий год";
                            e.Layout.Bands[0].Columns[4].Header.Title = "Доля расхода в общей сумме расходов бюджета";
                            e.Layout.Bands[0].Columns[5].Header.Title = "Плановые назначения на текущий год";
                            e.Layout.Bands[0].Columns[6].Header.Title = "Доля расхода в общей сумме расходов бюджета";
        ...
        private void ExcelExporter_HeaderCellExporting(object sender, HeaderCellExportingEventArgs e)
        {
            if ((Convert.ToInt32(ComboYear.SelectedValue) < 2011) || (RList.SelectedIndex == 2))
            {
                ...
                {
                    e.HeaderText = "Консолидированый бюджет";
                }
                else
                    if ((e.CurrentColumnIndex > 1) && (e.CurrentColumnIndex < 4))
                    {
                        e.HeaderText = "Областной бюджет";
                    }
                    else
                        if ((e.CurrentColumnIndex > 3))
                        {
                            e.HeaderText = "Местные бюджеты";
                        }
            }
            else
            {
                ...
                if ((e.CurrentColumnIndex > 0) && (e.CurrentColumnIndex < 2))
                {
                    ...
                    {
                        e.HeaderText = "Исключаемые суммы";
                    }
                    else
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            Worksheet sheet1 = workbook.Worksheets.Add("Распр. расходов");
