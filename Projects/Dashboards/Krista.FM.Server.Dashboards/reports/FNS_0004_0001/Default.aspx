<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0004_0001.Default" Title="Оценка потерь бюджета от недополученных доходов" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
      <asp:RadioButtonList ID="DebtKindButtonList" runat="server" AutoPostBack="True"
        RepeatDirection="Vertical" Width="100px" style="font-family:Verdana; font-size:12px;">
       
         <asp:ListItem Selected="True">Расчет потерь от недополученных доходов по ставке рефинансирования, действующей на отчетную дату</asp:ListItem>
        
        <asp:ListItem>Расчет потерь от недополученных доходов по средней хронометрической ставке рефинансирования</asp:ListItem>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" Height="200px" OnActiveRowChange="UltraWebGrid_ActiveRowChange"
