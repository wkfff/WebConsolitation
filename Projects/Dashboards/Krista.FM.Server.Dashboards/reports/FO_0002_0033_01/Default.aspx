<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0033_01.Default" Title="Untitled Page" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboMeans" runat="server" />
            </td>
    ...
    <table>
     <tr>
       <td valign="top">
        <uc3:CustomMultiCombo ID="ComboRzPr" runat="server" />
       </td>
       <td valign="top">
        <uc3:CustomMultiCombo ID="ComboKOSGU" runat="server" />
       </td>
     </tr>
    </table>
    <table>
      <tr>
       <td valign="top">
        <asp:Label ID="Label3" runat="server" CssClass="PageSubTitle">Расчет остатка и % исполнения</asp:Label>
        <asp:RadioButtonList ID="DebtKindButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" Width="850px" style="font-family:Verdana; font-size:12px;">
            <asp:ListItem Selected="True">от утвержденного плана на год</asp:ListItem> 
            <asp:ListItem>от уточненного плана на год</asp:ListItem>
            <asp:ListItem >от уточненного плана на конец квартала</asp:ListItem>
        </asp:RadioButtonList>
       </td>
      </tr>
      <tr>
       <td valign="top">
        <asp:Label ID="Label4" runat="server" CssClass="PageSubTitle">Расчет темпа роста</asp:Label>
        <asp:RadioButtonList ID="DebtKindButtonList2" runat="server" AutoPostBack="True"
                             RepeatDirection="Horizontal" Width="1000px" style="font-family:Verdana; font-size:12px;">
            <asp:ListItem Selected="True">Утвержденного плана на год</asp:ListItem> 
            <asp:ListItem>Уточненного плана на год</asp:ListItem>
            <asp:ListItem >Уточненного плана на конец квартала</asp:ListItem>
            <asp:ListItem >Кассового исполнения</asp:ListItem>
        </asp:RadioButtonList>
       </td>
      </tr>
    </table>
    <table style="vertical-align: top; margin-top: -3px">
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" EnableAppStyling="True" SkinID="UltraWebGrid"
        ...
        <tr>
          <td><asp:Label ID="Label5" runat="server" CssClass="PageSubTitle">* Итого расходов - общая сумма расходов областного бюджета без учета фильтра по КБК</asp:Label></td>
        </tr>
    </table>
