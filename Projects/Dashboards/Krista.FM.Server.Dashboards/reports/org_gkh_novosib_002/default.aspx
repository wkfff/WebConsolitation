<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.org_gkh_novosib_002.Default" %>
        ...
        <tr><td class="left"></td>
            <td style="overflow: visible;">
                <asp:RadioButton ID="RadioButton1" runat="server" Checked="True" 
                    GroupName="TypeGrid" Text="Доходы организации" AutoPostBack="True" />
                <asp:RadioButton ID="RadioButton2" runat="server" GroupName="TypeGrid" 
                    Text="Расходы организации" AutoPostBack="True" />
                <asp:RadioButton ID="RadioButton3" runat="server" GroupName="TypeGrid" 
                    Text="Задолженность организации" AutoPostBack="True" />
