<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0007_0001.Default" %>
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td>
                          <asp:CheckBox ID="CheckBox1" runat="server" Text="сумма с начала года с накоплением" AutoPostBack="true" Checked="false" Style="font-family: Verdana; font-size: 10pt;" />
                        </td>
                    </tr>
                </table>
            </td>
