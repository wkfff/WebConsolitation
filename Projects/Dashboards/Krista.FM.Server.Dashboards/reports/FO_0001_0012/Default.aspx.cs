...
namespace Krista.FM.Server.Dashboards.reports.FO_0001_0012
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            UltraWebGrid.Height = CRHelper.GetGridHeight(CustomReportConst.minScreenHeight * 0.11);
            ...
            UltraChart1.Width = Unit.Pixel((int)(CustomReportConst.minScreenWidth * 0.87));
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string queryName = "FO_0001_0012_date";
                ...
                ComboYear.SetСheckedState(Convert.ToString(Convert.ToInt32(endYear.ToString()) - 1), true);
           ...
           {
               queryName = "FO_0001_0012_compare_Grid";
               queryChartName = "FO_0001_0012_compare_Chart1";
           ...
           {
               queryName = "FO_0001_0012_compare_Grid1";
               queryChartName = "FO_0001_0012_compare_Chart2";
               lab = "плановые данные";
               ComboIncomes.Visible = false;
               ComboMonth.Visible = true;
               ComboYear.Visible = true;
           ...
           {
               queryName = "FO_0001_0012_compare_Grid2";
               queryChartName = "FO_0001_0012_compare_Chart3";
           ...
           Label1.Text = "Распределение доходов консолидированного бюджета";
        ...
        private static void FillIncomesCombo()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0001_0012_compare_Grid_Kind");
            ...
            query = DataProvider.GetQueryText("FO_0001_0012_compare_Grid_Kind_a");
        ...
        private static void FillOutcomesCombo()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0001_0012_compare_Grid_Kinds");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            if (e.Layout.Bands[0].Columns.Count > 0)
            {
              ...
              if (RList.SelectedIndex == 0)
                {
                    e.Layout.Bands[0].Columns[1].Header.Title = "Доходы областного бюджета до передачи межбюджетных трансфертов";
                    e.Layout.Bands[0].Columns[2].Header.Title = "Доходы областного бюджета после передачи межбюджетных трансфертов";
                    e.Layout.Bands[0].Columns[3].Header.Title = "Межбюджетные трансферты, передаваемые из областного бюджета в местные бюджеты";
                }else
                    if (RList.SelectedIndex == 1)
                    {
                        e.Layout.Bands[0].Columns[1].Header.Title = "Доходы местных бюджетов до передачи межбюджетных трансфертов";
                        e.Layout.Bands[0].Columns[2].Header.Title = "Доходы местных бюджетов после передачи межбюджетных трансфертов";
                        e.Layout.Bands[0].Columns[3].Header.Title = "Межбюджетные трансферты, передаваемые из местных бюджетов в областной бюджет";
                    }else
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            Worksheet sheet1 = workbook.Worksheets.Add("Распределение доходов");
            Worksheet sheet2 = workbook.Worksheets.Add("Распр. дох. диаграмма");
