...
namespace Krista.FM.Server.Dashboards.reports.FO_0035_0003_Yamal
{
    public partial class Kinds : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            PopupInformer1.HelpPageUrl = "DailyKindsHelp.html";
            ...
            Link3.NavigateUrl = "~/reports/FO_0035_0003_Yamal/Executed.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            addExcepted.Value = "[Администратор].[ИспКасПланСопост].[Все].[Расходы- всего]";
