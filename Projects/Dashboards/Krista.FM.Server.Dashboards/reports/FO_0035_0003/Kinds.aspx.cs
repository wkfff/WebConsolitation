...
{
    public partial class Kinds : CustomReportPage
    {
        ...
        // дополнительный фильтр исключения
        private CustomParam addExcepted;
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            addExcepted = UserParams.CustomParam("add_excepted");

            #endregion

            PopupInformer1.HelpPageUrl = (IsKursk) ? "WeeklyKindsHelp.html" : "DailyKindsHelp.html";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    string query = DataProvider.GetQueryText("date_outcomes");
            ...
            if (IsYar)
            {
                addExcepted.Value = ",[Администратор].[ИспКасПланСопост].[Все].[Расходы- всего],[Администратор].[ИспКасПланСопост].[Все].[в том числе по главным распорядителям:] ";
            }
            else
            {
                addExcepted.Value = string.Empty;
            }
            ...
            if (IsQuaterPlanType)
            {
                ...
                lbTitle.Text = String.Format("Структура расходов областного бюджета за {0}", CRHelper.PeriodDescr(CustomCalendar1.WebCalendar.SelectedDate, 3));
                lbSubTitle.Text = "(на " + CustomCalendar1.WebCalendar.SelectedDate.ToString("dd.MM.yyyy") + "г.) по ведомствам";
            }
            else
            {
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            e.Layout.Bands[0].Columns[0].Width = CRHelper.GetColumnWidth(600);
            ...
            {
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i, "Сумма, тыс.руб.", "");
