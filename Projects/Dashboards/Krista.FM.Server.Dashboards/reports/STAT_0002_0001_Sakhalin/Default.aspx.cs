...
namespace Krista.FM.Server.Dashboards.reports.STAT_0002_0001_Sakhalin
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //string query = DataProvider.GetQueryText("STAT_0002_0001_Sakhalin_date");
                ...
                regionsDigest = new MemberAttributesDigest(DataProvidersFactory.PrimaryMASDataProvider, "STAT_0002_0001_Sakhalin_regions");
           ...
           Label2.Text = String.Format("Анализ динамики процентных ставок по кредитам и депозитам ({0})", regionsCombo.SelectedValue);
...
#region Обработчики грида
        ...
        {
                int start = Environment.TickCount;
                string query = DataProvider.GetQueryText("STAT_0002_0001_Sakhalin_compare_Grid");
                ...
                for (int i = 0; i < dtGrid.Rows.Count; i++)
                {
                    ...
                    dtGrid.Rows[i][oldcount + 9] = string.Format("{0:N2}",dtGrid.Rows[i][73]).Replace((char)160,' ');//Объёмы потр. кред.
                    ...
                    dtGrid.Rows[i][oldcount + 12] = string.Format("{0:N2}", dtGrid.Rows[i][94]).Replace((char)160, ' ');//Объёмы ипот. кред.
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            groupCell.AddCell(e.Layout.Bands[0].Columns[count - 14].Header.Caption);
            groupCell.AddCell(e.Layout.Bands[0].Columns[count - 13].Header.Caption);
            groupCell.AddCell(e.Layout.Bands[0].Columns[count - 12].Header.Caption);
            groupCell.AddCell(e.Layout.Bands[0].Columns[count - 11].Header.Caption);
            ...
            groupCell2.AddCell(e.Layout.Bands[0].Columns[count - 10].Header.Caption);
            groupCell2.AddCell(e.Layout.Bands[0].Columns[count - 9].Header.Caption);
            groupCell2.AddCell(e.Layout.Bands[0].Columns[count - 8].Header.Caption);
            groupCell2.AddCell(e.Layout.Bands[0].Columns[count - 7].Header.Caption);
            GridHeaderCell groupCell3 = headerLayout.AddCell("Потребительские кредиты:");
            groupCell3.AddCell(e.Layout.Bands[0].Columns[count - 6].Header.Caption);
            groupCell3.AddCell(e.Layout.Bands[0].Columns[count - 5].Header.Caption);
            groupCell3.AddCell(e.Layout.Bands[0].Columns[count - 4].Header.Caption);
            GridHeaderCell groupCell4 = headerLayout.AddCell("Ипотечные кредиты:");
            groupCell4.AddCell(e.Layout.Bands[0].Columns[count - 3].Header.Caption);
            groupCell4.AddCell(e.Layout.Bands[0].Columns[count - 2].Header.Caption);
            groupCell4.AddCell(e.Layout.Bands[0].Columns[count - 1].Header.Caption);
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            UltraChart3.Width = Unit.Pixel((int)(CustomReportConst.minScreenWidth * 0.7));
        ...
        private void PdfExportButton_Click(object sender, EventArgs e)
        {
            ...
            ReportPDFExporter1.Export(UltraChart, ChartCaption.Text + '\n' + UserParams.StateArea.Value, section2);
            ReportPDFExporter1.Export(UltraChart1, ChartCaption1.Text + '\n' + UserParams.StateArea.Value, section3);
            ReportPDFExporter1.Export(UltraChart2, ChartCaption2.Text + '\n' + UserParams.StateArea.Value, section4);
            ReportPDFExporter1.Export(UltraChart3, ChartCaption3.Text + '\n' + UserParams.StateArea.Value, section5);
        }
