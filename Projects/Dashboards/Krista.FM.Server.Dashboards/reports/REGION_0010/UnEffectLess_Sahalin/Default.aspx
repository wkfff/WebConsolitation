<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLess_Sahalin._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" Font-Size="Small" 
                    NavigateUrl="~/reports/REGION_0010/UnEffectLessForRegion_Sahalin/default.aspx">Оценка неэффективных расходов (по муниципальным образованиям)</asp:HyperLink></div>
                </td>
            </tr>
        </table>
