<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.REGION_0010.UnEffectLess_Novosib._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
    <div>
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" Font-Size="Small" 
                    ...
                    NavigateUrl="~/reports/REGION_0010/UnEffectLessForRegion_Novosib/default.aspx">Оценка неэффективных расходов (по муниципальным образованиям)</asp:HyperLink></div>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td style="vertical-align: top">
                    ...
                    <DeploymentScenario FilePath="../../../TemporaryImages" 
                                    ImageURL="../../../TemporaryImages/Chart__#SEQNUM(100).png" />
                    ...
                    <Axis>
                        ...
                        <X LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True" 
                            ...
                            <Labels Font="Verdana, 8pt" FontColor="DimGray" HorizontalAlign="Near" ItemFormatString="&lt;ITEM_LABEL&gt;"
                                ...
                                <SeriesLabels Font="Verdana, 8pt" FontColor="DimGray" HorizontalAlign="Near" Orientation="VerticalLeftFacing"
                                    VerticalAlign="Far">
                    ...
                    <Legend Location="Bottom" FormatString="&lt;SERIES_LABEL&gt; d as as as asd as da d" 
                                    Visible="True"></Legend>
