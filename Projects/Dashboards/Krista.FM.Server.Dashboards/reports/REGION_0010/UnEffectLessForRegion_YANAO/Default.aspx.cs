...
namespace Krista.FM.Server.Dashboards.REGION_0010.UnEffectLessForRegion_YANAO
{
    public partial class _default : CustomReportPage
    {
        ...
        private void ChoseParam()
        {
            ...
            if (SelectRegion.Value.Contains("муниципальный"))
            {
                GO.Value = "Районы Ямало-Ненецкого АО";                
            }
            else
            {
                GO.Value = "Городские округа Ямало-Ненецкого АО";
            }
