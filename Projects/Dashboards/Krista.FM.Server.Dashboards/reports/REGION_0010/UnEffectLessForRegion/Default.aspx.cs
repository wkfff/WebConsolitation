    ...
    public partial class _default : CustomReportPage
    {
        ...
        private void SetImageForRang(UltraWebGrid Grid)
        {
            ...
            foreach (UltraGridRow row in Grid.Rows)
            {
                ...
                {
                    row.Cells.FromKey("CurrRang").Title = "Hаилучшее значение по ХМАО-Югре";
                ...
                {
                    row.Cells.FromKey("CurrRang").Title = "Наихудшее значение по ХМАО-Югре";
                ...
                {
                    row.Cells.FromKey("PrevRang").Title = "Hаилучшее значение по ХМАО-Югре";
                ...
                {
                    row.Cells.FromKey("PrevRang").Title = "Наихудшее значение по ХМАО-Югре";
