<%@ Control Language="C#" AutoEventWireup="true" Codebehind="FO_0002_0006_Gadget.ascx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.DashboardNotepadFin.FO_0002_0006_Gadget" %>
...
<asp:Panel ID="MainPanel" runat="server" CssClass="GadgetMainPanel" Height="100%"
    ...
    <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="200px" Width="325px"
        EnableAppStyling="True" StyleSetName="Office2007Blue" SkinID="GadgetGrid">
        <Bands>
            <igtbl:UltraGridBand>
