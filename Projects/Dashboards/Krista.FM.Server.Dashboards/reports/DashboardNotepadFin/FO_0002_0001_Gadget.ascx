<%@ Control Language="C#" AutoEventWireup="true" Codebehind="FO_0002_0001_Gadget.ascx.cs" Inherits="Krista.FM.Server.Dashboards.DashboardNotepadFin.Dashboard.reports.DashboardNotepadFin.FO_0002_0001_Gadget" %>
<%@ Register Assembly="Infragistics35.WebUI.UltraWebGrid.v11.1, Version=11.1.20111.2036, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb"
    Namespace="Infragistics.WebUI.UltraWebGrid" TagPrefix="igtbl" %>
<div class="GadgetTopDate">
    <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
</div>
<asp:Panel ID="MainPanel" runat="server" Height="306">
    <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="200px" Width="325px" EnableAppStyling="True"
        StyleSetName="Office2007Blue" SkinID="GadgetGrid">
        <Bands>
            <igtbl:UltraGridBand>
