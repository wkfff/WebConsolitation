<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FK_0001_0003_Gadget.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.FK_0001_0003_Gadget" %>
    ...
    <table border="0" cellspacing="0">
        <tr>
            <td style="width: 200px;">
                 <igGauge:UltraGauge ID="Gauge" runat="server" BackColor="Transparent"
...
<table width="230" style="font:Verdana; margin-right:5px; border-collapse:collapse;">
    <tr>
        ...
        <td class="GadgetGridTD">
            <div class="GadgetValueTextLeft"><asp:Label ID="Label1" runat="server"></asp:Label></div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="GadgetGridTD" style="border-top: 1px;">
            <div class="GadgetValueTextRight"><asp:Label ID="Label2" runat="server"></asp:Label></div>
        </td>
    </tr>    
    <tr>
        <td class="GadgetGridTD">
        ...
        <td class="GadgetGridTD">
            <div class="GadgetValueTextRight"><asp:Label ID="Label3" runat="server"></asp:Label></div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="GadgetGridTD" style="padding-top:0px;">
            <div class="GadgetValueTextLeft"><asp:Label ID="Label5" runat="server"></asp:Label></div>
        </td>
    </tr>    
    <tr>
        <td class="GadgetGridTD" >
        ...
        <td class="GadgetGridTD">
            <div class="GadgetValueTextLeft"><asp:Label ID="Label4" runat="server"></asp:Label></div>
        </td>
    </tr>
    <tr>
