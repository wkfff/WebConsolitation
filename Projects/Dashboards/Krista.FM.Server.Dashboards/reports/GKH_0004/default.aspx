<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.GKH_0004._default" %>
                            ...
                            <td colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: top;">
                                            <asp:CheckBox ID="isBig" runat="server" AutoPostBack="True" 
                                                Text="Детализация" />
                                            <br />
                    <asp:Label ID="Textovka" runat="server" CssClass="PageSubTitle"></asp:Label>
                                            <igtbl:UltraWebGrid
