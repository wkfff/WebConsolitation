...
namespace Krista.FM.Server.Dashboards.reports.FO_0001_0007
{
    public partial class Default: CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            UltraWebGrid1.Height = CRHelper.GetGridHeight(CustomReportConst.minScreenHeight / 1.3);
       ...
       protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = DataProvider.GetQueryText("FO_0001_0007_data");
            ...
            Page.Title = "Фактические расходы на содержание органов государственной власти";
        ...
        protected void UltraWebGrid_DataBinding(Object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0001_0007_Grid");
        ...
        protected void UltraWebGrid_InitializeLayout(Object sender, LayoutEventArgs e)
        {
            ...
            GridHeaderCell cell1 = headerLayout.AddCell("Фактически замещено штатных единиц, чел.", string.Format("Фактически замещено штатных единиц за {0} год ", ComboYear.SelectedValue));
            ...
            cell1.AddCell("Отклонение", "Отклонение фактической численности работников от предыдущего отчетного периода");
            cell1.AddCell("Темп роста, %", "Темп роста фактической численности работников к предыдущему отчетному периоду");

            GridHeaderCell cell2 = headerLayout.AddCell("Расходы на одного работника, тыс. руб.", string.Format("Расходы на 1 работника государственного органа за {0} год", ComboYear.SelectedValue));
            ...
            cell2.AddCell("Отклонение", "Отклонение расходов на одного работника от предыдущего отчетного периода");
            cell2.AddCell("Темп роста, %","Темп роста расходов на одного работника к предыдущему отчетному периоду");
