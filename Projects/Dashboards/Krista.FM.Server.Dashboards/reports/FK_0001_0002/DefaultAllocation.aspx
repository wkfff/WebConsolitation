<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultAllocation.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FK_0001_0002.DefaultAllocation" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="top">
                <asp:CheckBox ID="allRegionsCheckBox" runat="server" Text="Субъекты&nbsp;одного&nbsp;федерального&nbsp;округа" Style="font-family: Verdana; font-size: 10pt;"
                    AutoPostBack="true" /><br />
                <asp:CheckBox ID="useDotationCheckBox" runat="server" Text="Не&nbsp;учитывать&nbsp;дотации&nbsp;на&nbsp;выравнивание&nbsp;бюджетной&nbsp;обеспеченности" Style="font-family: Verdana; font-size: 10pt;"
                    AutoPostBack="true" /><br />
            </td>
        </tr>
    </table>
