<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0004_0006.Default" Title="Индикаторы БК и КУ " %>
                ...
                <table runat="server" id="GridTable1" style="border-collapse: collapse; background-color: white;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle" Text="Анализ выпадающих доходов по налогам по Ханты-Мансийскому автономному округу - Югре"></asp:Label>
                        </td>
