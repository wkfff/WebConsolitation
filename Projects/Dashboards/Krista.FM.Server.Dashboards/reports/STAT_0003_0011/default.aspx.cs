 ...
 */
namespace Krista.FM.Server.Dashboards.reports.STAT_0003_0011
{
	public partial class Default : CustomReportPage
	{
		...
		private const string PageTitleCaption = "Мониторинг ситуации на рынке труда (г. Губкинский)";
		private const string PageSubTitleCaption = "Данные еженедельного мониторинга ситуации на рынке труда в г. Губкинский";
		private const string Chart1TitleCaption = "Динамика уровня зарегистрированной безработицы";
		private const string Chart2TitleCaption = "Динамика численности зарегистрированных безработных в расчете на одну вакансию";
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				FillComboDate("STAT_0003_0011_list_of_dates");
		...
		protected void MakeDynamicText()
		{
			...
			string text1 = "Численность безработных граждан, зарегистрированных в органах службы занятости, по состоянию на <b>{0}</b> составила <b>{1:N0}</b> человек. {2} числа безработных граждан за период с <b>{3}</b> по <b>{0}</b> в целом по выбранному муниципальному образванию составил{4} <b>{5:N0}</b> чел. (темп {6}<b>{7:P2}</b>).";
			string text2 = "<br/>Уровень регистрируемой безработицы в течение отчетного периода {0} на <b>{1:N3}</b> процентных пункта и на <b>{2}</b> составил <b>{3:N3}%</b>.";

			object[] values1 = new object[8];
			values1[0] = dtGridDescription.Rows[dtGridDescription.Rows.Count - 1][0].ToString();
			values1[1] = Convert.ToDouble(row0[2].ToString());
			...
			LabelText.Text = String.Format(text1, values1) + String.Format(text2, values2);
		}
		...
		{
			string query = DataProvider.GetQueryText("STAT_0003_0011_grid");
			dtGrid = new DataTable();
			DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Период", dtGrid);
			query = DataProvider.GetQueryText("STAT_0003_0011_grid_description");
		...
		protected void UltraChart1_DataBinding(object sender, EventArgs e)
		{
			...
			string query = DataProvider.GetQueryText("STAT_0003_0011_chart1");
		...
		{
			LabelChart2.Text = Chart2TitleCaption;
			string query = DataProvider.GetQueryText("STAT_0003_0011_chart2");
		...
		private void ExcelExportButton_Click(object sender, EventArgs e)
		{
			...
			sheet1.MergedCellsRegions.Add(3, 0, 3, 7);
			sheet1.MergedCellsRegions.Add(4, 0, 4, 7);
