<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0006_0003.Default" Title="Индикаторы БК и КУ " %>
                ...
                <table runat="server" id="GridTable1" style="border-collapse: collapse; background-color: white;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="Label4" runat="server" CssClass="ElementTitle" Text="Анализ предоставленных льгот в разрезе федерального, регионального и местного законодательства"></asp:Label>
                        </td>
