<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0006_Sakhalin.Default" Title = "Анализ динамики и структурного соотношения численности безработных граждан, состоящих на регистрационном учете"%>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            ...
            <td runat="server" id="HorizontalTD">
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    <tr>
                        <td class="topleft">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" runat="server" id="HorizontalChartTD">
        ...
        <tr>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td runat="server" id="VerticalChartTD" style="overflow: visible;">
