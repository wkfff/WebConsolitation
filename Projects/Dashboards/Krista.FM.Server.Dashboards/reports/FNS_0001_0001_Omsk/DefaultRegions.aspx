<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultRegions.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0001_0001_Omsk.DefaultRegions" %>
            ...
            <td valign="top">
                <table>
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:CheckBox ID="useClimaticZones" Checked="false" runat="server" Text="Природно-климатические&nbsp;зоны"
                                AutoPostBack="true" style="font-size:12px;font-family:Verdana;" Width="250px" />
                        </td>  
                    </tr>
                </table>
            </td>
            ...
            <td valign="top" align="left">
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="AbsobuteMeasure" runat="server" Text="Прирост/снижение в тыс.руб." AutoPostBack="true" Checked="true"
                                Style="font-family: Verdana; font-size: 10pt;" />
                            <asp:CheckBox ID="RelativeMeasure" runat="server" Text="Прирост/снижение в %" AutoPostBack="true" Checked="false"
                                Style="font-family: Verdana; font-size: 10pt;" /><br/>
                            <asp:CheckBox ID="Chart2DistrictExclude" runat="server" Text="Без городских округов" AutoPostBack="true" Checked="false"
                                Style="font-family: Verdana; font-size: 10pt;" />                                
                        </td>
                        <td class="right">
                        </td>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="Chart1DistrictExclude" runat="server" Text="Без городских округов" AutoPostBack="true" Checked="false"
                                Style="font-family: Verdana; font-size: 10pt;" />
                        </td>
                        <td class="right">
                        </td>
