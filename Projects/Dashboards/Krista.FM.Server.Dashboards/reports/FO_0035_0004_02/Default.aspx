<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0035_0004_02.Default " Title="Untitled Page" %>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="grid1Label" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            ...
                            <asp:Label ID="MeansDeficit" runat="server" CssClass="PageSubTitle"></asp:Label>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
            ...
            <td valign="top" align="left">
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="grid2Label" runat="server" CssClass="ElementTitle"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <asp:Label ID="CommentText" runat="server" CssClass="PageSubTitle"></asp:Label><br/>
