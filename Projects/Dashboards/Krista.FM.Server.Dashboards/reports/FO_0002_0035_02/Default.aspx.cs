...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0035_02
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = "Распределение ассигнований из областного бюджета на капитальный ремонт автомобильных дорог и дорожных сооружений, тыс.руб.";
        ...
        private DateTime GetLastYearDay()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0035_02_date");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0035_02_grid");
            ...
            if (gridDt.Rows.Count > 0)
            {
                ...
                PerformanceUniformityRule uniformRule = new PerformanceUniformityRule(3, currentDate.Month);
                GridBrick.AddIndicatorRule(uniformRule);
        ...
        protected void Grid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            for (int i = 1; i < columnCount - 1; i = i + 1)
            {
                ...
                e.Layout.Bands[0].Columns[i].Width = CRHelper.GetColumnWidth(250);
            ...
            headerLayout.AddCell("Бюджетные ассигнования на региональные и межмуниципальные объекты", "Утвержденные бюджетные ассигнования на региональные и межмуниципальные объекты");
            headerLayout.AddCell("Кассовое исполнение", String.Format("Кассовое исполнение за месяц (по состоянию на {0:dd.MM.yyyy} года)", lastYearDay.AddDays(-1)));
