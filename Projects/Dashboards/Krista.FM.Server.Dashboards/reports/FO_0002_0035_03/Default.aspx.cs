...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0035_03
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = "Распределение ассигнований из областного бюджета на ремонт автомобильных дорог и дорожных сооружений, тыс.руб.";
        ...
        private DateTime GetLastYearDay()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0035_03_date");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0035_03_grid");
