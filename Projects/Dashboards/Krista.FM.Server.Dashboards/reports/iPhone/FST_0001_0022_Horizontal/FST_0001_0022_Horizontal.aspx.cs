...
{
    public partial class FST_0001_0022_Horizontal : CustomReportPage
    {
        ...
        {
            string query = DataProvider.GetQueryText("FST_0001_0022_Horizontal_Grid");
            ...
            dtGrid.Rows[0]["Рост тарифа на тепловую энергию для населения"] = notZeroDemosCountRF == 0 ? 0 : foDemosAvgRF / notZeroDemosCountRF;
            ...
            dtGrid.Rows[0]["Рост тарифа на тепловую энергию для бюджетных потребителей"] = notZeroBujetCountRF == 0 ? 0 : foBujetAvgRF / notZeroBujetCountRF;
            ...
            dtGrid.Rows[0]["Рост тарифа на тепловую энергию для прочих потребителей"] = notZeroOthersCountRF == 0 ? 0 : foOthersAvgRF / notZeroOthersCountRF;
