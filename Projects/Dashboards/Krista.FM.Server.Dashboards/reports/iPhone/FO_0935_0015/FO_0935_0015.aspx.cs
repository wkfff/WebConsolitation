...
{
    public partial class FO_0935_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                UserParams.Mo.Value = "Красноселькупский район";
            }
            ...
            query = DataProvider.GetQueryText("FO_0935_0015_population");
            ...
            query = DataProvider.GetQueryText("FO_0935_0015_incomes_date");
            ...
            query = DataProvider.GetQueryText("FO_0935_0015_outcomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0935_0015_Incomes");
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0935_0015_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0935_0015_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0935_0015_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0935_0015_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0935_0015_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        {
            DataTable dtDate = new DataTable();
            string query = DataProvider.GetQueryText("FO_0935_0015_incomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            DataTable dtIncomes = new DataTable();
             query = DataProvider.GetQueryText("FO_0935_0015_Incomes_settlement");
            ...
            query = DataProvider.GetQueryText("FO_0935_0015_Outcomes_settlement");
        ...
        private void InitializeSettlement()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0935_0015_settlements_count");
