...
{
    public partial class FO_0002_0014 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0014_incomes_date");
            ...
            query = DataProvider.GetQueryText("FO_0002_0014_population");
            ...
            lbPopulation.Text = String.Format("Численность постоянного населения&nbsp;<span style=\"color: white\"><b>{0:N0}</b></span>&nbsp;чел.", Convert.ToDouble(dtPopulation.Rows[0][0].ToString()));
            ...
            {
                gosDebtFilter.Value = @", [Показатели].[СопМесОСпВнтД].[Filter]";
            ...
            {
                gosDebtFilter.Value = ", [Показатели].[СопМесОСпВнтД].[Все показатели].[ГОСУДАРСТВЕННЫЙ ВНУТРЕННИЙ ДОЛГ СУБЪЕКТА РОССИЙСКОЙ ФЕДЕРАЦИИ, всего]";
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0002_0014_Incomes");
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0002_0014_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
...
//            UserParams.PeriodYear.Value = "[2011]";
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0014_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0002_0014_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0002_0014_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0002_0014_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
