<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oil_0001_0004.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.Oil_0001_0004" %>
        ...
        <table style="border-collapse: collapse; background-color: Black; top: 0px; left: 0px;">
            <tr>
                <td align="left" valign="top">                    
                    <uc1:iPadElementHeader ID="Grid1Header" runat="server" Width="760px" />
                    <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" SkinID="UltraWebGrid" />
                    <uc1:iPadElementHeader ID="Grid2Header" runat="server" Width="760px" />
