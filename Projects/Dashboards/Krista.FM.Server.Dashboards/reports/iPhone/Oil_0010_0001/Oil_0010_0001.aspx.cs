...
{
    public partial class Oil_0010_0001 : CustomReportPage
    {
        string subjectId = "0";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            DateTime previousDate = CubeInfo.GetLastDate(DataProvidersFactory.SpareMASDataProvider, "Oil_0010_0001_lastDate", false, 0);
            DateTime currentDate = CubeInfo.GetLastDate(DataProvidersFactory.SpareMASDataProvider, "Oil_0010_0001_lastDate", false, 1);
            ...
            UltraChart1.ReportCode = "Oil_0010_0001";
            UltraChart2.ReportCode = "Oil_0010_0001";
            UltraChart3.ReportCode = "Oil_0010_0001";
            UltraChart4.ReportCode = "Oil_0010_0001";
            UltraChart5.ReportCode = "Oil_0010_0001";

            UltraChart1.MultiTouchReportCode = "Oil_0010_0002_oil=1";
            UltraChart2.MultiTouchReportCode = "Oil_0010_0002_oil=2";
            UltraChart3.MultiTouchReportCode = "Oil_0010_0002_oil=3";
            UltraChart4.MultiTouchReportCode = "Oil_0010_0002_oil=4";
            UltraChart5.MultiTouchReportCode = "Oil_0010_0002_oil=5";
        ...
        protected override void Page_LoadComplete(object sender, EventArgs e)
        {
            ...
            string filename = HttpContext.Current.Server.MapPath("~/TemporaryImages/Oil_0010_0001/") + "TouchElementBounds.xml";
            Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/TemporaryImages/Oil_0010_0001/"));
            File.WriteAllText(filename, String.Format("<?xml version=\"1.0\" encoding=\"UTF-8\"?><touchElements>" +
    "<element id=\"oil_0010_0002_oil=1\" bounds=\"x=0;y=0;width=768;height={0}\" openMode=\"\"/>" +
    "<element id=\"Oil_0010_0002_oil=2\" bounds=\"x=0;y={0};width=768;height={1}\" openMode=\"\"/>" +
    "<element id=\"Oil_0010_0002_oil=3\" bounds=\"x=0;y={1};width=768;height={2}\" openMode=\"\"/>" +
    "<element id=\"Oil_0010_0002_oil=4\" bounds=\"x=0;y={2};width=768;height={3}\" openMode=\"\"/>" +
    "<element id=\"Oil_0010_0002_oil=5\" bounds=\"x=0;y={3};width=768;height={4}\" openMode=\"\"/></touchElements>",
         control1Height, control2Height, control3Height, control5Height, control4Height));
        }
    }
}
