...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
    public partial class FO_0035_0020 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            lbPlanIncomes.Text = String.Format("{0:N2}", dtData.Rows[0]["График на месяц "]);
            lbFactIncomes.Text = String.Format("{0:N2}", dtData.Rows[0]["Исполнено с начала месяца "]);
            ...
            lbPlanOutcomes.Text = String.Format("{0:N2}", dtData.Rows[1]["График на месяц "]);
            lbFactOutcomes.Text = String.Format("{0:N2}", dtData.Rows[1]["Исполнено с начала месяца "]);
            ...
            lbRestStartPlan.Text = String.Format("{0:N2}", dtData.Rows[2]["График на месяц "]);
            lbRestStartFact.Text = String.Format("{0:N2}", dtData.Rows[2]["Исполнено с начала месяца "]);
        }
