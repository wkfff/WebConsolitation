<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFK_0017_0001_H.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.UFK_0017_0001_H" %>
...
<body>
    ...
    <div> 
        ...
        <tr><td colspan="2" style="background-color: black; border-right: 0px solid; border-top: 0px solid; left: 0px; border-left: 0px solid; border-bottom: 0px solid; position: static; top: 195px; border-collapse: collapse;" valign="top">
            <asp:Label ID="Label3" runat="server" SkinID="InformationText" Text="Динамика остатка собственных средств бюджета"></asp:Label><br />
            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                 EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                Version="8.2" OnDataBinding="UltraChart_DataBinding" OnFillSceneGraph="UltraChart_FillSceneGraph" SkinID="UltraWebColumnChart" Height="200px">
...
<Y LineThickness="1" TickmarkInterval="100" Visible="True" TickmarkStyle="Smart">
<MinorGridLines Color="LightGray" DrawStyle="Dot" Visible="False" Thickness="1" AlphaLevel="255"></MinorGridLines>
