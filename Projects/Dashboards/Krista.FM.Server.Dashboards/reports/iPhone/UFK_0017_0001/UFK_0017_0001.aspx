<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFK_0017_0001.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.UFK_0017_0001" %>
...
<igGaugeProp:SolidFillBrushElement></igGaugeProp:SolidFillBrushElement>
                 ...
                 <asp:Label ID="Label4" runat="server" SkinID="InformationText" Text="Максимум"></asp:Label><br />
                 ...
                 <asp:Label ID="Label10" runat="server" SkinID="InformationText" Text="Среднее"></asp:Label><br />
                 ...
                 <asp:Label ID="Label7" runat="server" SkinID="InformationText" Text="Минимум"></asp:Label><br />
              ...
              <tr><td style="padding-left: 5px">
                 <asp:Label ID="lbRestDate" runat="server" SkinID="InformationText" Text="До конца ноября остатки"></asp:Label></td><td style="padding-right: 5px" align="right">
                <asp:Label ID="Label12" runat="server" SkinID="ServeText" Text="тыс. руб."></asp:Label></td></tr>           
             <tr>             
             <td style="position: static; top: 243px; padding-left: 5px; padding-top: 5px; border-right: #323232 1px solid; border-collapse: collapse; font-size: 10px;" valign="top" colspan="2">
                 <asp:Table ID="tableStat" runat="server" BorderColor="#333333" CellPadding="1" CellSpacing="0">
                     <asp:TableRow runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px">
                         <asp:TableCell runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" Width="165px"><asp:Label ID="Label1" runat="server" SkinID="InformationText" Text="доходы "></asp:Label></asp:TableCell>
                     ...
                     <asp:TableRow runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px">
                         <asp:TableCell runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" Width="165px"><asp:Label ID="Label5" runat="server" SkinID="InformationText" Text="расходы "></asp:Label></asp:TableCell>
                     ...
                     <asp:TableRow runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px">
                         <asp:TableCell runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" Width="165px"><asp:Label ID="Label9" runat="server" SkinID="InformationText" Text="заимствования "></asp:Label></asp:TableCell>
                     ...
                     <asp:TableRow runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px">
                         <asp:TableCell runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" Width="165px"><asp:Label ID="Label14" runat="server" SkinID="InformationText" Text="прочие ИФ "></asp:Label></asp:TableCell>
                     ...
                     <asp:TableRow runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px">
                         <asp:TableCell runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" Width="165px"><asp:Label ID="Label17" runat="server" SkinID="InformationText" Text="Ожидаемый остаток "></asp:Label></asp:TableCell>
