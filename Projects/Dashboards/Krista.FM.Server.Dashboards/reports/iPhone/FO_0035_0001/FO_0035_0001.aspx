<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0001.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0001" %>
            ...
            <div>
                <table style="border-right: 0px solid; border-top: 0px solid; left: 0px; border-left: 0px solid;
                    ...
                    <tr runat="server" id="restEndTR">
                        <td  runat="server" id="restEndTD" valign="top" style="padding-left: 5px; padding-top: 6px;" colspan="2">
                    ...
                    <tr>
                        <td style="padding-left: 5px; padding-top: 10px;" valign="top">
                            <asp:Label ID="Label6" runat="server" Text="Кассовые поступления" CssClass="InformationText"></asp:Label>&nbsp;
                    ...
                    <tr>
                        <td valign="top" style="padding-left: 5px; padding-top: 6px;">
                            <asp:Label ID="Label8" runat="server" CssClass="InformationText" Text="Кассовые выплаты"></asp:Label>&nbsp;
