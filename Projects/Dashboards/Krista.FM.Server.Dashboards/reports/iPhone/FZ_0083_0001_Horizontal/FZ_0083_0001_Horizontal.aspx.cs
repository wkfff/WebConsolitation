...
{
    public partial class FZ_0083_0001_Horizontal : CustomReportPage
    {
        ...
        protected void UltraWebGridRF_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            e.Layout.Bands[0].Columns[0].CellStyle.Padding.Right = 50;
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            int todayColumnIndex = GetTodayColumnIndex();
            string todayText = String.Format("<div style='margin-left: 5px;margin-top: -20px;text-align:left'><span style='font-size: 12px; color: #C0C0C0;text-align:left'>Сегодня&nbsp;</span></div>");
            ...
            e.Layout.Bands[0].Columns[todayColumnIndex].Header.Style.BorderDetails.StyleLeft = BorderStyle.Dashed;
            ...
            e.Layout.Bands[0].Columns[todayColumnIndex].CellStyle.BorderDetails.StyleLeft = BorderStyle.Dashed;
            e.Layout.Bands[0].Columns[todayColumnIndex].CellStyle.BorderDetails.WidthLeft = 1;
            e.Layout.Bands[0].Columns[todayColumnIndex].CellStyle.BorderDetails.ColorLeft = Color.FromArgb(0x7c7c7c);
        }
        ...
        protected void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
                 ...
                 e.Row.Cells[0].Value.ToString() != String.Empty)
            {
                ...
                e.Row.Cells[0].Style.CustomRules = "background-repeat: no-repeat; background-position: right center; padding-right: 30px";
