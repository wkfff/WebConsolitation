<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FW_0003_0001_Horizontal.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FW_0003_0001_Horizontal" %>
...
<body link="White" vlink="White" style="background-color: black;">
    ...
    <div id="mainDiv" runat="server" style="position: absolute; width:1022px; top: 0px;
        left: 0px; overflow: hidden; z-index: 2; background-position: left top; background-repeat: no-repeat">
        <table style="border-collapse: collapse">
            <tr>
                <td>
                    <table style="width: 1000px; margin-bottom: -20px">
                        <tr>
