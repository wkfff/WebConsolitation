...
{
    public partial class FST_0001_0023_Horizontal : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FST_0001_0023_Horizontal_Chart");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "dummy", dtChart);
            UltraChartGrownTemp.DataSource = dtChart;
            UltraChartGrownTemp.DataBind();

            TagCloudFST_0001_0023_Horizontal_Text2.TaxName = "тариф для населения";
            TagCloudFST_0001_0023_Horizontal_Text3.TaxName = "тариф для бюджетных потребителей";
            TagCloudFST_0001_0023_Horizontal_Text4.TaxName = "тариф для прочих потребителей";

            SetChart(TagCloudFST_0001_0023_Horizontal_Text1, "1", measureName);
            SetChart(TagCloudFST_0001_0023_Horizontal_Text2, "2", measureName);
            SetChart(TagCloudFST_0001_0023_Horizontal_Text3, "3", measureName);
            SetChart(TagCloudFST_0001_0023_Horizontal_Text4, "4", measureName);
        }
        ...
        private void SetChart(Dashboard.FST_0001_0003_Text textElement, string filter, string measure)
        {
            ...
            string chartQuery = DataProvider.GetQueryText(String.Format("FST_0001_0023_Horizontal_gauge{0}", filter));
            string textQuery = DataProvider.GetQueryText(String.Format("FST_0001_0023_Horizontal_text{0}", filter));            
