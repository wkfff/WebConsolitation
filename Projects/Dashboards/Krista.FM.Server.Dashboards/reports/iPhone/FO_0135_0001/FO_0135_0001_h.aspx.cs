...
{
    public partial class FO_0135_0001_h : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!dtDate.Rows[0][4].ToString().Contains("Заключительные обороты"))
            {
                ...
                else
                {
                    ...
                    TextBox1.Text = "Исполнение на " + date.ToString("dd.MM.yyyy") + ", тыс.руб.";
                }
        ...
        private void MakeHtmlTable()
        {
            ...
            for (int i = 0; i < dtOutcomes.Rows.Count; i++)
            {
                ...
                cell = GetPlanCell(String.Format("{0:N0}", dtOutcomes.Rows[i][1]));
                row.Cells.Add(cell);
