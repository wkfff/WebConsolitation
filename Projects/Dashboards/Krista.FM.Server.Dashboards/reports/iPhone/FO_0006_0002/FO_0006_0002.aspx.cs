...
{
    public partial class FO_0006_0002_1 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            FO_0006_0002_Chart1.QueryName = "FO_0006_0002_chart1";
            FO_0006_0002_Chart3.QueryName = "FO_0006_0002_chart3";
            FO_0006_0002_Chart1.Caption = "План";
            FO_0006_0002_Chart3.Caption = "Факт";

            FO_0004_0003_Chart1.QueryName = "FO_0004_0003_chart1";
            FO_0004_0003_Chart3.QueryName = "FO_0004_0003_chart3";
            FO_0004_0003_Chart1.Caption = "План";
            FO_0004_0003_Chart3.Caption = "Факт";

            FO_0006_0002_Chart1.Date = currDate;
            FO_0006_0002_Chart3.Date = currDate;
            FO_0004_0003_Chart1.Date = currDate;
            FO_0004_0003_Chart3.Date = currDate;

            FO_0004_0003_Chart1.PercentFormat = "N1";
            FO_0004_0003_Chart1.CurrencyFormat = "N0";
            FO_0004_0003_Chart3.PercentFormat = "N1";
            FO_0004_0003_Chart3.CurrencyFormat = "N0";

            FO_0006_0002_Chart1.PercentFormat = "N1";
            FO_0006_0002_Chart1.CurrencyFormat = "N0";
            FO_0006_0002_Chart3.PercentFormat = "N1";
            FO_0006_0002_Chart3.CurrencyFormat = "N0";
            ...
            query = DataProvider.GetQueryText("FO_0006_0002_population");
            DataProvidersFactory.SecondaryMASDataProvider.GetDataTableForChart(query, "dummy", dtPopulation);
            populationValue.Value = dtPopulation.Rows[0][0].ToString().Replace(",", ".");

            SetupGrid(UltraWebGrid, "FO_0006_0002_table_incomes");
            SetupGrid(UltraWebGrid1, "FO_0006_0002_table_outcomes");

            //UltraWebGrid1.DisplayLayout.Bands[0].HeaderLayout.Clear();

            DataTable dtText = new DataTable();
            query = DataProvider.GetQueryText("FO_0006_0002_text");
            ...
            lbDescription.Text =
                String.Format(
                    "Численность постоянного населения&nbsp;<span class='DigitsValue'>{0:N0}</span>&nbsp;тыс.чел.", dtText.Rows[0]["Численность постоянного населения "]);

            Label1.Text =
                String.Format(
                    "Бюджетные доходы на душу населения&nbsp;<span class='DigitsValue'>{0:N0}</span>&nbsp;тыс.руб./чел", dtText.Rows[0]["Среднедушевые доходы обл бюджет"]);

            Label2.Text =
                String.Format(
                    "Бюджетные расходы на душу населения&nbsp;<span class='DigitsValue'>{0:N0}</span>&nbsp;тыс.руб./чел", dtText.Rows[0]["Среднедушевые расходы обл бюджет"]);
        }
        ...
        private void SetupGrid(UltraWebGrid grid, string queryName)
        {
            ...
            foreach (DataRow row in dtSource.Rows)
            {
                ...
                newRow[1] = String.Format("{0:N0}<br/>{1:P1}", row[1], row[3]);
                newRow[2] = String.Format("{0:N0}<br/>{1:P1}", row[2], row[4]);

                newRow[3] = String.Format("{0:N0}<br/>{1:P1}", row[5], row[7]);
                newRow[4] = String.Format("{0:N0}<br/>{1:P1}", row[6], row[8]);
        ...
        void grid_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            else if (!e.Row.Cells[0].Value.ToString().Contains("БЕЗВОЗМЕЗДНЫЕ ПОСТУПЛЕНИЯ"))
            {
                e.Row.Cells[0].Value = e.Row.Cells[0].Value.ToString().Replace("бюджетам субъектов РФ и МО", "");
