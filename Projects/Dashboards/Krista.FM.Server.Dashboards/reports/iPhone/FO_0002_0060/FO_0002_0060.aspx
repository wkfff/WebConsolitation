<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0002_0060.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0002_0060_1" %>
...
<body style="background-color: black;">
    ...
    <div style="position: absolute; width: 768px; height: 950px; background-color: black;
        ...
        <table style="width: 768; height: 900; border-collapse: collapse; background-color: Black;
                    ...
                    <table>
                        ...
                        <td>
                            <div style="float: right">
                                <a href='webcommand?showPinchReport=FO_0002_0061'>
                                    <img style='padding-top: 5px; padding-right: 2px' src='../../../images/Detail.png' /></a></div>
                        </td>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    padding-top: 2px; padding-bottom: 2px; background-image: url(../../../images/max.png);
                    background-repeat: no-repeat; background-position: 2% center; padding-left: 58px;">
                    – максимальная среднесписочная численность
                </td>
            </tr>
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    padding-top: 2px; padding-bottom: 2px; background-image: url(../../../images/min.png);
                    background-repeat: no-repeat; background-position: 2% center; padding-left: 58px;">
                    – минимальная среднесписочная численность
                </td>
            </tr>
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    padding-top: 2px; padding-bottom: 2px; background-image: url(../../../images/arrowRedUpBB.png);
                    background-repeat: no-repeat; background-position: 4% center; padding-left: 58px;">
                    – рост расходов на одного работника по сравнению с предыдущим годом
                </td>
            </tr>
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    padding-top: 2px; padding-bottom: 2px; background-image: url(../../../images/arrowGreenDownBB.png);
                    background-repeat: no-repeat; background-position: 4% center; padding-left: 58px;">
                    – снижение расходов на одного работника по сравнению с предыдущим годом
                </td>
            </tr>
            <tr>
                <td>
