...
{
    public partial class OIL_0006_0001 : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            base.Page_Load(sender, e);

            DateTime currentDate = CubeInfo.GetLastDate(DataProvidersFactory.SecondaryMASDataProvider, "oil_0006_0001_lastDate");
            ...
            CustomParam.CustomParamFactory("fullRegionName").Value = "Российская Федерация";

            UltraChart1.ReportCode = "oil_0006_0001";
            UltraChart2.ReportCode = "oil_0006_0001";
            UltraChart3.ReportCode = "oil_0006_0001";
        ...
        protected override void Page_LoadComplete(object sender, EventArgs e)
        {
            ...
            string filename = HttpContext.Current.Server.MapPath("~/TemporaryImages/oil_0006_0001/") + "TouchElementBounds.xml";
            Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/TemporaryImages/oil_0006_0001/"));
    ...
    control1Height, control2Height, control3Height, 0));
        }
    }
}
