...
where              
  ...
  <query id="F0_0002_0007_iphone_outcomes">
    <![CDATA[
-- F0_0002_0007_iphone_outcomes
with 
...
where 
  ...
  <query id="FO_0002_0007_HMAO_population">
    <![CDATA[
-- FO_0002_0007_HMAO_population 
with   
    member Measures.[isMRGO] 
    as 'not
        (
