...
{
    public partial class FO_0735_0015_v : CustomReportPage
    {
        ...
        private void InitializeCreditDebts()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0735_0015_credit_debts");
        ...
        #region Муниципальный долг

        private void InitializeMunDebts()
        {
            DataTable dtСreditDebts = new DataTable();
            string query = DataProvider.GetQueryText("FO_0335_0015_Inner_Debt_v");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dtСreditDebts);
            ...
            UltraWebGrid2.DataSource = dtСreditDebts;
        ...
        void UltraWebGrid2_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            string dateMonth = string.Format("Долг на 01.{0:00}.{1} тыс.руб.", reportMonth, reportYear);

            e.Layout.Bands[0].Columns[1].Header.Caption = "Долг на начало года тыс.руб.";
            e.Layout.Bands[0].Columns[2].Header.Caption = dateMonth;
            e.Layout.Bands[0].Columns[3].Header.Caption = "Рост/снижение с начала года тыс.руб.";
        ...
        private static DataTable GetBudetDataSource()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0735_0015_budget_incomes_v");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0735_0015_budget_outcomes_all_v");
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_budget_outcomes_v");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0735_0015_budget_deficite_v");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        {           
            ...
            double rank = worseRank - Convert.ToDouble(rankCell.Value.ToString()) + 1;
        ...
        private void InitializeBudgetSettlement()
        {
            ...
            query = DataProvider.GetQueryText("FO_0735_0015_settlements_list");
        ...
        protected void UltraWebGridBudgetSettlement_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0735_0015_settlement_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0735_0015_settlement_outcomes_all");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0735_0015_settlement_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0735_0015_settlement_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
