<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0735_0015_v.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0735_0015_v" %>
            ...
            <tr>
                <td>
                    <table style="border-collapse: collapse; background-color: Black; width: 765px; height: 100%;
                        ...
                        <tr>
                            <td>
                                <igtbl:UltraWebGrid ID="UltraWebGridBudgetSelf" runat="server" Height="200px" Width="509px"
                                    OnDataBinding="UltraWebGridBudgetSelf_DataBinding" OnInitializeLayout="UltraWebGridBudget_InitializeLayout"
                                    SkinID="UltraWebGrid" OnInitializeRow="UltraWebGridBudget_InitializeRow">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                            <AddNewRow View="NotSet" Visible="NotSet">
                                ...
                                <table style="border-collapse: collapse; width: 763px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 18px; font-family: Verdana; color: White; background-image: url(../../../images/iPadContainer/containerheader.gif);
                                            background-color: Black; background-repeat: repeat-x; margin-left: -5px; margin-right: -5px;
                                            padding-left: 3px; height: 36px; text-align: center; vertical-align: middle;">
                                            <asp:Label ID="Label3" runat="server" CssClass="ElementTitle" Text="Муниципальный долг"></asp:Label>
                                        </td>
                                        <td style="background: white url(../../../images/iPadContainer/headerright.gif);
                                            background-repeat: no-repeat; width: 1px; height: 36px; background-color: Black;">
                                        </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <igtbl:UltraWebGrid ID="UltraWebGridBudgetSettlement" runat="server" Height="200px"
                                    Width="509px" OnDataBinding="UltraWebGridBudgetSettlement_DataBinding" OnInitializeLayout="UltraWebGridBudget_InitializeLayout"
                                    SkinID="UltraWebGrid" OnInitializeRow="UltraWebGridBudget_InitializeRow">
                                    <Bands>
                                        <igtbl:UltraGridBand>
                                            <AddNewRow View="NotSet" Visible="NotSet">
