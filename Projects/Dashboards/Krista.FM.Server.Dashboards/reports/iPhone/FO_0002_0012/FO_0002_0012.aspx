<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0002_0012.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0002_0012" %>
     ...
     <div style="position: absolute; width: 768px; top: 0px; left: 0px; overflow: hidden;
        ...
        <table style="width: 765; height: 950; border-collapse: collapse; background-color: Black;
            top: 0px; left: 0px">
             <tr>
                <td>
                    <asp:Label ID="lbPageTitle" runat="server" SkinID="InformationText" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td align="left">
                    ...
                    <Table>
                      <tr>
                        <td>
                          <div style='float: right'> <img src='../../../images/ballGreenBB.png'> </div>
                        </td>
                        <td>
                           <asp:Label ID="Label2" runat="server" SkinID="ImportantText" Text=""></asp:Label>
                        </td>
                      </tr>
                      <tr>
                        <td>
                           <div style='float: right'> <img src='../../../images/ballRedBB.png'> </div>
                        </td>
                        <td>
                          <asp:Label ID="Label1" runat="server" SkinID="ImportantText" Text=""></asp:Label>
                        </td>  
                     </tr>   
                   </Table>
                </td>
