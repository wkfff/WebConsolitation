<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Oil_0002_0001_v.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Oil_0002_0001_v" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-color: black; height: 360px; border-right: 0px solid; border-top: 0px solid; left: 0px;
            ...
            <table style="width: 320px; height: 360px; border-right: 0px solid; border-top: 0px solid; left: 0px;
                border-left: 0px solid; border-bottom: 0px solid; position: absolute; top: 0px; border-collapse: collapse;">
                <tr>
                    <td align="left" valign="top" style="left: 0px; width: 111px; position: static; top: 45px; border-collapse: collapse;
                        height: 150px; background-color: black">
                        <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""                             Height="323px" SkinID="UltraWebColumnChart" Version="8.2" Width="313px">
