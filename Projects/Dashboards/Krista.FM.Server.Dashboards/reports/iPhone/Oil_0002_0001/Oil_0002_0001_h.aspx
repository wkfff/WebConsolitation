<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oil_0002_0001_h.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Oil_0002_0001_h" %>
...
<body>
    <form id="form1" runat="server">
       <div style="background-color: black; height: 301px; border-right: 0px solid; border-top: 0px solid; left: 0px;
            border-left: 0px solid; border-bottom: 0px solid; position: absolute; top: 0px; border-collapse: collapse;">
            <table style="width: 320px; height: 301px; border-right: 0px solid; border-top: 0px solid; left: 0px;
                border-left: 0px solid; border-bottom: 0px solid; position: absolute; top: 0px; border-collapse: collapse;">
                <tr>
