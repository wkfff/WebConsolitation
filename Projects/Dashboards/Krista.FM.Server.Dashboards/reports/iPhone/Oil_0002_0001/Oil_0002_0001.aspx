<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Oil_0002_0001.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Oil_0002_0001" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-color: black; width: 320px; height: 360px; border-right: 0px solid; border-top: 0px solid;
                left: 0px; border-left: 0px solid; border-bottom: 0px solid; position: absolute; top: 0px; border-collapse: collapse; overflow: hidden">
