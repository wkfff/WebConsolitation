...
<root>
    ...
    <query id="Sport_0001_0010_population">
        <![CDATA[
-- Sport_0001_0010_population
with
    set [Строки] 
    as 'order
        (
...
where
    ...
    <query id="Sport_0001_0010_minsport">
        <![CDATA[
-- Sport_0001_0010_minsport
with 
    member [Measures].[Спортзалы] 
    as ' 
        (
            filter 
            (
                [1ФК_Строки_сопоставимые].members,
                [1ФК_Строки_сопоставимые].[Строки_сопоставимые].currentMember.properties("Код") = "51" 
            ).item(0),
            filter 
            (
                [1ФК_Столбцы_сопоставимые].members,
                [1ФК_Столбцы_сопоставимые].[Столбцы_сопоставимые].currentMember.properties("Код") = "25" 
            ).item(0),
            [Measures].[Значение] 
        )' 
    member [Measures].[Плоскостные]  
    as '  
        (
            filter  
            (
                [1ФК_Строки_сопоставимые].members,
                [1ФК_Строки_сопоставимые].[Строки_сопоставимые].currentMember.properties("Код") = "48"  
            ).item(0),
            filter  
            (
                [1ФК_Столбцы_сопоставимые].members,
    ...
    member [Measures].[Бассейны]  
    as '  
        (
            filter
            (
                [1ФК_Строки_сопоставимые].members,
                [1ФК_Строки_сопоставимые].[Строки_сопоставимые].currentMember.properties("Код") = "63"  
            ).item(0),
            filter  
            (
                [1ФК_Столбцы_сопоставимые].members,
...
where ( [Год].[Год].[Все].[<%param_year_last%>] ) 
    ...
    <query id="Sport_0001_0010_population_grid">
        <![CDATA[
-- Sport_0001_0010_population_grid
with
    set [Строки] 
    as 'order
        (
...
where
    ...
    <query id="Sport_0001_0010_minsport_grid">
        <![CDATA[
-- Sport_0001_0010_minsport_grid
with 
    member [Measures].[Спортзалы] 
    as ' 
        (
