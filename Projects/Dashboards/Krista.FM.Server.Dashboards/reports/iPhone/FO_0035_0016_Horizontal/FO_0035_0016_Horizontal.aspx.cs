...
{
    public partial class FO_0035_0016_Horizontal : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0035_0016_Horizontal_rests_date");
            ...
            query = DataProvider.GetQueryText("FO_0035_0016_Horizontal_table_today");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dtToday);

            dtYesterday = new DataTable();
            query = DataProvider.GetQueryText("FO_0035_0016_Horizontal_table_yesterday");
            ...
            UltraWebGrid.Width = 1020;

            lbDescription.Text =
                String.Format(
                    "Расчет остатков средств областного бюджета, свободных для распределения по направлениям финансирования<br/>на&nbsp;<span class='DigitsValue'>{0:dd.MM.yyyy}</span>, тыс.руб.",
                    currDate);
        }
        ...
        void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
            if (e.Row.Index == 1)
            {
                e.Row.Cells[0].Value = "<img src='../../../images/Incomes.png'/><br/><a href='webcommand?showPinchReport=FO_0035_0017_Horizontal'><img style='padding-top: 5px' src='../../../images/Detail.png'/></a>";
            ...
            {
                e.Row.Cells[0].Value = "<img src='../../../images/CashOutcomes.png'/><br/><a href='webcommand?showPinchReport=FO_0035_0018_Horizontal'><img style='padding-top: 5px' src='../../../images/Detail.png'/></a>";
                e.Row.Cells[0].Style.HorizontalAlign = HorizontalAlign.Center;
                SetGrown(e);
                e.Row.Cells[0].Style.BorderDetails.ColorBottom = Color.Transparent;
            }
            ...
            {
                e.Row.Cells[0].Value = "<img src='../../../images/CashRests.png'/><br/><a href='webcommand?showPinchReport=FO_0035_0019_Horizontal'><img style='padding-top: 5px' src='../../../images/Detail.png'/></a>";
                e.Row.Cells[0].Style.HorizontalAlign = HorizontalAlign.Center;
                SetGrown(e);
            }
        ...
        void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            UltraWebGrid.Columns[0].Width = 63;
            UltraWebGrid.Columns[1].Width = 354;
            UltraWebGrid.Columns[2].Width = 150;
            UltraWebGrid.Columns[3].Width = 150;
            UltraWebGrid.Columns[4].Width = 150;
            UltraWebGrid.Columns[5].Width = 150;
