<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0035_0032.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0035_0032" %>
    ...
    <form id="form1" runat="server">
        <div style="position: absolute; width: 768px; top: 0px; left: 0px; overflow: hidden;
            ...
            <table style="width: 765; height: 950; border-collapse: collapse; background-color: Black;
                ...
                <tr>
                    <td align="left">
                        <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Поступления"
                            Width="761px" HrefReport="FO_0035_0031" />
                        <igtbl:UltraWebGrid ID="IncomesGrid" runat="server" Height="200px" Width="509px"
                            OnDataBinding="IncomesGrid_DataBinding" OnInitializeLayout="IncomesGrid_InitializeLayout"
                            SkinID="UltraWebGrid" OnInitializeRow="IncomesGrid_InitializeRow">
                            <Bands>
                                <igtbl:UltraGridBand>
                ...
                <tr>
                    <td align="left">
                        <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Выбытия" Width="761px"
                            HrefReport="FO_0035_0022" />
                        <igtbl:UltraWebGrid ID="OutcomesGrid" runat="server" Height="200px" Width="509px"
                            OnDataBinding="OutcomesGrid_DataBinding" OnInitializeLayout="IncomesGrid_InitializeLayout"
                            SkinID="UltraWebGrid" OnInitializeRow="IncomesGrid_InitializeRow">
                            <Bands>
                                <igtbl:UltraGridBand>
                                    <AddNewRow View="NotSet" Visible="NotSet">
