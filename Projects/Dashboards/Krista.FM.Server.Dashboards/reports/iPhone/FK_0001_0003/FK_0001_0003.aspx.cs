...
{
    public partial class FK_0001_0003 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            UserParams.PeriodLastDate.Value = UserParams.PeriodDayFK.Value.Replace(UserParams.PeriodYear.Value, UserParams.PeriodLastYear.Value);
            ...
            string pointStr = (UserParams.ShortStateArea.Value == "јгинЅурјќ") ? string.Empty : ".";
            Label.Text = string.Format("–асходы {0} за {1} {2} {3}г{4}",
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FK_0001_0003");
            ...
            for (int i = 0; i < dt.Columns.Count; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 2:
                        {
                            k = 0.000001;
                            caption = "ѕлан, млн.руб.";
                            break;
                        }
                    case 7:
                        {
                            caption = string.Format("„исленность посто€нного населени€, тыс.чел. ({0})", populationDate);
                            break;
                        }
                    case 8:
                        {
                            k = 0.001;
                            caption = "<div style=\"line-height:15px;\">Ѕюджетные расходы на&nbsp;душу населени€,<br/>тыс.руб./чел.</div>";
                            break;
                        }
                    case 13:
                        {
            ...
            row = newDt.NewRow();
            row[0] = "“емп роста расходов к прошлому году";
        ...
        protected void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
            for (int i = 0; i < e.Row.Cells.Count; i++)
            {
                ...
                if (e.Row.Index == 1 || e.Row.Index == 6)
                {
                    ...
                    e.Row.Cells[0].Value = string.Format("ранг {4}&nbsp;{0}&nbsp;{1}&nbsp;&nbsp;ранг –‘&nbsp;{2}&nbsp;{3}", label1.Text, img1, label2.Text, img2, UserParams.ShortRegion.Value);
