...
{
    public partial class SE_0002_0008 : CustomReportPage
    {
        ...
        private void InitializeDate()
        {
            ...
            query = DataProvider.GetQueryText("SE_0002_0008_index");
        ...
        void UltraWebGrid1_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 2, "Ранг в РФ", String.Empty);
            ...
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 5, "Ранг в РФ", String.Empty);
            CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 7, "Доля в РФ, %", String.Empty);
        ...
        void UltraWebGrid1_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("SE_0002_0008_table1");
