<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MFRF_0002_0001_H.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.MFRF_0002_0001_H" %>
            ...
            <table style="left: 0px; position: absolute; top: 0px; border-collapse: collapse; width: 480px;">
                <tr>
                    ...
                    <asp:TextBox ID="LabelState" runat="server" CssClass="InformationText" SkinID="TextBoxInformationText"
                        Width="470px" ReadOnly="True"></asp:TextBox><br /><br />                                                 
