<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RG_0017_0002.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.RG_0017_0002" %>
...
<body style="background-color: black;">
	<form id="form1" runat="server">
		...
		<div style="position: absolute; width: 768px; height: 1290px; overflow: hidden; background-color: black; top: 0px; left: 0px; z-index: 2;">			
			...
			<div id="PoliticanGrid" runat="server" style="margin: 0 10px 15px 10px;">				
			</div>
