...
{
    public partial class FO_0033_0001 : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            dtSource.Rows[0][1] = String.Format("{0}", (Convert.ToDouble(dt.Rows[0][0])).ToString("N0"));
            dtSource.Rows[1][1] = String.Format("{0}", (Convert.ToDouble(dt.Rows[0][1])).ToString("N0"));
            dtSource.Rows[2][1] = String.Format("{0}", (Convert.ToDouble(dt.Rows[0][2])).ToString("N0"));
            dtSource.Rows[3][1] = String.Format("{0}", (Convert.ToDouble(dt.Rows[0][3])).ToString("N0"));
            dtSource.Rows[4][1] = String.Format("{0}", (Convert.ToDouble(dt.Rows[0][5])).ToString("N0"));
            dtSource.Rows[5][1] = String.Format("{0}", (Convert.ToDouble(dt.Rows[0][6])).ToString("N0"));
            dtSource.Rows[6][1] = String.Format("{0}", (Convert.ToDouble(dt.Rows[0][7])).ToString("P2"));
