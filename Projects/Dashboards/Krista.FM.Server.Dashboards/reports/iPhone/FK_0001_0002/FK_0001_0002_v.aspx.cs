...
{
    public partial class FK_0001_0002_v : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label3.Text = string.Format("ѕроцент исполнени€ плана по доходам и среднедушевые доходы (тыс.руб./чел.) за {0}&nbsp;{1}&nbsp;{2}&nbsp;года по субъектам {3}. –анг субъекта в {3}.",
                                        monthNum,
                                        monthStr,
                                        yearNum,
        ...
        protected void UltraWebGrid_InitializeLayout(object sender,LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 7)
            {
                ...
                AddColumnHeader(e.Layout, "—реднедуш. доходы", 0, 4, 2);
                ...
                e.Layout.Bands[0].Columns[2].Width = 54;
