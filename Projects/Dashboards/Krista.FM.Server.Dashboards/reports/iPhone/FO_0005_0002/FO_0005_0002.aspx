<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0005_0002.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0005_0002" %>
        ...
        <table style="border-collapse: collapse; background-color: Black; width: 764px; height: 100%;">
            ...
            <tr>
                ...
                <td style="font-size: 18px; font-family: Verdana; color: White; background-image: url(../../../images/iPadContainer/containerheader.gif);
                    ...
                    <asp:Label ID="Label16" runat="server" CssClass="ElementTitle" Text="Результат исполнения областного бюджета Новосибирской области<br/>в динамике, тыс.руб."></asp:Label>
                </td>
