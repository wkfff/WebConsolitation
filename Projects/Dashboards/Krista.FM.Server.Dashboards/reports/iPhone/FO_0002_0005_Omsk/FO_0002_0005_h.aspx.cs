...
{
    public partial class FO_0002_0005_Omsk_h : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            TextBox5.Text = string.Format("и плановые доходы на душу населения (тыс.руб./чел.)");

            TextBox6.Text = string.Format("за {0} {1} {2} года по {3}.", monthNum, monthStr, yearNum, RegionSettingsHelper.Instance.ShortName);
        ...
        {
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0002_0005_Omsk_h");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                const string executeColumnName = "План тыс.руб.";
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 7)
            {
                ...
                AddColumnHeader(e.Layout, "План.дох. на душу населения", 0, 5, 2);
