...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
	...
	/// детализация субъекта - сооружения (годовая динамика)
	/// </summary>
    public partial class Sport_0001_0012 : CustomReportPage
    {
    	public string TEMPORARY_URL_PREFIX = "../../..";
		public string REPORT_ID = "Sport_0001_0012";
    	...
    	protected override void Page_Load(object sender, EventArgs e)
        {
			...
			DataTable msTable = DataProvider.GetDataTableForChart("Sport_0001_0012_minsport", DataProvidersFactory.PrimaryMASDataProvider);
			msTable.InvertRowsOrder();
			DataTable fmTable = DataProvider.GetDataTableForChart("Sport_0001_0012_population", DataProvidersFactory.SecondaryMASDataProvider);
	...
	public class ChartProvide : ChartWrapper
	{
		...
		public new void SetStyleAndData()
		{
			...
			for (int i = 0; i < MsTable.Rows.Count; i++)
			{
				...
				if (CRHelper.DBValueIsEmpty(rawPopulation) || (CRHelper.DBValueIsEmpty(rawGymn) && CRHelper.DBValueIsEmpty(rawStad) && CRHelper.DBValueIsEmpty(rawSwim)))
					continue;
	...
	{
		public Sport_0001_0012 Page { set; get; }
		...
		protected override void SetStyle()
		{
			...
			GridBrick.Grid.Style.Add("color", "#fff");
		}
		...
		protected override void InitializeRow(object sender, RowEventArgs e)
		{
			...
			foreach (int columnIndex in (new[] { 1 }))
			{
				...
				{
					cell.Style.CustomRules = Helper.CellIndicatorStyle(55);
				}
			}
