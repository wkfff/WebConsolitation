<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0032_0001_V.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0032_0001_V" %>
...
<body>
    ...
    <div id="DIV1">
            <table style="width: 320px; height: 425px; border-right: 0px solid; border-top: 0px solid; left: 0px; border-left: 0px solid; border-bottom: 0px solid; position: absolute; top: 0px; border-collapse: collapse;">
        ...
        <tr><td colspan="2" style="background-color: black; border-right: 0px solid; border-top: 0px solid; padding-left: 5px; left: 0px; border-left: 0px solid; width: 314px; border-bottom: 0px solid; position: static; top: 195px; border-collapse: collapse; height: 211px;" valign="top">
            <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="200px" OnDataBinding="Grid_DataBinding"
                OnInitializeLayout="Grid_InitializeLayout" OnInitializeRow="Grid_InitializeRow"
                SkinID="UltraWebGrid" Width="537px">
                <Bands>
                    <igtbl:UltraGridBand>
                ...
                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                    ...
                    RowSelectorsDefault="NotSet" SelectTypeRowDefault="Extended" StationaryMargins="Header"
                    StationaryMarginsOutlookGroupBy="True" TableLayout="Fixed" Version="4.00" ViewType="OutlookGroupBy" CellClickActionDefault="RowSelect" ScrollBarView="Horizontal">
                    <GroupByBox>
                    ...
                    <RowSelectorStyleDefault BorderWidth="2px">
                    </RowSelectorStyleDefault>
                    <SelectedRowStyleDefault BackColor="#202020">
            ...
            <tr><td style="width: 315px; border-right: 0px solid; border-top: 0px solid; padding-left: 5px; background-image: url(../../../images/servePane.gif); border-left: 0px solid; border-bottom: 0px solid; background-repeat: repeat-x; border-collapse: collapse; height: 20px; left: 0px; position: static; top: 408px;" align="left" valign="top" colspan="2">
                 ...
                 <asp:Table ID="Table1" runat="server">
                             <asp:TableRow ID="TableRow1" runat="server">
                                 <asp:TableCell ID="TableCell1" runat="server"><asp:Label ID="Label" runat="server" SkinID="ServeText"></asp:Label><br />
