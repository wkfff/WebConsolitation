<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FST_0001_0011_Horizontal.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FST_0001_0011_Horizontal" %>
        ...
        <table>
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Ёлектроснабжение"
                        Width="100%" />
