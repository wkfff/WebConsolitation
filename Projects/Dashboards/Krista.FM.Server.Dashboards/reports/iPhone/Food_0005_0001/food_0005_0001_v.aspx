<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Food_0005_0001_v.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Food_0005_0001_v" %>
        ...
        <table style="background-color: black; width: 320px; height: 360px; border-right: 0px solid;
            ...
            <tr>
                <td valign="top" style="padding-left: 5px; width: 320px;">
                    <asp:Label ID="LabelInfo" runat="server" SkinID="InformationText"></asp:Label>
                </td>
            </tr>
            <tr>
                <td valign="top" style="padding-left: 5px; width: 320px">
