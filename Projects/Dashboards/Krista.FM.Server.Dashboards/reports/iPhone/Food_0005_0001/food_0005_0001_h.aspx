<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Food_0005_0001_h.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Food_0005_0001_h" %>
        ...
        <table style="background-color: black; width: 470px; height: 320px; border-right: 0px solid;
            ...
            <tr>
                <td valign="top" style="padding-left: 5px; width: 470px;">
                    <asp:Label ID="Label" runat="server" SkinID="InformationText"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
