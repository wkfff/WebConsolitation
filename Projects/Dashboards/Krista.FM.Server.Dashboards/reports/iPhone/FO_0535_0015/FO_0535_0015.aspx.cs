...
{
    public partial class FO_0535_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (UserParams.Mo.Value.Contains("г.") || UserParams.Mo.Value.Contains("р.п.") || UserParams.Mo.Value.ToLower().Contains("город ") || UserParams.Mo.Value.ToLower().Contains("знаменск"))
            {
                ...
                lbIncomesRankFO.Text = "ранг МО&nbsp;";
                lbOutcomesRankFO.Text = "ранг МО&nbsp;";
                lbIncomesRankFOAverage.Text = "ранг МО&nbsp;";
                lbOutcomesRankFOAverage.Text = "ранг МО&nbsp;";
                worseRank = 28;
            }
            else
            {
                ...
                settlementsDiv.Visible = false;
                lbIncomesRankFO.Text = "ранг МО&nbsp;";
                lbOutcomesRankFO.Text = "ранг MО&nbsp;";
                lbIncomesRankFOAverage.Text = "ранг MО&nbsp;";
                lbOutcomesRankFOAverage.Text = "ранг MО&nbsp;";
                worseRank = 28;
            }

            CustomParam populationDate = UserParams.CustomParam("population_date");
            DataTable dtPopulationDate = new DataTable();
            string query = DataProvider.GetQueryText("FO_0535_0015_population_date");
            DataProvidersFactory.SpareMASDataProvider.GetDataTableForChart(query, "dummy", dtPopulationDate);
            populationDate.Value = dtPopulationDate.Rows[0][1].ToString();
            DataTable dtPopulation = new DataTable();
            query = DataProvider.GetQueryText("FO_0535_0015_population");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_incomes_date");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_outcomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_credit_debts");
        ...
        private void InitializePopulation()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0535_0015_population_allMO");
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0535_0015_Incomes");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_Incomes_allMO");
            ...
            calc.ItemsToLog();
            img1 = String.Empty;
            if (calc.GetRank(Convert.ToDouble(dt.Rows[0]["Факт"]) / Convert.ToDouble(dt.Rows[0]["Численность постоянного населения"].ToString())) == 1)
            {
                img1 = string.Format("<img src=\"../../../images/starYellow.png\">");
            }
            else if (calc.GetRank(Convert.ToDouble(dt.Rows[0]["Факт"]) / Convert.ToDouble(dt.Rows[0]["Численность постоянного населения"].ToString())) == worseRank)
            {
                img1 = string.Format("<img src=\"../../../images/starGray.png\">");
            }

            lbIncomesRankFOAverageValue.Text = String.Format("{0:N0}{1}&nbsp;", calc.GetRank(Convert.ToDouble(dt.Rows[0]["Факт"]) / Convert.ToDouble(dt.Rows[0]["Численность постоянного населения"].ToString())), img1);
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0535_0015_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_Outcomes_allMO");
            ...
            lbOutcomesRankFOAverageValue.Text = String.Format("{0:N0}{1}&nbsp;", calc.GetRank(Convert.ToDouble(dt.Rows[0]["Факт"]) / Convert.ToDouble(dt.Rows[0]["Численность постоянного населения"].ToString())), img1);
        ...
        private void InitializeBkku()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0535_0015_Inner_Debt");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_Incomes_without_BP");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_inner_fin_source");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_Deficite");
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0535_0015_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0535_0015_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0535_0015_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
        ...
        {
            DataTable dtDate = new DataTable();
            string query = DataProvider.GetQueryText("FO_0535_0015_incomes_date");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForPivotTable(query, dtDate);
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_Incomes_settlement");
            ...
            query = DataProvider.GetQueryText("FO_0535_0015_Outcomes_settlement");
        ...
        private void InitializeSettlement()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0535_0015_settlements_count");
