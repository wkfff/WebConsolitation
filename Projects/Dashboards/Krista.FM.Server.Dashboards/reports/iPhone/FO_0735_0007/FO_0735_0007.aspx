<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0735_0007.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0735_0007" %>
            ...
            <tr>
                <td valign="top" style="padding-top: 0px;" colspan="3">
                    <asp:Table ID="detailTable" runat="server" BackColor="Black" BorderColor="#323232"
                        BorderStyle="Solid" BorderWidth="1px" GridLines="Both" Width="760px">
                    </asp:Table>
                </td>
            </tr>
        </table>
