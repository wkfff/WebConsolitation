<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0037_0001_V.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0037_0001_V" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width: 320px; height: 360px; border-right: 0px solid; border-top: 0px solid; left: 0px;
                ...
                <tr>
                    <td align="left" valign="top" style="left: 0px; width: 110px; position: static; top: 45px; border-collapse: collapse;
                        height: 150px; background-color: black; padding-left: 3px;">
                        ...
                        <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="200px" OnDataBinding="UltraWebGrid_DataBinding"
                            OnInitializeLayout="UltraWebGrid_InitializeLayout" Width="312px" OnInitializeRow="UltraWebGrid_InitializeRow"
                            SkinID="UltraWebGrid">
                            <Bands>
                                <igtbl:UltraGridBand>
                       ...
                       <br/>
                       <asp:Label ID="Label4" runat="server" Text="Label" SkinID="InformationText"></asp:Label>
                        <igtbl:UltraWebGrid ID="UltraWebGrid3" runat="server" Height="200px" OnDataBinding="UltraWebGrid3_DataBinding"
                            OnInitializeLayout="UltraWebGrid2_InitializeLayout" Width="312px" OnInitializeRow="UltraWebGrid_InitializeRow"
                            SkinID="UltraWebGrid">
                            <Bands>
                                <igtbl:UltraGridBand>
                                    <AddNewRow View="NotSet" Visible="NotSet">
