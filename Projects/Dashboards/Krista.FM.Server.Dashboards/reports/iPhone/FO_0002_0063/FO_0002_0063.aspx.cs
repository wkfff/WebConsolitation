...
{
    public partial class FO_0002_0063_1 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0002_0063_rests_date");
            ...
            query = DataProvider.GetQueryText("FO_0002_0063_table");
            ...
            for (int i = 0; i < dtTable.Rows.Count - 1; i++)
            {
                ...
                if (val1 != DBNull.Value)
                {
                    ...
                    if ((decimal)val1 < min1 && (decimal)val1!=0)
                    { min1 = (decimal)val1; }
                }
                if (val2 != DBNull.Value)
                {
                    ...
                    { max2 = (decimal)val2; }
                        ...
                        if ((decimal)val2 < min2 && (decimal)val2!=0)
                        { min2 = (decimal)val2; }
                }
                if (val3 != DBNull.Value)
                {
                    ...
                    { max3 = (decimal)val3; }
                        ...
                        if ((decimal)val3 < min3 && (decimal)val3 != 0)
                        { min3 = (decimal)val3; }
                }
            }
            ...
            lbDescription.Text =
                String.Format(
                    "Удельный вес расходов на содержание органов государственной власти в общем объеме расходов за&nbsp;<b><span class='DigitsValue'>{0}</span></b>&nbsp;год, тыс. руб.",
                    endYear);
        }
        ...
        void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
           ...
           /* if (e.Row.Cells[8].Value != null)
            {
                e.Row.Cells[0].Value = e.Row.Cells[8].Value;
            }*/
        ...
        void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            UltraWebGrid.Columns[8].Hidden = true;
            ...
            GridHeaderCell Cell = headerLayout.AddCell("Расходы на содержание органов государственной власти");
            Cell.AddCell("Всего");
        ...
        void setMinMax(RowEventArgs e, int i, decimal min, decimal max)
        {
            ...
            e.Row.Cells[i].Style.CustomRules = "background-repeat: no-repeat; background-position: 5% 40%; padding-left: 2px";
        }
    }
}