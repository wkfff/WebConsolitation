<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0003_0001.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0003_0001" %>
...
<body link="White" vlink="White" style="background-color: black;">
    ...
    <touchelementbounds src="../../../TemporaryImages/FO_0003_0001/TouchElementBounds.xml"></touchelementbounds>
        ...
        <table style="border-collapse: collapse">
                ...
                <td>
                    <table style="width: 765px">
                        <tr>
                            ...
                            <td>
                                <div runat="server" style="margin-top: 5px; margin-right: 15px" id="PersonImageContainer">
                                </div>
                            </td>
                            <td>
                                <div runat="server" style="margin-top: 5px" id="TwitterImageContainer">
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td>
                    ...
                    <div id="incomesIndicatorsDiv" runat="server" style="margin-left: 57px">
                    </div>
                    ...
                    <div id="outcomesIndicatorsDiv" runat="server" style="margin-left: 57px">
                    </div>
