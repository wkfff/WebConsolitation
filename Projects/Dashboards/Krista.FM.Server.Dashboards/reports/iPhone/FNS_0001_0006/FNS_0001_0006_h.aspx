<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FNS_0001_0006_h.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FNS_0001_0006_h" %>
            ...
            <table style="left: 0px; position: absolute; top: 0px; border-collapse: collapse;">
                <tr>
                    <td style="width: 480px; height: 360px; border-right: lime 0px solid; border-top: lime 0px solid;
                        ...
                        background-color: black; left: 0px; top: 0px; padding-left: 3px; border-collapse: collapse;"
                        ...
                        <igtbl:UltraWebGrid ID="UltraWebGrid" runat="server" Height="200px" OnDataBinding="UltraWebGrid_DataBinding"
                            OnInitializeLayout="UltraWebGrid_InitializeLayout" SkinID="UltraWebGrid" Width="475px"
