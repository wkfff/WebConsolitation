<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oil_0007_0003.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.Oil_0007_0003" %>
...
<body style="background-color: black;">
    ...
    <touchelementbounds src="../../../TemporaryImages/OIL_0007_0003/TouchElementBounds.xml"></touchelementbounds>
    <div style="position: absolute; width: 768px; height: 1250px; background-color: black;
        ...
        <table style="width: 768px; height: 900; border-collapse: collapse; background-color: Black;
            ...
            <tr>
                <td align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader4" runat="server" Text="Динамика розничных цен на дизельное топливо по ЯНАО"
                        Width="760px" />
                    ...
                    <table style="border-collapse: collapse; width: 760px; margin-top: -10px" runat="server"
                        id="headerTable">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 18px; font-family: Verdana; color: White; background-image: url(../../../images/iPadContainer/containerheader.gif);
                                ...
                                <table style="border-collapse: collapse; width: 100%">
                                    <tr>
                                        <td style="width: 100%">
                                            <asp:Label ID="elementCaption" runat="server" CssClass="ElementTitle" Text="Сравнение средней цены по МО ЯНАО"></asp:Label>
                                        </td>
                                        <td valign="top">
