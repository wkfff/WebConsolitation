...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
    ...
    {       
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label3.Text = String.Format("Темп роста фактических показателей исполнения бюджета за {0} {1} {2} г.<br/>к аналогичному периоду предыдущего года по ВологО", monthNum, CRHelper.RusManyMonthGenitive(monthNum), yearNum);
        ...
        void UltraWebGrid1_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            GridHeaderCell childCell = cell.AddCell("Темп роста к прошлому");
            childCell.AddCell("году");
            childCell.AddCell("мес.");            
