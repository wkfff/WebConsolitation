<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FST_0001_0033_Horizontal.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FST_0001_0033_Horizontal" %>
            ...
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Водоснабжение (среднеотпускной тариф)"
                        Width="100%" />
                    <uc2:FST_0001_0003_Text ID="TagCloudFST_0001_0033_Horizontal_Text1" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Водоснабжение (тариф для населения)"
                        Width="100%" />
                    <uc2:FST_0001_0003_Text ID="TagCloudFST_0001_0033_Horizontal_Text2" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader4" runat="server" Text="Водоснабжение (тариф для бюджетных потребителей)"
                        Width="100%" />
                    <uc2:FST_0001_0003_Text ID="TagCloudFST_0001_0033_Horizontal_Text3" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="text-align: left; background-color: Black;" align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadElementHeader5" runat="server" Text="Водоснабжение (тариф для прочих потребителей)"
                        Width="100%" />
                    <uc2:FST_0001_0003_Text ID="TagCloudFST_0001_0033_Horizontal_Text4" runat="server" />
                </td>
            </tr>
        </table>
    </div>
