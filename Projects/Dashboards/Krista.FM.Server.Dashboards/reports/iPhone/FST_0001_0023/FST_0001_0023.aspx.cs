...
{
    public partial class FST_0001_0023 : CustomReportPage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            base.Page_Load(sender, e);

            string measureName = "руб./Гкал.";

            UltraChartGrownTemp.Width = 768;
            ...
            string query = DataProvider.GetQueryText("FST_0001_0023_Chart");
            ...
            TagCloudFST_0001_0023_Text2.TaxName = "тариф для населения";
            TagCloudFST_0001_0023_Text3.TaxName = "тариф для бюджетных потребителей";
            TagCloudFST_0001_0023_Text4.TaxName = "тариф для прочих потребителей";

            SetChart(TagCloudFST_0001_0023_Text1, "1", measureName);
            SetChart(TagCloudFST_0001_0023_Text2, "2", measureName);
            SetChart(TagCloudFST_0001_0023_Text3, "3", measureName);
            SetChart(TagCloudFST_0001_0023_Text4, "4", measureName);
        }
        ...
        {
            chart.Style.Add("margin-left", "-7px");
        ...
        private void AddLineAppearencesUltraChart(UltraChart chart)
        {
            ...
            appearance.HorizontalAlign = StringAlignment.Center;
        ...
        private void SetChart(Dashboard.FST_0001_0003_Text textElement, string filter, string measure)
        {
            ...
            string chartQuery = DataProvider.GetQueryText(String.Format("FST_0001_0023_gauge{0}", filter));
            string textQuery = DataProvider.GetQueryText(String.Format("FST_0001_0023_text{0}", filter));            
