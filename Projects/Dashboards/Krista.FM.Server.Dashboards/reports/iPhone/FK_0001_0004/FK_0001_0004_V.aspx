<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FK_0001_0004_V.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FK_0001_0004_V" %>
...
<body>
    ...
    <div>
        ...
        <tr><td align="left" valign="top" style="left: 0px; width: 110px; position: static; top: 45px; border-collapse: collapse; height: 150px; background-color: black; padding-left: 3px;">
            ...
            <igtbl:ultrawebgrid id="UltraWebGrid" runat="server" height="200px" ondatabinding="UltraWebGrid_DataBinding"
                oninitializelayout="UltraWebGrid_InitializeLayout" width="312px" OnInitializeRow="UltraWebGrid_InitializeRow" SkinID="UltraWebGrid"><Bands>
<igtbl:UltraGridBand>
...
<FrameStyle BorderWidth="1px" BorderColor="InactiveCaption" BorderStyle="Solid" Font-Size="8.25pt" Font-Names="Microsoft Sans Serif" BackColor="Window" Width="312px" Height="200px"></FrameStyle>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
            ...
            <asp:Label ID="Label4" runat="server" SkinID="ServeText" Text="Label"></asp:Label><br /><br /></td></tr>
