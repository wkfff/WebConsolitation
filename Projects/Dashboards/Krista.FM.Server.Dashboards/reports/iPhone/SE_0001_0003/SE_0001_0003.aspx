<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SE_0001_0003.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.SE_0001_0003" %>
    ...
    <form id="form1" runat="server">
        <div style="position: absolute; width: 768px; height: 900px; background-color: black; top: 0px; left: 0px;">
            <table style="position: absolute; width: 768; height: 900; background-color: Black; top: 0px; left: 0px">
                <tr>
                    <td>
                        <uc3:SE_0001_0002_DynamicsChart ID="UltraChartSE_0001_0002_DynamicsChart1" runat="server"  QueryName="SE_0001_0003_chart5" Text="Динамика индекса промышленного производства" Width="760px" />
                    </td>
                </tr>
                 <tr>
                    <td>
                        <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Сравнение индекса промышленного производства" Width="760px" />
                        ...
                        <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Индекс промышленного производства по видам деятельности"  Width="760px"/>
                         <igtbl:UltraWebGrid ID="UltraWebGrid2" runat="server" Height="200px" Width="509px" SkinID="UltraWebGrid">
                            <Bands>
                                <igtbl:UltraGridBand>
                                    <AddNewRow View="NotSet" Visible="NotSet">
                                    </AddNewRow>
