<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FST_0001_0012_Horizontal.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FST_0001_0012_Horizontal" %>
...
<body style="background-color: Black">
    ...
    <div style="position: absolute;   width: 1022px; height: 100%; top: 0px; left: 0px;
        z-index: 2;">
        <table style="position: absolute; background-color: Black; top: 0px;
            left: 0px; overflow: hidden;">            
            <tr>
                <td>
                <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="Электроснабжение (среднеотпускной тариф)"
                        Width="100%" />
            ...
            <tr>
                <td>
                <uc1:iPadElementHeader ID="IPadElementHeader3" runat="server" Text="Электроснабжение (тариф для населения)"
                        Width="100%" />
