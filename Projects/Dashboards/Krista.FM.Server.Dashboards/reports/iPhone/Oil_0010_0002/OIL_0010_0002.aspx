<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oil_0010_0002.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.Oil_0010_0002" %>
...
<body link="White" vlink="White" style="background-color: black;">
    ...
    <div style="position: absolute; width: 768px; background-color: black;
       ...
       <uc1:iPadElementHeader ID="OilHeader1" runat="server" Width="100%" />
       ...
       <uc1:iPadElementHeader ID="OilHeader2" runat="server" Width="100%" />
