<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0635_0015.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0635_0015" %>
                                        ...
                                        <td style="overflow: visible; background-color: Black">
                                            ...
                                            <div style="margin-left: 15px; margin-top: -1px">
                                                <div style="margin-top: -1px">
                                                    ...
                                                    <asp:Label ID="lbIncomesAverageTitle" runat="server" SkinID="InformationText" Text="Плановые&nbsp;доходы&nbsp;на душу нас.&nbsp;"></asp:Label>
                                    ...
                                    <tr>
                                        <td style="overflow: visible; background-color: Black">
                                            ...
                                            <div style="margin-left: 10px; margin-top: -1px">
                                                <div style="margin-top: -1px">
                                                    <asp:Label ID="lbOutcomesAverageTitle" runat="server" SkinID="InformationText" Text="Плановые расходы на душу населения&nbsp;"></asp:Label>
