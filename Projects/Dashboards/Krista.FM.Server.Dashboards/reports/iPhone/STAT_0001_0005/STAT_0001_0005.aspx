<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="STAT_0001_0005.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.STAT_0001_0005" %>
...
<body style="background-color: black;">
    ...
    <div style="position: absolute; width: 758px; height: 950px; background-color: black;
        ...
        <div style="position: absolute; width: 315px; height: 120px; background-color: transparent;
            top: 50px; left: 437px; z-index: 20; overflow: hidden; background-image: url(../../../images/peoples.png);
            background-repeat: repeat-x">
        </div>
        <div style="position: absolute; width: 315px; height: 120px; background-color: transparent;
            top: 430px; left: 437px; z-index: 20; overflow: hidden; background-image: url(../../../images/peoples.png);
            background-repeat: repeat-x">
        </div>
