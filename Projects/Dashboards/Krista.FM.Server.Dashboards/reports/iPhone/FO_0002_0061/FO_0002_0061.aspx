<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0002_0061.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0002_0061_1" %>
        ...
        <div style="position: absolute; width: 768px; height: 950px; background-color: black; top: 0px; left: 0px;
            ...
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    ...
                    Ц максимальна€ дол€ расходов на содержание ќћ—”
                </td>
            </tr>
            <tr>
                <td style="color: White; font-family: Verdana; font-size: 16px; border-color: #323232;
                    ...
                    background-repeat: no-repeat; background-position: 2% center; padding-left: 58px;">
                    Ц минимальна€ дол€ расходов на содержание ќћ—”
                </td>
            </tr>
            <tr>
                <td>
