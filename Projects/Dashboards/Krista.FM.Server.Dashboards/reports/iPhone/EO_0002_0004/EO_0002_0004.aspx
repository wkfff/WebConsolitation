<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EO_0002_0004.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.EO_0002_0004" %>
...
<body style="background-color: black;">
    ...
    <div style="position: absolute; width: 768px; height: 148px; background-color: black;
        ...
        <table>
            <tr>
                <td>
                    <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Исполнение целевых программ, млн.руб."
                        Width="760px" />
                </td>
            </tr>
            <tr>
