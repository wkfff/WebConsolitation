<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MFRF_0004_0003_V.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.MFRF_0004_0003_V" %>
...
<body>
    ...
    <div>
        ...
        <tr><td runat="server" ID="mainTD" align="left" valign="top" style="left: 0px; width: 110px; position: static; top: 45px; border-collapse: collapse; background-color: black; padding-left: 4px;">
            ...
            <asp:Label ID="Label4" runat="server" SkinID="ServeText" Text="Label"></asp:Label><br /></td></tr>
