...
{
    public partial class FO_0235_0015 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0235_0015_incomes_date");
            ...
            bool normalFoRankCount = Convert.ToBoolean(RegionSettingsHelper.Instance.GetPropertyValue("NormalFoRankCount"));
            ...
            query = DataProvider.GetQueryText("FO_0235_0015_mr_count");
            ...
            query = DataProvider.GetQueryText("FO_0235_0015_go_count");
            ...
            query = DataProvider.GetQueryText("FO_0235_0015_population_date");
            ...
            query = DataProvider.GetQueryText("FO_0235_0015_population");
            ...
            query = DataProvider.GetQueryText("FO_0235_0015_credit_debts");
        ...
        private void InitializeIncomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0235_0015_Incomes");
        ...
        private void InitializeOutcomes()
        {
            ...
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0235_0015_Outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dt);
        ...
        private void InitializeBkku()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0235_0015_Inner_Debt");
            ...
            query = DataProvider.GetQueryText("FO_0235_0015_Outcomes_debt");
            ...
            Double.TryParse(dtInnerDebt.Rows[1][1].ToString(), out creditCredits);
        ...
        protected void UltraWebGridBudget_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0235_0015_budget_incomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", dt);

            DataTable source = new DataTable();

            query = DataProvider.GetQueryText("FO_0235_0015_budget_outcomes_all");
            ...
            query = DataProvider.GetQueryText("FO_0235_0015_budget_outcomes");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
            ...
            source = new DataTable();
            query = DataProvider.GetQueryText("FO_0235_0015_budget_deficite");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Показатель", source);
       ...
       // private bool fns28nSplitting;
        ...
        void UltraWebGridSettlements_DataBinding(object sender, EventArgs e)
        {
            ...
            string query = DataProvider.GetQueryText("FO_0235_0015_Incomes_settlement");
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, " ", dtIncomes);

            DataTable dtOutcomes = new DataTable();
            query = DataProvider.GetQueryText("FO_0235_0015_Outcomes_settlement");
        ...
        private void InitializeSettlement()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0235_0015_settlements_count");
