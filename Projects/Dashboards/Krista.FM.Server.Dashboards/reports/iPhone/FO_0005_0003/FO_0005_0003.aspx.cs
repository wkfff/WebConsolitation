...
{
    public partial class FO_0005_0003 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            BindChartData("ChartOutcomesAll");
             ...
             Label16.Text = String.Format("Динамика структуры государственного внутреннего долга<br/>Новосибирской области на&nbsp;{0:dd.MM.yyyy}, тыс.руб.",
                    date.AddMonths(1));
        }
