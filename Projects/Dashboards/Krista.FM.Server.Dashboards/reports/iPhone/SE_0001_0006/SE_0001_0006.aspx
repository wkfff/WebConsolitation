<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SE_0001_0006.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.SE_0001_0006" %>
    ...
    <form id="form1" runat="server">
        <div style="position: absolute; width: 768px; height: 900px; background-color: black; top: 0px; left: 0px;">
            <table style="position: absolute; width: 768; height: 900; background-color: Black; top: 0px; left: 0px">
                <tr>
                    <td>
                        <uc3:SE_0001_0002_DynamicsChart ID="UltraChartSE_0001_0002_DynamicsChart1" runat="server" QueryName="SE_0001_0006_chart5"
                            Text="Динамика индекса производства электроэнергии, газа и воды" Width="760px" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="Сравнение индекса производства электроэнергии, газа и воды"
                            Width="760px" />
