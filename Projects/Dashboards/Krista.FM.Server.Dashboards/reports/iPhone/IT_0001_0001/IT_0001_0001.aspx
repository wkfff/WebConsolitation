<%@ Page Language="C#" AutoEventWireup="true" Codebehind="IT_0001_0001.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.IT_0001_0001" %>
...
function UltraChartMarketSegments_ClientOnMouseOver(this_ref, row, column, value, row_label, column_label, evt_type, layer_id)
{
	var DetalizationIdSpan = document.getElementById('DetalizationId'); 
	var DetalizationReportId = "IT_0001_0002_"
	if (row_label.indexOf("Аппаратное") != -1)
	{
	    DetalizationReportId = 1;
	}
	else if (row_label.indexOf("Программное") != -1)
	{
	    DetalizationReportId = 2;
	}
	else if (row_label.indexOf("услуги") != -1)
	{
	    DetalizationReportId = 3;
	}
	DetalizationIdSpan.innerText = "webcommand?showPopoverReport=IT_0001_0002_IT=" + DetalizationReportId + "&width=500&height=450";	
}

function GetDetalizationId()
{
	var DetalizationIdSpan = document.getElementById('DetalizationId'); 
	var DetalizationId = DetalizationIdSpan.innerText;
	DetalizationIdSpan.innerText = "";
	return DetalizationId;
}
// -->
</SCRIPT>
                        ...
                        <table style="border-collapse: collapse; background-color: Black; width: 760px; height: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="headerReport">
                                    <asp:Label ID="ActionsElementCaption" runat="server" CssClass="ElementTitle" Text="Темп роста ИТ-рынка"></asp:Label>
                                </td>
                    ...
                    <td align="left" valign="top">
                        <table style="border-collapse: collapse; background-color: Black; width: 760px; height: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="headerReport">
                                    <asp:Label ID="Label1" runat="server" CssClass="ElementTitle" Text="Объем сегментов внутреннего ИТ-рынка в 2009 году"></asp:Label>
                                </td>
                                <td class="headerright">
                                </td>
                            </tr>
                ...
                <tr>
                    <td>
                        <table style="border-collapse: collapse; width: 758px;">
                            ...
                            <tr>
                                <td align="right" class="InformationTextLarge" style="text-align: right;"><br/><br/>
