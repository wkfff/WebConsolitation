<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Sport_0001_0001.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.Sport_0001_0001" %>
	...
	<form id="form1" runat="server">
		...
		<div style="position: absolute; width: 768px; height: 950px; background-color: black; top: 0px; left: 0px; z-index: 2;">
			...
			<div style="position: relative;">
				...
				<div style="position: absolute; top: 5px; right: 58px;"><a href="" id="SporterDetailTerra" runat="server"><img src="../../../images/detail.png"/></a></div>
			...
			<div style="position: relative;">
				...
				<div style="position: absolute; top: 5px; right: 58px;"><a href="" id="StaffDetailTerra" runat="server"><img src="../../../images/detail.png"/></a></div>
			...
			<div style="margin-bottom: 20px;">
				...
				<div style="float: left; width: 480px;"><asp:Label ID="StaffText" runat="server" SkinID="InformationText"/></div>
				<div style="clear: both;"></div>
			</div>
			
			<div style="position: relative;">
				<uc:iPadElementHeader ID="RecreationHeader" runat="server" Width="100%" />
				<div style="position: absolute; top: 5px; right: 58px;"><a href="" id="RecreationDetailTerra" runat="server"><img src="../../../images/detail.png"/></a></div>
