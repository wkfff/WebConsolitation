<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FK_0001_0001_wm2_v.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FK_0001_0001_wm2_v" %>
...
<body bgcolor="black">
    ...
    <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
        ...
        SkinID="UltraWebColumnChart" Version="8.2" Width="311px">
    ...
    <table>
        <tr>
            <td style="width: 430px; border-right: 0px solid; border-top: 0px solid; border-left: 0px solid;
