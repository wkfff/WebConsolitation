<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FK_0001_0001_wm1_v.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FK_0001_0001_wm1_v" %>
...
<body bgcolor="pink">
    ...
    <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
        ...
        Height="323px" SkinID="UltraWebColumnChart" Version="8.2" Width="313px" JavaScriptEnabled="False">
    ...
    <table>
        <tr>
            <td style="width: 220px; border-right: 0px solid; border-top: 0px solid; padding-left: 5px;
