...
{
    public partial class MFRF_0001_0005_wm1 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            //UltraChart.Width = 225;
            //UltraChart.Height = 215;

            UltraChart.Width = 226; 
            UltraChart.Height = 226;
            ...
            UltraChart.Axis.Y.Labels.Font = new Font("Verdana", fontSize);
            UltraChart.TitleLeft.Font = new Font("Verdana", fontSize);
            ...
            //UltraChart.BackColor = Color.Aqua;

            UltraChart.Axis.X.Labels.Visible = false;
            UltraChart.Axis.X.Labels.SeriesLabels.FontSizeBestFit = false;
            UltraChart.Axis.X.Labels.SeriesLabels.Font = new Font("Verdana", fontSize);
        }
        ...
        protected void UltraChart_FillSceneGraph(object sender, Infragistics.UltraChart.Shared.Events.FillSceneGraphEventArgs e)
        {
            for (int i = 0; i < e.SceneGraph.Count; i++)
            {
                ...
                if (primitive is Text && primitive.Path != null && primitive.Path.Contains("Grid.X"))
                {
                    ...
                    text.labelStyle.Font = new Font("Verdana", fontSize);
