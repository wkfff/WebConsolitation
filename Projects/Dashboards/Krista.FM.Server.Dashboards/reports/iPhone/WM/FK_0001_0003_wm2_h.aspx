<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FK_0001_0003_wm2_h.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FK_0001_0003_wm2_h" %>
...
<body bgcolor="black">
    <table style="width:100%; border-collapse: collapse;">
        ...
        <tr>
            <td style="width:100%;">
                <asp:Label ID="LabelComments1" runat="server" SkinID="InformationText" Text="Label"></asp:Label>
            </td>
        </tr>
        <tr>
