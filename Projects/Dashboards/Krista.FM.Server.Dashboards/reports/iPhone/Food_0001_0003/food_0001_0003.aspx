<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="food_0001_0003.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.Food_0001_0003" %>
...
<body style="background-color: black;">
    ...
    <touchelementbounds src="../../../TemporaryImages/Food_0001_0003/TouchElementBounds.xml"></touchelementbounds>
        ...
        <table>
            <tr>
                <td align="left" valign="top">
                    <uc1:iPadElementHeader ID="IPadUltraChart1Header" runat="server" Text="Динамика средней розничной цены по ХМАО-Югре"
                        Width="760px" />
                        ...
                        <tr>
                            ...
                            <td style="font-size: 18px; font-family: Verdana; color: White; background-image: url(../../../images/iPadContainer/containerheader.gif);
                                ...
                                <table style="border-collapse: collapse; width: 100%; margin-top: -5px">
                                    <tr>
                                        <td style="width: 100%">
                                            <asp:Label ID="elementCaption" runat="server" CssClass="ElementTitle" Text="Сравнение цен по МО ХМАО-Югры"></asp:Label>
                                        </td>
                                        <td valign="top">
