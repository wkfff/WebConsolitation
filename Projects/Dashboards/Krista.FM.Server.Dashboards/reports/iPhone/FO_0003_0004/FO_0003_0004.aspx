<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FO_0003_0004.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0003_0004" %>
...
<body style="background-color: black;">
    ...
    <div id="container">
        <div id="content">
            <div style="width: 2500px; height: 1405px;">
    ...
    <div id="header">
        <igtbl:UltraWebGrid ID="UltraWebGrid3" runat="server" Height="200px" Width="509px"
            SkinID="UltraWebGrid">
            <Bands>
                <igtbl:UltraGridBand>
                    <AddNewRow View="NotSet" Visible="NotSet">
