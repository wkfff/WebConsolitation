...
{
    public partial class FO_0003_0004 : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            SetupGrid(UltraWebGrid1, "FO_0003_0004_incomes");
            SetupGrid(UltraWebGrid2, "FO_0003_0004_incomes");
            SetupGrid(UltraWebGrid3, "FO_0003_0004_incomes");
        ...
        void UltraWebGridIncomes_InitializeRow(object sender, RowEventArgs e)
        {
                ...
                e.Row.Cells[0].Value.ToString().Contains("дефицит"))
            {
                ...
                SetConditionCorner(e, 11);
                SetConditionCorner(e, 12);
                SetConditionCorner(e, 14);
                SetConditionCorner(e, 15);
                SetConditionCorner(e, 19);                
            }
        }
