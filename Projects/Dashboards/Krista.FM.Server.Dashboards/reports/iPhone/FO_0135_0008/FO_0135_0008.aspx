<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FO_0135_0008.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.FO_0135_0008" %>
        ...
        <table style="border-collapse: collapse; background-color: #a8a8a8; width: 670px; height: 100%;">            
            ...
            <tr>
                <td valign="top" style="padding-top: 0px;" colspan="3">
                    <asp:Table ID="detailTable" runat="server" Width="675px">
                    </asp:Table>
                </td>
            </tr>
        </table>
