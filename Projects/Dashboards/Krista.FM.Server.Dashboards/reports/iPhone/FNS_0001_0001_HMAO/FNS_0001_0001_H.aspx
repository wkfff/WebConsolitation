                        ...
                        <table>
                            <tr>
                                <td style="color: white; font-size: 16px;vertical-align: top;">
                                    <b>5</b></td>
                                <td>
                                    <asp:TextBox ID="WeightLabel" runat="server" CssClass="InformationText" SkinID="TextBoxInformationText"
                                        Width="400px" ReadOnly="True"></asp:TextBox>
                                    <asp:TextBox ID="WeightBudgetLabel" runat="server" CssClass="InformationText" SkinID="TextBoxInformationText"
                                        Width="400px" ReadOnly="True">   </asp:TextBox>                                      
                                         </td>
                            </tr>
                        </table>
                        <igtbl:UltraWebGrid ID="WeightGrid" runat="server" EnableViewState="False" Height="200px"
                            SkinID="UltraWebGrid" Width="470px" OnDataBinding="WeightGrid_DataBinding" OnInitializeLayout="WeightGrid_InitializeLayout">
                            <Bands>
                                <igtbl:UltraGridBand>
                                    <AddNewRow View="NotSet" Visible="NotSet">
                                    </AddNewRow>
