...
//        }
        ...
        protected void UltraWebGrid_DataBinding(object sender, EventArgs e)
        {
            ...
            top5 = top5.Replace("Муниципальный район", "МР");
            top5Label.Text = string.Format("Наибольшая недоимка* по налоговым и неналоговым доходам:&nbsp;{0}", top5);
            commentLabel.Text = string.Format("<*> - недоимка с учетом неурегулированной задолженности по всем категориям налогоплательщиков");
        ...
        protected void Grid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            {
                e.Layout.Bands[0].Columns[0].Width = 102;
                e.Layout.Bands[0].Columns[1].Width = 102;
                e.Layout.Bands[0].Columns[2].Width = 107;
