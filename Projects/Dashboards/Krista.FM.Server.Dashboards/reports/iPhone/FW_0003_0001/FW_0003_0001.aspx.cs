...
{
    public partial class FW_0003_0001 : CustomReportPage
    {
        ...
        void grid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            e.Layout.Bands[0].Columns[0].Width = 154;
            ...
            cell = headerLayout.AddCell(String.Format("<table style='margin-left: 100px'><tr><td>Из них за {0}&nbsp;</td><td><a href='webcommand?showPinchReport=FW_0003_0002'><img src='../../../images/detail.png'></a></td></tr></table>", date.ToShortDateString()));
