...
{
    public partial class FO_0035_0036_h : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            dt2 = GetDataSource("FO_0035_0018_chart_rests");
            ...
            UltraChart2.Series.Add(CRHelper.GetNumericSeries(3, dt2));
            UltraChart2.Series.Add(CRHelper.GetNumericSeries(4, dt2));
            UltraChart2.DataBind();

            lbDescription.Text = "Остатки средств областного бюджета, свободных для распределения по направлениям финансирования";
        ...
        private void SetupChart2(UltraChart chart)
        {
            chart.Width = 485;
            chart.Height = 100;
            ...
            chart.Legend.SpanPercentage = 100;
            //chart.Legend.Margins.Left = -10;
