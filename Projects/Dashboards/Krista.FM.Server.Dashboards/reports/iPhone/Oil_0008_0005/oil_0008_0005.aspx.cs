...
{
    public partial class Oil_0008_0005 : CustomReportPage
    {
        ...
        private void InitializeTable1()
        {
            ...
            if (HttpContext.Current.Session["CurrentOilID"].ToString() != "5")
            {
                ...
                query = DataProvider.GetQueryText("Oil_0008_0005_incomes_federal_date");
                ...
                query = DataProvider.GetQueryText("Oil_0008_0005_table2");
            ...
            query = DataProvider.GetQueryText("Oil_0008_0005_incomes_regional_date");
            ...
            dt = new DataTable();
            query = DataProvider.GetQueryText("Oil_0008_0005_table1");
