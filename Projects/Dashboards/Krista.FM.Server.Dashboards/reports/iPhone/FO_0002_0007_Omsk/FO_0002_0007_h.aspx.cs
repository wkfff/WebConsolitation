...
{
    public partial class FO_0002_0007_Omsk_h : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            TextBox2.Text = string.Format("и плановые расходы на душу населения  (тыс.руб./чел.)");
        ...
        {
            dt = new DataTable();
            string query = DataProvider.GetQueryText("FO_0002_0007_Omsk_h");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 7)
            {
                ...
                AddColumnHeader(e.Layout, "План.расх. на душу населения", 0, 5, 2);
