<%@ Page Language="C#" AutoEventWireup="true" Codebehind="IT_0003_0001.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.iPhone.IT_0003_0001" %>
        ...
        <div style="position: absolute; width: 768px; height: 950px; top: 0px; left: 0px; z-index: 2; overflow: hidden">
                            ...
                            <tr>
                                <td align="left">
                                    <uc1:IT_0002_0001_IncomesGrid ID="IT_0002_0001_IncomesGrid1" runat="server" Width="377px" Text="Доходы за 1 полугодие 2010 года"
                                        QueryName="IT_0003_0001_incomes" ImageUrl="../Images/Incomes.png" DescriptionText="Доходы консолидированного бюджета составляют&nbsp;<span style='color: White'><b>{0:N0}</b></span>&nbsp;тыс.руб.">
                                ...
                                <td align="left">
                                    <uc1:IT_0002_0001_IncomesGrid ID="IT_0002_0001_IncomesGrid2" runat="server" Width="377px" Text="Расходы за 1 полугодие 2010 года"
                                        QueryName="IT_0003_0001_outcomes" ImageUrl="../Images/Outcomes.png" DescriptionText="Расходы консолидированного бюджета составляют&nbsp;<span style='color: White'><b>{0:N0}</b></span>&nbsp;тыс.руб.">
                                    </uc1:IT_0002_0001_IncomesGrid>
                                </td>
                            </tr>
                        </table>
            ...
            <table>
                <tr>
                    <td>
                       <div style="margin-top: -10px">
                            <uc5:UltraChartIT_0002_0001_Chart ID="UltraChartIT_0002_0001_Chart2" runat="server" QueryName="IT_0003_0001_Chart">
                ...
                <tr>
                    <td>
                    <div style="margin-top: -10px">
                        <uc3:IT_0003_0001_AssesmentGrid ID="IT_0003_0001_AssesmentGrid1" runat="server" Width="760px" Text="Показатели оценки деятельности за 1 полугодие 2010 года"
                            QueryName="IT_0003_0001_assesment" />
                            </div>
                    </td>
                </tr>               
            </table>
