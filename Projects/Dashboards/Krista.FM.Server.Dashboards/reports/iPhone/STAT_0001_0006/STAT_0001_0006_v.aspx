<%@ Page Language="C#" AutoEventWireup="true" Codebehind="STAT_0001_0006_v.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.iPad.STAT_0001_0006_v" %>
    ...
    <form id="form1" runat="server">
        <div style="position: absolute; width: 768px; background-color: black; top: 0px;
            ...
            <table style="width: 768; height: 900; border-collapse: collapse; background-color: Black;
                ...
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="IPadElementHeader2" runat="server" Text="ƒинамика уровн€ регистрируемой безработицы"
                            Width="100%" />
                ...
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="IPadElementHeader3" runat="server" Text="”ровень напр€женности на рынке труда"
                            Width="100%" />
                ...
                <tr>
                    <td>
                        <uc1:iPadElementHeader ID="IPadElementHeader1" runat="server" Text="«адолженность по выплате заработной платы"
                            Width="100%" />
