...
namespace Krista.FM.Server.Dashboards.reports.iPhone
{
    public partial class FO_0035_0035_v : CustomReportPage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Label3.Text = String.Format("Исполнение бюджета {1} по расходам на {0:dd.MM.yyyy} г.", currentDate, regionName);
        ...
        private void GridDataBind()
        {
            ...
            {
                string factColumnName = "Факт с начала  месяца ";
        ...
        protected void Grid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            headerLayout.AddCell("Факт /<br/>% исп.");
