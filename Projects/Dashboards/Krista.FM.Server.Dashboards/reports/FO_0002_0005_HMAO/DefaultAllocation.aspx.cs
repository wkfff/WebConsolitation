...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0005_HMAO
{
    public partial class DefaultAllocation : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.NavigateUrl = GetReportFullName("ФО_0002_0005_01");
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0005_HMAO_chart");
            dtChart = new DataTable();
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Субъект", dtChart);

            query = DataProvider.GetQueryText("FO_0002_0005_HMAO_allcation_population");
            ...
            query = DataProvider.GetQueryText("FO_0002_0005_HMAO_avg");
            dtAVG = new DataTable();
            ...
            {
                populationLabel.Text = string.Format("Численность постоянного населения <b>{0:N3}</b> тыс.чел.",
