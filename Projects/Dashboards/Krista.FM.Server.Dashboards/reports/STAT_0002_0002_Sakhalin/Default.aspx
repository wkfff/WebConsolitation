<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0002_0002_Sakhalin.Default" Title="Индикаторы БК и КУ " %>
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="ChartCaption" runat="server" CssClass="ElementTitle" Text= "Колебания показателя «Банковские максимальные/минимальные средневзвешенные ставки по кредитам» "></asp:Label>
            ...
            <td>
                    ...
                    <table style="border-collapse: collapse; background-color: white; width: 100%; margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text= "Колебания показателя «Банковские максимальные/минимальные средневзвешенные ставки по депозитам» "></asp:Label>
