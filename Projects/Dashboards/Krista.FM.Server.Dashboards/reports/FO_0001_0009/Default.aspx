<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0001_0009.Default" Title="Индикаторы БК и КУ " %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top">
                <td valign="top">
                    <uc3:CustomMultiCombo ID="ComboIncomes" runat="server"></uc3:CustomMultiCombo>
                </td>
            </td>
            <td valign="top">
                ...
                <table runat="server" id="ChartTable1" style="border-collapse: collapse; background-color: white;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption1" runat="server" CssClass="ElementTitle" Text="Структура доходов бюджетов"></asp:Label>
                        </td>
            ...
            <td>
                <table runat="server" id="Table1" style="border-collapse: collapse; background-color: white;
                    ...
                    <tr>
                        ...
                        <td class="headerReport">
                            <asp:Label ID="ChartCaption2" runat="server" CssClass="ElementTitle" Text="Структура налоговых доходов"></asp:Label>
                        </td>
                        <td class="headerright">
                        </td>
                    </tr>
