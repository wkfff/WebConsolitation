...
namespace Krista.FM.Server.Dashboards.reports.FO_0001_0009
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            UltraWebGrid.Width = CRHelper.GetGridWidth(CustomReportConst.minScreenWidth * 0.49);
            UltraWebGrid.Height = CRHelper.GetGridHeight(CustomReportConst.minScreenHeight * 0.21);
            UltraWebGrid1.Width = CRHelper.GetGridWidth(CustomReportConst.minScreenWidth * 0.50);
            UltraWebGrid1.Height = CRHelper.GetGridHeight(CustomReportConst.minScreenHeight * 0.21);
            ...
            UltraChart1.Legend.SpanPercentage = 34;
            ...
            UltraChart2.Height = CRHelper.GetChartHeight(CustomReportConst.minScreenHeight * 0.70);
            ...
            UltraChart2.Legend.SpanPercentage = 36;
            ...
            UltraChart1.ChartDrawItem += new ChartDrawItemEventHandler(UltraChart_ChartDrawItem);
            UltraChart2.ChartDrawItem += new ChartDrawItemEventHandler(UltraChart_ChartDrawItem);
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string queryName = "FO_0001_0009_date";
           ...
           Page.Title = "Структура доходов бюджетов";
           ...
           {
               queryName1 = "FO_0001_0009_compare_Grid1_1";
               queryName2 = "FO_0001_0009_compare_Grid2_1";
               queryChart1Name = "FO_0001_0009_compare_Chart1_1";
               queryChart2Name = "FO_0001_0009_compare_Chart2_1";
           ...
           {
               queryName1 = "FO_0001_0009_compare_Grid1_2";
               queryName2 = "FO_0001_0009_compare_Grid2_2";
               queryChart1Name = "FO_0001_0009_compare_Chart1_2";
               queryChart2Name = "FO_0001_0009_compare_Chart2_2";
               lab = "плановые данные";
               ComboIncomes.Visible = false;
               ComboMonth.Visible = true;
               ComboYear.Visible = true;
           ...
           {
               queryName1 = "FO_0001_0009_compare_Grid1_3";
               queryName2 = "FO_0001_0009_compare_Grid2_3";
               queryChart1Name = "FO_0001_0009_compare_Chart1_3";
               queryChart2Name = "FO_0001_0009_compare_Chart2_3";
               ...
               case "Местные бюджеты":
                   {
                       ...
                       {
                           level.Value = memb + ".[Конс.бюджет субъекта].[Конс.бюджет МО]";
                       }
                       break;
                   }
               ...
               case "Собственный бюджет субъекта":
                   {
                       ...
                       if (RList.SelectedIndex == 2)
                       {
                           level.Value = memb + ".[Конс.бюджет субъекта].[Бюджет субъекта]";
                       }
                       break;
                   }
               default:
          ...
          Label1.Text = "Структура доходов бюджетов";
        ...
        protected void UltraWebGrid1_DataBinding(object sender, EventArgs e)
        {
            ...
            DataProvidersFactory.PrimaryMASDataProvider.GetDataTableForChart(query, "Наименование доходов", dtGrid1);
        ...
        private static void FillIncomesCombo()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0001_0009_compare_Grid_Kind");
            ...
            query = DataProvider.GetQueryText("FO_0001_0009_compare_Grid_Kind_a");
        ...
        private static void FillOutcomesCombo()
        {
            ...
            string query = DataProvider.GetQueryText("FO_0001_0009_compare_Grid_Kinds");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            if (e.Layout.Bands[0].Columns.Count > 0)
            {
                ...
                {
                    e.Layout.Bands[0].Columns[k].Width = 140;
                ...
                if (RList.SelectedIndex == 0)
                {
                    e.Layout.Bands[0].Columns[1].Header.Caption = String.Format("Исполнено, {0}", units);
                    e.Layout.Bands[0].Columns[1].Header.Title = "Фактическое поступление доходов";
                    ...
                    if (RList.SelectedIndex == 1)
                    {
                        ...
                        e.Layout.Bands[0].Columns[1].Header.Title = "Плановые назначения доходов";
                        e.Layout.Bands[0].Columns[2].Header.Title = "Доля доходного источника в общей сумме доходов";
         
                    }else
                        if (RList.SelectedIndex == 2)
                        {
                            e.Layout.Bands[0].Columns[1].Header.Caption = String.Format("Проект, {0}", units);
                            e.Layout.Bands[0].Columns[1].Header.Title = "Проект доходов";
                            e.Layout.Bands[0].Columns[2].Header.Title = "Доля доходного источника в общей сумме доходов";

                        }

                ColumnHeader ch = new ColumnHeader(true);
                ch.Caption = "Доходы бюджетов";
                ch.Title = "";
        ...
        protected void UltraWebGrid_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            if (e.Row.Cells[i].Value != null && e.Row.Cells[i].Value.ToString() != string.Empty)
            {
                if (Convert.ToDouble(e.Row.Cells[i].Value) < 1)
                {
                    ...
                    e.Row.Cells[i].Title = "Снижение фактических доходов";
                }
                else if (Convert.ToDouble(e.Row.Cells[i].Value) > 1)
                {
                    e.Row.Cells[i].Style.BackgroundImage = "~/images/arrowGreenUpBB.png";
                    e.Row.Cells[i].Title = "Рост фактических доходов";
                }
            ...
            if ((e.Row.Index == 0) || (e.Row.Index == 1) || (e.Row.Index == 6)||(e.Row.Index == 13) || (e.Row.Index == 14))
            {
        ...
        protected void UltraWebGrid1_InitializeRow(object sender, RowEventArgs e)
        {
            ...
            if ((e.Row.Index < 4) || (e.Row.Index == 7) || (e.Row.Index == 8) || (e.Row.Index == 14))
            {
                e.Row.Cells[0].Style.Font.Bold = true;
            }
        }
        ...
        {
           if (e.CurrentWorksheet.Name.Contains("Доходы") )
           {
        ...
        private void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            Worksheet sheet2 = workbook.Worksheets.Add("Налоговые доходы");
            Worksheet sheet3 = workbook.Worksheets.Add("Доходы");
            Worksheet sheet4 = workbook.Worksheets.Add("Нал. доходы");
