<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports.Master" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.HMAO_ARC_001._default" %>
                                ...
                                <table style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; height: 360px;"><igmisc:WebAsyncRefreshPanel id = "WebAsyncRefreshPanel1" runat="server" LinkedRefreshControlID="PanelChart">
                                            ...
                                            <igchart:UltraChart ID="ChartPoint" runat="server" BackgroundImageFileName=""  
                                                 EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
