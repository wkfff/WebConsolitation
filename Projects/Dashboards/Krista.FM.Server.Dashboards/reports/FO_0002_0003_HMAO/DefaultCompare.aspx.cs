...
namespace Krista.FM.Server.Dashboards.reports.FO_0002_0003_HMAO
{
    public partial class DefaultCompare : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.NavigateUrl = "~/reports/FO_0002_0003_HMAO/DefaultCompareChart.aspx";
        ...
        {
            string query = DataProvider.GetQueryText("FO_0002_0003_HMAO_compare_grid");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            for (int i = 1; i < e.Layout.Bands[0].Columns.Count; i = i + 5)
            {
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i + 1,
                    String.Format("Исполнено за аналогичный период прошлого года, {0}", RubMiltiplierButtonList.SelectedValue), "Исполнено за аналогичный период прошлого года");
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i + 2, "Темп роста к аналогичному периоду прошлого года, %", "Темп роста исполнения к аналогичному периоду прошлого года");
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, i + 4, "Удельный вес в общей сумме доходов в аналогичном периоде прошлого года, %", "Удельный вес в общей сумме фактических доходов в прошлом году");
