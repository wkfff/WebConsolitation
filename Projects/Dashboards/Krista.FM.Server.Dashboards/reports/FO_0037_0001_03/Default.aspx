<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0037_0001_03.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;&nbsp;&nbsp;<asp:Label ID="incomesGridLabel" runat="server" Text="Label" CssClass="ElementSubTitle" Style="line-height: 30px;"></asp:Label>
            ...
            <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td style="overflow: visible;" align="right">
                         <asp:Label ID="dataItemCaption" runat="server" CssClass="ElementSubTitle"></asp:Label>
                    </td>
                    <td class="right">
                    </td>
                </tr>
