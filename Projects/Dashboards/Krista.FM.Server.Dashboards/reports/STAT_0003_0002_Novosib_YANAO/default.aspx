<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0003_0002_Novosib_YANAO.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                            <uc1:CustomMultiCombo ID="ComboCompareMode" runat="server">
                            </uc1:CustomMultiCombo>
                        </td>
                        <td valign="top">
    ...
    <table runat="server" id = "HTMLTABLETEXT" style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        <tr>
            <td class="topleft">
            </td>
            <td class="top">
