<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0063.Default" %>
                ...
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top" align="right" 
                            ...
                            style="font-family:Verdana; font-size:12px; padding-left:20px; width: 250px;">
                            <asp:RadioButtonList ID="RubMiltiplierButtonList" runat="server" 
                                AutoPostBack="True" RepeatDirection="horizontal"
                                Width="240px" style="font-family: Verdana; font-size: 12px;">
                                <asp:ListItem Selected="True">руб.</asp:ListItem>
