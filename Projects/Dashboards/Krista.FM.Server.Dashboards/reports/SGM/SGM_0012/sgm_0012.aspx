<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sgm_0012.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SGM.SGM_0012.sgm_0012" Title="Паспорт субъекта" MasterPageFile="~/Reports.Master" %>
...
<%@ Register Src="../../../Components/CustomMultiCombo.ascx" runat="server" TagName="CustomMultiCombo"
    TagPrefix="uc1" %>
<%@ Register Src="../../../Components/RefreshButton.ascx" runat="server" TagName="RefreshButton"
    TagPrefix="uc2" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <table>
            <tr>
                <td valign="top">
                    <uc1:CustomMultiCombo ID="ComboMap" runat="server" Title="Территория" Width="250" ParentSelect="false" />
                </td>
                <td valign="top">
    ...
    <table id="tableMeasure1" style="width: 707px">
        <tr>
            <td colspan="2">
                <asp:Label ID="LabelPart1Text" runat="server" CssClass="InformationText" Text="Label" Font-Names="Verdana" Font-Size="10pt"></asp:Label>&nbsp;
            </td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <td style="overflow: visible;">            
                <igchart:UltraChart ID="chart1" runat="server" BackgroundImageFileName=""  
                    ...
                    Height="217px" Version="9.1" Width="325px" SmoothingMode="HighQuality">
                    ...
                    <DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_sgm0012_01#SEQNUM(100).png" />
                </igchart:UltraChart>
        </td>
        <td class="right">
        </td>
    ...
    <tr>
        ...
        <td style="overflow: visible;">             
                <igchart:UltraChart ID="chart2" runat="server" BackgroundImageFileName=""  
                     ChartType="PieChart" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    Height="216px" Version="9.1" SmoothingMode="HighQuality">
                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" />
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" ModelStyle="CustomLinear">
                    </ColorModel>
                    ...
                    <PieChart OthersCategoryPercent="0" OthersCategoryText="Остальные">
                        <Labels FormatString="&lt;DATA_VALUE:#0.00&gt;%" />
                    </PieChart>
                    <DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_sgm0012_02#SEQNUM(100).png" />
                </igchart:UltraChart>
        </td>
        <td class="right">
        </td>
    ...
    <tr>
        ...
        <tr>
            <td colspan="2">
                <asp:Label ID="LabelPart2Text" runat="server" CssClass="InformationText" Text="Label" Font-Names="Verdana" Font-Size="10pt"></asp:Label></td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <td style="overflow: visible;">              
                <igchart:UltraChart ID="chart3" runat="server" BackgroundImageFileName=""  
                    ...
                    Height="209px" Version="9.1" Width="653px" OnFillSceneGraph="chart3_FillSceneGraph" ChartType="BarChart">
                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" />
                    <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" ModelStyle="CustomLinear">
                    </ColorModel>
                    ...
                    <Axis>
                        ...
                        <X LineThickness="1" TickmarkInterval="50" TickmarkStyle="Smart" Visible="True">
                            <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                Visible="False" />
                            <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                Visible="True" />
    ...
    <tr>
        ...
        <tr>
            <td colspan="2" align="left">
                <asp:Label ID="LabelPart3Text" runat="server" CssClass="InformationText" Text="Label" Font-Names="Verdana" Font-Size="10pt"></asp:Label></td>
        </tr>
    </table>
</asp:Content>
