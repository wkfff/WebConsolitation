<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="sgm_0010.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.sgm.sgm_0010.sgm_0010" Title="Соотношение объема расходов и заболеваемости населения" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td colspan="1" style="width: 100%;">
                ...
                <asp:Label ID="Label2" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label><br />
                <asp:Label ID="Label3" runat="server" Text="Label" CssClass="ElementSubTitle"></asp:Label><br />
                <asp:Label ID="Label4" runat="server" Text="Label" CssClass="ElementSubTitle"></asp:Label>
            </td>
    ...
    <table style="vertical-align: top;">
        <tr>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboYear" runat="server" MultiSelect="false" Title="Год"
                    Width="100"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboMonth" runat="server" MultiSelect="false" Title="Месяц"
                    Width="130"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboDesease" runat="server" ParentSelect="true" MultiSelect="true"
                    Title="Заболевания" Width="220"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboFO" runat="server" MultiSelect="false" Title="ФО"
                    Width="250"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                <uc3:CustomMultiCombo ID="ComboFKR" runat="server" MultiSelect="true" ParentSelect="true"
                    Title="РзПр" Width="350"></uc3:CustomMultiCombo>
            </td>
            <td valign="top">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <igchart:UltraChart ID="UltraChart" runat="server" BackgroundImageFileName=""  
                                ...
                                <DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_SGM0010#SEQNUM(100).png" />
                            </igchart:UltraChart>
                        </td>
                        <td class="right">
                        </td>
