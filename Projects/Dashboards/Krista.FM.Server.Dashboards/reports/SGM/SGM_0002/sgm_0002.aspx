<%@ Page Language="C#" AutoEventWireup="true" Codebehind="sgm_0002.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SGM.SGM_0002.sgm_0002"
    Title="Динамика по годам и прогнозирование заболеваемости" MasterPageFile="~/Reports.Master" %>
            ...
            <tr>
                <td align="left" valign="top">
                    <uc1:CustomMultiCombo ID="ComboMap" runat="server" MultiSelect="false" ParentSelect="true"
                        Title="Территория" Width="280" />
                </td>
                <td align="left" valign="top">
                    <uc1:CustomMultiCombo ID="ComboGroup" runat="server" MultiSelect="true" Title="Группа населения"
                        Width="200" />
                </td>
                <td align="left" valign="top">
                ...
                <td align="left" valign="top">
                    <uc1:CustomMultiCombo ID="ComboYear" runat="server" MultiSelect="true" Title="Года расчета"
                        Width="170" />
                </td>
                <td align="left" valign="top">
                    <uc1:CustomMultiCombo ID="ComboPlan" runat="server" MultiSelect="false" Title="Год прогноза"
                        Width="150" />
                </td>
                <td align="left" valign="top">
                            ...
                            <td style="overflow: visible;">
                                <igchart:UltraChart ID="chart" runat="server" BackgroundImageFileName=""  
                                    ...
                                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" FormatString="&lt;SERIES_LABEL&gt; на &lt;ITEM_LABEL&gt; год &lt;DATA_VALUE:00.##&gt; на 100 тыс. человек" />
