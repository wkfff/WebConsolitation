...
//            IndicateLink.NavigateUrl = "~/reports/FNS_0002_0001/DefaultIndicate.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                ComboRegion.FillDictionaryValues(CustomMultiComboDataHelper.FillTerritories(RegionsNamingHelper.LocalBudgetTypes, true, districtParamInclude));
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0002_0001_settlement_grid_split" : "FNS_0002_0001_settlement_grid";
            string query = DataProvider.GetQueryText(queryName);
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            if (e.Layout.Bands[0].Columns.Count > 14)
            {
                ...
                CRHelper.SetHeaderCaption(e.Layout.Grid, 0, 9,
                    string.Format("Ранг по темпу роста недоимки к {0} году", year),
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0002_0001_settlement_chart1_split" : "FNS_0002_0001_settlement_chart1";
            string query = DataProvider.GetQueryText(queryName);
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0002_0001_settlement_chart2_split" : "FNS_0002_0001_settlement_chart2";
            string query = DataProvider.GetQueryText(queryName);
