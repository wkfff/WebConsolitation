<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="DefaultRegions.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FNS_0002_0001.DefaultRegions" %>
            ...
            <td valign="top" align="left">
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="RegionCenterExclude" runat="server" Text="Без областного центра" AutoPostBack="true" Checked="false"
                                Style="font-family: Verdana; font-size: 10pt;" />
                        </td>
                        <td class="right">
                        </td>
