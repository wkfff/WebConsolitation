...
//            UltraChart2.Axis.X.StripLines.Visible = true;
            ...
            OKVDLink.NavigateUrl = "~/reports/FNS_0002_0001/DefaultKD.aspx";
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0002_0001_gridOKVD_split" : "FNS_0002_0001_gridOKVD";
            string query = DataProvider.GetQueryText(queryName);
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0002_0001_chartOKVD1_split" : "FNS_0002_0001_chartOKVD1";
            string query = DataProvider.GetQueryText(queryName);
...
//            }
        ...
        {
            string queryName = fns28nSplitting ? "FNS_0002_0001_chartOKVD2_split" : "FNS_0002_0001_chartOKVD2";
            string query = DataProvider.GetQueryText(queryName);
