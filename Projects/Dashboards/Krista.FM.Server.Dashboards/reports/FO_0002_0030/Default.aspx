<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0030.Default"  Title="Финансовый паспорт субъекта РФ" %>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                          <asp:Label ID="table1Captions" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label>
            ...
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                           <asp:Label ID="table2Captions" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label>
                            <igtbl:UltraWebGrid ID="UltraWebGrid2" runat="server" EnableAppStyling="True" Height="200px" 
                                OnDataBinding="UltraWebGrid2_DataBinding" OnInitializeLayout="UltraWebGrid2_InitializeLayout"
                                StyleSetName="Office2007Blue" SkinID="UltraWebGrid" Width="325px" OnInitializeRow="UltraWebGrid2_InitializeRow">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
            ...
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                           <asp:Label ID="table3Captions" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label>
                            <igtbl:UltraWebGrid ID="UltraWebGrid3" runat="server" EnableAppStyling="True" Height="200px" 
                                OnDataBinding="UltraWebGrid3_DataBinding" OnInitializeLayout="UltraWebGrid3_InitializeLayout"
                                StyleSetName="Office2007Blue" SkinID="UltraWebGrid" Width="325px" OnInitializeRow="UltraWebGrid3_InitializeRow">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
            ...
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                           <asp:Label ID="table4Captions" runat="server" Text="Label" CssClass="PageSubTitle"></asp:Label>
                            <igtbl:UltraWebGrid ID="UltraWebGrid4" runat="server" EnableAppStyling="True" Height="200px" 
                                OnDataBinding="UltraWebGrid4_DataBinding" OnInitializeLayout="UltraWebGrid4_InitializeLayout"
                                StyleSetName="Office2007Blue" SkinID="UltraWebGrid" Width="325px" OnInitializeRow="UltraWebGrid4_InitializeRow">
                                <Bands>
                                    <igtbl:UltraGridBand>
                                        <AddNewRow View="NotSet" Visible="NotSet">
                                        </AddNewRow>
