<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FSGS_0001_0001.Default" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right" rowspan="1" style="width: 15%;">
                ...
                &nbsp;<br />
        <asp:HyperLink ID="HyperLink2" runat="server" style="font-family:Verdana;font-size:XX-Small;font-weight:normal;"
                    NavigateUrl="~/reports/FSGS_0001_0003/default.aspx" SkinID="HyperLink">Анализ средних розничных цен на отдельные товары и услуги в разрезе территорий РФ</asp:HyperLink>
