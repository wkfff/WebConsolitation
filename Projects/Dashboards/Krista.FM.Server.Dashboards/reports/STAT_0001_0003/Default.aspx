<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.STAT_0001_0003.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td>
                <table style="vertical-align: top;">
                    <tr>
                        ...
                        <td valign="top">
                            <uc3:CustomMultiCombo ID="ComboLastPeriod" runat="server"></uc3:CustomMultiCombo>
                        </td>
                        <td valign="top">
    ...
    <table runat="server" id="commentTextTable">
        <tr>
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" valign="top">
                            <asp:Label ID="CommentText1" runat="server" CssClass="PageSubTitle"></asp:Label>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
            ...
            <td>
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;" valign="top">
                            <asp:Label ID="CommentText2" runat="server" CssClass="PageSubTitle"></asp:Label>
                        </td>
                        <td class="right">
                        </td>
                    </tr>
    ...
    <table runat="server" id="ultraGridTable" style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        <tr>
            <td class="topleft">
            </td>
            <td class="top">
        ...
        <tr>
            ...
            <td style="overflow: visible;" valign="top">
                ...
                <igtbl:UltraWebGrid ID="UltraWebGrid2" runat="server" Height="200px" Width="325px"
                    OnDataBinding="UltraWebGrid2_DataBinding" OnInitializeLayout="UltraWebGrid_InitializeLayout"
                    OnInitializeRow="UltraWebGrid_InitializeRow" SkinID="UltraWebGrid">
                    <Bands>
                        <igtbl:UltraGridBand>
                            <AddNewRow View="NotSet" Visible="NotSet">
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""  
                    ...
                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_stat_01_03_01#SEQNUM(100).png" />
                </igchart:UltraChart>
            </td>
            <td class="right">
            </td>
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                <igchart:UltraChart ID="UltraChart2" runat="server" BackgroundImageFileName=""  
                    ...
                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_stat_01_03_02#SEQNUM(100).png" />
                </igchart:UltraChart>
            </td>
            <td class="right">
            </td>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td class="headerReport">
                <asp:Label ID="chart3ElementCaption" runat="server" CssClass="ElementTitle"></asp:Label>
            </td>
            <td class="headerright">
            </td>
        </tr>
        <tr>
            ...
            <td style="overflow: visible;">
                <igchart:UltraChart ID="UltraChart3" runat="server" BackgroundImageFileName=""  
                    ...
                    <DeploymentScenario FilePath="../../TemporaryImages" ImageURL="../../TemporaryImages/Chart_stat_01_03_03#SEQNUM(100).png" />
                </igchart:UltraChart>
            </td>
            <td class="right">
            </td>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td class="headerReport">
                <asp:Label ID="chart4ElementCaption" runat="server" CssClass="ElementTitle"></asp:Label>
            </td>
            <td class="headerright">
            </td>
        </tr>
        <tr>
            ...
            <td style="overflow: visible;">
                <igchart:UltraChart ID="UltraChart4" runat="server" BackgroundImageFileName=""  
                     EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    Version="9.1" OnDataBinding="UltraChart4_DataBinding">
                    <Tooltips Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False"
                        Font-Bold="False"></Tooltips>
                    <ColorModel ModelStyle="CustomLinear" ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink">
                    </ColorModel>
