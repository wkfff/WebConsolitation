<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.SEP_0004_ComplexSahalin._default" %>
                    ...
                    <ColumnChart ColumnSpacing="1" >
                        <ChartText>
                            <igchartprop:ChartTextAppearance ChartTextFont="Arial, 7pt" ClipText="False" 
                                Column="-2" ItemFormatString="&lt;DATA_VALUE:### ##0.000&gt;" Row="-2" 
