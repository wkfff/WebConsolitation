<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.MO_SP_0002.Default" Title="Доходы по субъектам РФ" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>  
            <td style="width: 100%; vertical-align: top;">
                ...
                &nbsp;&nbsp;<asp:Label ID="PageTitle" runat="server" Text="Label" CssClass="PageTitle"></asp:Label><br/s>
                <asp:Label
            ...
            <td align="right" style="width: 100%;">
              ...
              <uc7:ReportPDFExporter ID="ReportPDFExporter1" runat="server" />
                <br /> <asp:HyperLink ID="HyperLink1" runat="server" SkinID="HyperLink">[HyperLink1]</asp:HyperLink>
            </td>
        </tr>
    </table>
    <table style="vertical-align: top;"> 
        ...
        <tr>
       <td valign="top" align="left">
            <uc3:CustomMultiCombo ID="ComboTypeTable" runat="server"></uc3:CustomMultiCombo>
            </td>
            <td valign="top" align="left">
...
<table id="Table2" runat="server"  style="width:100%;" >
   ...
   <div class="ElementTitle" style="margin-left:15px">Общие сведения</div>
    ...
    <table   runat="server" id="gridTable_0" 
        style="border-collapse: collapse; background-color: White; width: 100%; ">
        <tr>
            <td class="topleft">
                </td>
            <td class="top">
    ...
    <table   runat="server" id="gridTable_" 
