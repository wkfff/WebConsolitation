<%@ Page Language="C#"  MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.EO.EO_0011_2._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID=ContentPlaceHolder1 runat=server>
        ...
        <asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>
         <table  id="Text1" runat="server" style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;" runat="server" >
                        <tr>
                            <td class="topleft">
                            </td>
                            <td class="top">
    ...
    <td class="right">
        ...
        <table id="TabChart1"  runat="server" style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        <tr>
                            <td class="topleft">
                            </td>
                            <td class="top">
                        ...
                        <tr>
                            ...
                            <igchart:UltraChart ID="Chart" runat="server"   
                                    ...
                                    ondatabinding="Chart_DataBinding" Version="11.1">
                                <Border Color="Transparent" />
                                <Legend Location="Bottom" SpanPercentage="25" Visible="True"></Legend>
...
<X Visible="True" TickmarkInterval="0" Extent="10">
...
<SeriesLabels HorizontalAlign="Center" VerticalAlign="Center" 
        Orientation="Horizontal" Visible="False"></SeriesLabels>
</Labels>
</X>
...
<SeriesLabels FormatString="" HorizontalAlign="Far" VerticalAlign="Center" 
...
<Labels ItemFormatString="&lt;DATA_VALUE:00.##&gt;" Visible="False" HorizontalAlign="Near" VerticalAlign="Center" Orientation="Horizontal">
<SeriesLabels FormatString="" HorizontalAlign="Near" VerticalAlign="Center" 
        Orientation="VerticalLeftFacing"></SeriesLabels>
</Labels>
</Y2>
...
<Labels ItemFormatString="&lt;ITEM_LABEL&gt;" Visible="False" HorizontalAlign="Far" VerticalAlign="Center" Orientation="VerticalLeftFacing">
<SeriesLabels HorizontalAlign="Center" VerticalAlign="Center" 
...
<SeriesLabels HorizontalAlign="Near" VerticalAlign="Center" Orientation="Horizontal"></SeriesLabels>
    ...
    <td class="right" style="height: 245px">
         ...
         <table  id="Text2" runat="server" 
                style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;" 
                runat="server" >
                        <tr>
                            <td class="topleft">
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: top;">
                            <asp:Label ID="DynamicText2" runat="server" CssClass="PageSubTitle"></asp:Label>
                            </td>
    <td class="right">
                            </td>
                        </tr>
                    ...
                    <table id="TabChart2"  runat="server" style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;">
                        <tr>
                            <td class="topleft">
                            </td>
                            <td class="top">
                        ...
                        <tr>
                            ...
                            <td style="height: 100%">
                                <asp:Label ID="Chart_2Caption" runat="server" CssClass="ElementTitle" 
                                    Text="Label"></asp:Label>
                                <br />
                            <igchart:UltraChart ID="Chart2" runat="server" 
                                    EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" 
                                    ondatabinding="Chart2_DataBinding" Version="11.1">
                                <Border Color="Transparent" />
...
<X Visible="True" TickmarkInterval="0" Extent="180">
<MajorGridLines Visible="True" DrawStyle="Dot" Color="Gainsboro" Thickness="1" AlphaLevel="255"></MajorGridLines>
