<%@ Page Language="C#" title="Оценка качества жизни населения" ClientTarget="uplevel" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.EO.EO_0004new.EO_0004LeninRegionNew1._default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 100%">
        <tr>
            <td style="width: 100%">
   <uc5:PopupInformer ID="PopupInformer" runat="server" HelpPageUrl="Help.html" Visible="true" /><asp:Label ID="Label1" runat="server" Text="Label" CssClass="PageTitle"></asp:Label><br />
    <asp:Label ID="Label5" runat="server" CssClass="PageSubTitle" ></asp:Label></td>
            <td>
    ...
    <div style="width: 100%; text-align: right; visible: true;"><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/reports/EO/EO_0004new/EO_0004_LeninRegionNew1/01/default1.aspx" Font-Size="Small">Оценка качества жизни населения (в разрезе муниципальных образований)</asp:HyperLink></div>
    <table style="width: 317px">
        <tr>
            ...
            <td>
            <uc3:CustomMultiCombo ID="ComboRegion" runat="server" Visible="true" />
            </td>
            <td>
    ...
    <igtbl:UltraWebGrid ID="Grid" runat="server" EnableAppStyling="True" SkinID="UltraWebGrid" StyleSetName="Office2007Blue" OnDataBinding="Grid_DataBinding" OnInitializeRow="Grid_InitializeRow" Height="200px" OnInitializeLayout="Grid_InitializeLayout" Width="325px">
        ...
        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes" AllowUpdateDefault="Yes" BorderCollapseDefault="Separate"
            ...
            <HeaderStyleDefault BackColor="LightGray" BorderStyle="Solid" HorizontalAlign="Left" Font-Names="Verdana" Font-Size="8.25pt">
                <BorderDetails ColorLeft="White" ColorTop="White" WidthLeft="1px" WidthTop="1px" />
            </HeaderStyleDefault>
            <RowStyleDefault BackColor="Window" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px"
                Font-Names="Verdana" Font-Size="12pt" HorizontalAlign="Center" VerticalAlign="Middle">
                <Padding Left="3px" />
    ...
    <table style="width: 100%">
        <tr>
            <td style="vertical-align: top">
                <table id="Table2" style="border-collapse: collapse; margin-top: 5px; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: white">
                            ...
                            <igchart:UltraChart ID="Chart1" runat="server" Height="400px" OnDataBinding="Chart1_DataBinding" Width="500px" BackgroundImageFileName=""  EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" Version="9.1" OnInvalidDataReceived="Chart1_InvalidDataReceived">
                ...
                <Axis>
                    ...
                    <X LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True" Extent="15">
                        ...
                        <Labels Font="Verdana, 7pt" FontColor="DimGray" HorizontalAlign="Near" ItemFormatString="&lt;ITEM_LABEL&gt;"
                            Orientation="VerticalLeftFacing" VerticalAlign="Center" OrientationAngle="40">
                ...
                <ColumnChart>
                    <ChartText>
                        <igchartprop:ChartTextAppearance ChartTextFont="Verdana, 7pt" Column="-2" ItemFormatString="&lt;DATA_VALUE:### ##0.0000&gt;"
                ...
                <table id="Table3" style="border-collapse: collapse; float: right; margin-top: 5px; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: white">
                            ...
                            <igchart:UltraChart ID="Chart2" runat="server" BackgroundImageFileName=""  ChartType="LineChart" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                Height="383px" OnDataBinding="Chart2_DataBinding"
                                OnFillSceneGraph="Chart2_FillSceneGraph" Version="9.1" Width="500px" OnInvalidDataReceived="Chart1_InvalidDataReceived">
                                <ColorModel AlphaLevel="150" ColorBegin="Pink" ColorEnd="DarkRed" ModelStyle="CustomLinear">
                                </ColorModel>
                                <Effects>
                                    <Effects>
                                ...
                                <Axis>
                                    <PE ElementType="None" Fill="Cornsilk" />
                                    <X Extent="6" LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True">
                                        <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                            Visible="True" />
                                        <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                            Visible="False" />
                                    ...
                                    <Y Extent="15" LineColor="Gainsboro" LineThickness="1" TickmarkInterval="50" TickmarkStyle="Smart"
                                        Visible="True">
                                        <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                            Visible="True" />
                                        <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
