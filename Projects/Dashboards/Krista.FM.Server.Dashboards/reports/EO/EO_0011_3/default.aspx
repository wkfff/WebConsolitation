<%@ Page Language="C#" MasterPageFile="~/Reports.Master"  AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.EO.EO_0011_30._default" %>
...
<SeriesLabels HorizontalAlign="Near" VerticalAlign="Center" Orientation="Horizontal"></SeriesLabels>
                                ...
                                <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                    Font-Strikeout="False" Font-Underline="False" FormatString="" />
    ...
    <td class="right" style="height: 245px">
                    ...
                    <table  id="Text2" runat="server" style="width: 100%; border-collapse: collapse; background-color: white; height: 100%;" runat="server" >
                        <tr>
                            <td class="topleft">
                            </td>
                            <td class="top">
