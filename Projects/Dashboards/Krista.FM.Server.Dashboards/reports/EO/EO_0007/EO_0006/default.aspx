<%@ Page Language="C#"  Title="Статистика размещения заказа" MasterPageFile="~/Reports.Master"  AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krista.FM.Server.Dashboards.reports.EO.EO_0007.EO_00060.Default" %>
...
<uc3:CustomMultiCombo ID="YearComboBox" runat="server" />
    ...
    <igtbl:UltraWebGrid ID="Grid" runat="server" EnableAppStyling="True" OnDataBinding="Grid_DataBinding" SkinID="UltraWebGrid" StyleSetName="Office2007Blue" OnActiveRowChange="Grid_ActiveRowChange" OnInitializeLayout="Grid_InitializeLayout" Height="160px" Width="1019px" OnInitializeRow="Grid_InitializeRow">
        <Bands>
            <igtbl:UltraGridBand>
            ...
            <tr>
                <td>
                    <asp:Panel ID="Panel1" runat="server" BackColor="Transparent" BorderColor="Transparent"
                        ForeColor="Transparent" Visible="False" Width="100%">
                    <table style="border-collapse: collapse; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="headerReport">
                                <asp:Label ID="Label12" runat="server" CssClass="ElementTitle" Text="Структура показателя"></asp:Label></td>
                            <td class="headerright">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="background-color: white">
                                <asp:Label ID="Label5" runat="server" CssClass="ElementTitle" Text="Label" Visible="False"></asp:Label><br />
                <igchart:UltraChart ID="Chart5" runat="server" OnDataBinding="Chart5_DataBinding" BackgroundImageFileName="" BorderColor="Transparent"  ChartType="PieChart3D" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" OnInvalidDataReceived="SetErorFonn" Version="9.1" Visible="False" Width="900px" CrossHairColor="Crimson" Transform3D-Scale="95" Transform3D-XRotation="-140">
                    <ColorModel AlphaLevel="255" ColorBegin="255, 128, 128" ColorEnd="0, 0, 192" Scaling="Decreasing">
                    </ColorModel>
                    <Effects>
                        <Effects>
                    ...
                    <Axis>
                        ...
                        <X LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="False" Extent="70">
                    ...
                    <CompositeChart>
                        <ChartAreas>
                            <igchartprop:ChartArea Bounds="0, 0, 300, 200" Key="area1">
                                <axes>
<igchartprop:AxisItem Key="axis1" OrientationType="X_Axis" DataType="Numeric" SetLabelAxisType="GroupBySeries" TickmarkInterval="0">
...
<igchartprop:AxisItem Key="axis2" OrientationType="Y_Axis" DataType="Numeric" SetLabelAxisType="GroupBySeries" TickmarkInterval="0" Extent="59">
<MajorGridLines Visible="True" DrawStyle="Dot" Color="Gainsboro" Thickness="1" AlphaLevel="255"></MajorGridLines>
...
<SeriesLabels HorizontalAlign="Center" VerticalAlign="Center" Orientation="Horizontal"></SeriesLabels>
                                ...
                                <pe fill="DarkRed" fillgradientstyle="Horizontal"></pe>
                    ...
                    <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                        Font-Underline="False" Font-Size="10pt" FormatString="&lt;PERCENT_VALUE:#0.00&gt;% &lt;ITEM_LABEL&gt;" />
            ...
            <td style="width: 50%">
                <table style="border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: white">
                            <asp:Label ID="Label9" runat="server" CssClass="ElementTitle" Text="Label"></asp:Label><br />
                           <igchart:UltraChart ID="Chart1" runat="server" BackgroundImageFileName="" BorderColor="Transparent"  EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" Height="350px" OnDataBinding="Chart1_DataBinding" Version="9.1" Width="560px" ChartType="LineChart" OnFillSceneGraph="Chart1_FillSceneGraph1">
                               <Tooltips Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                               ...
                               <CompositeChart>
                                   <Series>
                                       <igchartprop:NumericSeries Key="series1">
                                           <points>
<igchartprop:NumericDataPoint Value="10" Label="21">
<PE ElementType="None"></PE>
</igchartprop:NumericDataPoint>
<igchartprop:NumericDataPoint Value="40" Label="23">
<PE ElementType="None"></PE>
</igchartprop:NumericDataPoint>
<igchartprop:NumericDataPoint Value="50" Label="27">
<PE ElementType="None"></PE>
</igchartprop:NumericDataPoint>
<igchartprop:NumericDataPoint Value="60" Label="2">
<PE ElementType="None"></PE>
</igchartprop:NumericDataPoint>
</points>
                               ...
                               <Axis>
                                   <PE ElementType="None" Fill="Cornsilk" />
                                   <X LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True" LineEndCapStyle="Triangle">
                                       <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                           Visible="True" />
                                       <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                           Visible="False" />
            ...
            <td style="width: 50%; text-align: right; align: right;">
                <table style="border-collapse: collapse; right: 0px; float: right; top: 0px; align: right;">
                    <tr>
                        <td class="topleft">
                        </td>
                        <td class="top">
                    ...
                    <tr>
                        ...
                        <td class="headerReport" style="text-align: left">
                    ...
                    <tr>
                        ...
                        <td style="background-color: white; text-align: left;">
                            <asp:Label ID="Label10" runat="server" CssClass="ElementTitle" Text="Label"></asp:Label><br />
            <igchart:UltraChart ID="Chart2" runat="server" ChartType="AreaChart" BackgroundImageFileName="" BorderColor="Transparent"  EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" Version="9.1" Height="350px" OnDataBinding="Chart2_DataBinding" Width="560px" OnInvalidDataReceived="SetErorFonn" OnFillSceneGraph="Chart2_FillSceneGraph">
                <Border Color="Transparent" />
                ...
                <AreaChart LineDrawStyle="Solid">
                    <ChartText>
                        <igchartprop:ChartTextAppearance ChartTextFont="Arial, 9pt, style=Bold" Column="-2"
                            HorizontalAlign="Far" ItemFormatString="&lt;DATA_VALUE:### ### ### ##0.##&gt;"
                ...
                <Axis>
                    ...
                    <X LineThickness="1" TickmarkInterval="0" TickmarkStyle="Smart" Visible="True" Extent="30">
                        ...
                        <Labels Font="Verdana, 8pt" FontColor="DimGray" HorizontalAlign="Far" ItemFormatString="&lt;DATA_VALUE:00.##&gt;"
                            Orientation="Horizontal" VerticalAlign="Near" Flip="True" OrientationAngle="180">
                            <SeriesLabels Font="Verdana, 7pt" FontColor="DimGray" FormatString="" HorizontalAlign="Center"
                                Orientation="VerticalLeftFacing" VerticalAlign="Center">
                                <Layout Behavior="Auto">
                                </Layout>
                            </SeriesLabels>
                    ...
                    <Y LineThickness="1" TickmarkInterval="40" TickmarkStyle="Smart" Visible="True" Extent="50">
                        <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                            Visible="True" />
                        <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                            Visible="False" />
         ...
         <tr>
                     ...
                     <tr>
                         ...
                         <td style="background-color: white">
                             <igchart:UltraChart ID="Chart3" runat="server" BackgroundImageFileName="" BorderColor="Transparent"
                                 ...
                                 Height="350px" OnDataBinding="Chart3_DataBinding" OnInvalidDataReceived="SetErorFonn"
                                 Transform3D-Scale="100" Transform3D-XRotation="45" Transform3D-YRotation="-12"
                                 Version="9.1" Width="555px" OnFillSceneGraph="Chart3_FillSceneGraph">
                                 <Tooltips EnableFadingEffect="True" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                     Font-Size="10pt" Font-Strikeout="False" Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;"
                                     Overflow="ClientArea" />
                                 <Border Color="Transparent" />
                                 <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                                 <DoughnutChart3D OthersCategoryPercent="0">
                                     <Labels Font="Verdana, 8pt" FormatString="&lt;PERCENT_VALUE:#0.00&gt;% (&lt;DATA_VALUE:### ##0&gt; ед.)" />
                                 </DoughnutChart3D>
                                 ...
                                 <Axis>
                                     ...
                                     <Y Extent="50" LineThickness="1" TickmarkInterval="10" TickmarkStyle="Smart" Visible="True">
                                         <MajorGridLines AlphaLevel="255" Color="Gainsboro" DrawStyle="Dot" Thickness="1"
                                             Visible="True" />
                                         <MinorGridLines AlphaLevel="255" Color="LightGray" DrawStyle="Dot" Thickness="1"
                                             Visible="False" />
                                 ...
                                 <Legend Location="Bottom" SpanPercentage="40" Visible="True" FormatString=""></Legend>
                             </igchart:UltraChart>
                         </td>
                         <td class="right">
                         </td>
             ...
             <td style="width: 50%; text-align: right; right: 0px;">
                     ...
                     <tr>
                         ...
                         <td style="background-color: white; text-align: left;">
                             <igchart:UltraChart ID="Chart4" runat="server" BackgroundImageFileName="" BorderColor="Transparent"
                                  ChartType="DoughnutChart3D" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                                 Height="350px" OnDataBinding="Chart4_DataBinding" OnInvalidDataReceived="SetErorFonn"
                                 Transform3D-Scale="100" Transform3D-XRotation="45" Transform3D-YRotation="-12"
                                 Version="9.1" Width="555px" OnFillSceneGraph="Chart4_FillSceneGraph">
                                 <Tooltips EnableFadingEffect="True" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                     Font-Size="10pt" Font-Strikeout="False" Font-Underline="False" FormatString="&lt;ITEM_LABEL&gt;"
                                     Overflow="ClientArea" />
                                 <Border Color="Transparent" />
                                 <DeploymentScenario FilePath="../../../../TemporaryImages" ImageURL="../../../../TemporaryImages/Chart_#SEQNUM(100).png" />
                                 <DoughnutChart3D OthersCategoryPercent="0">
                                     <Labels Font="Verdana, 8pt" FormatString="&lt;PERCENT_VALUE:#0.00&gt;% (&lt;DATA_VALUE:### ##0.##&gt; млн.р.)" />
                                 </DoughnutChart3D>
                                 <ColorModel AlphaLevel="255" ColorBegin="Pink" ColorEnd="DarkRed">
                                 </ColorModel>
                                 <Effects>
