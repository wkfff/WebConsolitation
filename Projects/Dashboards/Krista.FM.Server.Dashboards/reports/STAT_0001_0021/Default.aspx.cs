...
namespace Krista.FM.Server.Dashboards.reports.STAT_0001_0021
{
	/// <summary>
	...
	public partial class Default : CustomReportPage
	{
		...
		protected override void Page_PreLoad(object sender, EventArgs e)
		{
			...
			ComboRegion.Title = "Выберите муниципальное образование";
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				FillComboRegion(ComboRegion, "STAT_0001_0021_list_of_regions");
				GetQuarters(firstQuarter, lastQuarter, "STAT_0001_0021_quarters");
			}
		...
		{
			string query = DataProvider.GetQueryText("STAT_0001_0021_grid");
					...
					if (i % 3 != 2)
						for (int j = 2; j < dtGrid.Columns.Count; ++j)
							if (dtGrid.Rows[i][j] != DBNull.Value)
								dtGrid.Rows[i][j] = Convert.ToDouble(dtGrid.Rows[i][j]) / 1000;
		...
		protected void UltraWebGrid_InitializeLayout(object sender, Infragistics.WebUI.UltraWebGrid.LayoutEventArgs e)
		{
			...
			double columnWidth = CRHelper.GetColumnWidth(gridWidth / 14 * k);
		...
		void UltraChart_DataBinding(object sender, EventArgs e)
		{
			...
			string query = DataProvider.GetQueryText("STAT_0001_0021_chart");
