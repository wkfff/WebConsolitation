...
namespace Krista.FM.Server.Dashboards.reports.FO_0042_0001
{
    public partial class Default : CustomReportPage
    {
        ...
        protected override void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            CrossLink1.NavigateUrl = "~/reports/FO_0042_0002/Default.aspx";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = String.Format("Результаты оценки качества финансового менеджмента, осуществляемого главными распорядителями средств областного бюджета");
            PageTitle.Text = Page.Title;

            PageSubTitle.Text = String.Format("в {0} году", currentYear);
...
", " ");
        ...
        protected void UltraWebGrid_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            {
                if (i == 0 || i == 1 || i == 2 || (!ValueSelected && (i == 3 || i == 4 || i == 5)))
                {
