<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.ORG_0001_0006.Default" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td style="overflow: visible;">
                            <asp:Label ID="GridHeader" runat="server" CssClass="ElementTitle"></asp:Label>
            ...
            <td>
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="overflow: visible;">
                            <asp:Label ID="LabelChart2" runat="server" Text="заголовок диаграммы" 
                                CssClass="ElementTitle"></asp:Label>
                            <igchart:UltraChart ID="SDChart" runat="server" 
                                EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" 
                                Version="11.1">
                                <ColorModel ModelStyle="CustomLinear" ColorEnd="DarkRed" AlphaLevel="150" ColorBegin="Pink">
                                </ColorModel>
    ...
    <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                <igmisc:WebAsyncRefreshPanel ID="PanelMapCaption" runat="server">
                    <asp:Label ID="LabelMap" runat="server" CssClass="ElementTitle"></asp:Label><br />
        ...
        <tr>
            ...
            <td>
                <asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" 
                    Checked="True" GroupName="gr1" Text="Средняя розничная цена" 
                    ValidationGroup="gr1" />
                <asp:RadioButton ID="RadioButton2" runat="server" AutoPostBack="True" 
                    GroupName="gr1" Text="Изменение цены к предыдущей дате" ValidationGroup="gr1" />
                <asp:RadioButton ID="RadioButton3" runat="server" AutoPostBack="True" 
                    GroupName="gr1" Text="Изменение цены к началу года" ValidationGroup="gr1" />
                <br />
            </td>
            <td class="right">
            </td>
        ...
        <tr>
            ...
            <td>
                <igmisc:WebAsyncRefreshPanel ID="PanelMap" runat="server">
                    <asp:Label ID="EmptyMapLabel" runat="server" CssClass="ElementSubTitle"></asp:Label><br />
