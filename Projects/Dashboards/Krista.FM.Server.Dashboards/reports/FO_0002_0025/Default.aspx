<%@ Page Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" Codebehind="Default.aspx.cs"
    Inherits="Krista.FM.Server.Dashboards.reports.FO_0002_0025.Default" Title="Доходы по субъектам РФ" %>
    ...
    <table style="vertical-align: top;">
        <tr>
            ...
            <td valign="middle" align="right">
                <asp:CheckBox ID="RzPrCheckBox" runat="server" Text="РзПр" AutoPostBack="true" Checked="true"
                    Style="font-family: Verdana; font-size: 10pt;" />
                <asp:CheckBox ID="KOSGUCheckBox" runat="server" Text="КОСГУ" AutoPostBack="true"
                ...
                <table style="border-collapse: collapse; background-color: White; width: 100%; margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="right">
                            <asp:CheckBox ID="MeasurePlan" runat="server" Text="Годовые назначения" AutoPostBack="true" Checked="false"
                                Style="font-family: Verdana; font-size: 10pt;" />
                            <asp:CheckBox ID="MeasureFact" runat="server" Text="Факт" AutoPostBack="true" Checked="true"
                                Style="font-family: Verdana; font-size: 10pt;" />
                        </td>
                        <td class="right">
                        </td>
