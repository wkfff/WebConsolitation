<%@ Control Language="C#" AutoEventWireup="true" Codebehind="Food_0001_0001_Chart.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.Food_0001_0001_Chart" %>
...
<table style="border-collapse: collapse; height: 100%">
    <tr>
        ...
        <div style="margin-top: -10px">
            ...
            <table id="LabelArea" runat="server" style="margin-left: 50px; margin-top: -18px">
                <tr>
