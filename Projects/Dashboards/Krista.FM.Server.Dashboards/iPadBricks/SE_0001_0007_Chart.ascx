<%@ Control Language="C#" AutoEventWireup="true" Codebehind="SE_0001_0007_Chart.ascx.cs" Inherits="Krista.FM.Server.Dashboards.reports.Dashboard.SE_0001_0007_Chart" %>
    ...
    <tr>
        <td>
            ...
            <igchart:UltraChart ID="UltraChart1" runat="server" BackgroundImageFileName=""
                ...
                <DeploymentScenario FilePath="../../../TemporaryImages" ImageURL="../../../TemporaryImages/Chart_SE0107Gadget_#SEQNUM(100).png" />
            </igchart:UltraChart>
        </td>
    </tr>
</table>
