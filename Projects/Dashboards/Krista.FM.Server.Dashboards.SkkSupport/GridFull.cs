...
{
	public class GridFull : GridBase
	{
			...
			: base(grid)
		{
			...
			marks.Add("transport", new[]
				{
					"ТС",
					"Количество досмотренных транспортных средств",
					"Количество приостановленных транспортных средств",
					(object)2
				});
			marks.Add("people", new[]
				{
					"Лиц",
					"Число лиц, досмотренных на наличие признаков инфекционных заболеваний",
					"Выявлено больных и/или лиц с подозрением на инфекционные заболевания",
					(object)(2+markColumnsCount)
				});

			marks.Add("goods", new[]
				{
					"Грузы",
					"Количество партий грузов, на которые предъявлены документы должностным лицам органа Роспотребнадзора, осуществляющего СКК",
					"Количество партий грузов, подлежащих СКК",
					(object)(2+2*markColumnsCount-1) // magic here! "-1" as negative margin
				});

			marks.Add("gcapacity", new[]
				{
					"ПартииГрузов",
					"Количество партий грузов, подлежащих СКК",
					"Количество приостановленных партий грузов",
					(object)(2+2*markColumnsCount+3)
				});

			marks.Add("gvolume", new[]
				{
					"ОбъемГрузов",
					"Объем партий грузов, подлежащих СКК",
					"Объем приостановленных партий грузов",
					(object)(2+3*markColumnsCount+3)
				});
		...
		public override void SetStyle()
		{
			...
			SetHeight(SKKHelper.defaultHeightFull);
		}
		...
		public override void SetDataHeader()
		{
			...
			headerLayout.AddCell("Территория", 5);
			headerLayout.AddCell("Число пунктов пропуска, в которых осуществлялся СКК", 5);

			groupCell_1 = headerLayout.AddCell("Досмотр транспортных средств");
