...
{
    public sealed class InstallerSubProgram : BaseSubProgram
    {
        public InstallerSubProgram(string path) : base(path)
        {
        }

        protected override string GetBaseUrl(string appVersion, string installerVersion)
        {
            return String.Format(@"Installer\{0}\", installerVersion);
        }
        ...
        {
            return UpdateManager.InstallerFeed;
        }
    }
}
