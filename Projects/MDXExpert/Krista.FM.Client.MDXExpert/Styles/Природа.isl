...
<styleLibrary>
  <annotation>
    <lastModified>2008-05-08T08:53:05</lastModified>
  </annotation>
  <styleSets defaultStyleSet="Default">
    <styleSet name="Default" viewStyle="Standard" useOsThemes="False" useFlatMode="True">
      ...
      <styles>
        ...
        <style role="Base">
          <states>
            <state name="Normal" backColor="Ivory" fontName="" textVAlign="Middle" backGradientStyle="None" themedElementAlpha="Transparent" backHatchStyle="None">
              <resources>
  ...
  <gridPropertys>
    ...
    <gridCaption>
      <style>
        <colors backColorStart="White" backColorEnd="White" borderColor="Red" foreColor="0; 0; 0"/>
      </style>
    </gridCaption>
    <filtersCaptions>
      <style>
