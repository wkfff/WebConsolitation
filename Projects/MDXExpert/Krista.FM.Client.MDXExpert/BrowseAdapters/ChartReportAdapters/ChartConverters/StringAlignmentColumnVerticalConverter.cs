...
{
    public class StringAlignmentColumnVerticalConverter : EnumConverter
    {
        const string sCenter = "По центру";
        const string sFar = "По верхнему краю";
        const string sNear = "По нижнему краю";

        public StringAlignmentColumnVerticalConverter(Type type)
            : base(type)
        {
        }
