...
{
    public class StringAlignmentColumnHorizontalConverter : EnumConverter
    {
        const string sCenter = "По центру";
        const string sFar = "По левому краю";
        const string sNear = "По правому краю";

        public StringAlignmentColumnHorizontalConverter(Type type)
            : base(type)
        {
        }
