...
namespace Krista.FM.Client.MDXExpert
{
    ...
    public class  GaugeColorRangeBrowseClass : FilterablePropertyBase
    {
        #region Поля
        ...
        public bool IsRangesExists
        {
            get
            {
                return (this._gaugeElement.ColorRanges.Count > 0); 
            }
        }
        ...
        {
            get { return this._gaugeElement.ColorRanges.Count; }
        ...
        [Browsable(true)]
        public RadialGaugeRangeCollection RangeColors
        {
            get
            {
        ...
        */
        ...
        [Editor(typeof(GaugeRangeEditor), typeof(UITypeEditor))]
        ...
        public GaugeColorRangeBrowseClass(GaugeReportElement gaugeElement)
        {
        ...
        private double GetRangeLength(GaugeReportElement gaugeElement, int rangeCount)
        {
