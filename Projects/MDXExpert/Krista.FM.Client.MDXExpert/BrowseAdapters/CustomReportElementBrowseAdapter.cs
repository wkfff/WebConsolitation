...
namespace Krista.FM.Client.MDXExpert
{
    ...
    class CustomReportElementBrowseAdapter : FilterablePropertyBase
    {
        ...
        private GaugeLabelsBrowseClass gaugeColumnsLabelsBrowse;
        private GaugeLabelsBrowseClass gaugeRowsLabelsBrowse;
        ...
        public CustomReportElementBrowseAdapter(DockableControlPane dcPane)
        {
            ...
            gaugeColumnsLabelsBrowse = new GaugeLabelsBrowseClass(reportElement, reportElement.PivotData.ColumnAxis);
            gaugeRowsLabelsBrowse = new GaugeLabelsBrowseClass(reportElement, reportElement.PivotData.RowAxis);
        }
        ...
        {
            get { return this.reportElement; }
        }



        [Browsable(false)]
        public bool CubeNameIsReadOnly
        {
            get 
            { 
                if (this.reportElement.ElementType == ReportElementType.eChart)
                {
                    ChartReportElement chartElement = (ChartReportElement) this.reportElement;
                    return !String.IsNullOrEmpty(chartElement.Synchronization.BoundTo);
                }
                if (this.reportElement.ElementType == ReportElementType.eMap)
                {
                    MapReportElement mapElement = (MapReportElement)this.reportElement;
                    return !String.IsNullOrEmpty(mapElement.Synchronization.BoundTo);
                }
                if (this.reportElement.ElementType == ReportElementType.eMultiGauge)
                {
                    MultipleGaugeReportElement gaugeElement = (MultipleGaugeReportElement)this.reportElement;
                    return !String.IsNullOrEmpty(gaugeElement.Synchronization.BoundTo);
                }
        ...
        /// <summary>
        /// Является ли элемент диаграммой
        /// </summary>
        [Browsable(false)]
        public bool IsChart
        {
            get { return reportElement.ElementType == ReportElementType.eChart; }
        }
        ...
        {
            get { return reportElement.ElementType == ReportElementType.eMultiGauge; }
        }
        
        /// <summary>
        /// Является ли элемент таблицей
        /// </summary>
        [Browsable(false)]
        public bool IsTable
        {
            get { return reportElement.ElementType == ReportElementType.eTable; }
        }

        /// <summary>
        /// Является ли элемент индикатором
        /// </summary>
        [Browsable(false)]
        public bool IsGauge
        {
            get { return reportElement.ElementType == ReportElementType.eGauge; }
        }
        ...
        public bool IsCustomMap
        {
            get
            {
                if (reportElement.ElementType == ReportElementType.eMap)
                {
                    return (((MapReportElement) this.reportElement).DataSourceType == DataSourceType.Custom);
                }
                return false;
            }
        }
        ...
        /// <summary>
        /// Есть ли структура у элемента
        /// </summary>
        [Browsable(false)]
        public bool IsPivotDataExists
        {
            get { return !IsGauge && !IsComposite; }
        }
        ...
        /// </summary>
        [Browsable(false)]
        public bool isShowVisualTotalsProperties
        {
            get
            {
                return ((this.IsTable || (this.IsChart && !this.IsComposite)) 
                && !this.reportElement.PivotData.IsCustomMDX); }
        }
        ...
        public bool IsComposite
        {
            get 
            {
                if (this.IsChart)
                {
                    return ((ChartReportElement)reportElement).Chart.ChartType == ChartType.Composite;
                }
                else
                {
                    return false;
        ...
        [Browsable(false)]
        public bool ShowChartDataProperties
        {
            get
            {
                return (this.IsChart && !IsComposite);
            }
        }

        [Browsable(false)]
        public bool ShowDataProperties
        {
            get
            {
                return (this.IsMultiGauge || (this.IsChart && !IsComposite));
            }
        }


        [Category("Управление данными")]
        [DisplayName("Вычислять итоги по видимым элементам")]
        [Description("Подсчет итогов ведется только по видимым элементам измерения")]
        [DynamicPropertyFilter("isShowVisualTotalsProperties", "True")]
        [DefaultValue(true)]
        ...
        public bool IsVisualTotals
        {
            get
            {
                return this.reportElement.PivotData.IsVisualTotals;
            }
            set
            {
                this.reportElement.PivotData.IsVisualTotals = value;
            }
        }
        ...
        [DynamicPropertyFilter("ShowChartDataProperties", "True")]
        [DefaultValue(true)]       
        [TypeConverter(typeof(BooleanTypeConverter))]
        ...
        [DisplayName("Обновление")]
        [Description("Если флаг установлен, диаграмма строится по данным из базы")]
        [DynamicPropertyFilter("IsMultiGauge", "True")]
        [DefaultValue(true)]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool IsUpdatableGauge
        {
            get
            {
                return ((MultipleGaugeReportElement)reportElement).IsUpdatable;
            }
            set
            {
                ((MultipleGaugeReportElement)reportElement).IsUpdatable = value;
            }
        }
        ...
        [Description("Данные")]
        [DynamicPropertyFilter("IsMultiGauge", "True")]
        [Editor(typeof(MultiGaugeSourceDataEditor), typeof(UITypeEditor))]
        [TypeConverter(typeof(TypeConverter))]
        public MultipleGaugeReportElement MultiGaugeSourceData
        {
            get
            {
                return ((MultipleGaugeReportElement)reportElement);
            }
            set
            {
            }
        ...
        [Category("Управление данными")]
        [Description("Метки показателей")]        
        [DisplayName("Метки показателей")]
        [DynamicPropertyFilter("IsMultiGauge", "True")]
        [Browsable(true)]
        public GaugeLabelsBrowseClass GaugeСolumnsLabelsBrowse
        {
            get { return gaugeColumnsLabelsBrowse; }
            set { gaugeColumnsLabelsBrowse = value; }
        }
        ...
        [DynamicPropertyFilter("IsMultiGauge", "True")]
        [Browsable(true)]
        public GaugeLabelsBrowseClass GaugeRowsLabelsBrowse
        {
            get { return gaugeRowsLabelsBrowse; }
            set { gaugeRowsLabelsBrowse = value; }
        }

        [Category("Управление данными")]
        [DisplayName("Куб")]
        [Description("Куб, из которого берутся данные для элемента отчета")]
        [Editor(typeof(CubeChooserEditor), typeof(UITypeEditor))]
        [DynamicPropertyFilter("IsPivotDataExists", "True")]
        [ReadOnlyPropertyFilter("CubeNameIsReadOnly", "True")]
        [ReadOnly(false)]
        [Browsable(true)]
        [TypeConverter(typeof(NotEditableStringConverter))]
        public string CubeName
        {
            get { return reportElement.CubeName; }
            set { reportElement.CubeName = value; }
        }
        ...
        {
            get { return reportElement.PivotData.MDXQuery; }
        }
    ...
    #region Редактор данных диаграммы
    /// <summary>
    ...
    #region Редактор данных множественного индикатора
    /// <summary>
    /// Редактор данных диаграммы
    /// </summary>
    public class MultiGaugeSourceDataEditor : UITypeEditor
    {
        ...
        public override Object EditValue(ITypeDescriptorContext context, IServiceProvider provider, Object value)
        {
            if ((context != null) && (provider != null))
            {
                ...
                if (svc != null)
                {
                    this.gaugeElement = (MultipleGaugeReportElement)value;
                    RelationalTable tbl = new RelationalTable();
                    tbl.SetDataSource(this.gaugeElement.SourceDT);
                    tbl.AfterDataSourceUpdate += new RelationalTable.DataSourceEventHandler(tbl_AfterDataSourceUpdate);
                    tbl.Tag = svc;
                    svc.DropDownControl(tbl);
                }
    ...
    /// </summary>
    [AttributeUsage(AttributeTargets.Property, Inherited = true)]
    class ReadOnlyPropertyFilterAttribute : Attribute
    {
        string _propertyName;
        ...
        /// <summary>
        /// Значения свойства, от которого зависит readonly 
        /// (через запятую, если несколько), при котором свойство, к
        /// которому применен атрибут, будет нередактируемо. 
        /// </summary>
        public string ReadOnlyOn
        {
            get { return _readOnlyOn; }
        }
        ...
        /// <param name="value">Значения свойства (через запятую, если несколько), 
        /// при котором свойство, к которому применен атрибут, будет видимо.</param>
        public ReadOnlyPropertyFilterAttribute(string propertyName, string value)
        {
            _propertyName = propertyName;
            _readOnlyOn = value;
        }
          ...
          GetFilteredProperties(Attribute[] attributes)
        {
            ...
            foreach (PropertyDescriptor pd in pdc)
            {
                ...
                foreach (Attribute a in pd.Attributes)
                {
                    ...
                    if (a is ReadOnlyPropertyFilterAttribute)
                    {
                        ReadOnlyPropertyFilterAttribute rpf =
                         (ReadOnlyPropertyFilterAttribute)a;

                        string[] strArray = rpf.ReadOnlyOn.Split(',');
                        foreach (string strItem in strArray)
                        {
                            if (string.Compare(strItem.Trim(' '), pdc[rpf.PropertyName].GetValue(this).ToString()) == 0)
                            {
                                isReadOnly = true;
                                break;
                            }
                        ...
                        ReadOnlyAttribute attrib = (ReadOnlyAttribute)pd.Attributes[typeof(ReadOnlyAttribute)];
                        FieldInfo isReadOnlyInfo = attrib.GetType().GetField("isReadOnly", BindingFlags.NonPublic | BindingFlags.Instance);
                        isReadOnlyInfo.SetValue(attrib, isReadOnly);
                        if (isReadOnly)
                        {
                            EditorAttribute editorAttrib = (EditorAttribute)pd.Attributes[typeof(EditorAttribute)];
                            //editorAttrib.GetType().GetFields().SetValue() (editorAttrib, null);
                            /*
                            FieldInfo editorInfo = editorAttrib.GetType().GetField("editor", BindingFlags.NonPublic | BindingFlags.Instance);
                            editorInfo.SetValue(editorAttrib, null);*/
    ...
    public class ChartLabelsBrowseClass
    {
        ...
        public Axis ChartRowsLabels
        {
            ...
            set
            {
                reportElement.InitialByCellSet();
            }
        }
        ...
        public bool IncludeInLabelParentMember
        {
            get
            {
                if (axis.AxisType == AxisType.atColumns)
                {
                    return reportElement.PivotData.ColumnAxis.IncludeInChartLabelParentMember;
                }
                else
                {
                    return reportElement.PivotData.RowAxis.IncludeInChartLabelParentMember;
                }
            }
            set
            {
                if (axis.AxisType == AxisType.atColumns)
                {
                    reportElement.PivotData.ColumnAxis.IncludeInChartLabelParentMember = value;
                }
                else
                {
                    reportElement.PivotData.RowAxis.IncludeInChartLabelParentMember = value;
                }
            }
        }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class GaugeLabelsBrowseClass
    {
        private CustomReportElement reportElement;
        private Axis axis;

        public GaugeLabelsBrowseClass(CustomReportElement element, Axis ax)
        {
            axis = ax;
            this.reportElement = element;
        }
        ...
        [Description("Символ, разделяющий элементы метки")]
        [TypeConverter(typeof(EnumTypeConverter))]
        [DynamicPropertyFilter("ElementType", "eMultiGauge")]
        public DataSeriesSeparator GaugeColumnsSeparator
        {
            get
            {
                if (axis.AxisType == AxisType.atColumns)
                {
                    return ((MultipleGaugeReportElement)reportElement).ColumnsSeparator;
                }
                else
                {
                    return ((MultipleGaugeReportElement)reportElement).RowsSeparator;
                }
            }
            set
            {
                if (axis.AxisType == AxisType.atColumns)
                {
                    ((MultipleGaugeReportElement)reportElement).ColumnsSeparator = value;
                }
                else
                {
                    ((MultipleGaugeReportElement)reportElement).RowsSeparator = value;
                }
            }
        }
        */
        ...
        /// в формировании меток диаграммы
        /// </summary>
        public class GaugeLabelsElementDropDownEditor : UITypeEditor
        {
            /// <summary>
            /// Реализация метода редактирования
            /// </summary>
    ...
    public class NotEditableStringConverter : StringConverter
    {
