...
namespace Krista.FM.RIA.Extensions.DebtBook.Presentation.ViewBuilders.Guarantee
{
    public class FormView : BebtBookFormView
    {
        ...
        private void BuildStavropol(List<Component> components)
        {
            ...
            var fieldSet = formPanel.Items.OfType<FieldSet>().FirstOrDefault(x => x.Title.Equals("Информация по гарантии"));
            if (fieldSet == null)
            {
                throw new Exception("Не найдена группа с наименованием Информация по гарантии");
            }
