...
{
    public class BebtBookStructureRegionFormView : BebtBookStructureServiceRegionFormViewBase
    {
        public BebtBookStructureRegionFormView(IVariantProtocolService protocolService, IDebtBookExtension extension, IParametersService parametersService) 
        ...
        {
            var record = new NHibernateLinqRepository<F_S_StructureDebt>().FindAll()
