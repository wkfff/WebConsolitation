...
{
    public class ForecastMSERDExtensionInstaller : ExtensionInstallerBase, IExtensionInstaller
    {
        public ForecastMSERDExtensionInstaller()
            : base(typeof(ForecastMSERDExtensionInstaller).Assembly, "Krista.FM.RIA.Extensions.Forecast.MSERD.Config.xml")
        {
        }
