...
namespace egrul.nalog.ruvo_rugf_2_311_26_04_04_02
{
    /// <summary>
    /// <para>
    /// Regular expression: (ИдОтпр?, Документ*)
    /// </para>
    /// </summary>
    public partial class Файл : XTypedElement, IXMetaData
    {

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private XTypedList<ДокументLocalType> ДокументField;
        ...
        public static explicit operator Файл(XElement xe) { return XTypedServices.ToXTypedElement<Файл>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

        static Файл()
        {
            BuildElementDictionary();
            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ИдОтпр", "")), new NamedContentModelEntity(XName.Get("Документ", "")));
        }
        ...
        /// </para>
        /// </summary>
        public ИдОтпрLocalType ИдОтпр
        {
            get
            {
                XElement x = this.GetElement(XName.Get("ИдОтпр", ""));
                return ((ИдОтпрLocalType)(x));
            }
            set
            {
                this.SetElement(XName.Get("ИдОтпр", ""), value);
            }
        }
        ...
        /// </para>
        /// </summary>
        public IList<Файл.ДокументLocalType> Документ
        {
            get
            {
                if ((this.ДокументField == null))
                {
                    this.ДокументField = new XTypedList<ДокументLocalType>(this, LinqToXsdTypeManager.Instance, XName.Get("Документ", ""));
                }
            ...
            set
            {
                if ((value == null))
                {
                    this.ДокументField = null;
                }
                else
                {
                    if ((this.ДокументField == null))
                    {
                        this.ДокументField = XTypedList<ДокументLocalType>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("Документ", ""));
                    }
                    else
                    {
                        XTypedServices.SetList<ДокументLocalType>(this.ДокументField, value);
                    }
                }
            }
        }
        ...
        /// </para>
        /// <para>
        /// Содержит (повторяет) имя передаваемого файла (без расширения)
        /// </para>
        /// <para>
        /// Occurrence: required
        /// </para>
        ...
        public string ИдФайл
        {
            get
            {
                XAttribute x = this.Attribute(XName.Get("ИдФайл", ""));
                return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
            set
            {
                this.SetAttribute(XName.Get("ИдФайл", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
        }
        ...
        public string ВерсФорм
        {
            get
            {
                XAttribute x = this.Attribute(XName.Get("ВерсФорм", ""));
                return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
            set
            {
                this.SetAttribute(XName.Get("ВерсФорм", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
        }
        ...
        public string ТипИнф
        {
            get
            {
                XAttribute x = this.Attribute(XName.Get("ТипИнф", ""));
                return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
            set
            {
                this.SetAttribute(XName.Get("ТипИнф", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
        }
        ...
        public string ВерсПрог
        {
            get
            {
                XAttribute x = this.Attribute(XName.Get("ВерсПрог", ""));
                return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
            set
            {
                this.SetAttribute(XName.Get("ВерсПрог", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
            }
        }
        ...
        /// </para>
        /// </summary>
        public decimal КолДок
        {
            get
            {
                XAttribute x = this.Attribute(XName.Get("КолДок", ""));
                return XTypedServices.ParseValue<decimal>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Integer).Datatype);
            }
            set
            {
                this.SetAttribute(XName.Get("КолДок", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Integer).Datatype);
            }
        }
        ...
        public static Файл Load(string xmlFile)
        {
            return XTypedServices.Load<Файл>(xmlFile);
        }

        public static Файл Load(System.IO.TextReader xmlFile)
        {
            return XTypedServices.Load<Файл>(xmlFile);
        }

        public static Файл Parse(string xml)
        {
            return XTypedServices.Parse<Файл>(xml);
        }

        public override XTypedElement Clone()
        {
            return XTypedServices.CloneXTypedElement<Файл>(this);
        }

        private static void BuildElementDictionary()
        {
            localElementDictionary.Add(XName.Get("ИдОтпр", ""), typeof(ИдОтпрLocalType));
            localElementDictionary.Add(XName.Get("Документ", ""), typeof(ДокументLocalType));
        }
        ...
        /// <summary>
        /// <para>
        /// Regular expression: (ФИООтв)
        /// </para>
        /// </summary>
        public partial class ИдОтпрLocalType : XTypedElement, IXMetaData
        {
            ...
            public static explicit operator ИдОтпрLocalType(XElement xe) { return XTypedServices.ToXTypedElement<ИдОтпрLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

            static ИдОтпрLocalType()
            {
                BuildElementDictionary();
                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ФИООтв", "")));
            }
            ...
            public ФИОТип ФИООтв
            {
                get
                {
                    XElement x = this.GetElement(XName.Get("ФИООтв", ""));
                    return ((ФИОТип)(x));
                }
                set
                {
                    this.SetElement(XName.Get("ФИООтв", ""), value);
                }
            }
            ...
            public string ДолжОтв
            {
                get
                {
                    XAttribute x = this.Attribute(XName.Get("ДолжОтв", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetAttribute(XName.Get("ДолжОтв", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public string Тлф
            {
                get
                {
                    XAttribute x = this.Attribute(XName.Get("Тлф", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetAttribute(XName.Get("Тлф", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public override XTypedElement Clone()
            {
                return XTypedServices.CloneXTypedElement<ИдОтпрLocalType>(this);
            }

            private static void BuildElementDictionary()
            {
                localElementDictionary.Add(XName.Get("ФИООтв", ""), typeof(ФИОТип));
            }
        ...
        /// </para>
        /// </summary>
        public partial class ДокументLocalType : XTypedElement, IXMetaData
        {
            ...
            public static explicit operator ДокументLocalType(XElement xe) { return XTypedServices.ToXTypedElement<ДокументLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

            static ДокументLocalType()
            {
                BuildElementDictionary();
            ...
            /// </para>
            /// <para>
            /// Для присвоения номера используется глобально уникальный идентификатор (GUID)
            /// </para>
            /// <para>
            /// Occurrence: required
            /// </para>
            ...
            public string ИдДок
            {
                get
                {
                    XAttribute x = this.Attribute(XName.Get("ИдДок", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetAttribute(XName.Get("ИдДок", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public override XTypedElement Clone()
            {
                return XTypedServices.CloneXTypedElement<ДокументLocalType>(this);
            }
            ...
            public partial class СвЮЛLocalType : XTypedElement, IXMetaData
            {
                ...
                public static explicit operator СвЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                static СвЮЛLocalType()
                {
                    BuildElementDictionary();
                    contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвНаимЮЛ", "")), new NamedContentModelEntity(XName.Get("СвАдресЮЛ", "")), new NamedContentModelEntity(XName.Get("СвАдрЭлПочты", "")), new NamedContentModelEntity(XName.Get("СвОбрЮЛ", "")), new NamedContentModelEntity(XName.Get("СвРегОрг", "")), new NamedContentModelEntity(XName.Get("СвСтатус", "")), new NamedContentModelEntity(XName.Get("СвПрекрЮЛ", "")), new NamedContentModelEntity(XName.Get("СвУчетНО", "")), new NamedContentModelEntity(XName.Get("СвРегПФ", "")), new NamedContentModelEntity(XName.Get("СвРегФСС", "")), new NamedContentModelEntity(XName.Get("СвУстКап", "")), new NamedContentModelEntity(XName.Get("СвУпрОрг", "")), new NamedContentModelEntity(XName.Get("СведДолжнФЛ", "")), new NamedContentModelEntity(XName.Get("СвУчредит", "")), new NamedContentModelEntity(XName.Get("СвДоляООО", "")), new NamedContentModelEntity(XName.Get("СвДержРеестрАО", "")), new NamedContentModelEntity(XName.Get("СвОКВЭД", "")), new NamedContentModelEntity(XName.Get("СвЛицензия", "")), new NamedContentModelEntity(XName.Get("СвПодразд", "")), new NamedContentModelEntity(XName.Get("СвРеорг", "")), new NamedContentModelEntity(XName.Get("СвПредш", "")), new NamedContentModelEntity(XName.Get("СвКФХПредш", "")), new NamedContentModelEntity(XName.Get("СвПреем", "")), new NamedContentModelEntity(XName.Get("СвКФХПреем", "")), new NamedContentModelEntity(XName.Get("СвЗапЕГРЮЛ", "")));
                }
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвСтатусLocalType> СвСтатус
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУпрОргLocalType> СвУпрОрг
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СведДолжнФЛLocalType> СведДолжнФЛ
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвЛицензияLocalType> СвЛицензия
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвРеоргLocalType> СвРеорг
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвПредшLocalType> СвПредш
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвКФХПредшLocalType> СвКФХПредш
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвПреемLocalType> СвПреем
                {
                    get
                    {
                ...
                /// </para>
                /// </summary>
                public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвЗапЕГРЮЛLocalType> СвЗапЕГРЮЛ
                {
                    get
                    {
                ...
                public partial class СвНаимЮЛLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвНаимЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвНаимЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвАдресЮЛLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвАдресЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвАдресЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвАдресЮЛLocalType.СведОтсутАдресЮЛLocalType> СведОтсутАдресЮЛ
                    {
                        get
                        {
                    ...
                    public partial class СведОтсутАдресЮЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СведОтсутАдресЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СведОтсутАдресЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static СведОтсутАдресЮЛLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("РешСудНедАдр", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                        }
                ...
                public partial class СвАдрЭлПочтыLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвАдрЭлПочтыLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвАдрЭлПочтыLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвОбрЮЛLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвОбрЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвОбрЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвОбрЮЛLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СпОбрЮЛ", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                    }
                    ...
                    public partial class СпОбрЮЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СпОбрЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СпОбрЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвРегОргLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвРегОргLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРегОргLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвСтатусLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвСтатусLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвСтатусLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвСтатусLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвСтатус", "")), new NamedContentModelEntity(XName.Get("СвРешИсклЮЛ", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                    }
                    ...
                    public partial class СвСтатусLocalType1 : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвСтатусLocalType1(XElement xe) { return XTypedServices.ToXTypedElement<СвСтатусLocalType1>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class СвРешИсклЮЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвРешИсклЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРешИсклЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвПрекрЮЛLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвПрекрЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвПрекрЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвПрекрЮЛLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СпПрекрЮЛ", "")), new NamedContentModelEntity(XName.Get("СвРегОрг", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")));
                    }
                    ...
                    public partial class СпПрекрЮЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СпПрекрЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СпПрекрЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвУчетНОLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвУчетНОLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвУчетНОLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвУчетНОLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвНО", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                    }
                ...
                public partial class СвРегПФLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвРегПФLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРегПФLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвРегПФLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвОргПФ", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                    }
                    ...
                    public partial class СвОргПФLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвОргПФLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвОргПФLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвРегФССLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвРегФССLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРегФССLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвРегФССLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвОргФСС", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                    }
                    ...
                    public partial class СвОргФССLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвОргФССLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвОргФССLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвУстКапLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвУстКапLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвУстКапLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвУстКапLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ДоляРубля", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")), new NamedContentModelEntity(XName.Get("СведУмУК", "")));
                    }
                    ...
                    public partial class СведУмУКLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СведУмУКLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СведУмУКLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвУпрОргLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвУпрОргLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвУпрОргLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвУпрОргLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("НаимИННЮЛ", "")), new NamedContentModelEntity(XName.Get("СвРегИн", "")), new NamedContentModelEntity(XName.Get("СвПредЮЛ", "")), new NamedContentModelEntity(XName.Get("СвАдрРФ", "")), new NamedContentModelEntity(XName.Get("СвНомТел", "")), new NamedContentModelEntity(XName.Get("ПредИнЮЛ", "")));
                    }
                    ...
                    public partial class СвПредЮЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвПредЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвПредЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class ПредИнЮЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator ПредИнЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<ПредИнЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static ПредИнЮЛLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("СвФЛ", "")), new NamedContentModelEntity(XName.Get("СвНомТел", "")), new NamedContentModelEntity(XName.Get("СвРождФЛ", "")), new NamedContentModelEntity(XName.Get("УдЛичнФЛ", "")), new NamedContentModelEntity(XName.Get("АдресМЖРФ", "")), new NamedContentModelEntity(XName.Get("АдрМЖИн", "")));
                        }
                ...
                public partial class СведДолжнФЛLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СведДолжнФЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СведДолжнФЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СведДолжнФЛLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("СвФЛ", "")), new NamedContentModelEntity(XName.Get("СвДолжн", "")), new NamedContentModelEntity(XName.Get("СвНомТел", "")), new NamedContentModelEntity(XName.Get("СвРождФЛ", "")), new NamedContentModelEntity(XName.Get("УдЛичнФЛ", "")), new NamedContentModelEntity(XName.Get("АдресМЖРФ", "")), new NamedContentModelEntity(XName.Get("АдрМЖИн", "")), new NamedContentModelEntity(XName.Get("СвДискв", "")));
                    }
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СведДолжнФЛLocalType.СвДисквLocalType> СвДискв
                    {
                        get
                        {
                    ...
                    public partial class СвДолжнLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвДолжнLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвДолжнLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class СвДисквLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвДисквLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвДисквLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвУчредитLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвУчредитLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвУчредитLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвУчредитLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("УчрЮЛРос", "")), new NamedContentModelEntity(XName.Get("УчрЮЛИн", "")), new NamedContentModelEntity(XName.Get("УчрФЛ", "")), new NamedContentModelEntity(XName.Get("УчрРФСубМО", "")), new NamedContentModelEntity(XName.Get("УчрПИФ", "")));
                    }
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУчредитLocalType.УчрЮЛРосLocalType> УчрЮЛРос
                    {
                        get
                        {
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУчредитLocalType.УчрЮЛИнLocalType> УчрЮЛИн
                    {
                        get
                        {
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУчредитLocalType.УчрФЛLocalType> УчрФЛ
                    {
                        get
                        {
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУчредитLocalType.УчрРФСубМОLocalType> УчрРФСубМО
                    {
                        get
                        {
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУчредитLocalType.УчрПИФLocalType> УчрПИФ
                    {
                        get
                        {
                    ...
                    public partial class УчрЮЛРосLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator УчрЮЛРосLocalType(XElement xe) { return XTypedServices.ToXTypedElement<УчрЮЛРосLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static УчрЮЛРосLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("НаимИННЮЛ", "")), new NamedContentModelEntity(XName.Get("СвРегСтарые", "")), new NamedContentModelEntity(XName.Get("ДоляУстКап", "")), new NamedContentModelEntity(XName.Get("СвОбрем", "")));
                        }
                        ...
                        public partial class СвРегСтарыеLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвРегСтарыеLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРегСтарыеLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class УчрЮЛИнLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator УчрЮЛИнLocalType(XElement xe) { return XTypedServices.ToXTypedElement<УчрЮЛИнLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static УчрЮЛИнLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("НаимИННЮЛ", "")), new NamedContentModelEntity(XName.Get("СвРегИн", "")), new NamedContentModelEntity(XName.Get("ДоляУстКап", "")), new NamedContentModelEntity(XName.Get("СвОбрем", "")));
                        }
                    ...
                    public partial class УчрФЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator УчрФЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<УчрФЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static УчрФЛLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("СвФЛ", "")), new NamedContentModelEntity(XName.Get("СвРождФЛ", "")), new NamedContentModelEntity(XName.Get("УдЛичнФЛ", "")), new NamedContentModelEntity(XName.Get("АдресМЖРФ", "")), new NamedContentModelEntity(XName.Get("АдрМЖИн", "")), new NamedContentModelEntity(XName.Get("ДоляУстКап", "")), new NamedContentModelEntity(XName.Get("СвОбрем", "")), new NamedContentModelEntity(XName.Get("СвДовУпрЮЛ", "")), new NamedContentModelEntity(XName.Get("СвДовУпрФЛ", "")), new NamedContentModelEntity(XName.Get("ЛицоУпрНасл", "")));
                        }
                        ...
                        public partial class СвДовУпрЮЛLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвДовУпрЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвДовУпрЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                            static СвДовУпрЮЛLocalType()
                            {
                                BuildElementDictionary();
                                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("НаимИННДовУпр", "")));
                            }
                        ...
                        public partial class СвДовУпрФЛLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвДовУпрФЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвДовУпрФЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                        ...
                        public partial class ЛицоУпрНаслLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator ЛицоУпрНаслLocalType(XElement xe) { return XTypedServices.ToXTypedElement<ЛицоУпрНаслLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class УчрРФСубМОLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator УчрРФСубМОLocalType(XElement xe) { return XTypedServices.ToXTypedElement<УчрРФСубМОLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static УчрРФСубМОLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("ВидНаимУчр", "")), new NamedContentModelEntity(XName.Get("ДоляУстКап", "")), new NamedContentModelEntity(XName.Get("СвОргОсущПр", "")), new NamedContentModelEntity(XName.Get("СвФЛОсущПр", "")), new NamedContentModelEntity(XName.Get("СвОбрем", "")));
                        }
                        ...
                        /// </para>
                        /// </summary>
                        public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУчредитLocalType.УчрРФСубМОLocalType.СвОргОсущПрLocalType> СвОргОсущПр
                        {
                            get
                            {
                        ...
                        /// </para>
                        /// </summary>
                        public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвУчредитLocalType.УчрРФСубМОLocalType.СвФЛОсущПрLocalType> СвФЛОсущПр
                        {
                            get
                            {
                        ...
                        public partial class ВидНаимУчрLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator ВидНаимУчрLocalType(XElement xe) { return XTypedServices.ToXTypedElement<ВидНаимУчрLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                        ...
                        public partial class СвОргОсущПрLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвОргОсущПрLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвОргОсущПрLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                        ...
                        public partial class СвФЛОсущПрLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвФЛОсущПрLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвФЛОсущПрLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class УчрПИФLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator УчрПИФLocalType(XElement xe) { return XTypedServices.ToXTypedElement<УчрПИФLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static УчрПИФLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("СвНаимПИФ", "")), new NamedContentModelEntity(XName.Get("СвУпрКомпПИФ", "")), new NamedContentModelEntity(XName.Get("ДоляУстКап", "")), new NamedContentModelEntity(XName.Get("СвОбрем", "")));
                        }
                        ...
                        public partial class СвНаимПИФLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвНаимПИФLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвНаимПИФLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                        ...
                        public partial class СвУпрКомпПИФLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвУпрКомпПИФLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвУпрКомпПИФLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвДержРеестрАОLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвДержРеестрАОLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвДержРеестрАОLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвОКВЭДLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвОКВЭДLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвОКВЭДLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвЛицензияLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвЛицензияLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвЛицензияLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвЛицензияLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("НаимЛицВидДеят", "")), new NamedContentModelEntity(XName.Get("МестоДейстЛиц", "")), new NamedContentModelEntity(XName.Get("ЛицОргВыдЛиц", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")), new NamedContentModelEntity(XName.Get("СвПриостЛиц", "")));
                    }
                    ...
                    public IList<string> НаимЛицВидДеят
                    {
                        ...
                        set
                        {
                            ...
                            else
                            {
                                if ((this.НаимЛицВидДеятField == null))
                                {
                                    this.НаимЛицВидДеятField = XSimpleList<string>.Initialize(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype, value, XName.Get("НаимЛицВидДеят", ""));
                                }
                                else
                                {
                    ...
                    public IList<string> МестоДейстЛиц
                    {
                        ...
                        set
                        {
                            ...
                            else
                            {
                                if ((this.МестоДейстЛицField == null))
                                {
                                    this.МестоДейстЛицField = XSimpleList<string>.Initialize(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype, value, XName.Get("МестоДейстЛиц", ""));
                                }
                                else
                                {
                    ...
                    private class МестоДейстЛицLocalType
                    {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(6)), null, 0, 0, null, null, 500, null, null, 5, null, 0, XmlSchemaWhiteSpace.Preserve));
                    ...
                    public partial class СвПриостЛицLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвПриостЛицLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвПриостЛицLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвПодраздLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвПодраздLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвПодраздLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвПодраздLocalType.СвФилиалLocalType> СвФилиал
                    {
                        get
                        {
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвПодраздLocalType.СвПредставLocalType> СвПредстав
                    {
                        get
                        {
                    ...
                    public partial class СвФилиалLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвФилиалLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвФилиалLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static СвФилиалLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("СвНаим", "")), new NamedContentModelEntity(XName.Get("АдрМНРФ", "")), new NamedContentModelEntity(XName.Get("АдрМНИн", "")), new NamedContentModelEntity(XName.Get("СвУчетНОФилиал", "")));
                        }
                    ...
                    public partial class СвПредставLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвПредставLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвПредставLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static СвПредставLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("СвНаим", "")), new NamedContentModelEntity(XName.Get("АдрМНРФ", "")), new NamedContentModelEntity(XName.Get("АдрМНИн", "")), new NamedContentModelEntity(XName.Get("СвУчетНОПредстав", "")));
                        }
                ...
                public partial class СвРеоргLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвРеоргLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРеоргLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвРеоргLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвСтатус", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИзмСостРеоргЮЛ", "")), new NamedContentModelEntity(XName.Get("СвРеоргЮЛ", "")));
                    }
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвРеоргLocalType.СвРеоргЮЛLocalType> СвРеоргЮЛ
                    {
                        get
                        {
                    ...
                    public partial class СвРеоргЮЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвРеоргЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРеоргЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвПредшLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвПредшLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвПредшLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвПредшLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвЮЛсложнРеорг", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                    }
                    ...
                    public partial class СвЮЛсложнРеоргLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвЮЛсложнРеоргLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвЮЛсложнРеоргLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвКФХПредшLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвКФХПредшLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвКФХПредшLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвПреемLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвПреемLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвПреемLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвКФХПреемLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвКФХПреемLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвКФХПреемLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                ...
                public partial class СвЗапЕГРЮЛLocalType : XTypedElement, IXMetaData
                {
                    ...
                    public static explicit operator СвЗапЕГРЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвЗапЕГРЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                    static СвЗапЕГРЮЛLocalType()
                    {
                        BuildElementDictionary();
                        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ВидЗап", "")), new NamedContentModelEntity(XName.Get("СвРегОрг", "")), new NamedContentModelEntity(XName.Get("СвЗаявФЛ", "")), new NamedContentModelEntity(XName.Get("СведПредДок", "")), new NamedContentModelEntity(XName.Get("СвСвид", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспрПред", "")), new NamedContentModelEntity(XName.Get("ГРНДатаНедПред", "")), new NamedContentModelEntity(XName.Get("СвСтатусЗап", "")));
                    }
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвЗапЕГРЮЛLocalType.СвЗаявФЛLocalType> СвЗаявФЛ
                    {
                        get
                        {
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвЗапЕГРЮЛLocalType.СведПредДокLocalType> СведПредДок
                    {
                        get
                        {
                    ...
                    /// </para>
                    /// </summary>
                    public IList<Файл.ДокументLocalType.СвЮЛLocalType.СвЗапЕГРЮЛLocalType.СвСвидLocalType> СвСвид
                    {
                        get
                        {
                    ...
                    public partial class СвЗаявФЛLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвЗаявФЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвЗаявФЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static СвЗаявФЛLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ВидЗаяв", "")), new NamedContentModelEntity(XName.Get("СвЮЛ", "")), new NamedContentModelEntity(XName.Get("СвУпрОрг", "")), new NamedContentModelEntity(XName.Get("СвФЛ", "")));
                        }
                        ...
                        public partial class ВидЗаявLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator ВидЗаявLocalType(XElement xe) { return XTypedServices.ToXTypedElement<ВидЗаявLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                        ...
                        public partial class СвФЛLocalType : XTypedElement, IXMetaData
                        {
                            ...
                            public static explicit operator СвФЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвФЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                            static СвФЛLocalType()
                            {
                                BuildElementDictionary();
                                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("СвФИОИНН", "")), new NamedContentModelEntity(XName.Get("СвРожд", "")), new NamedContentModelEntity(XName.Get("УдЛичнФЛ", "")), new NamedContentModelEntity(XName.Get("АдресМЖРФ", "")), new NamedContentModelEntity(XName.Get("АдрМЖИн", "")));
                            }
                            ...
                            public partial class СвФИОИННLocalType : XTypedElement, IXMetaData
                            {
                                ...
                                public static explicit operator СвФИОИННLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвФИОИННLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                            ...
                            public partial class СвРождLocalType : XTypedElement, IXMetaData
                            {
                                ...
                                public static explicit operator СвРождLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвРождLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                            ...
                            public partial class УдЛичнФЛLocalType : XTypedElement, IXMetaData
                            {
                                ...
                                public static explicit operator УдЛичнФЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<УдЛичнФЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                            ...
                            public partial class АдресМЖРФLocalType : XTypedElement, IXMetaData
                            {
                                ...
                                public static explicit operator АдресМЖРФLocalType(XElement xe) { return XTypedServices.ToXTypedElement<АдресМЖРФLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                                static АдресМЖРФLocalType()
                                {
                                    BuildElementDictionary();
                                    contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("Регион", "")), new NamedContentModelEntity(XName.Get("Район", "")), new NamedContentModelEntity(XName.Get("Город", "")), new NamedContentModelEntity(XName.Get("НаселПункт", "")), new NamedContentModelEntity(XName.Get("Улица", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
                                }
                            ...
                            public partial class АдрМЖИнLocalType : XTypedElement, IXMetaData
                            {
                                ...
                                public static explicit operator АдрМЖИнLocalType(XElement xe) { return XTypedServices.ToXTypedElement<АдрМЖИнLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class СведПредДокLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СведПредДокLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СведПредДокLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                        static СведПредДокLocalType()
                        {
                            BuildElementDictionary();
                            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("НаимДок", "")), new NamedContentModelEntity(XName.Get("НомДок", "")), new NamedContentModelEntity(XName.Get("ДатаДок", "")));
                        }
                        ...
                        private class НаимДокLocalType
                        {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(6)), null, 0, 0, null, null, 255, null, null, 1, null, 0, XmlSchemaWhiteSpace.Preserve));
                        ...
                        private class ДатаДокLocalType
                        {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Date), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(256)), null, 0, 0, null, null, 0, null, new System.DateTime(599266080000000000), 0, null, 0, XmlSchemaWhiteSpace.Collapse));
                    ...
                    public partial class СвСвидLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвСвидLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвСвидLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
                    ...
                    public partial class СвСтатусЗапLocalType : XTypedElement, IXMetaData
                    {
                        ...
                        public static explicit operator СвСтатусЗапLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвСтатусЗапLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class ВидЗапТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator ВидЗапТип(XElement xe) { return XTypedServices.ToXTypedElement<ВидЗапТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class АдрИнЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator АдрИнЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<АдрИнЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class АдрРФЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator АдрРФЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<АдрРФЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class ГородТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator ГородТип(XElement xe) { return XTypedServices.ToXTypedElement<ГородТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class ГРНДатаТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator ГРНДатаТип(XElement xe) { return XTypedServices.ToXTypedElement<ГРНДатаТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class ДоляУстКапЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator ДоляУстКапЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<ДоляУстКапЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

        static ДоляУстКапЕГРЮЛТип()
        {
            BuildElementDictionary();
            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("РазмерДоли", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")));
        }
        ...
        public partial class РазмерДолиLocalType : XTypedElement, IXMetaData
        {
            ...
            public static explicit operator РазмерДолиLocalType(XElement xe) { return XTypedServices.ToXTypedElement<РазмерДолиLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

            static РазмерДолиLocalType()
            {
                BuildElementDictionary();
                contentModel = new ChoiceContentModelEntity(new NamedContentModelEntity(XName.Get("Процент", "")), new NamedContentModelEntity(XName.Get("ДробДесят", "")), new NamedContentModelEntity(XName.Get("ДробПрост", "")));
            }
            ...
            private class ПроцентLocalType
            {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Decimal), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(3328)), null, 15, 0, null, null, 0, null, 0m, 0, null, 18, XmlSchemaWhiteSpace.Collapse));
            ...
            private class ДробДесятLocalType
            {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Decimal), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(3328)), null, 15, 0, null, null, 0, null, 0m, 0, null, 16, XmlSchemaWhiteSpace.Collapse));
    ...
    public partial class ДробьТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator ДробьТип(XElement xe) { return XTypedServices.ToXTypedElement<ДробьТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class ИдГРНДатаТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator ИдГРНДатаТип(XElement xe) { return XTypedServices.ToXTypedElement<ИдГРНДатаТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class НаселПунктТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator НаселПунктТип(XElement xe) { return XTypedServices.ToXTypedElement<НаселПунктТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class РайонТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator РайонТип(XElement xe) { return XTypedServices.ToXTypedElement<РайонТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class РегионТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator РегионТип(XElement xe) { return XTypedServices.ToXTypedElement<РегионТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class РешСудТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator РешСудТип(XElement xe) { return XTypedServices.ToXTypedElement<РешСудТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвНаимПодраздТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвНаимПодраздТип(XElement xe) { return XTypedServices.ToXTypedElement<СвНаимПодраздТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвНомТелТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвНомТелТип(XElement xe) { return XTypedServices.ToXTypedElement<СвНомТелТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвНОТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвНОТип(XElement xe) { return XTypedServices.ToXTypedElement<СвНОТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвНотУдДогЗалТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвНотУдДогЗалТип(XElement xe) { return XTypedServices.ToXTypedElement<СвНотУдДогЗалТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвОбремТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвОбремТип(XElement xe) { return XTypedServices.ToXTypedElement<СвОбремТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

        static СвОбремТип()
        {
            BuildElementDictionary();
            contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("РешСуд", "")), new NamedContentModelEntity(XName.Get("ГРНДата", "")), new NamedContentModelEntity(XName.Get("ГРНДатаИспр", "")), new NamedContentModelEntity(XName.Get("СвЗалогДержФЛ", "")), new NamedContentModelEntity(XName.Get("СвЗалогДержЮЛ", "")));
        }
        ...
        public partial class СвЗалогДержФЛLocalType : XTypedElement, IXMetaData
        {
            ...
            public static explicit operator СвЗалогДержФЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвЗалогДержФЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

            static СвЗалогДержФЛLocalType()
            {
                BuildElementDictionary();
                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("СвФЛ", "")), new NamedContentModelEntity(XName.Get("СвРождФЛ", "")), new NamedContentModelEntity(XName.Get("УдЛичнФЛ", "")), new NamedContentModelEntity(XName.Get("АдресМЖРФ", "")), new NamedContentModelEntity(XName.Get("АдрМЖИн", "")), new NamedContentModelEntity(XName.Get("СвНотУдДогЗал", "")));
            }
        ...
        public partial class СвЗалогДержЮЛLocalType : XTypedElement, IXMetaData
        {
            ...
            public static explicit operator СвЗалогДержЮЛLocalType(XElement xe) { return XTypedServices.ToXTypedElement<СвЗалогДержЮЛLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

            static СвЗалогДержЮЛLocalType()
            {
                BuildElementDictionary();
                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ГРНДатаПерв", "")), new NamedContentModelEntity(XName.Get("НаимИННЮЛ", "")), new NamedContentModelEntity(XName.Get("СвРегИн", "")), new NamedContentModelEntity(XName.Get("СвНотУдДогЗал", "")));
            }
    ...
    public partial class СвОКВЭДТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвОКВЭДТип(XElement xe) { return XTypedServices.ToXTypedElement<СвОКВЭДТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвРегИнЮЛЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвРегИнЮЛЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<СвРегИнЮЛЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвРегОргТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвРегОргТип(XElement xe) { return XTypedServices.ToXTypedElement<СвРегОргТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвРождЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвРождЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<СвРождЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвУчетНОПодраздТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвУчетНОПодраздТип(XElement xe) { return XTypedServices.ToXTypedElement<СвУчетНОПодраздТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвФЛЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвФЛЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<СвФЛЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class СвЮЛЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator СвЮЛЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<СвЮЛЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class УдЛичнЕГРЮЛТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator УдЛичнЕГРЮЛТип(XElement xe) { return XTypedServices.ToXTypedElement<УдЛичнЕГРЮЛТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class УлицаТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator УлицаТип(XElement xe) { return XTypedServices.ToXTypedElement<УлицаТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public partial class ФИОТип : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator ФИОТип(XElement xe) { return XTypedServices.ToXTypedElement<ФИОТип>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }
    ...
    public sealed class ИННФЛТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 12, null, null, 0, null, null, 0, new string[] {
                    "([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{10}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class ИННЮЛТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 10, null, null, 0, null, null, 0, new string[] {
                    "([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})[0-9]{8}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class КППТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 9, null, null, 0, null, null, 0, new string[] {
                    "([0-9]{1}[1-9]{1}|[1-9]{1}[0-9]{1})([0-9]{2})([0-9A-F]{2})([0-9]{3})"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class ОГРНТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 13, null, null, 0, null, null, 0, new string[] {
                    "[0-9]{13}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class ОГРНИПТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 15, null, null, 0, null, null, 0, new string[] {
                    "[0-9]{15}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class ОКВЭДТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(14)), null, 0, 0, null, null, 8, null, null, 2, new string[] {
                    "[0-9]{2}",
                    "[0-9]{2}\\.[0-9]{1}",
                    "[0-9]{2}\\.[0-9]{2}",
                    "[0-9]{2}\\.[0-9]{2}\\.[0-9]{1}",
                    "[0-9]{2}\\.[0-9]{2}\\.[0-9]{2}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class ОКСМТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 3, null, null, 0, null, null, 0, new string[] {
                    "[0-9]{3}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class СОНОТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 4, null, null, 0, null, null, 0, new string[] {
                    "[0-9]{4}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public sealed class СПДУЛТип
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static Xml.Schema.Linq.SimpleTypeValidator TypeDefinition = new Xml.Schema.Linq.AtomicSimpleTypeValidator(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String), new Xml.Schema.Linq.RestrictionFacets(((Xml.Schema.Linq.RestrictionFlags)(9)), null, 0, 2, null, null, 0, null, null, 0, new string[] {
                    "[0-9]{2}"}, 0, XmlSchemaWhiteSpace.Preserve));
    ...
    public class LinqToXsdTypeManager : ILinqToXsdTypeManager
    {
        ...
        private static void BuildElementDictionary()
        {
            elementDictionary.Add(XName.Get("Файл", ""), typeof(Файл));
        }
        ...
        {
            return elementDictionary[XName.Get("Файл", "")];
        }
    }
    ...
    public partial class XRootNamespace
    {
        ...
        public Файл Файл { get { return rootObject as Файл; } }

        private XRootNamespace()
        {
        }

        public XRootNamespace(Файл root)
        {
