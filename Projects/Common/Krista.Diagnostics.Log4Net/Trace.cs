...
namespace Krista.Diagnostics.Log4Net
{
    ...
    internal sealed class Trace
    {
        ...
        ///  Имя источника
        /// </summary>
        private static string sourceName = "Krista.Diagnostics.Log4Net";
        ...
        {
            KristaDiagnostics.TraceEvent(TraceEventType.Error, sourceName, KristaDiagnostics.ExpandException(e));
        }
