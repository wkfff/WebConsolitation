...
{
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof (Krista.FM.Client.Common.Wizards.WizardForm), "Krista.FM.Client.Common.Wizards.WizardForm.bmp"
        )]
    [Designer(
     "Krista.FM.Client.Design.WizardFormDesigner, Krista.FM.Client.Design, Version=2.4.1.*, Culture=neutral, PublicKeyToken=null"
        )]
    public class WizardForm : System.Windows.Forms.UserControl
    {
        ...
        {
            [Browsable(false)] None = 0x0000,
            [Description("Enable or Disable Previous Button")] Previous = 0x0001,
            [Description("Enable or Disable Next/Finish button")] Next = 0x0002,
            [Description("If checked then Next button become a Finish Button")] Finish = 0x0004,
            [Description("Show or not Help button")] Help = 0x0010,
            [Description("Enable or Disable Cancel button")] Cancel = 0x0020,

            [Browsable(false)] All = Previous | Next | Cancel | Help,
            [Browsable(false)] AllShort = Previous | Next | Cancel,
            [Browsable(false)] AllShortFinishDisabled = Previous | Finish | Cancel,
            [Browsable(false)] AllShortFinishEnabled = Previous | Next | Finish | Cancel,
            [Browsable(false)] AllFinishEnabled = Previous | Next | Finish | Cancel | Help,
            [Browsable(false)] AllFinishDisabled = Previous | Finish | Help | Cancel
        }
        ...
        public static string DEF_FINISH = "&Готово";
        public static string DEF_NEXT = "&Далее >";
        public static string DEF_BACK = "< &Назад";
        public static string DEF_HELP = "&Справка";
        public static string DEF_CANCEL = "&Отмена";
		public static string DEF_CLOSE = "Все введенные данные на страницах мастера будут потеряны. Закрыть мастер?";
        public static string DEF_CLOSE_ = "Do you want to close Wizard and loose all Data entered on Wizard Pages?";
        public static string DEF_WARNING = "Внимание";
        ...
        public class WizardPagesCollection : CollectionBase
        {
            ...
            {
                get { return InnerList[index] as WizardPageBase; }
                set
                {
                    value.WizardPageParent = m_parent;
                    value.Index = index;
        ...
        private Krista.FM.Client.Common.Wizards.LineFrame lineDownLimit;
        private System.Windows.Forms.Panel pnlBody;
        private UltraButton btnCancel;
        private UltraButton btnNextFinish;
        ...
        [Editor(
            "UtilityLibrary.Designers.FlagsEditor, UtilityLibrary.Designers, Version=1.0.4.0, Culture=neutral, PublicKeyToken=fe06e967d3cf723d"
            ,
            typeof (UITypeEditor))]
        ...
        {
            get { return !m_bFireEvents; }
            set { m_bFireEvents = !value; }
        }
        ...
        {
            get { return m_bShowConfirm; }
            set { m_bShowConfirm = value; }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.btnNextFinish = new UltraButton();
            this.btnBack = new UltraButton();
            this.lineDownLimit = new Krista.FM.Client.Common.Wizards.LineFrame();
            this.pnlBody = new System.Windows.Forms.Panel();
            this.btnHelp = new UltraButton();
            ...
            this.lblTitle.Appearance.TextVAlign = Infragistics.Win.VAlign.Middle;
            this.lblTitle.Appearance.TextHAlign = Infragistics.Win.HAlign.Left;
            // 
            // lblDescription
            // 
            ...
            // btnNextFinish
            // 
            this.btnNextFinish.Anchor = (System.Windows.Forms.AnchorStyles.Bottom |
                                         System.Windows.Forms.AnchorStyles.Right);
            ...
            // lineDownLimit
            // 
            this.lineDownLimit.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom |
                                          System.Windows.Forms.AnchorStyles.Left)
                                         | System.Windows.Forms.AnchorStyles.Right);
        ...
        protected virtual DialogResult OnCancelPressed()
        {
            ...
            {
                DialogResult result = MessageBox.Show(this, e.Message, e.Title, MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
