...
// PASTLWTR : 1.2
// File generated on 08.07.2003 12:42:52 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\DEVNULL\FMSO\msmddo.dll (1)
...
//   (2) v1.2 POMInterfaces, (D:\Program Files\Common Files\Microsoft Shared\DSO\msmdint.dll)
//   (3) v6.0 VBA, (D:\WINNTSRV\System32\msvbvm60.dll)
//   (4) v2.1 ADODB, (D:\Program Files\Common Files\System\ADO\msado21.tlb)
//   (5) v1.0 MSOLAPADMINLib, (D:\Program Files\Common Files\System\OLE DB\msmdgdrv.dll)
// Errors:
...
uses Windows, ActiveX, ADODB_TLB, {Classes, Graphics,} MSOLAPADMINLib_TLB, POMInterfaces_TLB, {StdVCL,}
VBA_TLB;
...
const
  ...
  IID__Server70: TGUID = '{63A7E3A6-79EE-4915-9447-7850CC4940ED}';
  CLASS_Server70: TGUID = '{5C05329F-B9DB-44AE-8045-5BCE24100112}';
...
// *********************************************************************//
  _PartitionAnalyzer = interface(IDispatch)
    ...
    procedure AddGoalQuery(const DatasetName: WideString; Frequancy: Double); safecall;
...
// *********************************************************************//
  _PartitionAnalyzerDisp = dispinterface
    ...
    procedure AddGoalQuery(const DatasetName: WideString; Frequancy: Double); dispid 1610809381;
...
// Interface: _Server70
// Flags:     (4560) Hidden Dual NonExtensible OleAutomation Dispatchable
// GUID:      {63A7E3A6-79EE-4915-9447-7850CC4940ED}
// *********************************************************************//
  _Server70 = interface(IDispatch)
    ['{63A7E3A6-79EE-4915-9447-7850CC4940ED}']
    function Get_CustomProperties: _Properties; safecall;
    procedure Set_Valid(Param1: WordBool); safecall;
    function Get_RepositoryVersion: Smallint; safecall;
    function Get_Valid: WordBool; safecall;
...
// *********************************************************************//
// DispIntf:  _Server70Disp
// Flags:     (4560) Hidden Dual NonExtensible OleAutomation Dispatchable
// GUID:      {63A7E3A6-79EE-4915-9447-7850CC4940ED}
// *********************************************************************//
  _Server70Disp = dispinterface
    ['{63A7E3A6-79EE-4915-9447-7850CC4940ED}']
    property CustomProperties: _Properties readonly dispid 1745027092;
    property Valid: WordBool dispid 1745027091;
    property RepositoryVersion: Smallint readonly dispid 1745027090;
    property Machine: WideString readonly dispid 1745027089;
    property Name: WideString dispid 1745027088;
    procedure ClearCollections; dispid 1610809366;
    property LockTimeout: Integer dispid 1745027087;
    procedure LockObject(LockType: OlapLockTypes; const LockDescription: WideString); dispid 1610809367;
    procedure UnlockObject; dispid 1610809368;
    procedure Refresh; dispid 1610809369;
    function UnlockAllObjects: WordBool; dispid 1610809370;
    property State: ServerStates readonly dispid 1745027085;
    property Path: WideString readonly dispid 1745027084;
    property MDStores: _OlapCollection readonly dispid 1745027083;
    property Parent: IDispatch readonly dispid 1745027082;
    property Description: WideString dispid 1745027081;
    property Edition: OlapEditions readonly dispid 1745027080;
    procedure Update; dispid 1610809371;
    property Timeout: Integer dispid 1745027079;
    property ConnectTimeout: Integer dispid 1745027078;
    property ClassType: Smallint readonly dispid 1745027077;
    procedure Connect(const ServerName: WideString); dispid 1610809373;
    procedure CloseServer; dispid 1610809374;
    property IObject: IDispatch readonly dispid 1745027076;
    property ServiceState: Integer dispid 1745027075;
    property IsValid: WordBool readonly dispid 1745027074;
    function CreateObject(ObjectType: ClassTypes; SubClassType: SubClassTypes): IDispatch; dispid 1610809375;
    property Version: WideString readonly dispid 1745027073;
    property ProcessingLogFileName: WideString dispid 1745027072;
  end;
...
// *********************************************************************//
// The Class CoServer70 provides a Create and CreateRemote method to          
// create instances of the default interface _Server70 exposed by              
// the CoClass Server70. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoServer70 = class
    class function Create: _Server70;
    class function CreateRemote(const MachineName: string): _Server70;
  end;
...
class function CoServer70.Create: _Server70;
begin
  Result := CreateComObject(CLASS_Server70) as _Server70;
end;

class function CoServer70.CreateRemote(const MachineName: string): _Server70;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Server70) as _Server70;
end;
