...
// File generated on 15.02.2005 17:50:11 from Type Library described below.
...
// they can be used.                                                          
// ************************************************************************ //
// Type Lib: D:\WINNT\system32\richtx32.ocx (1)
// IID\LCID: {3B7C8863-D78F-101B-B9B5-04021C009402}\0
// Helpfile: D:\WINNT\system32\RTFBox98.CHM
// DepndLst: 
...
//   Error creating palette bitmap of (TOLEObjects) : Invalid GUID format
// ************************************************************************ //
...
// Server Object    : TOLEObjects
// Help String      : RichText Control OLEObjects Collection Interface
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TOLEObjectsProperties= class;
{$ENDIF}
  TOLEObjects = class(TOleServer)
  private
    FIntf:        IOLEObjects;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TOLEObjectsProperties;
    function      GetServerProperties: TOLEObjectsProperties;
{$ENDIF}
    function      GetDefaultInterface: IOLEObjects;
  protected
  ...
  public
    ...
    procedure ConnectTo(svrIntf: IOLEObjects);
    procedure Disconnect; override;
    procedure Clear;
    function  Add: IOLEObject; overload;
    function  Add(Index: OleVariant): IOLEObject; overload;
    function  Add(Index: OleVariant; Key: OleVariant): IOLEObject; overload;
    function  Add(Index: OleVariant; Key: OleVariant; source: OleVariant): IOLEObject; overload;
    function  Add(Index: OleVariant; Key: OleVariant; source: OleVariant; objclass: OleVariant): IOLEObject; overload;
    procedure Remove(Item: OleVariant);
    function  _NewEnum: IUnknown;
    property  DefaultInterface: IOLEObjects read GetDefaultInterface;
    property Item[Item: OleVariant]: IOLEObject read Get_Item; default;
    property Count: Integer read Get_Count;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TOLEObjectsProperties read GetServerProperties;
{$ENDIF}
  end;
...
// *********************************************************************//
 TOLEObjectsProperties = class(TPersistent)
  private
    FServer:    TOLEObjects;
    function    GetDefaultInterface: IOLEObjects;
    constructor Create(AServer: TOLEObjects);
  protected
    function  Get_Item(Item: OleVariant): IOLEObject;
    function  Get_Count: Integer;
  public
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TOLEObject
// Help String      : The RichTextBox control enables you to add insertable objects to an RTF file. Insertable objects are represented by the OLEObject.
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TOLEObjectProperties= class;
{$ENDIF}
  TOLEObject = class(TOleServer)
  private
    FIntf:        IOLEObject;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TOLEObjectProperties;
    function      GetServerProperties: TOLEObjectProperties;
{$ENDIF}
    function      GetDefaultInterface: IOLEObject;
  protected
    procedure InitServerData; override;
    function  Get_Index: SYSINT;
    function  Get_Key: WideString;
    procedure Set_Key(const pbstrKey: WideString);
    function  Get_Class_: WideString;
    function  Get_DisplayType: DisplayTypeConstants;
    procedure Set_DisplayType(pnType: DisplayTypeConstants);
  ...
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IOLEObject);
    procedure Disconnect; override;
    procedure DoVerb; overload;
    procedure DoVerb(verb: OleVariant); overload;
    function  FetchVerbs: SYSINT;
    property  DefaultInterface: IOLEObject read GetDefaultInterface;
    property Index: SYSINT read Get_Index;
    property Class_: WideString read Get_Class_;
    property ObjectVerbs: OleVariant read Get_ObjectVerbs;
    property ObjectVerbFlags: OleVariant read Get_ObjectVerbFlags;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TOLEObjectProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TOLEObjectProperties = class(TPersistent)
  private
    FServer:    TOLEObject;
    function    GetDefaultInterface: IOLEObject;
    constructor Create(AServer: TOLEObject);
  protected
    function  Get_Index: SYSINT;
    function  Get_Key: WideString;
    procedure Set_Key(const pbstrKey: WideString);
...
procedure TOLEObjects.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{4A8F35A0-D900-11CF-89B4-00AA00688B10}';
    IntfIID:   '{859321D0-3FD1-11CF-8981-00AA00688B10}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
begin
  ...
  begin
    punk := GetServer;
    Fintf:= punk as IOLEObjects;
  end;
end;

procedure TOLEObjects.ConnectTo(svrIntf: IOLEObjects);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TOLEObjects.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TOLEObjects.GetDefaultInterface: IOLEObjects;
begin
  if FIntf = nil then
    Connect;
...
constructor TOLEObjects.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TOLEObjectsProperties.Create(Self);
{$ENDIF}
end;

destructor TOLEObjects.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TOLEObjects.GetServerProperties: TOLEObjectsProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function  TOLEObjects.Get_Item(Item: OleVariant): IOLEObject;
begin
  Result := DefaultInterface.Get_Item(Item);
end;

function  TOLEObjects.Get_Count: Integer;
begin
  Result := DefaultInterface.Get_Count;
end;

procedure TOLEObjects.Clear;
begin
  DefaultInterface.Clear;
end;

function  TOLEObjects.Add: IOLEObject;
begin
  Result := DefaultInterface.Add(EmptyParam, EmptyParam, EmptyParam, EmptyParam);
end;

function  TOLEObjects.Add(Index: OleVariant): IOLEObject;
begin
  Result := DefaultInterface.Add(Index, EmptyParam, EmptyParam, EmptyParam);
end;

function  TOLEObjects.Add(Index: OleVariant; Key: OleVariant): IOLEObject;
begin
  Result := DefaultInterface.Add(Index, Key, EmptyParam, EmptyParam);
end;

function  TOLEObjects.Add(Index: OleVariant; Key: OleVariant; source: OleVariant): IOLEObject;
begin
  Result := DefaultInterface.Add(Index, Key, source, EmptyParam);
end;

function  TOLEObjects.Add(Index: OleVariant; Key: OleVariant; source: OleVariant; 
                          objclass: OleVariant): IOLEObject;
begin
  Result := DefaultInterface.Add(Index, Key, source, objclass);
end;

procedure TOLEObjects.Remove(Item: OleVariant);
begin
  DefaultInterface.Remove(Item);
end;

function  TOLEObjects._NewEnum: IUnknown;
begin
  Result := DefaultInterface._NewEnum;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TOLEObjectsProperties.Create(AServer: TOLEObjects);
begin
  inherited Create;
  FServer := AServer;
end;

function TOLEObjectsProperties.GetDefaultInterface: IOLEObjects;
begin
  Result := FServer.DefaultInterface;
end;

function  TOLEObjectsProperties.Get_Item(Item: OleVariant): IOLEObject;
begin
  Result := DefaultInterface.Get_Item(Item);
end;

function  TOLEObjectsProperties.Get_Count: Integer;
begin
  Result := DefaultInterface.Get_Count;
end;
...
procedure TOLEObject.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{4A8F35A1-D900-11CF-89B4-00AA00688B10}';
    IntfIID:   '{ED117630-4090-11CF-8981-00AA00688B10}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
begin
  ...
  begin
    punk := GetServer;
    Fintf:= punk as IOLEObject;
  end;
end;

procedure TOLEObject.ConnectTo(svrIntf: IOLEObject);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TOLEObject.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TOLEObject.GetDefaultInterface: IOLEObject;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
constructor TOLEObject.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TOLEObjectProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TOLEObject.GetServerProperties: TOLEObjectProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function  TOLEObject.Get_Index: SYSINT;
begin
  Result := DefaultInterface.Get_Index;
end;

function  TOLEObject.Get_Key: WideString;
begin
  Result := DefaultInterface.Get_Key;
end;

procedure TOLEObject.Set_Key(const pbstrKey: WideString);
begin
  DefaultInterface.Set_Key(pbstrKey);
end;

function  TOLEObject.Get_Class_: WideString;
begin
  Result := DefaultInterface.Get_Class_;
end;

function  TOLEObject.Get_DisplayType: DisplayTypeConstants;
begin
  Result := DefaultInterface.Get_DisplayType;
end;

procedure TOLEObject.Set_DisplayType(pnType: DisplayTypeConstants);
begin
  DefaultInterface.Set_DisplayType(pnType);
end;

function  TOLEObject.Get_ObjectVerbs: OleVariant;
begin
  Result := DefaultInterface.Get_ObjectVerbs;
end;

function  TOLEObject.Get_ObjectVerbFlags: OleVariant;
begin
  Result := DefaultInterface.Get_ObjectVerbFlags;
end;

function  TOLEObject.Get_ObjectVerbsCount: SYSINT;
begin
  Result := DefaultInterface.Get_ObjectVerbsCount;
end;

procedure TOLEObject.DoVerb;
begin
  DefaultInterface.DoVerb(EmptyParam);
end;

procedure TOLEObject.DoVerb(verb: OleVariant);
begin
  DefaultInterface.DoVerb(verb);
end;

function  TOLEObject.FetchVerbs: SYSINT;
begin
  Result := DefaultInterface.FetchVerbs;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TOLEObjectProperties.Create(AServer: TOLEObject);
begin
  inherited Create;
  FServer := AServer;
end;

function TOLEObjectProperties.GetDefaultInterface: IOLEObject;
begin
  Result := FServer.DefaultInterface;
end;

function  TOLEObjectProperties.Get_Index: SYSINT;
begin
  Result := DefaultInterface.Get_Index;
end;

function  TOLEObjectProperties.Get_Key: WideString;
begin
  Result := DefaultInterface.Get_Key;
end;

procedure TOLEObjectProperties.Set_Key(const pbstrKey: WideString);
begin
  DefaultInterface.Set_Key(pbstrKey);
end;

function  TOLEObjectProperties.Get_Class_: WideString;
begin
  Result := DefaultInterface.Get_Class_;
end;

function  TOLEObjectProperties.Get_DisplayType: DisplayTypeConstants;
begin
  Result := DefaultInterface.Get_DisplayType;
end;

procedure TOLEObjectProperties.Set_DisplayType(pnType: DisplayTypeConstants);
begin
  DefaultInterface.Set_DisplayType(pnType);
end;

function  TOLEObjectProperties.Get_ObjectVerbs: OleVariant;
begin
  Result := DefaultInterface.Get_ObjectVerbs;
end;

function  TOLEObjectProperties.Get_ObjectVerbFlags: OleVariant;
begin
  Result := DefaultInterface.Get_ObjectVerbFlags;
end;

function  TOLEObjectProperties.Get_ObjectVerbsCount: SYSINT;
begin
  Result := DefaultInterface.Get_ObjectVerbsCount;
end;
...
procedure Register;
begin
  RegisterComponents('Samples',[TRichTextBox]);
  RegisterComponents('Samples',[TOLEObjects, TOLEObject]);
end;
