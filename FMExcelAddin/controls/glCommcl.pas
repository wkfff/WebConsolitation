...
TglHintStyle = class(TglListBoxItemStyle)
end;

TglSpeedButtonStyle = class(TglListBoxItemStyle)
published
...
function TglBevel.BordersHeight: integer;
begin
  Result := 0;
...
function TglBevel.BordersWidth: integer;
begin
  Result := 0;
  if Inner <> bvNone then
  begin
...
function TglCustomListBoxItemStyle.HighlightColor: TColor;
begin
  Result := incColor(Color, 60);
end;

function TglCustomListBoxItemStyle.ShadowColor: TColor;
begin
