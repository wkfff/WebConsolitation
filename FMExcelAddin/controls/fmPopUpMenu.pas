...
type
  ...
  published
    ...
    property CheckBoxBackground : TColor Read CheckBoxColor write CheckBoxColor default $006B2408;
  end;
...
constructor TfmPopUpMenu.Create(AOwner: TComponent);
begin
...
destructor TfmPopUpMenu.Destroy;
begin
 Try
  LP.Remove(self);
  LP.free;
...
procedure TfmPopUpMenu.Notification(AComponent: TComponent;Operation: TOperation);
Begin
...
Procedure TfmPopUpMenu.SetCustomDrawn;
var i: Integer;
begin
  PopupHeight := 0;
  Drawn := False;
...
procedure TfmPopUpMenu.Popup(X, Y: Integer);
var i: Integer;
  pm : TTPMParams;
  Store : TpopUpList;
begin
...
Procedure TfmPopUpMenu.MakeSubCustomDraw(SubMenu : TMenuItem);
var i: Integer;
begin
...
procedure TfmPopUpMenu.ExpandSubItemWidth(Sender: TObject;
...
procedure TfmPopUpMenu.ExpandItemWidth(Sender: TObject;
  ACanvas: TCanvas; var Width, Height: Integer);
var
  MenuItem: TMenuItem;
begin
...
procedure TfmPopUpMenu.AdvancedDrawItem(Sender: TObject;
...
Procedure TfmPopUpMenu.DrawTick(ACanvas : TCanvas; CheckedRect : TRect; Selected : Boolean);
var X1, X2: integer;
begin
...
Procedure TfmPopUpMenu.DrawChecked(Item : TMenuItem; ACanvas : TCanvas; ARect : TRect);
Begin
...
Procedure TfmPopUpMenu.DrawGlpyh(Item : TMenuItem; Canvas : TCanvas; Arect : TRect; Idx : Integer);
Begin
...
Procedure TfmPopUpMenu.DrawCaption(Item : TMenuItem; Canvas : TCanvas; Arect : TRect);
...
Procedure TfmPopUpMenu.DrawXPItem(Sender: TObject; ACanvas: TCanvas;
...
Procedure TfmPopUpMenu.DrawStandardItem(Sender: TObject; ACanvas: TCanvas;
                                    ARect: TRect; Selected: Boolean);
Var Item : TMenuItem;
    TmpRect   : TRect;
    tmp : TBitmap;
...
Procedure TfmPopUpMenu.DrawSubItem(Sender: TObject; ACanvas: TCanvas;
                                    ARect: TRect; Selected: Boolean);
Begin
 Inc(Arect.Left,2);
 If XP_Border Then
...
Procedure TfmPopUpMenu.DrawItem(Sender: TObject; ACanvas: TCanvas;
                                    ARect: TRect; Selected: Boolean);
Begin
 If XP_Border Then
   DrawXPItem(Sender,ACanvas,Arect,Selected)
...
procedure Register;
begin
  RegisterComponents('FM Controls', [TfmPopUpMenu]);
end;
